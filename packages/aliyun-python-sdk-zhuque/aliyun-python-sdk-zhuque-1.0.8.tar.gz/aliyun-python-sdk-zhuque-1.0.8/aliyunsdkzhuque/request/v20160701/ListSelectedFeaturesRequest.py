...
class ListSelectedFeaturesRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Zhuque', '2016-07-01', 'ListSelectedFeatures')
	...
	def get_Commit(self):
		return self.get_query_params().get('Commit')

	def set_Commit(self,Commit):
		self.add_query_param('Commit',Commit)
