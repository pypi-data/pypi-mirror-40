...
class SaveProjectComponentPackagesRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Zhuque', '2016-07-01', 'SaveProjectComponentPackages')

	def get_IgnoreCheck(self):
		return self.get_query_params().get('IgnoreCheck')

	def set_IgnoreCheck(self,IgnoreCheck):
		self.add_query_param('IgnoreCheck',IgnoreCheck)
