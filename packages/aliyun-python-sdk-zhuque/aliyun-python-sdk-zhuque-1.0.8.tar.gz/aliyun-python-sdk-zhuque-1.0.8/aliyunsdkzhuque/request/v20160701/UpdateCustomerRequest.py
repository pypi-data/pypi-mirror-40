...
class UpdateCustomerRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'Zhuque', '2016-07-01', 'UpdateCustomer')
	...
	def get_NewCustomerId(self):
		return self.get_query_params().get('NewCustomerId')

	def set_NewCustomerId(self,NewCustomerId):
		self.add_query_param('NewCustomerId',NewCustomerId)
