...
class ListCommitRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Zhuque', '2016-07-01', 'ListCommit')
	...
	def get_ProductBase(self):
		return self.get_query_params().get('ProductBase')

	def set_ProductBase(self,ProductBase):
		self.add_query_param('ProductBase',ProductBase)