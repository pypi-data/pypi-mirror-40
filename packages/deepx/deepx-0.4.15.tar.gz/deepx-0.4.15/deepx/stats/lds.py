...
class LDS(ExponentialFamily):
    ...
    def internal_to_natural(cls, internal_parameters):
        ...
        if potentials is None:
            ...
            # potentials_natparam = T.core.Print(potentials_natparam, [potentials_natparam], 'Potentials')
            # dynamics_natparam = T.core.Print(dynamics_natparam, [dynamics_natparam], 'Dynamics')
            # prior_natparam = T.core.Print(prior_natparam, [prior_natparam], 'Prior')
