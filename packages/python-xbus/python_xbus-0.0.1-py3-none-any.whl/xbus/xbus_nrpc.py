...
class EnvelopeStorageHandler:
    ...
    def subject(self, method='>'):
        return '.'.join([
            "xbus", EnvelopeStorage_SUBJECT, method
        ])
...
class ClientAPIHandler:
    ...
    def subject(self, svc_accountID='*', method='>'):
        return '.'.join([
            "xbus", ClientAPI_SUBJECT, svc_accountID, method
        ])
...
ProcessState_SUBJECT_PARAMS = ['emitterID']
ProcessState_SUBJECT_PARAMS_COUNT = 1


class ProcessStateHandler:
    methods = {
        'envelope': ('Envelope', 1, nrpc_dot_nrpc__pb2.NoRequest, True, False, False),
    }
    ...
    def subject(self, svc_emitterID='*', method='>'):
        return '.'.join([
            "xbus", ProcessState_SUBJECT, svc_emitterID, method
        ])
...
class ProcessStateClient:
    def __init__(
        ...
        self.nc = nc
        self.svc_emitterID = svc_emitterID
    ...
    async def Envelope(
        ...
        subject = PKG_SUBJECT + '.' + ProcessState_SUBJECT + '.' + self.svc_emitterID + '.' + 'envelope' + '.' + envelopeID
        rawReq = req.SerializeToString()
...
class ActorAgentHandler:
    ...
    def subject(self, svc_actorID='*', method='>'):
        return '.'.join([
            "xbus", ActorAgent_SUBJECT, svc_actorID, method
        ])
...
class BrokerHandler:
    ...
    def subject(self, svc_actorID='*', method='>'):
        return '.'.join([
            "xbus", Broker_SUBJECT, svc_actorID, method
        ])
...
class CoreEventsHandler:
    ...
    def subject(self, method='>'):
        return '.'.join([
            "xbus", CoreEvents_SUBJECT, method
        ])
...
class SvcRegistrationHandler:
    ...
    def subject(self, method='>'):
        return '.'.join([
            "xbus", SvcRegistration_SUBJECT, method
        ])
