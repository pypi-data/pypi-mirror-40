...
class AccountHandler:
    ...
    def subject(self, method='>'):
        return '.'.join([
            "xbus.control", Account_SUBJECT, method
        ])
...
class ActorHandler:
    ...
    def subject(self, method='>'):
        return '.'.join([
            "xbus.control", Actor_SUBJECT, method
        ])
...
class EnvelopeHandler:
    ...
    def subject(self, method='>'):
        return '.'.join([
            "xbus.control", Envelope_SUBJECT, method
        ])
...
class PipelineHandler:
    ...
    def subject(self, method='>'):
        return '.'.join([
            "xbus.control", Pipeline_SUBJECT, method
        ])
...
class LogsHandler:
    ...
    def subject(self, method='>'):
        return '.'.join([
            "xbus.control", Logs_SUBJECT, method
        ])
...
class PMProcessHandler:
    methods = {
        'query': ('Query', 0, xbus_dot_control__pb2.PMProcessQueryRequest, True, False, False),
    ...
    def subject(self, method='>'):
        return '.'.join([
            "xbus.control", PMProcess_SUBJECT, method
        ])
...
class PMProcessClient:
    ...
    async def Query(
        ...
        if rawRep.data and rawRep.data[0] == 0:
            raise nrpc.exc.from_error(
                nrpc_pb2.Error.FromString(rawRep.data[1:]))
        return xbus_dot_control__pb2.PMProcessQueryReply.FromString(rawRep.data)
...
class ProcessHandler:
    ...
    def subject(self, method='>'):
        return '.'.join([
            "xbus.control", Process_SUBJECT, method
        ])
