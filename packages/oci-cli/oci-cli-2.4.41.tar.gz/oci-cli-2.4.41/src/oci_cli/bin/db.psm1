...
function GetOciSubcommands_db() {
    $ociSubcommands = @{
        ...
        'db autonomous-database' = 'create delete generate-wallet get list restore start stop update'
        ...
        'db system' = 'get launch launch-from-backup list patch terminate update'
...
function GetOciCommandsToLongParams_db() {
    $ociCommandsToLongParams = @{
        ...
        'db system launch' = 'admin-password availability-domain backup-subnet-id character-set cluster-name compartment-id cpu-core-count data-storage-percentage database-edition db-name db-version db-workload defined-tags disk-redundancy display-name domain freeform-tags from-json help hostname initial-data-storage-size-in-gb license-model max-wait-seconds ncharacter-set node-count pdb-name shape sparse-diskgroup ssh-authorized-keys-file subnet-id wait-for-state wait-interval-seconds'
        'db system launch-from-backup' = 'admin-password availability-domain backup-id backup-subnet-id backup-tde-password cluster-name compartment-id cpu-core-count data-storage-percentage database-edition defined-tags disk-redundancy display-name domain freeform-tags from-json help hostname initial-data-storage-size-in-gb license-model max-wait-seconds node-count shape sparse-diskgroup ssh-authorized-keys-file subnet-id wait-for-state wait-interval-seconds'
