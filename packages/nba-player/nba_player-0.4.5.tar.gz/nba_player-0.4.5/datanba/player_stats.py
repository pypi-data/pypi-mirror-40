...
class AllOfBasketball:
    ...
    def gather(self, file_name):
        remove_ids = []
        decoded_file = players_from_json(file_name)
            ...
            for player in players:
                try:
                    ...
                    with open(file_name, 'w') as file:
                        file.write(jsonpickle.encode(self.profs))

                    time.sleep(1.0)

                except(KeyError, IndexError, requests.exceptions.ConnectionError):
