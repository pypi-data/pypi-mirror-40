...
class Player:
    def __init__(self, id, name, current):
        ...
        self.raw_data_seasons = []
        self.advanced_statistic_seasons = []
    ...
    def find_advanced_for_year(self, year):
        ...
        return None
    def ret_stuff(self):
        return ((self.advanced_statistics[-1].secondaryassist+self.raw_data_seasons[-1].ast)*2.678245121380469)+self.raw_data_seasons[-1].pts+(self.raw_data_seasons[-1].reb*1.2076782265205361)+(self.raw_data_seasons[-1].stl*1.2076782265205361)+(self.raw_data_seasons[-1].blk*1.2076782265205361)-(self.raw_data_seasons[-1].tov*1.2076782265205361)-(self.raw_data_seasons[-1].pf*1.2076782265205361)
...
class AdvancedStatisticSeason:
    def __init__(self, playerid, teamid, teamabr, gp, min, wins, losses, win_p, offensive_rating, defensive_rating, net_rating, ast_pct, ast_to, ast_ratio, oreb_percentage, dreb_percentage, tm_tov_pct, ts_pct, usg_pct, pace, pie, year):
        self.playerid = playerid
        self.teamid = teamid
        self.teamabr = teamabr
        self.gp = gp
        ...
        for year in self.years:
            ...
            for player in players:
                try:
                    ...
                    for c in i["rowSet"]:
                        season = RawDataSeason(player.id, c[1], c[3], c[4], c[5], c[6], c[7], c[8], c[9], c[10],
                        c[11], c[12], c[13], c[14], c[15], c[16], c[17], c[18], c[19],
                        c[20], c[21], c[22], c[23], c[24], c[25], c[26])
                        player.raw_data_seasons.append(season)
                    ...
                    for c in i_advanced["rowSet"]:
                        season = AdvancedStatisticSeason(player.id, c[2], c[3],
                        c[5], c[9], c[6], c[7], c[8], c[10], c[11], c[12], c[13], c[14],
                        c[15], c[16], c[17], c[19], c[21], c[22], c[23], c[24], c[1])
                        player.advanced_statistic_seasons.append(season)
