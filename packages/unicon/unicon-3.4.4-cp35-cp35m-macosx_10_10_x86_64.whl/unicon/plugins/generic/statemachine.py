...
pre_connection_statement_list = [statements.escape_char_stmt,
...
authentication_statement_list = [statements.bad_password_stmt,
                                 statements.login_stmt,
                                 statements.useraccess_stmt,
                                 statements.password_stmt,
                                 statements.password_ok_stmt,
                                 ]
#############################################################
