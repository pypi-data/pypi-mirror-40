...
class AutoMLConfig(object):
    ...
    This configuration object contains persists the parameters for configuring
    the AutoML experiment as well as the data to be used at run time. This
    configuration is directly submitted as an AzureML experiment as follows:
    ...
    :param max_concurrent_iterations:
        ...
        This should be less than the number of cores on the AzureML compute.
