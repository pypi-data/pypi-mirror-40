...
# ---------------------------------------------------------
"""_win32_helper.py, Helper code that wraps the Win32 API using ctypes."""
...
class PROCESS_MEMORY_COUNTERS_EX(ctypes.Structure):
    """Keep track of process memory counters."""
...
class IO_COUNTERS(ctypes.Structure):
    """Keep track of process input output counters."""
...
class JOBOBJECT_BASIC_ACCOUNTING_INFORMATION(ctypes.Structure):
    """Keep track of job accounting counters."""
...
class JOBOBJECT_BASIC_AND_IO_ACCOUNTING_INFORMATION(ctypes.Structure):
    """Keep track of job accounting and input output counters."""
...
class JobObjectInfoClass(object):
    """Keep information for job accounting."""
...
class Win32Helper(object):
    """Handle all process interactions for a windows process."""
    ...
    def close_handle(self, handle):
        """
        Wrap the Win32 CloseHandle function.
    ...
    def get_process_id(self):
        """
        Wrap the Win32 GetProcessId function.
    ...
    def open_process(self, pid=None):
        """
        Wrap the Win32 OpenProcess function.
    ...
    def get_process_memory_info(self, pid=None):
        """
        Wrap the Win32 GetProcessMemoryInfo function.
    ...
    def assign_process_to_job_object(self, job, pid=None):
        """
        Wrap the Win32 AssignProcessToJobObject function.
    ...
    def is_process_in_job(self):
        """
        Wrap the Win32 IsProcessInJob function.
    ...
    def query_information_job_object(self, job_object_info_class, job_info_struct):
        """
        Wrap the Win32 QueryInformationJobObject function.
    ...
    def get_process_times(self, pid=None):
        """
        Wrap the Win32 GetProcessTimes function.
    ...
    def get_current_memory_usage(self):
        """
        Get the physical and virtual memory usage of this process.
    ...
    def get_children_memory_usage(self):
        """
        Get the physical and virtual memory usage of all of this process's children.
    ...
    def get_job_accounting_info(self):
        """
        Get the basic accounting and I/O accounting information for the job this process is in.
    ...
    def get_job_process_list(self):
        """
        Get the list of pids of all processes associated with the job this process is in.
    ...
    def get_child_process_times(self):
        """
        Get the timing information for all currently running processes in this job, except this one.
    ...
    def get_resource_usage(self):
        """
        Get the resource usage for both this process and all child processes in this job.
