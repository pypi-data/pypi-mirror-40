...
class _Pickler(ABC):
    ...
    def dump(self, obj, path, protocol=None):
        """
        Dump the object to file based on protocol.
...
class _DefaultPickler(_Pickler):
    ...
    def dump(self, obj, path, protocol=DEFAULT_PICKLER_VERSION):
        """
        Dump the object to a file based on the provided protocol.

        :param obj: The object to pickle.
        :param path: The path the pickler will use.
        :param protocol: The pickler protocol version.
        :return: The path.
        """
        try:
...
class _ChunkPickler(_Pickler):
    ...
    def _try_write_chunks(self, base_dir, bio, chunk_content, meta_file, pickle_file_name):
        ...
        :param bio: The bytes to write to file
