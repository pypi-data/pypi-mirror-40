...
class State:
    ...
    def sqrt_y(self, target):
        self.apply_gate(qcgpu.gate.sqrt_y(), target)

    def cx(self, control, target):
        self.apply_controlled_gate(qcgpu.gate.x(), control, target)

    def cz(self, control, target):
        self.apply_controlled_gate(qcgpu.gate.z(), control, target)
    ...
    def cu1(self, control, target, lda):
        self.cu(control, target, 0.0, 0.0, lda)
