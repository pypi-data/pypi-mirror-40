...
from RecursionTree.settings import CONN_COLOR, CONN_WIDTH, NUM_SHIFT, DRAW_CALLS, OUTLINE_COLOR
from RecursionTree.settings import FONT_SIZE, FUNC_NAME_COLOR, LABEL_COLOR, BG_COLOR
