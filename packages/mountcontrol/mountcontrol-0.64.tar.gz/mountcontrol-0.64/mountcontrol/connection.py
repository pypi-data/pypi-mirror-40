...
class Connection(object):
    ...
    COMMANDS = [':AP', ':FLIP', ':GDUT', ':GDUTV', ':GMs', ':GREF', ':GRPRS',
                ...
                ':GVZ', ':Gdat', ':Gev', ':Gg', ':Gh', ':Ginfo', ':Glms', ':Glmt',
                ':Gmte', ':Go', ':Gt', ':Guaf', ':MA', ':MS', ':MSao', ':MSap', ':PO',
                ':PO', ':PO', ':RT0', ':RT1', ':RT2', ':RT9', ':SREF', ':SRPRS', ':SRPRS',
                ':SRTMP', ':SRTMP', ':STOP', ':Sa', ':Sd', ':Sdat', ':Sev', ':Sev', ':Sg',
                ':Sg', ':Sh+', ':Slms', ':Slmt', ':So', ':Sr', ':St', ':Suaf', ':Sw',
                ':Sz', ':U2', ':delalig', ':delalst', ':endalig', ':getain', ':getalp',
                ':getalst', ':hP', ':modelcnt', ':modeldel0', ':modelld0', ':modelnam',
