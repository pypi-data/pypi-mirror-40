...
static PyObject *meth_wxAuiDockUIPartArray_append(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxAuiDockUIPartArray, &sipCpp, sipType_wxAuiDockUIPart, &obj))
        {
        sipCpp->Add(*obj);
...
static int slot_wxAuiDockUIPartArray___contains__(PyObject *sipSelf,PyObject *sipArg)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_AuiDockUIPartArray, sipName___contains__, NULL);
...
static PyObject *slot_wxAuiDockUIPartArray___getitem__(PyObject *sipSelf,PyObject *sipArg)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArg, "1l", &index))
        {
            ...
            if (sipError == sipErrorNone)
            {
            return sipConvertFromType(sipRes,sipType_wxAuiDockUIPart,NULL);
            }
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_AuiDockUIPartArray, sipName___getitem__, NULL);
...
static void *init_type_wxAuiDockUIPartArray(sipSimpleWrapper *, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxAuiDockUIPartArray, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxAuiDockUIPartArray[] = {
    {SIP_MLNAME_CAST(sipName_append), (PyCFunction)meth_wxAuiDockUIPartArray_append, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxAuiDockUIPartArray_append)},
    {SIP_MLNAME_CAST(sipName_index), (PyCFunction)meth_wxAuiDockUIPartArray_index, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxAuiDockUIPartArray_index)}
};
