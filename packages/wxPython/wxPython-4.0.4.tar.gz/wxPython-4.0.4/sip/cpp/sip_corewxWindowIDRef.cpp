...
static PyObject *meth_wxWindowIDRef_GetValue(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_WindowIDRef, sipName_GetValue, NULL);
...
static PyObject *meth_wxWindowIDRef_GetId(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_WindowIDRef, sipName_GetId, NULL);
...
extern "C" {static void *array_wxWindowIDRef(SIP_SSIZE_T);}
static void *array_wxWindowIDRef(SIP_SSIZE_T sipNrElem)
{
...
sipVariableDef variables_wxWindowIDRef[] = {
    {PropertyVariable, sipName_Value, &methods_wxWindowIDRef[1], NULL, NULL, NULL},
    {PropertyVariable, sipName_Id, &methods_wxWindowIDRef[0], NULL, NULL, NULL},
};
