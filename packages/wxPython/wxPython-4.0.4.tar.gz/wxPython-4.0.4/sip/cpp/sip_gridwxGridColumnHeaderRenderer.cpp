...
sipwxGridColumnHeaderRenderer::sipwxGridColumnHeaderRenderer():  ::wxGridColumnHeaderRenderer(), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxGridColumnHeaderRenderer::sipwxGridColumnHeaderRenderer(const  ::wxGridColumnHeaderRenderer& a0):  ::wxGridColumnHeaderRenderer(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
void sipwxGridColumnHeaderRenderer::DrawLabel(const  ::wxGrid& grid, ::wxDC& dc,const  ::wxString& value,const  ::wxRect& rect,int horizAlign,int vertAlign,int textOrientation) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[1]),sipPySelf,NULL,sipName_DrawLabel);
...
static void dealloc_wxGridColumnHeaderRenderer(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxGridColumnHeaderRenderer *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxGridColumnHeaderRenderer *sipCpp = 0;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxGridColumnHeaderRenderer, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxGridColumnHeaderRenderer[] = {{33, 255, 1}};
