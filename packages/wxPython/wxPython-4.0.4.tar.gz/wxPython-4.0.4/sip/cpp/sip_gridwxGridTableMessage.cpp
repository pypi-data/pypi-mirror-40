...
static PyObject *meth_wxGridTableMessage_SetTableObject(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8", &sipSelf, sipType_wxGridTableMessage, &sipCpp, sipType_wxGridTableBase, &table))
        {
            PyErr_Clear();
    ...
    sipNoMethod(sipParseErr, sipName_GridTableMessage, sipName_SetTableObject, NULL);
...
static PyObject *meth_wxGridTableMessage_GetTableObject(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxGridTableMessage, &sipCpp))
        {
            ...
            return sipConvertFromType(sipRes,sipType_wxGridTableBase,NULL);
        }
    }

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GridTableMessage, sipName_GetTableObject, NULL);
...
static PyObject *meth_wxGridTableMessage_SetId(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bi", &sipSelf, sipType_wxGridTableMessage, &sipCpp, &id))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GridTableMessage, sipName_SetId, NULL);
...
static PyObject *meth_wxGridTableMessage_GetId(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GridTableMessage, sipName_GetId, NULL);
...
static PyObject *meth_wxGridTableMessage_SetCommandInt(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bi", &sipSelf, sipType_wxGridTableMessage, &sipCpp, &comInt1))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GridTableMessage, sipName_SetCommandInt, NULL);
...
static PyObject *meth_wxGridTableMessage_GetCommandInt(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GridTableMessage, sipName_GetCommandInt, NULL);
...
static PyObject *meth_wxGridTableMessage_SetCommandInt2(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bi", &sipSelf, sipType_wxGridTableMessage, &sipCpp, &comInt2))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GridTableMessage, sipName_SetCommandInt2, NULL);
...
static PyObject *meth_wxGridTableMessage_GetCommandInt2(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GridTableMessage, sipName_GetCommandInt2, NULL);
...
static PyMethodDef methods_wxGridTableMessage[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SetCommandInt), (PyCFunction)meth_wxGridTableMessage_SetCommandInt, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridTableMessage_SetCommandInt)},
    {SIP_MLNAME_CAST(sipName_SetCommandInt2), (PyCFunction)meth_wxGridTableMessage_SetCommandInt2, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridTableMessage_SetCommandInt2)},
    {SIP_MLNAME_CAST(sipName_SetId), (PyCFunction)meth_wxGridTableMessage_SetId, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridTableMessage_SetId)},
    {SIP_MLNAME_CAST(sipName_SetTableObject), (PyCFunction)meth_wxGridTableMessage_SetTableObject, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridTableMessage_SetTableObject)}
};

sipVariableDef variables_wxGridTableMessage[] = {
    {PropertyVariable, sipName_TableObject, &methods_wxGridTableMessage[3], &methods_wxGridTableMessage[7], NULL, NULL},
    {PropertyVariable, sipName_Id, &methods_wxGridTableMessage[2], &methods_wxGridTableMessage[6], NULL, NULL},
    {PropertyVariable, sipName_CommandInt2, &methods_wxGridTableMessage[1], &methods_wxGridTableMessage[5], NULL, NULL},
    {PropertyVariable, sipName_CommandInt, &methods_wxGridTableMessage[0], &methods_wxGridTableMessage[4], NULL, NULL},
};
