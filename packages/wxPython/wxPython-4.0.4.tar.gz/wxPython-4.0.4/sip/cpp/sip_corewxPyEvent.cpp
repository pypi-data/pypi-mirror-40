...
sipwxPyEvent::sipwxPyEvent(int id, ::wxEventType eventType):  ::wxPyEvent(id,eventType), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxPyEvent::sipwxPyEvent(const  ::wxPyEvent& a0):  ::wxPyEvent(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
static PyObject *meth_wxPyEvent___getattr__(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BP0", &sipSelf, sipType_wxPyEvent, &sipCpp, &name))
        {
            PyObject * sipRes = 0;
    ...
    sipNoMethod(sipParseErr, sipName_PyEvent, sipName___getattr__, NULL);
...
static PyObject *meth_wxPyEvent_Clone(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PyEvent, sipName_Clone, NULL);
...
static PyObject *meth_wxPyEvent__getAttrDict(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PyEvent, sipName__getAttrDict, NULL);
...
static int slot_wxPyEvent___setattr__(PyObject *sipSelf,PyObject *sipName,PyObject *sipValue)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PyEvent, (sipValue != NULL ? sipName___setattr__ : sipName___delattr__), NULL);
...
static void dealloc_wxPyEvent(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxPyEvent *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static void *init_type_wxPyEvent(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxPyEvent, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxPyEvent[] = {{141, 255, 1}};
...
static PyMethodDef methods_wxPyEvent[] = {
    ...
    {SIP_MLNAME_CAST(sipName___getattr__), (PyCFunction)meth_wxPyEvent___getattr__, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPyEvent___getattr__)},
