...
static PyObject *meth_wxTextAttrDimensions_Reset(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_TextAttrDimensions, sipName_Reset, NULL);
...
static PyObject *meth_wxTextAttrDimensions_EqPartial(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9|b", &sipSelf, sipType_wxTextAttrDimensions, &sipCpp, sipType_wxTextAttrDimensions, &dims, &weakTest))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TextAttrDimensions, sipName_EqPartial, NULL);
...
static PyObject *meth_wxTextAttrDimensions_Apply(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9|J8", &sipSelf, sipType_wxTextAttrDimensions, &sipCpp, sipType_wxTextAttrDimensions, &dims, sipType_wxTextAttrDimensions, &compareWith))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TextAttrDimensions, sipName_Apply, NULL);
...
static PyObject *meth_wxTextAttrDimensions_CollectCommonAttributes(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9J9J9", &sipSelf, sipType_wxTextAttrDimensions, &sipCpp, sipType_wxTextAttrDimensions, &attr, sipType_wxTextAttrDimensions, &clashingAttr, sipType_wxTextAttrDimensions, &absentAttr))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TextAttrDimensions, sipName_CollectCommonAttributes, NULL);
...
static PyObject *meth_wxTextAttrDimensions_RemoveStyle(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxTextAttrDimensions, &sipCpp, sipType_wxTextAttrDimensions, &attr))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TextAttrDimensions, sipName_RemoveStyle, NULL);
...
static PyObject *meth_wxTextAttrDimensions_GetLeft(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TextAttrDimensions, sipName_GetLeft, NULL);
...
static PyObject *meth_wxTextAttrDimensions_GetRight(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TextAttrDimensions, sipName_GetRight, NULL);
...
static PyObject *meth_wxTextAttrDimensions_GetTop(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TextAttrDimensions, sipName_GetTop, NULL);
...
static PyObject *meth_wxTextAttrDimensions_GetBottom(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TextAttrDimensions, sipName_GetBottom, NULL);
...
static PyObject *meth_wxTextAttrDimensions_IsValid(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TextAttrDimensions, sipName_IsValid, NULL);
...
static void *init_type_wxTextAttrDimensions(sipSimpleWrapper *, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxTextAttrDimensions, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxTextAttrDimensions[] = {
    {SIP_MLNAME_CAST(sipName_Apply), (PyCFunction)meth_wxTextAttrDimensions_Apply, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTextAttrDimensions_Apply)},
    {SIP_MLNAME_CAST(sipName_CollectCommonAttributes), (PyCFunction)meth_wxTextAttrDimensions_CollectCommonAttributes, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTextAttrDimensions_CollectCommonAttributes)},
    {SIP_MLNAME_CAST(sipName_EqPartial), (PyCFunction)meth_wxTextAttrDimensions_EqPartial, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTextAttrDimensions_EqPartial)},
    ...
    {SIP_MLNAME_CAST(sipName_RemoveStyle), (PyCFunction)meth_wxTextAttrDimensions_RemoveStyle, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTextAttrDimensions_RemoveStyle)},
...
sipVariableDef variables_wxTextAttrDimensions[] = {
    {PropertyVariable, sipName_Top, &methods_wxTextAttrDimensions[6], NULL, NULL, NULL},
    {PropertyVariable, sipName_Right, &methods_wxTextAttrDimensions[5], NULL, NULL, NULL},
    {PropertyVariable, sipName_Left, &methods_wxTextAttrDimensions[4], NULL, NULL, NULL},
    {PropertyVariable, sipName_Bottom, &methods_wxTextAttrDimensions[3], NULL, NULL, NULL},
    {InstanceVariable, sipName_m_bottom, (PyMethodDef *)varget_wxTextAttrDimensions_m_bottom, (PyMethodDef *)varset_wxTextAttrDimensions_m_bottom, NULL, NULL},
    {InstanceVariable, sipName_m_left, (PyMethodDef *)varget_wxTextAttrDimensions_m_left, (PyMethodDef *)varset_wxTextAttrDimensions_m_left, NULL, NULL},
    {InstanceVariable, sipName_m_right, (PyMethodDef *)varget_wxTextAttrDimensions_m_right, (PyMethodDef *)varset_wxTextAttrDimensions_m_right, NULL, NULL},
    {InstanceVariable, sipName_m_top, (PyMethodDef *)varget_wxTextAttrDimensions_m_top, (PyMethodDef *)varset_wxTextAttrDimensions_m_top, NULL, NULL},
};
