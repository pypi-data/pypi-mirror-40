...
sipwxLogTextCtrl::sipwxLogTextCtrl( ::wxTextCtrl*pTextCtrl):  ::wxLogTextCtrl(pTextCtrl), sipPySelf(0)
{
...
static PyObject *meth_wxLogTextCtrl_DoLogRecord(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BmJ1J9", &sipSelf, sipType_wxLogTextCtrl, &sipCpp, &level, sipType_wxString,&msg, &msgState, sipType_wxLogRecordInfo, &info))
        {
            PyErr_Clear();
    ...
    sipNoMethod(sipParseErr, sipName_LogTextCtrl, sipName_DoLogRecord, NULL);
...
static PyObject *meth_wxLogTextCtrl_DoLogTextAtLevel(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BmJ1", &sipSelf, sipType_wxLogTextCtrl, &sipCpp, &level, sipType_wxString,&msg, &msgState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_LogTextCtrl, sipName_DoLogTextAtLevel, NULL);
...
static PyObject *meth_wxLogTextCtrl_DoLogText(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxLogTextCtrl, &sipCpp, sipType_wxString,&msg, &msgState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_LogTextCtrl, sipName_DoLogText, NULL);
...
static void dealloc_wxLogTextCtrl(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxLogTextCtrl *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static sipEncodedTypeDef supers_wxLogTextCtrl[] = {{298, 255, 1}};


static PyMethodDef methods_wxLogTextCtrl[] = {
    {SIP_MLNAME_CAST(sipName_DoLogRecord), (PyCFunction)meth_wxLogTextCtrl_DoLogRecord, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_DoLogText), (PyCFunction)meth_wxLogTextCtrl_DoLogText, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_DoLogTextAtLevel), (PyCFunction)meth_wxLogTextCtrl_DoLogTextAtLevel, METH_VARARGS|METH_KEYWORDS, NULL}
};
