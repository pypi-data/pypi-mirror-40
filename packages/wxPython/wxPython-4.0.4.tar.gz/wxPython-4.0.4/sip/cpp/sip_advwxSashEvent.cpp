...
sipwxSashEvent::sipwxSashEvent(int id, ::wxSashEdgePosition edge):  ::wxSashEvent(id,edge), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxSashEvent::sipwxSashEvent(const  ::wxSashEvent& a0):  ::wxSashEvent(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
static PyObject *meth_wxSashEvent_GetDragRect(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_SashEvent, sipName_GetDragRect, NULL);
...
static PyObject *meth_wxSashEvent_GetDragStatus(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_SashEvent, sipName_GetDragStatus, NULL);
...
static PyObject *meth_wxSashEvent_GetEdge(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_SashEvent, sipName_GetEdge, NULL);
...
static PyObject *meth_wxSashEvent_SetEdge(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BE", &sipSelf, sipType_wxSashEvent, &sipCpp, sipType_wxSashEdgePosition, &edge))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_SashEvent, sipName_SetEdge, NULL);
...
static PyObject *meth_wxSashEvent_SetDragRect(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxSashEvent, &sipCpp, sipType_wxRect, &rect, &rectState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_SashEvent, sipName_SetDragRect, NULL);
...
static PyObject *meth_wxSashEvent_SetDragStatus(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BE", &sipSelf, sipType_wxSashEvent, &sipCpp, sipType_wxSashDragStatus, &status))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_SashEvent, sipName_SetDragStatus, NULL);
...
static void dealloc_wxSashEvent(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxSashEvent *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static void *init_type_wxSashEvent(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxSashEvent, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxSashEvent[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SetDragRect), (PyCFunction)meth_wxSashEvent_SetDragRect, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxSashEvent_SetDragRect)},
    {SIP_MLNAME_CAST(sipName_SetDragStatus), (PyCFunction)meth_wxSashEvent_SetDragStatus, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxSashEvent_SetDragStatus)},
    {SIP_MLNAME_CAST(sipName_SetEdge), (PyCFunction)meth_wxSashEvent_SetEdge, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxSashEvent_SetEdge)}
};

sipVariableDef variables_wxSashEvent[] = {
    {PropertyVariable, sipName_Edge, &methods_wxSashEvent[3], &methods_wxSashEvent[6], NULL, NULL},
    {PropertyVariable, sipName_DragStatus, &methods_wxSashEvent[2], &methods_wxSashEvent[5], NULL, NULL},
    {PropertyVariable, sipName_DragRect, &methods_wxSashEvent[1], &methods_wxSashEvent[4], NULL, NULL},
};
