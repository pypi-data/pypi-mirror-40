...
sipwxGridRowHeaderRendererDefault::sipwxGridRowHeaderRendererDefault():  ::wxGridRowHeaderRendererDefault(), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxGridRowHeaderRendererDefault::sipwxGridRowHeaderRendererDefault(const  ::wxGridRowHeaderRendererDefault& a0):  ::wxGridRowHeaderRendererDefault(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
static PyObject *meth_wxGridRowHeaderRendererDefault_DrawBorder(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9J9J1", &sipSelf, sipType_wxGridRowHeaderRendererDefault, &sipCpp, sipType_wxGrid, &grid, sipType_wxDC, &dc, sipType_wxRect, &rect, &rectState))
        {
            PyErr_Clear();
    ...
    sipNoMethod(sipParseErr, sipName_GridRowHeaderRendererDefault, sipName_DrawBorder, NULL);
...
static void dealloc_wxGridRowHeaderRendererDefault(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxGridRowHeaderRendererDefault *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxGridRowHeaderRendererDefault *sipCpp = 0;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxGridRowHeaderRendererDefault, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxGridRowHeaderRendererDefault[] = {{36, 255, 1}};


static PyMethodDef methods_wxGridRowHeaderRendererDefault[] = {
    {SIP_MLNAME_CAST(sipName_DrawBorder), (PyCFunction)meth_wxGridRowHeaderRendererDefault_DrawBorder, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridRowHeaderRendererDefault_DrawBorder)}
};
