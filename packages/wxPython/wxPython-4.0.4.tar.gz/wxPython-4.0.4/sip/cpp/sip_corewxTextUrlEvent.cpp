...
sipwxTextUrlEvent::sipwxTextUrlEvent(int winid,const  ::wxMouseEvent& evtMouse,long start,long end):  ::wxTextUrlEvent(winid,evtMouse,start,end), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxTextUrlEvent::sipwxTextUrlEvent(const  ::wxTextUrlEvent& event):  ::wxTextUrlEvent(event), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
static PyObject *meth_wxTextUrlEvent_GetMouseEvent(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxTextUrlEvent, &sipCpp))
        {
            ...
            return sipConvertFromNewType(sipRes,sipType_wxMouseEvent,NULL);
        }
    }

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TextUrlEvent, sipName_GetMouseEvent, NULL);
...
static PyObject *meth_wxTextUrlEvent_GetURLStart(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TextUrlEvent, sipName_GetURLStart, NULL);
...
static PyObject *meth_wxTextUrlEvent_GetURLEnd(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TextUrlEvent, sipName_GetURLEnd, NULL);
...
static PyObject *meth_wxTextUrlEvent_Clone(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TextUrlEvent, sipName_Clone, NULL);
...
static void dealloc_wxTextUrlEvent(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxTextUrlEvent *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static sipEncodedTypeDef supers_wxTextUrlEvent[] = {{78, 255, 1}};
...
sipVariableDef variables_wxTextUrlEvent[] = {
    {PropertyVariable, sipName_URLStart, &methods_wxTextUrlEvent[3], NULL, NULL, NULL},
    {PropertyVariable, sipName_URLEnd, &methods_wxTextUrlEvent[2], NULL, NULL, NULL},
    {PropertyVariable, sipName_MouseEvent, &methods_wxTextUrlEvent[1], NULL, NULL, NULL},
};
