...
sipwxStaticBoxSizer::sipwxStaticBoxSizer( ::wxStaticBox*box,int orient):  ::wxStaticBoxSizer(box,orient), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxStaticBoxSizer::sipwxStaticBoxSizer(int orient, ::wxWindow*parent,const  ::wxString& label):  ::wxStaticBoxSizer(orient,parent,label), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
static PyObject *meth_wxStaticBoxSizer_GetStaticBox(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxStaticBoxSizer, &sipCpp))
        {
            ...
            return sipConvertFromType(sipRes,sipType_wxStaticBox,NULL);
        }
    }

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_StaticBoxSizer, sipName_GetStaticBox, NULL);
...
static PyObject *meth_wxStaticBoxSizer_CalcMin(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_StaticBoxSizer, sipName_CalcMin, NULL);

    return NULL;
}


PyDoc_STRVAR(doc_wxStaticBoxSizer_RecalcSizes, "RecalcSizes()\n"
"\n"
"Implements the calculation of a box sizer's dimensions and then sets\n"
"the size of its children (calling wxWindow::SetSize if the child is a\n"
"window).");

extern "C" {static PyObject *meth_wxStaticBoxSizer_RecalcSizes(PyObject *, PyObject *);}
static PyObject *meth_wxStaticBoxSizer_RecalcSizes(PyObject *sipSelf, PyObject *sipArgs)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxStaticBoxSizer, &sipCpp))
        {
            ...
            Py_BEGIN_ALLOW_THREADS
            (sipSelfWasArg ? sipCpp-> ::wxStaticBoxSizer::RecalcSizes() : sipCpp->RecalcSizes());
            Py_END_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_StaticBoxSizer, sipName_RecalcSizes, NULL);
...
static void dealloc_wxStaticBoxSizer(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxStaticBoxSizer *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static PyMethodDef methods_wxStaticBoxSizer[] = {
    ...
    {SIP_MLNAME_CAST(sipName_RecalcSizes), meth_wxStaticBoxSizer_RecalcSizes, METH_VARARGS, SIP_MLDOC_CAST(doc_wxStaticBoxSizer_RecalcSizes)}
};

sipVariableDef variables_wxStaticBoxSizer[] = {
    {PropertyVariable, sipName_StaticBox, &methods_wxStaticBoxSizer[1], NULL, NULL, NULL},
};
