...
{
     ::wxWebView* sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "DiNNNlN", parent, sipType_wxWindow, NULL, id, new  ::wxString(url), sipType_wxString, NULL, new  ::wxPoint(pos), sipType_wxPoint, NULL, new  ::wxSize(size), sipType_wxSize, NULL, style, new  ::wxString(name), sipType_wxString, NULL);
...
{
     ::wxFSFile* sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "N", new  ::wxString(uri), sipType_wxString, NULL);
...
static sipEnumTypeDef enumTypes[] = {
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxWebViewFindFlags, {0}, 0}, sipNameNr_WebViewFindFlags, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxWebViewReloadFlags, {0}, 0}, sipNameNr_WebViewReloadFlags, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxWebViewNavigationError, {0}, 0}, sipNameNr_WebViewNavigationError, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxWebViewZoomType, {0}, 0}, sipNameNr_WebViewZoomType, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxWebViewZoom, {0}, 0}, sipNameNr_WebViewZoom, -1, NULL},
};
...
static sipImportedModuleDef importsTable[] = {
    {"wx._core", sipImportedTypes__html2__core, NULL, NULL},
    {NULL, NULL, NULL, NULL}
};
