...
sipwxRichTextCommand::sipwxRichTextCommand(const  ::wxString& name, ::wxRichTextCommandId id, ::wxRichTextBuffer*buffer, ::wxRichTextParagraphLayoutBox*container, ::wxRichTextCtrl*ctrl,bool ignoreFirstTime):  ::wxRichTextCommand(name,id,buffer,container,ctrl,ignoreFirstTime), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxRichTextCommand::sipwxRichTextCommand(const  ::wxString& name):  ::wxRichTextCommand(name), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
bool sipwxRichTextCommand::CanUndo() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[0]),sipPySelf,NULL,sipName_CanUndo);
...
bool sipwxRichTextCommand::Do()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[1],sipPySelf,NULL,sipName_Do);
 ...
 ::wxString sipwxRichTextCommand::GetName() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[2]),sipPySelf,NULL,sipName_GetName);
...
bool sipwxRichTextCommand::Undo()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[3],sipPySelf,NULL,sipName_Undo);
...
static PyObject *meth_wxRichTextCommand_Do(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_RichTextCommand, sipName_Do, NULL);
...
static PyObject *meth_wxRichTextCommand_Undo(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextCommand, sipName_Undo, NULL);
...
static PyObject *meth_wxRichTextCommand_AddAction(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ:", &sipSelf, sipType_wxRichTextCommand, &sipCpp, sipType_wxRichTextAction, &action))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextCommand, sipName_AddAction, NULL);
...
static PyObject *meth_wxRichTextCommand_ClearActions(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextCommand, sipName_ClearActions, NULL);
...
static PyObject *meth_wxRichTextCommand_GetActions(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxRichTextCommand, &sipCpp))
        {
            ...
            return sipConvertFromType(sipRes,sipType_wxRichTextActionList,NULL);
        }
    }

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextCommand, sipName_GetActions, NULL);
...
static void dealloc_wxRichTextCommand(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxRichTextCommand *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static PyMethodDef methods_wxRichTextCommand[] = {
    {SIP_MLNAME_CAST(sipName_AddAction), (PyCFunction)meth_wxRichTextCommand_AddAction, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextCommand_AddAction)},
...
sipVariableDef variables_wxRichTextCommand[] = {
    {PropertyVariable, sipName_Actions, &methods_wxRichTextCommand[3], NULL, NULL, NULL},
};
