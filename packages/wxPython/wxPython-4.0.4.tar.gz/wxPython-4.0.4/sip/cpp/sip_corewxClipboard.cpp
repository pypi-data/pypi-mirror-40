...
void sipwxClipboard::UsePrimarySelection(bool primary)
{
    ...
    sipVH__core_87(sipGILState, 0, sipPySelf, sipMeth, primary);
}
...
bool sipwxClipboard::SetData( ::wxDataObject*data)
{
    ...
    extern bool sipVH__core_84(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDataObject*);

    return sipVH__core_84(sipGILState, 0, sipPySelf, sipMeth, data);
}
...
bool sipwxClipboard::IsSupported(const  ::wxDataFormat& format)
{
    ...
    extern bool sipVH__core_86(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxDataFormat&);

    return sipVH__core_86(sipGILState, 0, sipPySelf, sipMeth, format);
}
...
bool sipwxClipboard::GetData( ::wxDataObject& data)
{
    ...
    extern bool sipVH__core_85(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDataObject&);

    return sipVH__core_85(sipGILState, 0, sipPySelf, sipMeth, data);
}
...
static sipEncodedTypeDef supers_wxClipboard[] = {{358, 255, 1}};
