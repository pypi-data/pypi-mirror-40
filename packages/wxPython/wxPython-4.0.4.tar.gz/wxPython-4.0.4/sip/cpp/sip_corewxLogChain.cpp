...
sipwxLogChain::sipwxLogChain( ::wxLog*logger):  ::wxLogChain(logger), sipPySelf(0)
{
...
static PyObject *meth_wxLogChain_DoLogRecord(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BmJ1J9", &sipSelf, sipType_wxLogChain, &sipCpp, &level, sipType_wxString,&msg, &msgState, sipType_wxLogRecordInfo, &info))
        {
            PyErr_Clear();
    ...
    sipNoMethod(sipParseErr, sipName_LogChain, sipName_DoLogRecord, NULL);
...
static PyObject *meth_wxLogChain_DoLogTextAtLevel(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BmJ1", &sipSelf, sipType_wxLogChain, &sipCpp, &level, sipType_wxString,&msg, &msgState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_LogChain, sipName_DoLogTextAtLevel, NULL);
...
static PyObject *meth_wxLogChain_DoLogText(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxLogChain, &sipCpp, sipType_wxString,&msg, &msgState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_LogChain, sipName_DoLogText, NULL);
...
static PyObject *meth_wxLogChain_DetachOldLog(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_LogChain, sipName_DetachOldLog, NULL);
...
static PyObject *meth_wxLogChain_GetOldLog(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_LogChain, sipName_GetOldLog, NULL);
...
static PyObject *meth_wxLogChain_IsPassingMessages(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_LogChain, sipName_IsPassingMessages, NULL);
...
static PyObject *meth_wxLogChain_PassMessages(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bb", &sipSelf, sipType_wxLogChain, &sipCpp, &passMessages))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_LogChain, sipName_PassMessages, NULL);
...
static PyObject *meth_wxLogChain_SetLog(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8", &sipSelf, sipType_wxLogChain, &sipCpp, sipType_wxLog, &logger))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_LogChain, sipName_SetLog, NULL);
...
static void dealloc_wxLogChain(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxLogChain *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static sipEncodedTypeDef supers_wxLogChain[] = {{298, 255, 1}};
...
static PyMethodDef methods_wxLogChain[] = {
    ...
    {SIP_MLNAME_CAST(sipName_DoLogRecord), (PyCFunction)meth_wxLogChain_DoLogRecord, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_DoLogText), (PyCFunction)meth_wxLogChain_DoLogText, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_DoLogTextAtLevel), (PyCFunction)meth_wxLogChain_DoLogTextAtLevel, METH_VARARGS|METH_KEYWORDS, NULL},
    ...
    {SIP_MLNAME_CAST(sipName_PassMessages), (PyCFunction)meth_wxLogChain_PassMessages, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxLogChain_PassMessages)},
    {SIP_MLNAME_CAST(sipName_SetLog), (PyCFunction)meth_wxLogChain_SetLog, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxLogChain_SetLog)}
};

sipVariableDef variables_wxLogChain[] = {
    {PropertyVariable, sipName_OldLog, &methods_wxLogChain[4], NULL, NULL, NULL},
};
