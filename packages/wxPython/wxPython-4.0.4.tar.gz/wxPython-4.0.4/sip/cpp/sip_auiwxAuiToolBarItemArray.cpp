...
static PyObject *meth_wxAuiToolBarItemArray_append(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxAuiToolBarItemArray, &sipCpp, sipType_wxAuiToolBarItem, &obj))
        {
        sipCpp->Add(*obj);
...
static int slot_wxAuiToolBarItemArray___contains__(PyObject *sipSelf,PyObject *sipArg)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_AuiToolBarItemArray, sipName___contains__, NULL);
...
static PyObject *slot_wxAuiToolBarItemArray___getitem__(PyObject *sipSelf,PyObject *sipArg)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_AuiToolBarItemArray, sipName___getitem__, NULL);
...
{
     ::wxAuiToolBarItemArray *sipCpp = 0;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxAuiToolBarItemArray, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxAuiToolBarItemArray[] = {
    {SIP_MLNAME_CAST(sipName_append), (PyCFunction)meth_wxAuiToolBarItemArray_append, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxAuiToolBarItemArray_append)},
    {SIP_MLNAME_CAST(sipName_index), (PyCFunction)meth_wxAuiToolBarItemArray_index, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxAuiToolBarItemArray_index)}
};
