...
sipwxMetafileDC::sipwxMetafileDC(const  ::wxString& filename):  ::wxMetafileDC(filename), sipPySelf(0)
{
}
...
static PyObject *meth_wxMetafileDC_Close(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxMetafileDC, &sipCpp))
        {
            ...
            return sipConvertFromType(sipRes,sipType_wxMetafile,NULL);
        }
    }

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_MetafileDC, sipName_Close, NULL);
...
static void dealloc_wxMetafileDC(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxMetafileDC *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static sipEncodedTypeDef supers_wxMetafileDC[] = {{94, 255, 1}};
