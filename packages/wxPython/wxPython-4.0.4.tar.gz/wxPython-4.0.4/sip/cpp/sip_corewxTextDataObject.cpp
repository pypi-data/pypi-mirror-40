...
sipwxTextDataObject::sipwxTextDataObject(const  ::wxString& text):  ::wxTextDataObject(text), sipPySelf(0)
{
...
void sipwxTextDataObject::SetText(const  ::wxString& strText)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[0],sipPySelf,NULL,sipName_SetText);
    ...
    sipVH__core_51(sipGILState, 0, sipPySelf, sipMeth, strText);
}
 ...
 ::size_t sipwxTextDataObject::GetTextLength() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[1]),sipPySelf,NULL,sipName_GetTextLength);
 ...
 ::wxString sipwxTextDataObject::GetText() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[2]),sipPySelf,NULL,sipName_GetText);
 ...
 ::wxDataFormat sipwxTextDataObject::GetPreferredFormat( ::wxDataObject::Direction dir) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[4]),sipPySelf,NULL,sipName_GetPreferredFormat);
 ...
 ::size_t sipwxTextDataObject::GetFormatCount( ::wxDataObject::Direction dir) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[5]),sipPySelf,NULL,sipName_GetFormatCount);
...
void sipwxTextDataObject::GetAllFormats( ::wxDataFormat*formats, ::wxDataObject::Direction dir) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[6]),sipPySelf,NULL,sipName_GetAllFormats);
...
bool sipwxTextDataObject::GetDataHere(void*buf) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[7]),sipPySelf,NULL,sipName_GetDataHere);
 ...
 ::size_t sipwxTextDataObject::GetDataSize() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[8]),sipPySelf,NULL,sipName_GetDataSize);
...
bool sipwxTextDataObject::SetData( ::size_t len,const void*buf)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[9],sipPySelf,NULL,sipName_SetData);
...
static PyObject *meth_wxTextDataObject_GetText(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_TextDataObject, sipName_GetText, NULL);
...
static PyObject *meth_wxTextDataObject_GetTextLength(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxTextDataObject, &sipCpp))
        {
            ...
            Py_BEGIN_ALLOW_THREADS
            sipRes = new  ::size_t((sipSelfWasArg ? sipCpp-> ::wxTextDataObject::GetTextLength() : sipCpp->GetTextLength()));
            Py_END_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TextDataObject, sipName_GetTextLength, NULL);
...
static PyObject *meth_wxTextDataObject_GetFormatCount(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "B|E", &sipSelf, sipType_wxTextDataObject, &sipCpp, sipType_wxDataObject_Direction, &dir))
        {
             ::size_t*sipRes;
            ...
            Py_BEGIN_ALLOW_THREADS
            sipRes = new  ::size_t((sipSelfWasArg ? sipCpp-> ::wxTextDataObject::GetFormatCount(dir) : sipCpp->GetFormatCount(dir)));
            Py_END_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TextDataObject, sipName_GetFormatCount, NULL);
...
static PyObject *meth_wxTextDataObject_GetFormat(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TextDataObject, sipName_GetFormat, NULL);
...
static PyObject *meth_wxTextDataObject_GetAllFormats(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TextDataObject, sipName_GetAllFormats, NULL);
...
static PyObject *meth_wxTextDataObject_SetText(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxTextDataObject, &sipCpp, sipType_wxString,&strText, &strTextState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TextDataObject, sipName_SetText, NULL);
...
static PyObject *meth_wxTextDataObject_SetData(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9J0", &sipSelf, sipType_wxTextDataObject, &sipCpp, sipType_wxDataFormat, &format, sipType_wxPyBuffer,&buf, &bufState))
        {
            bool sipRes = 0;
            int sipIsErr = 0;
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1v", &sipSelf, sipType_wxTextDataObject, &sipCpp, sipType_size_t,&len, &lenState, &buf))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TextDataObject, sipName_SetData, NULL);
...
PyDoc_STRVAR(doc_wxTextDataObject_GetDataSize, "GetDataSize(self) -> object");
...
static PyObject *meth_wxTextDataObject_GetDataSize(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxTextDataObject, &sipCpp))
        {
            ...
            Py_BEGIN_ALLOW_THREADS
            sipRes = new  ::size_t((sipSelfWasArg ? sipCpp-> ::wxTextDataObject::GetDataSize() : sipCpp->GetDataSize()));
            Py_END_ALLOW_THREADS
...
PyDoc_STRVAR(doc_wxTextDataObject_GetDataHere, "GetDataHere(self, buf: sip.voidptr) -> bool");
...
static PyObject *meth_wxTextDataObject_GetDataHere(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bv", &sipSelf, sipType_wxTextDataObject, &sipCpp, &buf))
        {
            bool sipRes;
...
static void dealloc_wxTextDataObject(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxTextDataObject *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static sipEncodedTypeDef supers_wxTextDataObject[] = {{107, 255, 1}};


static PyMethodDef methods_wxTextDataObject[] = {
    {SIP_MLNAME_CAST(sipName_GetAllFormats), (PyCFunction)meth_wxTextDataObject_GetAllFormats, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTextDataObject_GetAllFormats)},
    {SIP_MLNAME_CAST(sipName_GetDataHere), (PyCFunction)meth_wxTextDataObject_GetDataHere, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTextDataObject_GetDataHere)},
    {SIP_MLNAME_CAST(sipName_GetDataSize), meth_wxTextDataObject_GetDataSize, METH_VARARGS, SIP_MLDOC_CAST(doc_wxTextDataObject_GetDataSize)},
    {SIP_MLNAME_CAST(sipName_GetFormat), meth_wxTextDataObject_GetFormat, METH_VARARGS, SIP_MLDOC_CAST(doc_wxTextDataObject_GetFormat)},
    {SIP_MLNAME_CAST(sipName_GetFormatCount), (PyCFunction)meth_wxTextDataObject_GetFormatCount, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTextDataObject_GetFormatCount)},
    {SIP_MLNAME_CAST(sipName_GetPreferredFormat), (PyCFunction)meth_wxTextDataObject_GetPreferredFormat, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTextDataObject_GetPreferredFormat)},
    {SIP_MLNAME_CAST(sipName_GetText), meth_wxTextDataObject_GetText, METH_VARARGS, SIP_MLDOC_CAST(doc_wxTextDataObject_GetText)},
    {SIP_MLNAME_CAST(sipName_GetTextLength), meth_wxTextDataObject_GetTextLength, METH_VARARGS, SIP_MLDOC_CAST(doc_wxTextDataObject_GetTextLength)},
    {SIP_MLNAME_CAST(sipName_SetData), (PyCFunction)meth_wxTextDataObject_SetData, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTextDataObject_SetData)},
    {SIP_MLNAME_CAST(sipName_SetText), (PyCFunction)meth_wxTextDataObject_SetText, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTextDataObject_SetText)}
};

sipVariableDef variables_wxTextDataObject[] = {
    {PropertyVariable, sipName_TextLength, &methods_wxTextDataObject[7], NULL, NULL, NULL},
    {PropertyVariable, sipName_Text, &methods_wxTextDataObject[6], &methods_wxTextDataObject[9], NULL, NULL},
    {PropertyVariable, sipName_FormatCount, &methods_wxTextDataObject[4], NULL, NULL, NULL},
    {PropertyVariable, sipName_Format, &methods_wxTextDataObject[3], NULL, NULL, NULL},
    {PropertyVariable, sipName_AllFormats, &methods_wxTextDataObject[0], NULL, NULL, NULL},
};
