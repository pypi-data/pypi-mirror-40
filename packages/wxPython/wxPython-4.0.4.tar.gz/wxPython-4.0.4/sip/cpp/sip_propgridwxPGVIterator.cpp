...
static PyObject *meth_wxPGVIterator_UnRef(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_PGVIterator, sipName_UnRef, NULL);
...
static PyObject *meth_wxPGVIterator_Next(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PGVIterator, sipName_Next, NULL);
...
static PyObject *meth_wxPGVIterator_AtEnd(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PGVIterator, sipName_AtEnd, NULL);
...
static PyObject *meth_wxPGVIterator_GetProperty(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PGVIterator, sipName_GetProperty, NULL);
...
extern "C" {static void *array_wxPGVIterator(SIP_SSIZE_T);}
static void *array_wxPGVIterator(SIP_SSIZE_T sipNrElem)
{
...
sipVariableDef variables_wxPGVIterator[] = {
    {PropertyVariable, sipName_Property, &methods_wxPGVIterator[1], NULL, NULL, NULL},
};
