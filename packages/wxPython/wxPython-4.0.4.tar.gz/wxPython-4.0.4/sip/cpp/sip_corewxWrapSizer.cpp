...
public:
     ...
     */
protected:
    bool IsSpaceItem( ::wxSizerItem*) const;
    void RecalcSizes();
     ::wxSize CalcMin();
...
sipwxWrapSizer::sipwxWrapSizer(int orient,int flags):  ::wxWrapSizer(orient,flags), sipPySelf(0)
{
...
bool sipwxWrapSizer::IsSpaceItem( ::wxSizerItem*item) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[0]),sipPySelf,NULL,sipName_IsSpaceItem);

    if (!sipMeth)
        return  ::wxWrapSizer::IsSpaceItem(item);

    extern bool sipVH__core_98(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxSizerItem*);

    return sipVH__core_98(sipGILState, 0, sipPySelf, sipMeth, item);
}
 ...
 ::wxSize sipwxWrapSizer::CalcMin()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[2],sipPySelf,NULL,sipName_CalcMin);
...
static PyObject *meth_wxWrapSizer_InformFirstDirection(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Biii", &sipSelf, sipType_wxWrapSizer, &sipCpp, &direction, &size, &availableOtherDir))
        {
            bool sipRes;
    ...
    sipNoMethod(sipParseErr, sipName_WrapSizer, sipName_InformFirstDirection, NULL);

    return NULL;
}


PyDoc_STRVAR(doc_wxWrapSizer_RecalcSizes, "RecalcSizes()\n"
"\n"
"Implements the calculation of a box sizer's dimensions and then sets\n"
"the size of its children (calling wxWindow::SetSize if the child is a\n"
"window).");

extern "C" {static PyObject *meth_wxWrapSizer_RecalcSizes(PyObject *, PyObject *);}
static PyObject *meth_wxWrapSizer_RecalcSizes(PyObject *sipSelf, PyObject *sipArgs)
{
    PyObject *sipParseErr = NULL;
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxWrapSizer, &sipCpp))
        {
            ...
            Py_BEGIN_ALLOW_THREADS
            (sipSelfWasArg ? sipCpp-> ::wxWrapSizer::RecalcSizes() : sipCpp->RecalcSizes());
            Py_END_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_WrapSizer, sipName_RecalcSizes, NULL);
...
static PyObject *meth_wxWrapSizer_CalcMin(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_WrapSizer, sipName_CalcMin, NULL);
...
static PyObject *meth_wxWrapSizer_IsSpaceItem(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8", &sipSelf, sipType_wxWrapSizer, &sipCpp, sipType_wxSizerItem, &item))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_WrapSizer, sipName_IsSpaceItem, NULL);
...
static void dealloc_wxWrapSizer(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxWrapSizer *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static PyMethodDef methods_wxWrapSizer[] = {
    ...
    {SIP_MLNAME_CAST(sipName_InformFirstDirection), (PyCFunction)meth_wxWrapSizer_InformFirstDirection, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWrapSizer_InformFirstDirection)},
    {SIP_MLNAME_CAST(sipName_IsSpaceItem), (PyCFunction)meth_wxWrapSizer_IsSpaceItem, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWrapSizer_IsSpaceItem)},
    {SIP_MLNAME_CAST(sipName_RecalcSizes), meth_wxWrapSizer_RecalcSizes, METH_VARARGS, SIP_MLDOC_CAST(doc_wxWrapSizer_RecalcSizes)}
};
