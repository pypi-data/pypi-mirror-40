...
static PyObject *meth_wxWebViewFSHandler_GetFile(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxWebViewFSHandler, &sipCpp, sipType_wxString,&uri, &uriState))
        {
             ::wxFSFile*sipRes;
    ...
    sipNoMethod(sipParseErr, sipName_WebViewFSHandler, sipName_GetFile, NULL);
...
static void dealloc_wxWebViewFSHandler(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxWebViewFSHandler *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxWebViewFSHandler *sipCpp = 0;
...
static PyMethodDef methods_wxWebViewFSHandler[] = {
    {SIP_MLNAME_CAST(sipName_GetFile), (PyCFunction)meth_wxWebViewFSHandler_GetFile, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWebViewFSHandler_GetFile)}
};
