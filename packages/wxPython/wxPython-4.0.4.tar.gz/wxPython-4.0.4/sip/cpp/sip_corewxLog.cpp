...
extern "C" {static void assign_wxLog(void *, SIP_SSIZE_T, void *);}
static void assign_wxLog(void *sipDst, SIP_SSIZE_T sipDstIdx, void *sipSrc)
{
    reinterpret_cast< ::wxLog *>(sipDst)[sipDstIdx] = *reinterpret_cast< ::wxLog *>(sipSrc);
}
