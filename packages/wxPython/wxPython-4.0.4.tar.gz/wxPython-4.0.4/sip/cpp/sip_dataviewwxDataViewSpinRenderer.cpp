...
sipwxDataViewSpinRenderer::sipwxDataViewSpinRenderer(int min,int max, ::wxDataViewCellMode mode,int align):  ::wxDataViewSpinRenderer(min,max,mode,align), sipPySelf(0)
{
...
bool sipwxDataViewSpinRenderer::FinishEditing()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[0],sipPySelf,NULL,sipName_FinishEditing);
...
void sipwxDataViewSpinRenderer::CancelEditing()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[1],sipPySelf,NULL,sipName_CancelEditing);
...
bool sipwxDataViewSpinRenderer::StartEditing(const  ::wxDataViewItem& item, ::wxRect labelRect)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[2],sipPySelf,NULL,sipName_StartEditing);
...
bool sipwxDataViewSpinRenderer::GetValueFromEditorCtrl( ::wxWindow*editor, ::wxVariant& value)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[3],sipPySelf,NULL,sipName_GetValueFromEditorCtrl);
 ...
 ::wxWindow* sipwxDataViewSpinRenderer::CreateEditorCtrl( ::wxWindow*parent, ::wxRect labelRect,const  ::wxVariant& value)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[4],sipPySelf,NULL,sipName_CreateEditorCtrl);
...
bool sipwxDataViewSpinRenderer::HasEditorCtrl() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[5]),sipPySelf,NULL,sipName_HasEditorCtrl);
...
bool sipwxDataViewSpinRenderer::Validate( ::wxDVCVariant& value)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[6],sipPySelf,NULL,sipName_Validate);
...
bool sipwxDataViewSpinRenderer::SetValue(const  ::wxVariant& value)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[7],sipPySelf,NULL,sipName_SetValue);
...
void sipwxDataViewSpinRenderer::SetAlignment(int align)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[8],sipPySelf,NULL,sipName_SetAlignment);
...
bool sipwxDataViewSpinRenderer::GetValue( ::wxVariant& value) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[9]),sipPySelf,NULL,sipName_GetValue);
 ...
 ::wxDataViewCellMode sipwxDataViewSpinRenderer::GetMode() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[10]),sipPySelf,NULL,sipName_GetMode);
...
int sipwxDataViewSpinRenderer::GetAlignment() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[11]),sipPySelf,NULL,sipName_GetAlignment);
...
bool sipwxDataViewSpinRenderer::ActivateCell(const  ::wxRect& cell, ::wxDataViewModel*model,const  ::wxDataViewItem& item,uint col,const  ::wxMouseEvent*mouseEvent)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[12],sipPySelf,NULL,sipName_ActivateCell);
 ...
 ::wxSize sipwxDataViewSpinRenderer::GetSize() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[13]),sipPySelf,NULL,sipName_GetSize);
...
bool sipwxDataViewSpinRenderer::LeftClick( ::wxPoint cursor, ::wxRect cell, ::wxDataViewModel*model,const  ::wxDataViewItem& item,uint col)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[14],sipPySelf,NULL,sipName_LeftClick);
...
bool sipwxDataViewSpinRenderer::Activate( ::wxRect cell, ::wxDataViewModel*model,const  ::wxDataViewItem& item,uint col)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[15],sipPySelf,NULL,sipName_Activate);
...
bool sipwxDataViewSpinRenderer::Render( ::wxRect cell, ::wxDC*dc,int state)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[16],sipPySelf,NULL,sipName_Render);
...
bool sipwxDataViewSpinRenderer::StartDrag(const  ::wxPoint& cursor,const  ::wxRect& cell, ::wxDataViewModel*model,const  ::wxDataViewItem& item,uint col)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[17],sipPySelf,NULL,sipName_StartDrag);
...
extern "C" {static PyObject *meth_wxDataViewSpinRenderer_GetView(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxDataViewSpinRenderer_GetView(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, NULL, NULL, "B", &sipSelf, sipType_wxDataViewSpinRenderer, &sipCpp))
        {
    ...
    sipNoMethod(sipParseErr, sipName_DataViewSpinRenderer, sipName_GetView, NULL);
...
static PyObject *meth_wxDataViewSpinRenderer_GetTextExtent(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxDataViewSpinRenderer, &sipCpp, sipType_wxString,&str, &strState))
        {
             ::wxSize*sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DataViewSpinRenderer, sipName_GetTextExtent, NULL);
...
static PyObject *meth_wxDataViewSpinRenderer_SetValue(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxDataViewSpinRenderer, &sipCpp, sipType_wxDVCVariant,&value, &valueState))
        {
            bool sipRes;
...
static PyObject *meth_wxDataViewSpinRenderer_Render(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1J8i", &sipSelf, sipType_wxDataViewSpinRenderer, &sipCpp, sipType_wxRect, &cell, &cellState, sipType_wxDC, &dc, &state))
        {
            bool sipRes;
...
static void dealloc_wxDataViewSpinRenderer(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxDataViewSpinRenderer *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxDataViewSpinRenderer *sipCpp = 0;
...
static sipEncodedTypeDef supers_wxDataViewSpinRenderer[] = {{8, 255, 1}};
...
static PyMethodDef methods_wxDataViewSpinRenderer[] = {
    ...
    {SIP_MLNAME_CAST(sipName_GetTextExtent), (PyCFunction)meth_wxDataViewSpinRenderer_GetTextExtent, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_GetValue), (PyCFunction)meth_wxDataViewSpinRenderer_GetValue, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDataViewSpinRenderer_GetValue)},
    {SIP_MLNAME_CAST(sipName_GetView), (PyCFunction)meth_wxDataViewSpinRenderer_GetView, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_Render), (PyCFunction)meth_wxDataViewSpinRenderer_Render, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDataViewSpinRenderer_Render)},
    {SIP_MLNAME_CAST(sipName_SetValue), (PyCFunction)meth_wxDataViewSpinRenderer_SetValue, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDataViewSpinRenderer_SetValue)}
};

sipVariableDef variables_wxDataViewSpinRenderer[] = {
    {PropertyVariable, sipName_Value, &methods_wxDataViewSpinRenderer[2], &methods_wxDataViewSpinRenderer[5], NULL, NULL},
};
