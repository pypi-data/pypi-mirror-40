...
extern "C" {static void *array_wxComboCtrlFeatures(SIP_SSIZE_T);}
static void *array_wxComboCtrlFeatures(SIP_SSIZE_T sipNrElem)
{
...
static void *init_type_wxComboCtrlFeatures(sipSimpleWrapper *, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxComboCtrlFeatures, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
