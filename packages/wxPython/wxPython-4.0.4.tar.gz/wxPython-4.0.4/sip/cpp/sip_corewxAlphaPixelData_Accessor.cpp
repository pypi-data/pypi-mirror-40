...
static PyObject *meth_wxAlphaPixelData_Accessor_Reset(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxAlphaPixelData_Accessor, &sipCpp, sipType_wxAlphaPixelData, &data))
        {
            PyErr_Clear();
    ...
    sipNoMethod(sipParseErr, sipName_AlphaPixelData_Accessor, sipName_Reset, NULL);
...
static PyObject *meth_wxAlphaPixelData_Accessor_IsOk(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_AlphaPixelData_Accessor, sipName_IsOk, NULL);
...
static PyObject *meth_wxAlphaPixelData_Accessor_Offset(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9ii", &sipSelf, sipType_wxAlphaPixelData_Accessor, &sipCpp, sipType_wxAlphaPixelData, &data, &x, &y))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_AlphaPixelData_Accessor, sipName_Offset, NULL);
...
static PyObject *meth_wxAlphaPixelData_Accessor_OffsetX(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9i", &sipSelf, sipType_wxAlphaPixelData_Accessor, &sipCpp, sipType_wxAlphaPixelData, &data, &x))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_AlphaPixelData_Accessor, sipName_OffsetX, NULL);
...
static PyObject *meth_wxAlphaPixelData_Accessor_OffsetY(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9i", &sipSelf, sipType_wxAlphaPixelData_Accessor, &sipCpp, sipType_wxAlphaPixelData, &data, &y))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_AlphaPixelData_Accessor, sipName_OffsetY, NULL);
...
static PyObject *meth_wxAlphaPixelData_Accessor_MoveTo(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_AlphaPixelData_Accessor, sipName_MoveTo, NULL);
...
static PyObject *meth_wxAlphaPixelData_Accessor_nextPixel(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_AlphaPixelData_Accessor, sipName_nextPixel, NULL);
...
static PyObject *meth_wxAlphaPixelData_Accessor_Set(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BMMMM", &sipSelf, sipType_wxAlphaPixelData_Accessor, &sipCpp, &red, &green, &blue, &alpha))
        {
            int sipIsErr = 0;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_AlphaPixelData_Accessor, sipName_Set, NULL);
...
static PyObject *meth_wxAlphaPixelData_Accessor_Get(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_AlphaPixelData_Accessor, sipName_Get, NULL);
...
extern "C" {static void *array_wxAlphaPixelData_Accessor(SIP_SSIZE_T);}
static void *array_wxAlphaPixelData_Accessor(SIP_SSIZE_T sipNrElem)
{
...
{
     ::wxAlphaPixelData_Accessor *sipCpp = 0;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxAlphaPixelData_Accessor, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxAlphaPixelData_Accessor[] = {
    ...
    {SIP_MLNAME_CAST(sipName_MoveTo), (PyCFunction)meth_wxAlphaPixelData_Accessor_MoveTo, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxAlphaPixelData_Accessor_MoveTo)},
    {SIP_MLNAME_CAST(sipName_Offset), (PyCFunction)meth_wxAlphaPixelData_Accessor_Offset, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxAlphaPixelData_Accessor_Offset)},
    {SIP_MLNAME_CAST(sipName_OffsetX), (PyCFunction)meth_wxAlphaPixelData_Accessor_OffsetX, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxAlphaPixelData_Accessor_OffsetX)},
    {SIP_MLNAME_CAST(sipName_OffsetY), (PyCFunction)meth_wxAlphaPixelData_Accessor_OffsetY, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxAlphaPixelData_Accessor_OffsetY)},
    {SIP_MLNAME_CAST(sipName_Reset), (PyCFunction)meth_wxAlphaPixelData_Accessor_Reset, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxAlphaPixelData_Accessor_Reset)},
    {SIP_MLNAME_CAST(sipName_Set), (PyCFunction)meth_wxAlphaPixelData_Accessor_Set, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxAlphaPixelData_Accessor_Set)},
