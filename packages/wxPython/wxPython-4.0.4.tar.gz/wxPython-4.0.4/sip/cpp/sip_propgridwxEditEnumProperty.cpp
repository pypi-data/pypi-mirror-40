...
sipwxEditEnumProperty::sipwxEditEnumProperty(const  ::wxString& label,const  ::wxString& name,const  ::wxArrayString& labels,const  ::wxArrayInt& values,const  ::wxString& value):  ::wxEditEnumProperty(label,name,labels,values,value), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxEditEnumProperty::sipwxEditEnumProperty(const  ::wxString& label,const  ::wxString& name, ::wxPGChoices& choices,const  ::wxString& value):  ::wxEditEnumProperty(label,name,choices,value), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxEditEnumProperty::sipwxEditEnumProperty(const  ::wxEditEnumProperty& a0):  ::wxEditEnumProperty(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
extern "C" {static void *array_wxEditEnumProperty(SIP_SSIZE_T);}
static void *array_wxEditEnumProperty(SIP_SSIZE_T sipNrElem)
{
...
static void dealloc_wxEditEnumProperty(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxEditEnumProperty *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxEditEnumProperty *sipCpp = 0;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxEditEnumProperty, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxEditEnumProperty[] = {{10, 255, 1}};
