...
sipwxPGArrayStringEditorDialog::sipwxPGArrayStringEditorDialog():  ::wxPGArrayStringEditorDialog(), sipPySelf(0)
{
...
void sipwxPGArrayStringEditorDialog::SetDialogValue(const  ::wxPGVariant& value)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[41],sipPySelf,NULL,sipName_SetDialogValue);
 ...
 ::wxPGVariant sipwxPGArrayStringEditorDialog::GetDialogValue() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[42]),sipPySelf,NULL,sipName_GetDialogValue);
 ...
 ::wxValidator* sipwxPGArrayStringEditorDialog::GetTextCtrlValidator() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[43]),sipPySelf,NULL,sipName_GetTextCtrlValidator);
 ...
 ::wxString sipwxPGArrayStringEditorDialog::ArrayGet( ::size_t index)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[44],sipPySelf,NULL,sipName_ArrayGet);
 ...
 ::size_t sipwxPGArrayStringEditorDialog::ArrayGetCount()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[45],sipPySelf,NULL,sipName_ArrayGetCount);
...
bool sipwxPGArrayStringEditorDialog::ArrayInsert(const  ::wxString& str,int index)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[46],sipPySelf,NULL,sipName_ArrayInsert);
...
bool sipwxPGArrayStringEditorDialog::ArraySet( ::size_t index,const  ::wxString& str)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[47],sipPySelf,NULL,sipName_ArraySet);
...
void sipwxPGArrayStringEditorDialog::ArrayRemoveAt(int index)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[48],sipPySelf,NULL,sipName_ArrayRemoveAt);
...
void sipwxPGArrayStringEditorDialog::ArraySwap( ::size_t first, ::size_t second)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[49],sipPySelf,NULL,sipName_ArraySwap);
...
bool sipwxPGArrayStringEditorDialog::OnCustomNewAction( ::wxString*resString)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[50],sipPySelf,NULL,sipName_OnCustomNewAction);
...
extern "C" {static PyObject *meth_wxPGArrayStringEditorDialog_SendDestroyEvent(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxPGArrayStringEditorDialog_SendDestroyEvent(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, NULL, NULL, "B", &sipSelf, sipType_wxPGArrayStringEditorDialog, &sipCpp))
        {
            PyErr_Clear();
    ...
    sipNoMethod(sipParseErr, sipName_PGArrayStringEditorDialog, sipName_SendDestroyEvent, NULL);
...
static PyObject *meth_wxPGArrayStringEditorDialog_ProcessEvent(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxPGArrayStringEditorDialog, &sipCpp, sipType_wxEvent, &event))
        {
            bool sipRes;
...
static PyObject *meth_wxPGArrayStringEditorDialog_DoEnable(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bb", &sipSelf, sipType_wxPGArrayStringEditorDialog, &sipCpp, &enable))
        {
            PyErr_Clear();
...
extern "C" {static PyObject *meth_wxPGArrayStringEditorDialog_DoGetBestSize(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxPGArrayStringEditorDialog_DoGetBestSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxPGArrayStringEditorDialog_DoGetBestClientSize(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxPGArrayStringEditorDialog_DoGetBestClientSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
static PyObject *meth_wxPGArrayStringEditorDialog_DoSetSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Biiiii", &sipSelf, sipType_wxPGArrayStringEditorDialog, &sipCpp, &x, &y, &width, &height, &sizeFlags))
        {
            PyErr_Clear();
...
static PyObject *meth_wxPGArrayStringEditorDialog_DoSetClientSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bii", &sipSelf, sipType_wxPGArrayStringEditorDialog, &sipCpp, &width, &height))
        {
            PyErr_Clear();
...
static PyObject *meth_wxPGArrayStringEditorDialog_DoSetSizeHints(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Biiiiii", &sipSelf, sipType_wxPGArrayStringEditorDialog, &sipCpp, &minW, &minH, &maxW, &maxH, &incW, &incH))
        {
            PyErr_Clear();
...
extern "C" {static PyObject *meth_wxPGArrayStringEditorDialog_DoGetBorderSize(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxPGArrayStringEditorDialog_DoGetBorderSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
static PyObject *meth_wxPGArrayStringEditorDialog_DoMoveWindow(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Biiii", &sipSelf, sipType_wxPGArrayStringEditorDialog, &sipCpp, &x, &y, &width, &height))
        {
            PyErr_Clear();
...
static PyObject *meth_wxPGArrayStringEditorDialog_DoSetWindowVariant(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BE", &sipSelf, sipType_wxPGArrayStringEditorDialog, &sipCpp, sipType_wxWindowVariant, &variant))
        {
            PyErr_Clear();
...
extern "C" {static PyObject *meth_wxPGArrayStringEditorDialog_GetDefaultBorder(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxPGArrayStringEditorDialog_GetDefaultBorder(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxPGArrayStringEditorDialog_GetDefaultBorderForControl(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxPGArrayStringEditorDialog_GetDefaultBorderForControl(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxPGArrayStringEditorDialog_DoFreeze(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxPGArrayStringEditorDialog_DoFreeze(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxPGArrayStringEditorDialog_DoThaw(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxPGArrayStringEditorDialog_DoThaw(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxPGArrayStringEditorDialog_HasTransparentBackground(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxPGArrayStringEditorDialog_HasTransparentBackground(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
static PyObject *meth_wxPGArrayStringEditorDialog_Init(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PGArrayStringEditorDialog, sipName_Init, NULL);
...
static PyObject *meth_wxPGArrayStringEditorDialog_SetDialogValue(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxPGArrayStringEditorDialog, &sipCpp, sipType_wxPGVariant,&value, &valueState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PGArrayStringEditorDialog, sipName_SetDialogValue, NULL);
...
static PyObject *meth_wxPGArrayStringEditorDialog_GetDialogValue(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PGArrayStringEditorDialog, sipName_GetDialogValue, NULL);
...
static PyObject *meth_wxPGArrayStringEditorDialog_SetCustomButton(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1J8", &sipSelf, sipType_wxPGArrayStringEditorDialog, &sipCpp, sipType_wxString,&custBtText, &custBtTextState, sipType_wxArrayStringProperty, &pcc))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PGArrayStringEditorDialog, sipName_SetCustomButton, NULL);
...
static PyObject *meth_wxPGArrayStringEditorDialog_OnCustomNewAction(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ0", &sipSelf, sipType_wxPGArrayStringEditorDialog, &sipCpp, sipType_wxString,&resString, &resStringState))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PGArrayStringEditorDialog, sipName_OnCustomNewAction, NULL);

    return NULL;
}


PyDoc_STRVAR(doc_wxPGArrayStringEditorDialog_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant = wxWINDOW_VARIANT_NORMAL) -> VisualAttributes");
...
static PyObject *meth_wxPGArrayStringEditorDialog_GetClassDefaultAttributes(PyObject *, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PGArrayStringEditorDialog, sipName_GetClassDefaultAttributes, doc_wxPGArrayStringEditorDialog_GetClassDefaultAttributes);
...
static PyObject *meth_wxPGArrayStringEditorDialog_ArrayGet(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxPGArrayStringEditorDialog, &sipCpp, sipType_size_t,&index, &indexState))
        {
             ::wxString*sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PGArrayStringEditorDialog, sipName_ArrayGet, NULL);
...
extern "C" {static PyObject *meth_wxPGArrayStringEditorDialog_ArrayGetCount(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxPGArrayStringEditorDialog_ArrayGetCount(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, NULL, NULL, "B", &sipSelf, sipType_wxPGArrayStringEditorDialog, &sipCpp))
        {
            ...
            Py_BEGIN_ALLOW_THREADS
            sipRes = new  ::size_t(sipCpp->sipProtectVirt_ArrayGetCount(sipSelfWasArg));
            Py_END_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PGArrayStringEditorDialog, sipName_ArrayGetCount, NULL);
...
static PyObject *meth_wxPGArrayStringEditorDialog_ArrayInsert(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1i", &sipSelf, sipType_wxPGArrayStringEditorDialog, &sipCpp, sipType_wxString,&str, &strState, &index))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PGArrayStringEditorDialog, sipName_ArrayInsert, NULL);
...
static PyObject *meth_wxPGArrayStringEditorDialog_ArraySet(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1J1", &sipSelf, sipType_wxPGArrayStringEditorDialog, &sipCpp, sipType_size_t,&index, &indexState, sipType_wxString,&str, &strState))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PGArrayStringEditorDialog, sipName_ArraySet, NULL);
...
static PyObject *meth_wxPGArrayStringEditorDialog_ArrayRemoveAt(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bi", &sipSelf, sipType_wxPGArrayStringEditorDialog, &sipCpp, &index))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PGArrayStringEditorDialog, sipName_ArrayRemoveAt, NULL);
...
static PyObject *meth_wxPGArrayStringEditorDialog_ArraySwap(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1J1", &sipSelf, sipType_wxPGArrayStringEditorDialog, &sipCpp, sipType_size_t,&first, &firstState, sipType_size_t,&second, &secondState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PGArrayStringEditorDialog, sipName_ArraySwap, NULL);
...
static void dealloc_wxPGArrayStringEditorDialog(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxPGArrayStringEditorDialog *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxPGArrayStringEditorDialog *sipCpp = 0;
...
static sipEncodedTypeDef supers_wxPGArrayStringEditorDialog[] = {{21, 255, 1}};


static PyMethodDef methods_wxPGArrayStringEditorDialog[] = {
    {SIP_MLNAME_CAST(sipName_ArrayGet), (PyCFunction)meth_wxPGArrayStringEditorDialog_ArrayGet, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPGArrayStringEditorDialog_ArrayGet)},
    {SIP_MLNAME_CAST(sipName_ArrayGetCount), (PyCFunction)meth_wxPGArrayStringEditorDialog_ArrayGetCount, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPGArrayStringEditorDialog_ArrayGetCount)},
    {SIP_MLNAME_CAST(sipName_ArrayInsert), (PyCFunction)meth_wxPGArrayStringEditorDialog_ArrayInsert, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPGArrayStringEditorDialog_ArrayInsert)},
    {SIP_MLNAME_CAST(sipName_ArrayRemoveAt), (PyCFunction)meth_wxPGArrayStringEditorDialog_ArrayRemoveAt, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPGArrayStringEditorDialog_ArrayRemoveAt)},
    {SIP_MLNAME_CAST(sipName_ArraySet), (PyCFunction)meth_wxPGArrayStringEditorDialog_ArraySet, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPGArrayStringEditorDialog_ArraySet)},
    {SIP_MLNAME_CAST(sipName_ArraySwap), (PyCFunction)meth_wxPGArrayStringEditorDialog_ArraySwap, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPGArrayStringEditorDialog_ArraySwap)},
    {SIP_MLNAME_CAST(sipName_DoEnable), (PyCFunction)meth_wxPGArrayStringEditorDialog_DoEnable, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_DoFreeze), (PyCFunction)meth_wxPGArrayStringEditorDialog_DoFreeze, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_DoGetBestClientSize), (PyCFunction)meth_wxPGArrayStringEditorDialog_DoGetBestClientSize, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_DoGetBestSize), (PyCFunction)meth_wxPGArrayStringEditorDialog_DoGetBestSize, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_DoGetBorderSize), (PyCFunction)meth_wxPGArrayStringEditorDialog_DoGetBorderSize, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_DoGetClientSize), (PyCFunction)meth_wxPGArrayStringEditorDialog_DoGetClientSize, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_DoGetPosition), (PyCFunction)meth_wxPGArrayStringEditorDialog_DoGetPosition, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_DoGetSize), (PyCFunction)meth_wxPGArrayStringEditorDialog_DoGetSize, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_DoMoveWindow), (PyCFunction)meth_wxPGArrayStringEditorDialog_DoMoveWindow, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_DoSetClientSize), (PyCFunction)meth_wxPGArrayStringEditorDialog_DoSetClientSize, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_DoSetSize), (PyCFunction)meth_wxPGArrayStringEditorDialog_DoSetSize, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_DoSetSizeHints), (PyCFunction)meth_wxPGArrayStringEditorDialog_DoSetSizeHints, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_DoSetWindowVariant), (PyCFunction)meth_wxPGArrayStringEditorDialog_DoSetWindowVariant, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_DoThaw), (PyCFunction)meth_wxPGArrayStringEditorDialog_DoThaw, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_GetClassDefaultAttributes), (PyCFunction)meth_wxPGArrayStringEditorDialog_GetClassDefaultAttributes, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPGArrayStringEditorDialog_GetClassDefaultAttributes)},
    {SIP_MLNAME_CAST(sipName_GetDefaultBorder), (PyCFunction)meth_wxPGArrayStringEditorDialog_GetDefaultBorder, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_GetDefaultBorderForControl), (PyCFunction)meth_wxPGArrayStringEditorDialog_GetDefaultBorderForControl, METH_VARARGS|METH_KEYWORDS, NULL},
    ...
    {SIP_MLNAME_CAST(sipName_HasTransparentBackground), (PyCFunction)meth_wxPGArrayStringEditorDialog_HasTransparentBackground, METH_VARARGS|METH_KEYWORDS, NULL},
    ...
    {SIP_MLNAME_CAST(sipName_OnCustomNewAction), (PyCFunction)meth_wxPGArrayStringEditorDialog_OnCustomNewAction, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPGArrayStringEditorDialog_OnCustomNewAction)},
    {SIP_MLNAME_CAST(sipName_ProcessEvent), (PyCFunction)meth_wxPGArrayStringEditorDialog_ProcessEvent, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxPGArrayStringEditorDialog_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_SetCustomButton), (PyCFunction)meth_wxPGArrayStringEditorDialog_SetCustomButton, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPGArrayStringEditorDialog_SetCustomButton)},
    {SIP_MLNAME_CAST(sipName_SetDialogValue), (PyCFunction)meth_wxPGArrayStringEditorDialog_SetDialogValue, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPGArrayStringEditorDialog_SetDialogValue)},
    {SIP_MLNAME_CAST(sipName_TryAfter), (PyCFunction)meth_wxPGArrayStringEditorDialog_TryAfter, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_TryBefore), (PyCFunction)meth_wxPGArrayStringEditorDialog_TryBefore, METH_VARARGS|METH_KEYWORDS, NULL}
};

sipVariableDef variables_wxPGArrayStringEditorDialog[] = {
    {PropertyVariable, sipName_DialogValue, &methods_wxPGArrayStringEditorDialog[23], &methods_wxPGArrayStringEditorDialog[30], NULL, NULL},
};
