...
protected:
    ...
    void SetParameters(const  ::wxString&);
...
sipwxGridCellTextEditor::sipwxGridCellTextEditor( ::size_t maxChars):  ::wxGridCellTextEditor(maxChars), sipPySelf(0)
{
...
void sipwxGridCellTextEditor::SetValidator(const  ::wxValidator& validator)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[0],sipPySelf,NULL,sipName_SetValidator);
    ...
    extern void sipVH__grid_14(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxValidator&);

    sipVH__grid_14(sipGILState, 0, sipPySelf, sipMeth, validator);
}
...
void sipwxGridCellTextEditor::SetParameters(const  ::wxString& params)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[1],sipPySelf,NULL,sipName_SetParameters);
    ...
    extern void sipVH__grid_3(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxString&);

    sipVH__grid_3(sipGILState, 0, sipPySelf, sipMeth, params);
}
...
void sipwxGridCellTextEditor::BeginEdit(int row,int col, ::wxGrid*grid)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[2],sipPySelf,NULL,sipName_BeginEdit);
...
void sipwxGridCellTextEditor::Destroy()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[5],sipPySelf,NULL,sipName_Destroy);
...
bool sipwxGridCellTextEditor::EndEdit(int row,int col,const  ::wxGrid*grid,const  ::wxString& oldval, ::wxString*newval)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[6],sipPySelf,NULL,sipName_EndEdit);
...
void sipwxGridCellTextEditor::ApplyEdit(int row,int col, ::wxGrid*grid)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[7],sipPySelf,NULL,sipName_ApplyEdit);
...
void sipwxGridCellTextEditor::HandleReturn( ::wxKeyEvent& event)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[8],sipPySelf,NULL,sipName_HandleReturn);
...
void sipwxGridCellTextEditor::PaintBackground( ::wxDC& dc,const  ::wxRect& rectCell, ::wxGridCellAttr& attr)
{
    sip_gilstate_t sipGILState;
    PyObject *sipMeth;

    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[9],sipPySelf,NULL,sipName_PaintBackground);
...
void sipwxGridCellTextEditor::SetSize(const  ::wxRect& rect)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[11],sipPySelf,NULL,sipName_SetSize);
...
void sipwxGridCellTextEditor::Show(bool show, ::wxGridCellAttr*attr)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[12],sipPySelf,NULL,sipName_Show);
...
void sipwxGridCellTextEditor::StartingClick()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[13],sipPySelf,NULL,sipName_StartingClick);
...
void sipwxGridCellTextEditor::StartingKey( ::wxKeyEvent& event)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[14],sipPySelf,NULL,sipName_StartingKey);
 ...
 ::wxString sipwxGridCellTextEditor::GetValue() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[15]),sipPySelf,NULL,sipName_GetValue);
...
static PyObject *meth_wxGridCellTextEditor_SetParameters(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxGridCellTextEditor, &sipCpp, sipType_wxString,&params, &paramsState))
        {
            PyErr_Clear();
    ...
    sipNoMethod(sipParseErr, sipName_GridCellTextEditor, sipName_SetParameters, NULL);
...
static PyObject *meth_wxGridCellTextEditor_SetValidator(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxGridCellTextEditor, &sipCpp, sipType_wxValidator, &validator))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GridCellTextEditor, sipName_SetValidator, NULL);
...
static PyObject *meth_wxGridCellTextEditor_BeginEdit(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BiiJ8", &sipSelf, sipType_wxGridCellTextEditor, &sipCpp, &row, &col, sipType_wxGrid, &grid))
        {
            PyErr_Clear();
...
static PyObject *meth_wxGridCellTextEditor_Create(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8iJ8", &sipSelf, sipType_wxGridCellTextEditor, &sipCpp, sipType_wxWindow, &parent, &id, sipType_wxEvtHandler, &evtHandler))
        {
            PyErr_Clear();
...
static PyObject *meth_wxGridCellTextEditor_EndEdit(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BiiJ8J1", &sipSelf, sipType_wxGridCellTextEditor, &sipCpp, &row, &col, sipType_wxGrid, &grid, sipType_wxString,&oldval, &oldvalState))
        {
            PyObject * sipRes = 0;
            int sipIsErr = 0;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GridCellTextEditor, sipName_EndEdit, NULL);
...
static void dealloc_wxGridCellTextEditor(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxGridCellTextEditor *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxGridCellTextEditor *sipCpp = 0;

    {
         ::size_t maxCharsdef = 0;
         ::size_t* maxChars = &maxCharsdef;
        int maxCharsState = 0;
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, sipKwdList, sipUnused, "|J1", sipType_size_t,&maxChars, &maxCharsState))
        {
            PyErr_Clear();
            ...
            *sipOwner = Py_None;
            sipReleaseType(maxChars,sipType_size_t,maxCharsState);
...
static sipEncodedTypeDef supers_wxGridCellTextEditor[] = {{15, 255, 1}};


static PyMethodDef methods_wxGridCellTextEditor[] = {
    {SIP_MLNAME_CAST(sipName_ApplyEdit), (PyCFunction)meth_wxGridCellTextEditor_ApplyEdit, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridCellTextEditor_ApplyEdit)},
    {SIP_MLNAME_CAST(sipName_BeginEdit), (PyCFunction)meth_wxGridCellTextEditor_BeginEdit, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridCellTextEditor_BeginEdit)},
    {SIP_MLNAME_CAST(sipName_Clone), meth_wxGridCellTextEditor_Clone, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGridCellTextEditor_Clone)},
    {SIP_MLNAME_CAST(sipName_Create), (PyCFunction)meth_wxGridCellTextEditor_Create, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridCellTextEditor_Create)},
    {SIP_MLNAME_CAST(sipName_EndEdit), (PyCFunction)meth_wxGridCellTextEditor_EndEdit, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridCellTextEditor_EndEdit)},
    ...
    {SIP_MLNAME_CAST(sipName_SetParameters), (PyCFunction)meth_wxGridCellTextEditor_SetParameters, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridCellTextEditor_SetParameters)},
    {SIP_MLNAME_CAST(sipName_SetValidator), (PyCFunction)meth_wxGridCellTextEditor_SetValidator, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridCellTextEditor_SetValidator)}
};
