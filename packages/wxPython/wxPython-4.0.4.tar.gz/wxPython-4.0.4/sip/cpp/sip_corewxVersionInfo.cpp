...
static PyObject *meth_wxVersionInfo_GetName(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_VersionInfo, sipName_GetName, NULL);
...
static PyObject *meth_wxVersionInfo_GetMajor(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_VersionInfo, sipName_GetMajor, NULL);
...
static PyObject *meth_wxVersionInfo_GetMinor(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_VersionInfo, sipName_GetMinor, NULL);
...
static PyObject *meth_wxVersionInfo_GetMicro(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_VersionInfo, sipName_GetMicro, NULL);
...
static PyObject *meth_wxVersionInfo_ToString(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_VersionInfo, sipName_ToString, NULL);
...
static PyObject *meth_wxVersionInfo_GetVersionString(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_VersionInfo, sipName_GetVersionString, NULL);
...
static PyObject *meth_wxVersionInfo_HasDescription(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_VersionInfo, sipName_HasDescription, NULL);
...
static PyObject *meth_wxVersionInfo_GetDescription(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_VersionInfo, sipName_GetDescription, NULL);
...
static PyObject *meth_wxVersionInfo_HasCopyright(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_VersionInfo, sipName_HasCopyright, NULL);
...
static PyObject *meth_wxVersionInfo_GetCopyright(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_VersionInfo, sipName_GetCopyright, NULL);
...
extern "C" {static void *array_wxVersionInfo(SIP_SSIZE_T);}
static void *array_wxVersionInfo(SIP_SSIZE_T sipNrElem)
{
...
static void *init_type_wxVersionInfo(sipSimpleWrapper *, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxVersionInfo, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
sipVariableDef variables_wxVersionInfo[] = {
    {PropertyVariable, sipName_VersionString, &methods_wxVersionInfo[6], NULL, NULL, NULL},
    {PropertyVariable, sipName_Name, &methods_wxVersionInfo[5], NULL, NULL, NULL},
    {PropertyVariable, sipName_Minor, &methods_wxVersionInfo[4], NULL, NULL, NULL},
    {PropertyVariable, sipName_Micro, &methods_wxVersionInfo[3], NULL, NULL, NULL},
    {PropertyVariable, sipName_Major, &methods_wxVersionInfo[2], NULL, NULL, NULL},
    {PropertyVariable, sipName_Description, &methods_wxVersionInfo[1], NULL, NULL, NULL},
    {PropertyVariable, sipName_Copyright, &methods_wxVersionInfo[0], NULL, NULL, NULL},
};
