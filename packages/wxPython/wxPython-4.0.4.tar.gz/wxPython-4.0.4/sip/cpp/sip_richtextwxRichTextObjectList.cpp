...
static PyObject *meth_wxRichTextObjectList_index(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8", &sipSelf, sipType_wxRichTextObjectList, &sipCpp, sipType_wxRichTextObject, &obj))
        {
            int sipRes = 0;
...
static PyObject *slot_wxRichTextObjectList___iter__(PyObject *sipSelf)
{
...

    {
        ...
        sipRes =  new wxRichTextObjectList_iterator(sipCpp->GetFirst());
            ...
            return sipConvertFromNewType(sipRes,sipType_wxRichTextObjectList_iterator,NULL);
        }
    }
...
static int slot_wxRichTextObjectList___contains__(PyObject *sipSelf,PyObject *sipArg)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextObjectList, sipName___contains__, NULL);
...
static PyObject *slot_wxRichTextObjectList___getitem__(PyObject *sipSelf,PyObject *sipArg)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextObjectList, sipName___getitem__, NULL);
...
extern "C" {static void *array_wxRichTextObjectList(SIP_SSIZE_T);}
static void *array_wxRichTextObjectList(SIP_SSIZE_T sipNrElem)
{
...
static void *init_type_wxRichTextObjectList(sipSimpleWrapper *, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxRichTextObjectList, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxRichTextObjectList[] = {
    {SIP_MLNAME_CAST(sipName_index), (PyCFunction)meth_wxRichTextObjectList_index, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextObjectList_index)}
};
