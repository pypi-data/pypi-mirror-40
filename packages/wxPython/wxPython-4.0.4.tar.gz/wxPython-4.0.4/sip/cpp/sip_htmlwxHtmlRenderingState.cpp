...
static PyObject *meth_wxHtmlRenderingState_SetSelectionState(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BE", &sipSelf, sipType_wxHtmlRenderingState, &sipCpp, sipType_wxHtmlSelectionState, &s))
        {
            PyErr_Clear();
    ...
    sipNoMethod(sipParseErr, sipName_HtmlRenderingState, sipName_SetSelectionState, NULL);
...
static PyObject *meth_wxHtmlRenderingState_GetSelectionState(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HtmlRenderingState, sipName_GetSelectionState, NULL);
...
static PyObject *meth_wxHtmlRenderingState_SetFgColour(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxHtmlRenderingState, &sipCpp, sipType_wxColour, &c, &cState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HtmlRenderingState, sipName_SetFgColour, NULL);
...
static PyObject *meth_wxHtmlRenderingState_GetFgColour(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HtmlRenderingState, sipName_GetFgColour, NULL);
...
static PyObject *meth_wxHtmlRenderingState_SetBgColour(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HtmlRenderingState, sipName_SetBgColour, NULL);
...
static PyObject *meth_wxHtmlRenderingState_GetBgColour(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HtmlRenderingState, sipName_GetBgColour, NULL);
...
static PyObject *meth_wxHtmlRenderingState_SetBgMode(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bi", &sipSelf, sipType_wxHtmlRenderingState, &sipCpp, &m))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HtmlRenderingState, sipName_SetBgMode, NULL);
...
static PyObject *meth_wxHtmlRenderingState_GetBgMode(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HtmlRenderingState, sipName_GetBgMode, NULL);
...
static void *init_type_wxHtmlRenderingState(sipSimpleWrapper *, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxHtmlRenderingState, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxHtmlRenderingState[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SetBgColour), (PyCFunction)meth_wxHtmlRenderingState_SetBgColour, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHtmlRenderingState_SetBgColour)},
    {SIP_MLNAME_CAST(sipName_SetBgMode), (PyCFunction)meth_wxHtmlRenderingState_SetBgMode, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHtmlRenderingState_SetBgMode)},
    {SIP_MLNAME_CAST(sipName_SetFgColour), (PyCFunction)meth_wxHtmlRenderingState_SetFgColour, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHtmlRenderingState_SetFgColour)},
    {SIP_MLNAME_CAST(sipName_SetSelectionState), (PyCFunction)meth_wxHtmlRenderingState_SetSelectionState, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHtmlRenderingState_SetSelectionState)}
};

sipVariableDef variables_wxHtmlRenderingState[] = {
    {PropertyVariable, sipName_SelectionState, &methods_wxHtmlRenderingState[3], &methods_wxHtmlRenderingState[7], NULL, NULL},
    {PropertyVariable, sipName_FgColour, &methods_wxHtmlRenderingState[2], &methods_wxHtmlRenderingState[6], NULL, NULL},
    {PropertyVariable, sipName_BgMode, &methods_wxHtmlRenderingState[1], &methods_wxHtmlRenderingState[5], NULL, NULL},
    {PropertyVariable, sipName_BgColour, &methods_wxHtmlRenderingState[0], &methods_wxHtmlRenderingState[4], NULL, NULL},
};
