...
static PyObject *meth_wxScrollWinEvent_GetOrientation(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_ScrollWinEvent, sipName_GetOrientation, NULL);
...
static PyObject *meth_wxScrollWinEvent_GetPosition(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_ScrollWinEvent, sipName_GetPosition, NULL);
...
static PyObject *meth_wxScrollWinEvent_SetOrientation(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_ScrollWinEvent, sipName_SetOrientation, NULL);
...
static PyObject *meth_wxScrollWinEvent_SetPosition(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_ScrollWinEvent, sipName_SetPosition, NULL);
...
static sipEncodedTypeDef supers_wxScrollWinEvent[] = {{141, 255, 1}};
...
sipVariableDef variables_wxScrollWinEvent[] = {
    {PropertyVariable, sipName_Position, &methods_wxScrollWinEvent[2], &methods_wxScrollWinEvent[4], NULL, NULL},
    {PropertyVariable, sipName_Orientation, &methods_wxScrollWinEvent[1], &methods_wxScrollWinEvent[3], NULL, NULL},
};
