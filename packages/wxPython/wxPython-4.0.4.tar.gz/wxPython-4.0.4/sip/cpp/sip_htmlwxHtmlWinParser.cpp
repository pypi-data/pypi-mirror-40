...
void sipwxHtmlWinParser::SetDC( ::wxDC*dc,double pixel_scale)
{
    ...
    extern void sipVH__html_61(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC*,double);

    sipVH__html_61(sipGILState, 0, sipPySelf, sipMeth, dc, pixel_scale);
}
 ...
 ::wxFont* sipwxHtmlWinParser::CreateCurrentFont()
{
    ...
    extern  ::wxFont* sipVH__html_60(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__html_60(sipGILState, 0, sipPySelf, sipMeth);
}
