...
sipwxColourPickerEvent::sipwxColourPickerEvent():  ::wxColourPickerEvent(), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxColourPickerEvent::sipwxColourPickerEvent( ::wxObject*generator,int id,const  ::wxColour& colour):  ::wxColourPickerEvent(generator,id,colour), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxColourPickerEvent::sipwxColourPickerEvent(const  ::wxColourPickerEvent& a0):  ::wxColourPickerEvent(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
static PyObject *meth_wxColourPickerEvent_GetColour(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_ColourPickerEvent, sipName_GetColour, NULL);
...
static PyObject *meth_wxColourPickerEvent_SetColour(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxColourPickerEvent, &sipCpp, sipType_wxColour, &pos, &posState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_ColourPickerEvent, sipName_SetColour, NULL);
...
static void dealloc_wxColourPickerEvent(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxColourPickerEvent *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxColourPickerEvent *sipCpp = 0;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxColourPickerEvent, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxColourPickerEvent[] = {{78, 255, 1}};
...
static PyMethodDef methods_wxColourPickerEvent[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SetColour), (PyCFunction)meth_wxColourPickerEvent_SetColour, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxColourPickerEvent_SetColour)}
};

sipVariableDef variables_wxColourPickerEvent[] = {
    {PropertyVariable, sipName_Colour, &methods_wxColourPickerEvent[1], &methods_wxColourPickerEvent[2], NULL, NULL},
};
