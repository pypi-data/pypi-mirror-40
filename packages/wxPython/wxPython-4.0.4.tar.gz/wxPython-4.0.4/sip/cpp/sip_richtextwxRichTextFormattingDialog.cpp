...
sipwxRichTextFormattingDialog::sipwxRichTextFormattingDialog():  ::wxRichTextFormattingDialog(), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxRichTextFormattingDialog::sipwxRichTextFormattingDialog(long flags, ::wxWindow*parent,const  ::wxString& title, ::wxWindowID id,const  ::wxPoint& pos,const  ::wxSize& sz,long style):  ::wxRichTextFormattingDialog(flags,parent,title,id,pos,sz,style), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
void sipwxRichTextFormattingDialog::AddBookCtrl( ::wxSizer*sizer)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[41],sipPySelf,NULL,sipName_AddBookCtrl);
    ...
    extern void sipVH__richtext_163(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxSizer*);

    sipVH__richtext_163(sipGILState, 0, sipPySelf, sipMeth, sizer);
}
 ...
 ::wxBookCtrlBase* sipwxRichTextFormattingDialog::CreateBookCtrl()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[42],sipPySelf,NULL,sipName_CreateBookCtrl);

    if (!sipMeth)
        return  ::wxRichTextFormattingDialog::CreateBookCtrl();

    extern  ::wxBookCtrlBase* sipVH__richtext_162(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__richtext_162(sipGILState, 0, sipPySelf, sipMeth);
}
...
void sipwxRichTextFormattingDialog::CreateButtons(int flags)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[43],sipPySelf,NULL,sipName_CreateButtons);
...
void sipwxRichTextFormattingDialog::LayoutDialog(int centreFlags)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[44],sipPySelf,NULL,sipName_LayoutDialog);
...
extern "C" {static PyObject *meth_wxRichTextFormattingDialog_SendDestroyEvent(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxRichTextFormattingDialog_SendDestroyEvent(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, NULL, NULL, "B", &sipSelf, sipType_wxRichTextFormattingDialog, &sipCpp))
        {
            PyErr_Clear();
    ...
    sipNoMethod(sipParseErr, sipName_RichTextFormattingDialog, sipName_SendDestroyEvent, NULL);
...
static PyObject *meth_wxRichTextFormattingDialog_GetAttributes(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxRichTextFormattingDialog, &sipCpp))
        {
            ...
            return sipConvertFromType(sipRes,sipType_wxTextAttr,NULL);
        }
    }

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextFormattingDialog, sipName_GetAttributes, NULL);
...
static PyObject *meth_wxRichTextFormattingDialog_ApplyStyle(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8J1|i", &sipSelf, sipType_wxRichTextFormattingDialog, &sipCpp, sipType_wxRichTextCtrl, &ctrl, sipType_wxRichTextRange, &range, &rangeState, &flags))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextFormattingDialog, sipName_ApplyStyle, NULL);
...
static PyObject *meth_wxRichTextFormattingDialog_Create(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BlJ8|J1iJ1J1l", &sipSelf, sipType_wxRichTextFormattingDialog, &sipCpp, &flags, sipType_wxWindow, &parent, sipType_wxString,&title, &titleState, &id, sipType_wxPoint, &pos, &posState, sipType_wxSize, &sz, &szState, &style))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextFormattingDialog, sipName_Create, NULL);
...
static PyObject *meth_wxRichTextFormattingDialog_GetImageList(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextFormattingDialog, sipName_GetImageList, NULL);
...
static PyObject *meth_wxRichTextFormattingDialog_GetStyle(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8J1", &sipSelf, sipType_wxRichTextFormattingDialog, &sipCpp, sipType_wxRichTextCtrl, &ctrl, sipType_wxRichTextRange, &range, &rangeState))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextFormattingDialog, sipName_GetStyle, NULL);
...
static PyObject *meth_wxRichTextFormattingDialog_GetStyleDefinition(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextFormattingDialog, sipName_GetStyleDefinition, NULL);
...
static PyObject *meth_wxRichTextFormattingDialog_GetStyleSheet(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextFormattingDialog, sipName_GetStyleSheet, NULL);
...
static PyObject *meth_wxRichTextFormattingDialog_SetAttributes(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxRichTextFormattingDialog, &sipCpp, sipType_wxTextAttr, &attr))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextFormattingDialog, sipName_SetAttributes, NULL);
...
static PyObject *meth_wxRichTextFormattingDialog_SetOptions(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bi", &sipSelf, sipType_wxRichTextFormattingDialog, &sipCpp, &options))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextFormattingDialog, sipName_SetOptions, NULL);
...
static PyObject *meth_wxRichTextFormattingDialog_GetOptions(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextFormattingDialog, sipName_GetOptions, NULL);
...
static PyObject *meth_wxRichTextFormattingDialog_HasOption(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bi", &sipSelf, sipType_wxRichTextFormattingDialog, &sipCpp, &option))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextFormattingDialog, sipName_HasOption, NULL);
...
static PyObject *meth_wxRichTextFormattingDialog_SetImageList(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8", &sipSelf, sipType_wxRichTextFormattingDialog, &sipCpp, sipType_wxImageList, &imageList))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextFormattingDialog, sipName_SetImageList, NULL);
...
static PyObject *meth_wxRichTextFormattingDialog_SetStyle(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9|b", &sipSelf, sipType_wxRichTextFormattingDialog, &sipCpp, sipType_wxTextAttr, &style, &update))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextFormattingDialog, sipName_SetStyle, NULL);
...
static PyObject *meth_wxRichTextFormattingDialog_SetStyleDefinition(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9J8|b", &sipSelf, sipType_wxRichTextFormattingDialog, &sipCpp, sipType_wxRichTextStyleDefinition, &styleDef, sipType_wxRichTextStyleSheet, &sheet, &update))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextFormattingDialog, sipName_SetStyleDefinition, NULL);
...
static PyObject *meth_wxRichTextFormattingDialog_UpdateDisplay(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextFormattingDialog, sipName_UpdateDisplay, NULL);
...
static PyObject *meth_wxRichTextFormattingDialog_GetDialog(PyObject *, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "J8", sipType_wxWindow, &win))
        {
            ...
            return sipConvertFromType(sipRes,sipType_wxRichTextFormattingDialog,NULL);
        }
    }

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextFormattingDialog, sipName_GetDialog, NULL);
...
static PyObject *meth_wxRichTextFormattingDialog_GetDialogAttributes(PyObject *, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextFormattingDialog, sipName_GetDialogAttributes, NULL);
...
static PyObject *meth_wxRichTextFormattingDialog_GetDialogStyleDefinition(PyObject *, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextFormattingDialog, sipName_GetDialogStyleDefinition, NULL);
...
static PyObject *meth_wxRichTextFormattingDialog_GetFormattingDialogFactory(PyObject *, PyObject *sipArgs)
{
...

    {
        if (sipParseArgs(&sipParseErr, sipArgs, ""))
        {
            ...
            return sipConvertFromType(sipRes,sipType_wxRichTextFormattingDialogFactory,NULL);
        }
    }

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextFormattingDialog, sipName_GetFormattingDialogFactory, NULL);
...
static PyObject *meth_wxRichTextFormattingDialog_SetFormattingDialogFactory(PyObject *, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "J8", sipType_wxRichTextFormattingDialogFactory, &factory))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextFormattingDialog, sipName_SetFormattingDialogFactory, NULL);
...
static PyObject *meth_wxRichTextFormattingDialog_AddChild(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8", &sipSelf, sipType_wxRichTextFormattingDialog, &sipCpp, sipType_wxWindowBase, &child))
        {
            PyErr_Clear();
...
static PyObject *meth_wxRichTextFormattingDialog_InformFirstDirection(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Biii", &sipSelf, sipType_wxRichTextFormattingDialog, &sipCpp, &direction, &size, &availableOtherDir))
        {
            bool sipRes;
...
static PyObject *meth_wxRichTextFormattingDialog_SetCanFocus(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bb", &sipSelf, sipType_wxRichTextFormattingDialog, &sipCpp, &canFocus))
        {
            PyErr_Clear();
...
static PyObject *meth_wxRichTextFormattingDialog_SetValidator(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxRichTextFormattingDialog, &sipCpp, sipType_wxValidator, &validator))
        {
            PyErr_Clear();
...
static PyObject *meth_wxRichTextFormattingDialog_ProcessEvent(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxRichTextFormattingDialog, &sipCpp, sipType_wxEvent, &event))
        {
            bool sipRes;
...
static PyObject *meth_wxRichTextFormattingDialog_DoEnable(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bb", &sipSelf, sipType_wxRichTextFormattingDialog, &sipCpp, &enable))
        {
            PyErr_Clear();
...
extern "C" {static PyObject *meth_wxRichTextFormattingDialog_DoGetBestSize(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxRichTextFormattingDialog_DoGetBestSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxRichTextFormattingDialog_DoGetBestClientSize(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxRichTextFormattingDialog_DoGetBestClientSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
static PyObject *meth_wxRichTextFormattingDialog_DoSetSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Biiiii", &sipSelf, sipType_wxRichTextFormattingDialog, &sipCpp, &x, &y, &width, &height, &sizeFlags))
        {
            PyErr_Clear();
...
static PyObject *meth_wxRichTextFormattingDialog_DoSetClientSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bii", &sipSelf, sipType_wxRichTextFormattingDialog, &sipCpp, &width, &height))
        {
            PyErr_Clear();
...
static PyObject *meth_wxRichTextFormattingDialog_DoSetSizeHints(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Biiiiii", &sipSelf, sipType_wxRichTextFormattingDialog, &sipCpp, &minW, &minH, &maxW, &maxH, &incW, &incH))
        {
            PyErr_Clear();
...
extern "C" {static PyObject *meth_wxRichTextFormattingDialog_DoGetBorderSize(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxRichTextFormattingDialog_DoGetBorderSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
static PyObject *meth_wxRichTextFormattingDialog_DoMoveWindow(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Biiii", &sipSelf, sipType_wxRichTextFormattingDialog, &sipCpp, &x, &y, &width, &height))
        {
            PyErr_Clear();
...
static PyObject *meth_wxRichTextFormattingDialog_DoSetWindowVariant(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BE", &sipSelf, sipType_wxRichTextFormattingDialog, &sipCpp, sipType_wxWindowVariant, &variant))
        {
            PyErr_Clear();
...
extern "C" {static PyObject *meth_wxRichTextFormattingDialog_GetDefaultBorder(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxRichTextFormattingDialog_GetDefaultBorder(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxRichTextFormattingDialog_GetDefaultBorderForControl(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxRichTextFormattingDialog_GetDefaultBorderForControl(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxRichTextFormattingDialog_DoFreeze(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxRichTextFormattingDialog_DoFreeze(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxRichTextFormattingDialog_DoThaw(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxRichTextFormattingDialog_DoThaw(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxRichTextFormattingDialog_HasTransparentBackground(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxRichTextFormattingDialog_HasTransparentBackground(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
static void dealloc_wxRichTextFormattingDialog(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxRichTextFormattingDialog *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxRichTextFormattingDialog *sipCpp = 0;
...
static PyMethodDef methods_wxRichTextFormattingDialog[] = {
    ...
    {SIP_MLNAME_CAST(sipName_AddChild), (PyCFunction)meth_wxRichTextFormattingDialog_AddChild, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_AddChild)},
    {SIP_MLNAME_CAST(sipName_ApplyStyle), (PyCFunction)meth_wxRichTextFormattingDialog_ApplyStyle, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_ApplyStyle)},
    {SIP_MLNAME_CAST(sipName_Create), (PyCFunction)meth_wxRichTextFormattingDialog_Create, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_Create)},
    ...
    {SIP_MLNAME_CAST(sipName_DoEnable), (PyCFunction)meth_wxRichTextFormattingDialog_DoEnable, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_DoEnable)},
    {SIP_MLNAME_CAST(sipName_DoFreeze), (PyCFunction)meth_wxRichTextFormattingDialog_DoFreeze, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_DoFreeze)},
    {SIP_MLNAME_CAST(sipName_DoGetBestClientSize), (PyCFunction)meth_wxRichTextFormattingDialog_DoGetBestClientSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_DoGetBestClientSize)},
    {SIP_MLNAME_CAST(sipName_DoGetBestSize), (PyCFunction)meth_wxRichTextFormattingDialog_DoGetBestSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_DoGetBestSize)},
    {SIP_MLNAME_CAST(sipName_DoGetBorderSize), (PyCFunction)meth_wxRichTextFormattingDialog_DoGetBorderSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_DoGetBorderSize)},
    {SIP_MLNAME_CAST(sipName_DoGetClientSize), (PyCFunction)meth_wxRichTextFormattingDialog_DoGetClientSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_DoGetClientSize)},
    {SIP_MLNAME_CAST(sipName_DoGetPosition), (PyCFunction)meth_wxRichTextFormattingDialog_DoGetPosition, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_DoGetPosition)},
    {SIP_MLNAME_CAST(sipName_DoGetSize), (PyCFunction)meth_wxRichTextFormattingDialog_DoGetSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_DoGetSize)},
    {SIP_MLNAME_CAST(sipName_DoMoveWindow), (PyCFunction)meth_wxRichTextFormattingDialog_DoMoveWindow, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_DoMoveWindow)},
    {SIP_MLNAME_CAST(sipName_DoSetClientSize), (PyCFunction)meth_wxRichTextFormattingDialog_DoSetClientSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_DoSetClientSize)},
    {SIP_MLNAME_CAST(sipName_DoSetSize), (PyCFunction)meth_wxRichTextFormattingDialog_DoSetSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_DoSetSize)},
    {SIP_MLNAME_CAST(sipName_DoSetSizeHints), (PyCFunction)meth_wxRichTextFormattingDialog_DoSetSizeHints, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_DoSetSizeHints)},
    {SIP_MLNAME_CAST(sipName_DoSetWindowVariant), (PyCFunction)meth_wxRichTextFormattingDialog_DoSetWindowVariant, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_DoSetWindowVariant)},
    {SIP_MLNAME_CAST(sipName_DoThaw), (PyCFunction)meth_wxRichTextFormattingDialog_DoThaw, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_DoThaw)},
    ...
    {SIP_MLNAME_CAST(sipName_GetDefaultBorder), (PyCFunction)meth_wxRichTextFormattingDialog_GetDefaultBorder, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_GetDefaultBorder)},
    {SIP_MLNAME_CAST(sipName_GetDefaultBorderForControl), (PyCFunction)meth_wxRichTextFormattingDialog_GetDefaultBorderForControl, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_GetDefaultBorderForControl)},
    {SIP_MLNAME_CAST(sipName_GetDialog), (PyCFunction)meth_wxRichTextFormattingDialog_GetDialog, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_GetDialog)},
    {SIP_MLNAME_CAST(sipName_GetDialogAttributes), (PyCFunction)meth_wxRichTextFormattingDialog_GetDialogAttributes, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_GetDialogAttributes)},
    {SIP_MLNAME_CAST(sipName_GetDialogStyleDefinition), (PyCFunction)meth_wxRichTextFormattingDialog_GetDialogStyleDefinition, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_GetDialogStyleDefinition)},
    ...
    {SIP_MLNAME_CAST(sipName_GetStyle), (PyCFunction)meth_wxRichTextFormattingDialog_GetStyle, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_GetStyle)},
    ...
    {SIP_MLNAME_CAST(sipName_HasOption), (PyCFunction)meth_wxRichTextFormattingDialog_HasOption, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_HasOption)},
    {SIP_MLNAME_CAST(sipName_HasTransparentBackground), (PyCFunction)meth_wxRichTextFormattingDialog_HasTransparentBackground, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_HasTransparentBackground)},
    {SIP_MLNAME_CAST(sipName_InformFirstDirection), (PyCFunction)meth_wxRichTextFormattingDialog_InformFirstDirection, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_InformFirstDirection)},
    ...
    {SIP_MLNAME_CAST(sipName_ProcessEvent), (PyCFunction)meth_wxRichTextFormattingDialog_ProcessEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_ProcessEvent)},
    {SIP_MLNAME_CAST(sipName_RemoveChild), (PyCFunction)meth_wxRichTextFormattingDialog_RemoveChild, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_RemoveChild)},
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxRichTextFormattingDialog_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_SetAttributes), (PyCFunction)meth_wxRichTextFormattingDialog_SetAttributes, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_SetAttributes)},
    {SIP_MLNAME_CAST(sipName_SetCanFocus), (PyCFunction)meth_wxRichTextFormattingDialog_SetCanFocus, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_SetCanFocus)},
    {SIP_MLNAME_CAST(sipName_SetFormattingDialogFactory), (PyCFunction)meth_wxRichTextFormattingDialog_SetFormattingDialogFactory, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_SetFormattingDialogFactory)},
    {SIP_MLNAME_CAST(sipName_SetImageList), (PyCFunction)meth_wxRichTextFormattingDialog_SetImageList, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_SetImageList)},
    {SIP_MLNAME_CAST(sipName_SetOptions), (PyCFunction)meth_wxRichTextFormattingDialog_SetOptions, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_SetOptions)},
    {SIP_MLNAME_CAST(sipName_SetStyle), (PyCFunction)meth_wxRichTextFormattingDialog_SetStyle, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_SetStyle)},
    {SIP_MLNAME_CAST(sipName_SetStyleDefinition), (PyCFunction)meth_wxRichTextFormattingDialog_SetStyleDefinition, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_SetStyleDefinition)},
    {SIP_MLNAME_CAST(sipName_SetValidator), (PyCFunction)meth_wxRichTextFormattingDialog_SetValidator, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_SetValidator)},
    ...
    {SIP_MLNAME_CAST(sipName_TryAfter), (PyCFunction)meth_wxRichTextFormattingDialog_TryAfter, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_TryAfter)},
    {SIP_MLNAME_CAST(sipName_TryBefore), (PyCFunction)meth_wxRichTextFormattingDialog_TryBefore, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextFormattingDialog_TryBefore)},
...
sipVariableDef variables_wxRichTextFormattingDialog[] = {
    {PropertyVariable, sipName_StyleSheet, &methods_wxRichTextFormattingDialog[34], NULL, NULL, NULL},
    {PropertyVariable, sipName_StyleDefinition, &methods_wxRichTextFormattingDialog[33], &methods_wxRichTextFormattingDialog[51], NULL, NULL},
    {PropertyVariable, sipName_Options, &methods_wxRichTextFormattingDialog[31], &methods_wxRichTextFormattingDialog[49], NULL, NULL},
    {PropertyVariable, sipName_ImageList, &methods_wxRichTextFormattingDialog[29], &methods_wxRichTextFormattingDialog[48], NULL, NULL},
    {PropertyVariable, sipName_Attributes, &methods_wxRichTextFormattingDialog[21], &methods_wxRichTextFormattingDialog[45], NULL, NULL},
};
...
sipClassTypeDef sipTypeDef__richtext_wxRichTextFormattingDialog = {
    ...
    },
    {
        ...
        {0, 0, 1},
        60, methods_wxRichTextFormattingDialog,
