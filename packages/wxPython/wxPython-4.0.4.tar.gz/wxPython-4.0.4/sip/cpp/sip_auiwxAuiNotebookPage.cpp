...
extern "C" {static void *array_wxAuiNotebookPage(SIP_SSIZE_T);}
static void *array_wxAuiNotebookPage(SIP_SSIZE_T sipNrElem)
{
...
static void *init_type_wxAuiNotebookPage(sipSimpleWrapper *, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxAuiNotebookPage, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyObject *varget_wxAuiNotebookPage_bitmap(void *sipSelf, PyObject *, PyObject *)
{
     ::wxBitmap*sipVal;
     ::wxAuiNotebookPage *sipCpp = reinterpret_cast< ::wxAuiNotebookPage *>(sipSelf);
...
static PyObject *varget_wxAuiNotebookPage_rect(void *sipSelf, PyObject *, PyObject *)
{
     ::wxRect*sipVal;
     ::wxAuiNotebookPage *sipCpp = reinterpret_cast< ::wxAuiNotebookPage *>(sipSelf);
...
sipVariableDef variables_wxAuiNotebookPage[] = {
    {InstanceVariable, sipName_active, (PyMethodDef *)varget_wxAuiNotebookPage_active, (PyMethodDef *)varset_wxAuiNotebookPage_active, NULL, NULL},
    {InstanceVariable, sipName_bitmap, (PyMethodDef *)varget_wxAuiNotebookPage_bitmap, (PyMethodDef *)varset_wxAuiNotebookPage_bitmap, NULL, NULL},
    {InstanceVariable, sipName_caption, (PyMethodDef *)varget_wxAuiNotebookPage_caption, (PyMethodDef *)varset_wxAuiNotebookPage_caption, NULL, NULL},
    {InstanceVariable, sipName_rect, (PyMethodDef *)varget_wxAuiNotebookPage_rect, (PyMethodDef *)varset_wxAuiNotebookPage_rect, NULL, NULL},
    {InstanceVariable, sipName_tooltip, (PyMethodDef *)varget_wxAuiNotebookPage_tooltip, (PyMethodDef *)varset_wxAuiNotebookPage_tooltip, NULL, NULL},
    {InstanceVariable, sipName_window, (PyMethodDef *)varget_wxAuiNotebookPage_window, (PyMethodDef *)varset_wxAuiNotebookPage_window, NULL, NULL},
};
