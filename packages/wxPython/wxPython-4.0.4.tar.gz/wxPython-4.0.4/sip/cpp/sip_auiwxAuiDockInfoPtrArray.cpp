...
static PyObject *meth_wxAuiDockInfoPtrArray_append(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8", &sipSelf, sipType_wxAuiDockInfoPtrArray, &sipCpp, sipType_wxAuiDockInfo, &obj))
        {
        sipCpp->Add(obj);
...
static int slot_wxAuiDockInfoPtrArray___contains__(PyObject *sipSelf,PyObject *sipArg)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_AuiDockInfoPtrArray, sipName___contains__, NULL);
...
static PyObject *slot_wxAuiDockInfoPtrArray___getitem__(PyObject *sipSelf,PyObject *sipArg)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_AuiDockInfoPtrArray, sipName___getitem__, NULL);
...
extern "C" {static void *array_wxAuiDockInfoPtrArray(SIP_SSIZE_T);}
static void *array_wxAuiDockInfoPtrArray(SIP_SSIZE_T sipNrElem)
{
...
{
     ::wxAuiDockInfoPtrArray *sipCpp = 0;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxAuiDockInfoPtrArray, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxAuiDockInfoPtrArray[] = {
    {SIP_MLNAME_CAST(sipName_append), (PyCFunction)meth_wxAuiDockInfoPtrArray_append, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxAuiDockInfoPtrArray_append)},
    {SIP_MLNAME_CAST(sipName_index), (PyCFunction)meth_wxAuiDockInfoPtrArray_index, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxAuiDockInfoPtrArray_index)}
};
