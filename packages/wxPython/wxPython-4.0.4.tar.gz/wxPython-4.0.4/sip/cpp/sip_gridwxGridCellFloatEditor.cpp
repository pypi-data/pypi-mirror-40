...
sipwxGridCellFloatEditor::sipwxGridCellFloatEditor(int width,int precision,int format):  ::wxGridCellFloatEditor(width,precision,format), sipPySelf(0)
{
 ...
 ::wxString sipwxGridCellFloatEditor::GetValue() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[0]),sipPySelf,NULL,sipName_GetValue);
...
void sipwxGridCellFloatEditor::Reset()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[5],sipPySelf,NULL,sipName_Reset);
...
void sipwxGridCellFloatEditor::PaintBackground( ::wxDC& dc,const  ::wxRect& rectCell, ::wxGridCellAttr& attr)
{
    sip_gilstate_t sipGILState;
    PyObject *sipMeth;
...
void sipwxGridCellFloatEditor::ApplyEdit(int row,int col, ::wxGrid*grid)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[8],sipPySelf,NULL,sipName_ApplyEdit);
...
bool sipwxGridCellFloatEditor::EndEdit(int row,int col,const  ::wxGrid*grid,const  ::wxString& oldval, ::wxString*newval)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[9],sipPySelf,NULL,sipName_EndEdit);
...
void sipwxGridCellFloatEditor::Create( ::wxWindow*parent, ::wxWindowID id, ::wxEvtHandler*evtHandler)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[11],sipPySelf,NULL,sipName_Create);
 ...
 ::wxGridCellEditor* sipwxGridCellFloatEditor::Clone() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[12]),sipPySelf,NULL,sipName_Clone);
...
void sipwxGridCellFloatEditor::BeginEdit(int row,int col, ::wxGrid*grid)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[13],sipPySelf,NULL,sipName_BeginEdit);
...
void sipwxGridCellFloatEditor::SetParameters(const  ::wxString& params)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[14],sipPySelf,NULL,sipName_SetParameters);
...
static PyObject *meth_wxGridCellFloatEditor_SetParameters(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxGridCellFloatEditor, &sipCpp, sipType_wxString,&params, &paramsState))
        {
            PyErr_Clear();
    ...
    sipNoMethod(sipParseErr, sipName_GridCellFloatEditor, sipName_SetParameters, NULL);
...
static PyObject *meth_wxGridCellFloatEditor_BeginEdit(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BiiJ8", &sipSelf, sipType_wxGridCellFloatEditor, &sipCpp, &row, &col, sipType_wxGrid, &grid))
        {
            PyErr_Clear();
...
static PyObject *meth_wxGridCellFloatEditor_Create(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8iJ8", &sipSelf, sipType_wxGridCellFloatEditor, &sipCpp, sipType_wxWindow, &parent, &id, sipType_wxEvtHandler, &evtHandler))
        {
            PyErr_Clear();
...
static PyObject *meth_wxGridCellFloatEditor_EndEdit(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BiiJ8J1", &sipSelf, sipType_wxGridCellFloatEditor, &sipCpp, &row, &col, sipType_wxGrid, &grid, sipType_wxString,&oldval, &oldvalState))
        {
            PyObject * sipRes = 0;
            int sipIsErr = 0;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GridCellFloatEditor, sipName_EndEdit, NULL);
...
static void dealloc_wxGridCellFloatEditor(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxGridCellFloatEditor *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxGridCellFloatEditor *sipCpp = 0;
...
static sipEncodedTypeDef supers_wxGridCellFloatEditor[] = {{25, 255, 1}};


static PyMethodDef methods_wxGridCellFloatEditor[] = {
    {SIP_MLNAME_CAST(sipName_ApplyEdit), (PyCFunction)meth_wxGridCellFloatEditor_ApplyEdit, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridCellFloatEditor_ApplyEdit)},
    {SIP_MLNAME_CAST(sipName_BeginEdit), (PyCFunction)meth_wxGridCellFloatEditor_BeginEdit, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridCellFloatEditor_BeginEdit)},
    ...
    {SIP_MLNAME_CAST(sipName_Create), (PyCFunction)meth_wxGridCellFloatEditor_Create, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridCellFloatEditor_Create)},
    {SIP_MLNAME_CAST(sipName_EndEdit), (PyCFunction)meth_wxGridCellFloatEditor_EndEdit, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridCellFloatEditor_EndEdit)},
    ...
    {SIP_MLNAME_CAST(sipName_SetParameters), (PyCFunction)meth_wxGridCellFloatEditor_SetParameters, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridCellFloatEditor_SetParameters)}
};
