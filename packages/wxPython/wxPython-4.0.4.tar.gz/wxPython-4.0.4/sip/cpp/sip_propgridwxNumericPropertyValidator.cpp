...
sipwxNumericPropertyValidator::sipwxNumericPropertyValidator( ::wxNumericPropertyValidator::NumericType numericType,int base):  ::wxNumericPropertyValidator(numericType,base), sipPySelf(0)
{
 ...
 ::wxObject* sipwxNumericPropertyValidator::Clone() const
{
    ...
    extern  ::wxObject* sipVH__propgrid_59(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__propgrid_59(sipGILState, 0, sipPySelf, sipMeth);
}
...
bool sipwxNumericPropertyValidator::TransferFromWindow()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[4],sipPySelf,NULL,sipName_TransferFromWindow);
...
bool sipwxNumericPropertyValidator::TransferToWindow()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[5],sipPySelf,NULL,sipName_TransferToWindow);
...
bool sipwxNumericPropertyValidator::Validate( ::wxWindow*parent)
{
    ...
    extern bool sipVH__propgrid_58(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*);

    return sipVH__propgrid_58(sipGILState, 0, sipPySelf, sipMeth, parent);
}
...
static PyObject *meth_wxNumericPropertyValidator_TryBefore(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxNumericPropertyValidator, &sipCpp, sipType_wxEvent, &event))
        {
            bool sipRes;
    ...
    sipNoMethod(sipParseErr, sipName_NumericPropertyValidator, sipName_TryBefore, NULL);
...
static PyObject *meth_wxNumericPropertyValidator_TryAfter(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_NumericPropertyValidator, sipName_TryAfter, NULL);
...
static PyObject *meth_wxNumericPropertyValidator_Validate(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8", &sipSelf, sipType_wxNumericPropertyValidator, &sipCpp, sipType_wxWindow, &parent))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_NumericPropertyValidator, sipName_Validate, NULL);
...
static void dealloc_wxNumericPropertyValidator(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxNumericPropertyValidator *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxNumericPropertyValidator *sipCpp = 0;
...
static sipEncodedTypeDef supers_wxNumericPropertyValidator[] = {{34, 0, 1}};


static PyMethodDef methods_wxNumericPropertyValidator[] = {
    {SIP_MLNAME_CAST(sipName_TryAfter), (PyCFunction)meth_wxNumericPropertyValidator_TryAfter, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_TryBefore), (PyCFunction)meth_wxNumericPropertyValidator_TryBefore, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_Validate), (PyCFunction)meth_wxNumericPropertyValidator_Validate, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxNumericPropertyValidator_Validate)}
};

static sipEnumMemberDef enummembers_wxNumericPropertyValidator[] = {
    {sipName_Float, static_cast<int>( ::wxNumericPropertyValidator::Float), 20},
    {sipName_Signed, static_cast<int>( ::wxNumericPropertyValidator::Signed), 20},
    {sipName_Unsigned, static_cast<int>( ::wxNumericPropertyValidator::Unsigned), 20},
};
