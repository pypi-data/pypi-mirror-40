...
static PyObject *meth_wxFileType_GetOpenCommand(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxFileType, &sipCpp, sipType_wxFileType_MessageParameters, &params))
        {
             ::wxString*sipRes = 0;
            int sipIsErr = 0;
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxFileType, &sipCpp, sipType_wxString,&filename, &filenameState))
        {
             ::wxString*sipRes = 0;
            int sipIsErr = 0;
    ...
    sipNoMethod(sipParseErr, sipName_FileType, sipName_GetOpenCommand, NULL);
...
static PyObject *meth_wxFileType_GetDescription(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FileType, sipName_GetDescription, NULL);
...
static PyObject *meth_wxFileType_GetExtensions(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FileType, sipName_GetExtensions, NULL);
...
static PyObject *meth_wxFileType_GetIcon(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FileType, sipName_GetIcon, NULL);
...
static PyObject *meth_wxFileType_GetMimeType(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FileType, sipName_GetMimeType, NULL);
...
static PyObject *meth_wxFileType_GetMimeTypes(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FileType, sipName_GetMimeTypes, NULL);
...
static PyObject *meth_wxFileType_GetPrintCommand(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FileType, sipName_GetPrintCommand, NULL);
...
static PyObject *meth_wxFileType_GetAllCommands(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxFileType, &sipCpp, sipType_wxFileType_MessageParameters, &params))
        {
            ...
            return sipBuildResult(0,"(NN)",verbs,sipType_wxArrayString,NULL,commands,sipType_wxArrayString,NULL);
        }
    }

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FileType, sipName_GetAllCommands, NULL);
...
static PyObject *meth_wxFileType_ExpandCommand(PyObject *, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "J1J9", sipType_wxString,&command, &commandState, sipType_wxFileType_MessageParameters, &params))
        {
             ::wxString*sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FileType, sipName_ExpandCommand, NULL);
...
static PyObject *meth_wxFileType_GetIconLocation(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (PyErr_Occurred()) sipIsErr = 1;
            ...
            return sipConvertFromNewType(sipRes,sipType_wxIconLocation,NULL);
        }
    }

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FileType, sipName_GetIconLocation, NULL);
...
static PyObject *meth_wxFileType_GetIconInfo(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FileType, sipName_GetIconInfo, NULL);
...
static PyMethodDef methods_wxFileType[] = {
    {SIP_MLNAME_CAST(sipName_ExpandCommand), (PyCFunction)meth_wxFileType_ExpandCommand, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxFileType_ExpandCommand)},
    {SIP_MLNAME_CAST(sipName_GetAllCommands), (PyCFunction)meth_wxFileType_GetAllCommands, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxFileType_GetAllCommands)},
    ...
    {SIP_MLNAME_CAST(sipName_GetOpenCommand), (PyCFunction)meth_wxFileType_GetOpenCommand, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxFileType_GetOpenCommand)},
    {SIP_MLNAME_CAST(sipName_GetPrintCommand), (PyCFunction)meth_wxFileType_GetPrintCommand, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxFileType_GetPrintCommand)}
};

sipVariableDef variables_wxFileType[] = {
    {PropertyVariable, sipName_PrintCommand, &methods_wxFileType[10], NULL, NULL, NULL},
    {PropertyVariable, sipName_OpenCommand, &methods_wxFileType[9], NULL, NULL, NULL},
    {PropertyVariable, sipName_MimeTypes, &methods_wxFileType[8], NULL, NULL, NULL},
    {PropertyVariable, sipName_MimeType, &methods_wxFileType[7], NULL, NULL, NULL},
    {PropertyVariable, sipName_IconLocation, &methods_wxFileType[6], NULL, NULL, NULL},
    {PropertyVariable, sipName_IconInfo, &methods_wxFileType[5], NULL, NULL, NULL},
    {PropertyVariable, sipName_Icon, &methods_wxFileType[4], NULL, NULL, NULL},
    {PropertyVariable, sipName_Extensions, &methods_wxFileType[3], NULL, NULL, NULL},
    {PropertyVariable, sipName_Description, &methods_wxFileType[2], NULL, NULL, NULL},
};
