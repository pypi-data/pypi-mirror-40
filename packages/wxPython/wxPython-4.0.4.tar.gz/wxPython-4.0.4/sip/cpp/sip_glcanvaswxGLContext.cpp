...
{
public:
    sipwxGLContext( ::wxGLCanvas*,const  ::wxGLContext*);
     ...
     */
protected:
    bool SetCurrent(const  ::wxGLCanvas&) const;
...
sipwxGLContext::sipwxGLContext( ::wxGLCanvas*win,const  ::wxGLContext*other):  ::wxGLContext(win,other), sipPySelf(0)
{
...
bool sipwxGLContext::SetCurrent(const  ::wxGLCanvas& win) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[0]),sipPySelf,NULL,sipName_SetCurrent);
...
static PyObject *meth_wxGLContext_SetCurrent(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxGLContext, &sipCpp, sipType_wxGLCanvas, &win))
        {
            bool sipRes;
    ...
    sipNoMethod(sipParseErr, sipName_GLContext, sipName_SetCurrent, NULL);
...
static void dealloc_wxGLContext(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxGLContext *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static void *init_type_wxGLContext(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, sipKwdList, sipUnused, "J8|J8", sipType_wxGLCanvas, &win, sipType_wxGLContext, &other))
        {
        ...
        if (!wxPyCheckForApp()) return NULL;
            ...
            Py_BEGIN_ALLOW_THREADS
            sipCpp = new sipwxGLContext(win,other);
            Py_END_ALLOW_THREADS
...
static PyMethodDef methods_wxGLContext[] = {
    {SIP_MLNAME_CAST(sipName_SetCurrent), (PyCFunction)meth_wxGLContext_SetCurrent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGLContext_SetCurrent)}
};

PyDoc_STRVAR(doc_wxGLContext, "GLContext(win, other=None)\n"
"\n"
