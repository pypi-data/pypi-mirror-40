...
const char sipStrings__propgrid[] = {
    ...
    'w', 'x', 'P', 'G', 'L', 'o', 'n', 'g', 'S', 't', 'r', 'i', 'n', 'g', 'D', 'i', 'a', 'l', 'o', 'g', 'A', 'd', 'a', 'p', 't', 'e', 'r', 0,
    ...
    'P', 'G', '_', 'C', 'U', 'S', 'T', 'O', 'M', '_', 'I', 'M', 'A', 'G', 'E', '_', 'S', 'P', 'A', 'C', 'I', 'N', 'G', 'Y', 0,
    ...
    'w', 'x', 'P', 'G', 'F', 'i', 'l', 'e', 'D', 'i', 'a', 'l', 'o', 'g', 'A', 'd', 'a', 'p', 't', 'e', 'r', 0,
    ...
    'O', 'n', 'V', 'a', 'l', 'i', 'd', 'a', 't', 'i', 'o', 'n', 'F', 'a', 'i', 'l', 'u', 'r', 'e', 0,
    ...
    'P', 'G', '_', 'P', 'R', 'O', 'P', '_', 'N', 'O', '_', 'E', 'S', 'C', 'A', 'P', 'E', 0,
    ...
    'P', 'G', '_', 'C', 'A', 'P', 'R', 'E', 'C', 'T', 'Y', 'M', 'A', 'R', 'G', 'I', 'N', 0,
    'P', 'G', '_', 'C', 'A', 'P', 'R', 'E', 'C', 'T', 'X', 'M', 'A', 'R', 'G', 'I', 'N', 0,
    ...
    'p', 'V', 'a', 'l', 'i', 'd', 'a', 't', 'i', 'o', 'n', 'I', 'n', 'f', 'o', 0,
...
wxString testPGVariantTypeName(const wxPGVariant& var)
{
 ...
 ::wxPropertyGrid* sipVH__propgrid_79(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
...
bool sipVH__propgrid_78(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int page)
{
    bool sipRes = 0;
 ...
 ::wxPropertyGridPage* sipVH__propgrid_77(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int index,const  ::wxString& label,const  ::wxBitmap& bmp, ::wxPropertyGridPage*pageObj)
{
     ::wxPropertyGridPage* sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "iNND", index, new  ::wxString(label), sipType_wxString, NULL, new  ::wxBitmap(bmp), sipType_wxBitmap, NULL, pageObj, sipType_wxPropertyGridPage, NULL);
...
void sipVH__propgrid_76(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxPGProperty*p)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "D", p, sipType_wxPGProperty, NULL);
}

 ::wxColour sipVH__propgrid_75(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int index)
{
     ::wxColour sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "i", index);
 ...
 ::wxString sipVH__propgrid_74(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxColour& col,int index,int argFlags)
{
     ::wxString sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "Nii", new  ::wxColour(col), sipType_wxColour, NULL, index, argFlags);
...
bool sipVH__propgrid_73(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxString*resString)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "D", resString, sipType_wxString, NULL);
...
void sipVH__propgrid_72(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::size_t first, ::size_t second)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "NN", new  ::size_t(first), sipType_size_t, NULL, new  ::size_t(second), sipType_size_t, NULL);
}

void sipVH__propgrid_71(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int index)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "i", index);
}

bool sipVH__propgrid_70(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::size_t index,const  ::wxString& str)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "NN", new  ::size_t(index), sipType_size_t, NULL, new  ::wxString(str), sipType_wxString, NULL);
...
bool sipVH__propgrid_69(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxString& str,int index)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "Ni", new  ::wxString(str), sipType_wxString, NULL, index);
 ...
 ::size_t sipVH__propgrid_68(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
     ::size_t sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "");
 ...
 ::wxString sipVH__propgrid_67(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::size_t index)
{
     ::wxString sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "N", new  ::size_t(index), sipType_size_t, NULL);
...
void sipVH__propgrid_66(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxPGVariant& value)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "N", new  ::wxPGVariant(value), sipType_wxPGVariant, NULL);
}

 ::wxPGArrayEditorDialog* sipVH__propgrid_65(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
...
bool sipVH__propgrid_64(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxPropertyGrid*propgrid, ::wxWindow*primary,const  ::wxChar*cbt)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "DDx", propgrid, sipType_wxPropertyGrid, NULL, primary, sipType_wxWindow, NULL, cbt);
...
bool sipVH__propgrid_63(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxWindow*parent, ::wxString& value)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "DD", parent, sipType_wxWindow, NULL, &value, sipType_wxString, NULL);
...
void sipVH__propgrid_62(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxArrayString& arr, ::wxString*pString,const  ::wxUniChar& delimiter)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "NDN", new  ::wxArrayString(arr), sipType_wxArrayString, NULL, pString, sipType_wxString, NULL, new  ::wxUniChar(delimiter), sipType_wxUniChar, NULL);
}

bool sipVH__propgrid_61(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxPropertyGrid*propgrid, ::wxString& value)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "DD", propgrid, sipType_wxPropertyGrid, NULL, &value, sipType_wxString, NULL);

    sipParseResultEx(sipGILState, sipErrorHandler, sipPySelf, sipMethod, sipResObj, "(bH5)", &sipRes, sipType_wxString, &value);

    return sipRes;
}

int sipVH__propgrid_60(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int value)
{
    int sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "i", value);
 ...
 ::wxObject* sipVH__propgrid_59(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
     ::wxObject* sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "");
...
bool sipVH__propgrid_58(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxWindow*parent)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "D", parent, sipType_wxWindow, NULL);
 ...
 ::wxEventCategory sipVH__propgrid_57(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
 ...
 ::wxEvent* sipVH__propgrid_56(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
     ::wxEvent* sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "");
...
bool sipVH__propgrid_55(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxPGPropArgCls& id)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "N", new  ::wxPGPropArgCls(id), sipType_wxPGPropArgCls, NULL);
 ...
 ::wxPGVIterator sipVH__propgrid_54(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int flags)
{
    ...
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "i", flags);
 ...
 ::wxPGProperty* sipVH__propgrid_52(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxPGProperty*parent,int index, ::wxPGProperty*property)
{
    ...
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "DiD", parent, sipType_wxPGProperty, NULL, index, property, sipType_wxPGProperty, NULL);
...
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "Db", item, sipType_wxPGProperty, NULL, doDelete);
}
...
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "DD", propGrid, sipType_wxPropertyGrid, NULL, property, sipType_wxPGProperty, NULL);
...
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "DDD", &variant, sipType_wxPGVariant, NULL, property, sipType_wxPGProperty, NULL, ctrl, sipType_wxWindow, NULL);
...
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "Di", ctrl, sipType_wxWindow, NULL, index);
}
...
{
    int sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "DNi", ctrl, sipType_wxWindow, NULL, new  ::wxString(label), sipType_wxString, NULL, index);
...
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "DDi", property, sipType_wxPGProperty, NULL, ctrl, sipType_wxWindow, NULL, value);
}
...
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "DDN", property, sipType_wxPGProperty, NULL, ctrl, sipType_wxWindow, NULL, new  ::wxString(txt), sipType_wxString, NULL);
}
...
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "DDDNNb", pg, sipType_wxPropertyGrid, NULL, property, sipType_wxPGProperty, NULL, ctrl, sipType_wxWindow, NULL, new  ::wxPGCell(appearance), sipType_wxPGCell, NULL, new  ::wxPGCell(oldAppearance), sipType_wxPGCell, NULL, unspecified);
}
...
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "DDDD", propgrid, sipType_wxPropertyGrid, NULL, property, sipType_wxPGProperty, NULL, wnd_primary, sipType_wxWindow, NULL, &event, sipType_wxEvent, NULL);
...
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "DNDN", &dc, sipType_wxDC, NULL, new  ::wxRect(rect), sipType_wxRect, NULL, property, sipType_wxPGProperty, NULL, new  ::wxString(text), sipType_wxString, NULL);
}
...
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "DD", property, sipType_wxPGProperty, NULL, ctrl, sipType_wxWindow, NULL);
}
 ...
 ::wxPGWindowList sipVH__propgrid_23(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxPropertyGrid*propgrid, ::wxPGProperty*property,const  ::wxPoint& pos,const  ::wxSize& size)
{
    ...
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "DDNN", propgrid, sipType_wxPropertyGrid, NULL, property, sipType_wxPGProperty, NULL, new  ::wxPoint(pos), sipType_wxPoint, NULL, new  ::wxSize(size), sipType_wxSize, NULL);
...
{
     ::wxString sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "i", argFlags);
...
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "D", &pendingValue, sipType_wxPGVariant, NULL);
}
...
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "ND", new  ::wxString(name), sipType_wxString, NULL, &value, sipType_wxPGVariant, NULL);
 ...
 ::wxPGCellRenderer* sipVH__propgrid_15(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int column)
{
    ...
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "i", column);
...
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "DND", &dc, sipType_wxDC, NULL, new  ::wxRect(rect), sipType_wxRect, NULL, &paintdata, sipType_wxPGPaintData, NULL);
}
...
{
     ::wxPGVariant sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "DiD", &thisValue, sipType_wxPGVariant, NULL, childIndex, &childValue, sipType_wxPGVariant, NULL);
...
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "DDD", propgrid, sipType_wxPropertyGrid, NULL, wnd_primary, sipType_wxWindow, NULL, &event, sipType_wxEvent, NULL);
...
{
     ::wxSize sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "i", item);
...
{
     ::wxString sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "Di", &value, sipType_wxPGVariant, NULL, argFlags);
...
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "ii", number, argFlags);
...
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "Ni", new  ::wxString(text), sipType_wxString, NULL, argFlags);
...
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "DD", &value, sipType_wxPGVariant, NULL, &validationInfo, sipType_wxPGValidationInfo, NULL);
...
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "Diiii", &dc, sipType_wxDC, NULL, x, y, w, h);
}
...
{
     ::wxSize sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "Dii", const_cast< ::wxPGProperty *>(property), sipType_wxPGProperty, NULL, column, item);
...
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "DNDDiii", &dc, sipType_wxDC, NULL, new  ::wxRect(rect), sipType_wxRect, NULL, const_cast< ::wxPropertyGrid *>(propertyGrid), sipType_wxPropertyGrid, NULL, property, sipType_wxPGProperty, NULL, column, item, flags);
...
static PyObject *func_PGGetDefaultImageWildcard(PyObject *,PyObject *sipArgs)
{
    ...
    sipNoFunction(sipParseErr, sipName_PGGetDefaultImageWildcard, NULL);
...
static PyObject *func_testPGVariantTypeName(PyObject *,PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "J1", sipType_wxPGVariant,&var, &varState))
        {
             ::wxString*sipRes;
...
static sipEnumTypeDef enumTypes[] = {
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxArrayStringProperty__ConversionFlags, {0}, 0}, sipNameNr_ConversionFlags, 1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxNumericPropertyValidator__NumericType, {0}, 0}, sipNameNr_NumericType, 19, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxPGNumericValidationConstants, {0}, 0}, sipNameNr_PGNumericValidationConstants, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxPG_KEYBOARD_ACTIONS, {0}, 0}, sipNameNr_PG_KEYBOARD_ACTIONS, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxPG_VALIDATION_FAILURE_BEHAVIOR_FLAGS, {0}, 0}, sipNameNr_PG_VALIDATION_FAILURE_BEHAVIOR_FLAGS, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxPG_EX_WINDOW_STYLES, {0}, 0}, sipNameNr_PG_EX_WINDOW_STYLES, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxPG_WINDOW_STYLES, {0}, 0}, sipNameNr_PG_WINDOW_STYLES, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxPropertyGridInterface__EditableStateFlags, {0}, 0}, sipNameNr_EditableStateFlags, 65, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxPG_ITERATOR_FLAGS, {0}, 0}, sipNameNr_PG_ITERATOR_FLAGS, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxPGPropertyFlags, {0}, 0}, sipNameNr_PGPropertyFlags, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxPG_SETVALUE_FLAGS, {0}, 0}, sipNameNr_PG_SETVALUE_FLAGS, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxPG_MISC_ARG_FLAGS, {0}, 0}, sipNameNr_PG_MISC_ARG_FLAGS, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxPG_GETPROPERTYVALUES_FLAGS, {0}, 0}, sipNameNr_PG_GETPROPERTYVALUES_FLAGS, -1, NULL},
};

/* These are the enum members of all global enums. */
static sipEnumMemberDef enummembers[] = {
    {sipName_PG_ACTION_CANCEL_EDIT, static_cast<int>(::wxPG_ACTION_CANCEL_EDIT), 56},
    {sipName_PG_ACTION_COLLAPSE_PROPERTY, static_cast<int>(::wxPG_ACTION_COLLAPSE_PROPERTY), 56},
    {sipName_PG_ACTION_EDIT, static_cast<int>(::wxPG_ACTION_EDIT), 56},
    {sipName_PG_ACTION_EXPAND_PROPERTY, static_cast<int>(::wxPG_ACTION_EXPAND_PROPERTY), 56},
    {sipName_PG_ACTION_INVALID, static_cast<int>(::wxPG_ACTION_INVALID), 56},
    {sipName_PG_ACTION_MAX, static_cast<int>(::wxPG_ACTION_MAX), 56},
    {sipName_PG_ACTION_NEXT_PROPERTY, static_cast<int>(::wxPG_ACTION_NEXT_PROPERTY), 56},
    {sipName_PG_ACTION_PRESS_BUTTON, static_cast<int>(::wxPG_ACTION_PRESS_BUTTON), 56},
    {sipName_PG_ACTION_PREV_PROPERTY, static_cast<int>(::wxPG_ACTION_PREV_PROPERTY), 56},
    {sipName_PG_ALPHABETIC_MODE, static_cast<int>(::wxPG_ALPHABETIC_MODE), 60},
    {sipName_PG_AUTO_SORT, static_cast<int>(::wxPG_AUTO_SORT), 60},
    {sipName_PG_BOLD_MODIFIED, static_cast<int>(::wxPG_BOLD_MODIFIED), 60},
    {sipName_PG_COMPOSITE_FRAGMENT, static_cast<int>(::wxPG_COMPOSITE_FRAGMENT), 57},
    {sipName_PG_DESCRIPTION, static_cast<int>(::wxPG_DESCRIPTION), 60},
    {sipName_PG_EDITABLE_VALUE, static_cast<int>(::wxPG_EDITABLE_VALUE), 57},
    {sipName_PG_EX_AUTO_UNSPECIFIED_VALUES, static_cast<int>(::wxPG_EX_AUTO_UNSPECIFIED_VALUES), 53},
    {sipName_PG_EX_ENABLE_TLP_TRACKING, static_cast<int>(::wxPG_EX_ENABLE_TLP_TRACKING), 53},
    {sipName_PG_EX_HELP_AS_TOOLTIPS, static_cast<int>(::wxPG_EX_HELP_AS_TOOLTIPS), 53},
    {sipName_PG_EX_HIDE_PAGE_BUTTONS, static_cast<int>(::wxPG_EX_HIDE_PAGE_BUTTONS), 53},
    {sipName_PG_EX_INIT_NOCAT, static_cast<int>(::wxPG_EX_INIT_NOCAT), 53},
    {sipName_PG_EX_MODE_BUTTONS, static_cast<int>(::wxPG_EX_MODE_BUTTONS), 53},
    {sipName_PG_EX_MULTIPLE_SELECTION, static_cast<int>(::wxPG_EX_MULTIPLE_SELECTION), 53},
    {sipName_PG_EX_NATIVE_DOUBLE_BUFFERING, static_cast<int>(::wxPG_EX_NATIVE_DOUBLE_BUFFERING), 53},
    {sipName_PG_EX_NO_FLAT_TOOLBAR, static_cast<int>(::wxPG_EX_NO_FLAT_TOOLBAR), 53},
    {sipName_PG_EX_NO_TOOLBAR_DIVIDER, static_cast<int>(::wxPG_EX_NO_TOOLBAR_DIVIDER), 53},
    {sipName_PG_EX_TOOLBAR_SEPARATOR, static_cast<int>(::wxPG_EX_TOOLBAR_SEPARATOR), 53},
    {sipName_PG_EX_WRITEONLY_BUILTIN_ATTRIBUTES, static_cast<int>(::wxPG_EX_WRITEONLY_BUILTIN_ATTRIBUTES), 53},
    {sipName_PG_FORCE, static_cast<int>(::wxPG_FORCE), 54},
    {sipName_PG_FULL_VALUE, static_cast<int>(::wxPG_FULL_VALUE), 57},
    {sipName_PG_HIDE_CATEGORIES, static_cast<int>(::wxPG_HIDE_CATEGORIES), 60},
    {sipName_PG_HIDE_MARGIN, static_cast<int>(::wxPG_HIDE_MARGIN), 60},
    {sipName_PG_INC_ATTRIBUTES, static_cast<int>(::wxPG_INC_ATTRIBUTES), 54},
    {sipName_PG_ITERATE_ALL, static_cast<int>(::wxPG_ITERATE_ALL), 55},
    {sipName_PG_ITERATE_ALL_PARENTS, static_cast<int>(::wxPG_ITERATE_ALL_PARENTS), 55},
    {sipName_PG_ITERATE_ALL_PARENTS_RECURSIVELY, static_cast<int>(::wxPG_ITERATE_ALL_PARENTS_RECURSIVELY), 55},
    {sipName_PG_ITERATE_CATEGORIES, static_cast<int>(::wxPG_ITERATE_CATEGORIES), 55},
    {sipName_PG_ITERATE_DEFAULT, static_cast<int>(::wxPG_ITERATE_DEFAULT), 55},
    {sipName_PG_ITERATE_FIXED_CHILDREN, static_cast<int>(::wxPG_ITERATE_FIXED_CHILDREN), 55},
    {sipName_PG_ITERATE_HIDDEN, static_cast<int>(::wxPG_ITERATE_HIDDEN), 55},
    {sipName_PG_ITERATE_NORMAL, static_cast<int>(::wxPG_ITERATE_NORMAL), 55},
    {sipName_PG_ITERATE_PROPERTIES, static_cast<int>(::wxPG_ITERATE_PROPERTIES), 55},
    {sipName_PG_ITERATE_VISIBLE, static_cast<int>(::wxPG_ITERATE_VISIBLE), 55},
    {sipName_PG_ITERATOR_FLAGS_ALL, static_cast<int>(::wxPG_ITERATOR_FLAGS_ALL), 55},
    {sipName_PG_ITERATOR_MASK_OP_ITEM, static_cast<int>(::wxPG_ITERATOR_MASK_OP_ITEM), 55},
    {sipName_PG_ITERATOR_MASK_OP_PARENT, static_cast<int>(::wxPG_ITERATOR_MASK_OP_PARENT), 55},
    {sipName_PG_KEEP_STRUCTURE, static_cast<int>(::wxPG_KEEP_STRUCTURE), 54},
    {sipName_PG_LIMITED_EDITING, static_cast<int>(::wxPG_LIMITED_EDITING), 60},
    {sipName_PG_NO_INTERNAL_BORDER, static_cast<int>(::wxPG_NO_INTERNAL_BORDER), 60},
    {sipName_PG_PROGRAMMATIC_VALUE, static_cast<int>(::wxPG_PROGRAMMATIC_VALUE), 57},
    {sipName_PG_PROPERTY_SPECIFIC, static_cast<int>(::wxPG_PROPERTY_SPECIFIC), 57},
    {sipName_PG_PROPERTY_VALIDATION_ERROR_MESSAGE, static_cast<int>(::wxPG_PROPERTY_VALIDATION_ERROR_MESSAGE), 40},
    {sipName_PG_PROPERTY_VALIDATION_SATURATE, static_cast<int>(::wxPG_PROPERTY_VALIDATION_SATURATE), 40},
    {sipName_PG_PROPERTY_VALIDATION_WRAP, static_cast<int>(::wxPG_PROPERTY_VALIDATION_WRAP), 40},
    {sipName_PG_PROP_AGGREGATE, static_cast<int>(::wxPG_PROP_AGGREGATE), 44},
    {sipName_PG_PROP_AUTO_UNSPECIFIED, static_cast<int>(::wxPG_PROP_AUTO_UNSPECIFIED), 44},
    {sipName_PG_PROP_BEING_DELETED, static_cast<int>(::wxPG_PROP_BEING_DELETED), 44},
    {sipName_PG_PROP_CATEGORY, static_cast<int>(::wxPG_PROP_CATEGORY), 44},
    {sipName_PG_PROP_CHILDREN_ARE_COPIES, static_cast<int>(::wxPG_PROP_CHILDREN_ARE_COPIES), 44},
    {sipName_PG_PROP_CLASS_SPECIFIC_1, static_cast<int>(::wxPG_PROP_CLASS_SPECIFIC_1), 44},
    {sipName_PG_PROP_CLASS_SPECIFIC_2, static_cast<int>(::wxPG_PROP_CLASS_SPECIFIC_2), 44},
    {sipName_PG_PROP_COLLAPSED, static_cast<int>(::wxPG_PROP_COLLAPSED), 44},
    {sipName_PG_PROP_COMPOSED_VALUE, static_cast<int>(::wxPG_PROP_COMPOSED_VALUE), 44},
    {sipName_PG_PROP_CUSTOMIMAGE, static_cast<int>(::wxPG_PROP_CUSTOMIMAGE), 44},
    {sipName_PG_PROP_DISABLED, static_cast<int>(::wxPG_PROP_DISABLED), 44},
    {sipName_PG_PROP_HIDDEN, static_cast<int>(::wxPG_PROP_HIDDEN), 44},
    {sipName_PG_PROP_INVALID_VALUE, static_cast<int>(::wxPG_PROP_INVALID_VALUE), 44},
    {sipName_PG_PROP_MISC_PARENT, static_cast<int>(::wxPG_PROP_MISC_PARENT), 44},
    {sipName_PG_PROP_MODIFIED, static_cast<int>(::wxPG_PROP_MODIFIED), 44},
    {sipName_PG_PROP_NOEDITOR, static_cast<int>(::wxPG_PROP_NOEDITOR), 44},
    {sipName_PG_PROP_PROPERTY, static_cast<int>(::wxPG_PROP_PROPERTY), 44},
    {sipName_PG_PROP_READONLY, static_cast<int>(::wxPG_PROP_READONLY), 44},
    {sipName_PG_PROP_USES_COMMON_VALUE, static_cast<int>(::wxPG_PROP_USES_COMMON_VALUE), 44},
    {sipName_PG_PROP_WAS_MODIFIED, static_cast<int>(::wxPG_PROP_WAS_MODIFIED), 44},
    {sipName_PG_RECURSE, static_cast<int>(::wxPG_RECURSE), 54},
    {sipName_PG_RECURSE_STARTS, static_cast<int>(::wxPG_RECURSE_STARTS), 54},
    {sipName_PG_REPORT_ERROR, static_cast<int>(::wxPG_REPORT_ERROR), 57},
    {sipName_PG_SETVAL_AGGREGATED, static_cast<int>(::wxPG_SETVAL_AGGREGATED), 58},
    {sipName_PG_SETVAL_BY_USER, static_cast<int>(::wxPG_SETVAL_BY_USER), 58},
    {sipName_PG_SETVAL_FROM_PARENT, static_cast<int>(::wxPG_SETVAL_FROM_PARENT), 58},
    {sipName_PG_SETVAL_REFRESH_EDITOR, static_cast<int>(::wxPG_SETVAL_REFRESH_EDITOR), 58},
    {sipName_PG_SORT_TOP_LEVEL_ONLY, static_cast<int>(::wxPG_SORT_TOP_LEVEL_ONLY), 54},
    {sipName_PG_SPLITTER_AUTO_CENTER, static_cast<int>(::wxPG_SPLITTER_AUTO_CENTER), 60},
    {sipName_PG_STATIC_LAYOUT, static_cast<int>(::wxPG_STATIC_LAYOUT), 60},
    {sipName_PG_STATIC_SPLITTER, static_cast<int>(::wxPG_STATIC_SPLITTER), 60},
    {sipName_PG_TOOLBAR, static_cast<int>(::wxPG_TOOLBAR), 60},
    {sipName_PG_TOOLTIPS, static_cast<int>(::wxPG_TOOLTIPS), 60},
    {sipName_PG_UNEDITABLE_COMPOSITE_FRAGMENT, static_cast<int>(::wxPG_UNEDITABLE_COMPOSITE_FRAGMENT), 57},
    {sipName_PG_VALUE_IS_CURRENT, static_cast<int>(::wxPG_VALUE_IS_CURRENT), 57},
    {sipName_PG_VFB_BEEP, static_cast<int>(::wxPG_VFB_BEEP), 59},
    {sipName_PG_VFB_DEFAULT, static_cast<int>(::wxPG_VFB_DEFAULT), 59},
    {sipName_PG_VFB_MARK_CELL, static_cast<int>(::wxPG_VFB_MARK_CELL), 59},
    {sipName_PG_VFB_SHOW_MESSAGE, static_cast<int>(::wxPG_VFB_SHOW_MESSAGE), 59},
    {sipName_PG_VFB_SHOW_MESSAGEBOX, static_cast<int>(::wxPG_VFB_SHOW_MESSAGEBOX), 59},
    {sipName_PG_VFB_SHOW_MESSAGE_ON_STATUSBAR, static_cast<int>(::wxPG_VFB_SHOW_MESSAGE_ON_STATUSBAR), 59},
    {sipName_PG_VFB_STAY_IN_PROPERTY, static_cast<int>(::wxPG_VFB_STAY_IN_PROPERTY), 59},
};
...
sipTypeDef *sipExportedTypes__propgrid[] = {
    ...
    &sipTypeDef__propgrid_wxPGFileDialogAdapter.ctd_base,
    &sipTypeDef__propgrid_wxPGInDialogValidator.ctd_base,
    &sipTypeDef__propgrid_wxPGLongStringDialogAdapter.ctd_base,
...
static sipImportedModuleDef importsTable[] = {
    {"wx._core", sipImportedTypes__propgrid__core, NULL, NULL},
    {NULL, NULL, NULL, NULL}
};
...
static sipIntInstanceDef intInstances[] = {
    ...
    {sipName_PG_CAPRECTXMARGIN, wxPG_CAPRECTXMARGIN},
    {sipName_PG_CAPRECTYMARGIN, wxPG_CAPRECTYMARGIN},
    ...
    {sipName_PG_CUSTOM_IMAGE_SPACINGY, wxPG_CUSTOM_IMAGE_SPACINGY},
    {sipName_PG_DEFAULT_STYLE, wxPG_DEFAULT_STYLE},
    {sipName_PG_DONT_RECURSE, wxPG_DONT_RECURSE},
    ...
    {sipName_PG_PROP_NO_ESCAPE, wxPG_PROP_NO_ESCAPE},
    ...
    {sipName_PG_SUBID1, wxPG_SUBID1},
    {sipName_PG_SUBID2, wxPG_SUBID2},
    {sipName_PG_SUBID_TEMP1, wxPG_SUBID_TEMP1},
    {0, 0}
};
...
#endif
{
    static PyMethodDef sip_methods[] = {
        ...
        {SIP_MLNAME_CAST(sipName_testPGVariantTypeName), (PyCFunction)func_testPGVariantTypeName, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_testPGVariantTypeName)},
        {SIP_MLNAME_CAST(sipName_testPGVariantTypemap), (PyCFunction)func_testPGVariantTypemap, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_testPGVariantTypemap)},
        {0, 0, 0, 0}
    };
