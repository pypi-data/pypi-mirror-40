...
public:
     ...
     */
protected:
    void DrawCaptionSelectionRect( ::wxDC&,int,int,int,int) const;
     ::wxSize GetImageSize(const  ::wxPGProperty*,int,int) const;
    bool Render( ::wxDC&,const  ::wxRect&,const  ::wxPropertyGrid*, ::wxPGProperty*,int,int,int) const;
...
sipwxPGCellRenderer::sipwxPGCellRenderer():  ::wxPGCellRenderer(), sipPySelf(0)
{
...
void sipwxPGCellRenderer::DrawCaptionSelectionRect( ::wxDC& dc,int x,int y,int w,int h) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[0]),sipPySelf,NULL,sipName_DrawCaptionSelectionRect);
 ...
 ::wxSize sipwxPGCellRenderer::GetImageSize(const  ::wxPGProperty*property,int column,int item) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[1]),sipPySelf,NULL,sipName_GetImageSize);
...
static PyObject *meth_wxPGCellRenderer_Render(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9J1J8J8iii", &sipSelf, sipType_wxPGCellRenderer, &sipCpp, sipType_wxDC, &dc, sipType_wxRect, &rect, &rectState, sipType_wxPropertyGrid, &propertyGrid, sipType_wxPGProperty, &property, &column, &item, &flags))
        {
            bool sipRes;
    ...
    sipNoMethod(sipParseErr, sipName_PGCellRenderer, sipName_Render, NULL);
...
static PyObject *meth_wxPGCellRenderer_GetImageSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8ii", &sipSelf, sipType_wxPGCellRenderer, &sipCpp, sipType_wxPGProperty, &property, &column, &item))
        {
             ::wxSize*sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PGCellRenderer, sipName_GetImageSize, NULL);
...
static PyObject *meth_wxPGCellRenderer_DrawCaptionSelectionRect(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9iiii", &sipSelf, sipType_wxPGCellRenderer, &sipCpp, sipType_wxDC, &dc, &x, &y, &w, &h))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PGCellRenderer, sipName_DrawCaptionSelectionRect, NULL);
...
static PyObject *meth_wxPGCellRenderer_DrawText(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9J1iJ1", &sipSelf, sipType_wxPGCellRenderer, &sipCpp, sipType_wxDC, &dc, sipType_wxRect, &rect, &rectState, &imageWidth, sipType_wxString,&text, &textState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PGCellRenderer, sipName_DrawText, NULL);
...
static PyObject *meth_wxPGCellRenderer_DrawEditorValue(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9J1iJ1J8J8", &sipSelf, sipType_wxPGCellRenderer, &sipCpp, sipType_wxDC, &dc, sipType_wxRect, &rect, &rectState, &xOffset, sipType_wxString,&text, &textState, sipType_wxPGProperty, &property, sipType_wxPGEditor, &editor))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PGCellRenderer, sipName_DrawEditorValue, NULL);
...
static PyObject *meth_wxPGCellRenderer_PreDrawCell(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9J1J9i", &sipSelf, sipType_wxPGCellRenderer, &sipCpp, sipType_wxDC, &dc, sipType_wxRect, &rect, &rectState, sipType_wxPGCell, &cell, &flags))
        {
            int sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PGCellRenderer, sipName_PreDrawCell, NULL);
...
static PyObject *meth_wxPGCellRenderer_PostDrawCell(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9J8J9i", &sipSelf, sipType_wxPGCellRenderer, &sipCpp, sipType_wxDC, &dc, sipType_wxPropertyGrid, &propGrid, sipType_wxPGCell, &cell, &flags))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PGCellRenderer, sipName_PostDrawCell, NULL);
...
static void dealloc_wxPGCellRenderer(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxPGCellRenderer *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static PyMethodDef methods_wxPGCellRenderer[] = {
    {SIP_MLNAME_CAST(sipName_DrawCaptionSelectionRect), (PyCFunction)meth_wxPGCellRenderer_DrawCaptionSelectionRect, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPGCellRenderer_DrawCaptionSelectionRect)},
    {SIP_MLNAME_CAST(sipName_DrawEditorValue), (PyCFunction)meth_wxPGCellRenderer_DrawEditorValue, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPGCellRenderer_DrawEditorValue)},
    {SIP_MLNAME_CAST(sipName_DrawText), (PyCFunction)meth_wxPGCellRenderer_DrawText, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPGCellRenderer_DrawText)},
    {SIP_MLNAME_CAST(sipName_GetImageSize), (PyCFunction)meth_wxPGCellRenderer_GetImageSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPGCellRenderer_GetImageSize)},
    {SIP_MLNAME_CAST(sipName_PostDrawCell), (PyCFunction)meth_wxPGCellRenderer_PostDrawCell, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPGCellRenderer_PostDrawCell)},
    {SIP_MLNAME_CAST(sipName_PreDrawCell), (PyCFunction)meth_wxPGCellRenderer_PreDrawCell, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPGCellRenderer_PreDrawCell)},
    {SIP_MLNAME_CAST(sipName_Render), (PyCFunction)meth_wxPGCellRenderer_Render, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPGCellRenderer_Render)}
};
