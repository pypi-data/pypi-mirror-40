...
static PyObject *meth_wxStreamBase_GetLastError(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_StreamBase, sipName_GetLastError, NULL);
...
static PyObject *meth_wxStreamBase_GetLength(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_StreamBase, sipName_GetLength, NULL);
...
static PyObject *meth_wxStreamBase_GetSize(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_StreamBase, sipName_GetSize, NULL);
...
static PyObject *meth_wxStreamBase_IsOk(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_StreamBase, sipName_IsOk, NULL);
...
static PyObject *meth_wxStreamBase_IsSeekable(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_StreamBase, sipName_IsSeekable, NULL);
...
static PyObject *meth_wxStreamBase_Reset(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "B|E", &sipSelf, sipType_wxStreamBase, &sipCpp, sipType_wxStreamError, &error))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_StreamBase, sipName_Reset, NULL);
...
static PyMethodDef methods_wxStreamBase[] = {
    ...
    {SIP_MLNAME_CAST(sipName_Reset), (PyCFunction)meth_wxStreamBase_Reset, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxStreamBase_Reset)}
};

sipVariableDef variables_wxStreamBase[] = {
    {PropertyVariable, sipName_Size, &methods_wxStreamBase[2], NULL, NULL, NULL},
    {PropertyVariable, sipName_Length, &methods_wxStreamBase[1], NULL, NULL, NULL},
    {PropertyVariable, sipName_LastError, &methods_wxStreamBase[0], NULL, NULL, NULL},
};
