...
sipwxDateProperty::sipwxDateProperty(const  ::wxString& label,const  ::wxString& name,const  ::wxDateTime& value):  ::wxDateProperty(label,name,value), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxDateProperty::sipwxDateProperty(const  ::wxDateProperty& a0):  ::wxDateProperty(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
static PyObject *meth_wxDateProperty_OnSetValue(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_DateProperty, sipName_OnSetValue, NULL);
...
static PyObject *meth_wxDateProperty_ValueToString(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1|i", &sipSelf, sipType_wxDateProperty, &sipCpp, sipType_wxPGVariant,&value, &valueState, &argFlags))
        {
             ::wxString*sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DateProperty, sipName_ValueToString, NULL);
...
static PyObject *meth_wxDateProperty_StringToValue(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1|i", &sipSelf, sipType_wxDateProperty, &sipCpp, sipType_wxString,&text, &textState, &argFlags))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DateProperty, sipName_StringToValue, NULL);
...
static PyObject *meth_wxDateProperty_DoSetAttribute(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1J1", &sipSelf, sipType_wxDateProperty, &sipCpp, sipType_wxString,&name, &nameState, sipType_wxPGVariant,&value, &valueState))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DateProperty, sipName_DoSetAttribute, NULL);
...
static PyObject *meth_wxDateProperty_SetFormat(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxDateProperty, &sipCpp, sipType_wxString,&format, &formatState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DateProperty, sipName_SetFormat, NULL);
...
static PyObject *meth_wxDateProperty_GetFormat(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DateProperty, sipName_GetFormat, NULL);
...
static PyObject *meth_wxDateProperty_SetDateValue(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxDateProperty, &sipCpp, sipType_wxDateTime, &dt, &dtState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DateProperty, sipName_SetDateValue, NULL);
...
static PyObject *meth_wxDateProperty_GetDateValue(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DateProperty, sipName_GetDateValue, NULL);
...
static PyObject *meth_wxDateProperty_GetDatePickerStyle(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DateProperty, sipName_GetDatePickerStyle, NULL);
...
extern "C" {static void *array_wxDateProperty(SIP_SSIZE_T);}
static void *array_wxDateProperty(SIP_SSIZE_T sipNrElem)
{
...
static void dealloc_wxDateProperty(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxDateProperty *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static void *init_type_wxDateProperty(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxDateProperty, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxDateProperty[] = {{43, 255, 1}};


static PyMethodDef methods_wxDateProperty[] = {
    {SIP_MLNAME_CAST(sipName_DoSetAttribute), (PyCFunction)meth_wxDateProperty_DoSetAttribute, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDateProperty_DoSetAttribute)},
    ...
    {SIP_MLNAME_CAST(sipName_SetDateValue), (PyCFunction)meth_wxDateProperty_SetDateValue, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDateProperty_SetDateValue)},
    {SIP_MLNAME_CAST(sipName_SetFormat), (PyCFunction)meth_wxDateProperty_SetFormat, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDateProperty_SetFormat)},
    {SIP_MLNAME_CAST(sipName_StringToValue), (PyCFunction)meth_wxDateProperty_StringToValue, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDateProperty_StringToValue)},
    {SIP_MLNAME_CAST(sipName_ValueToString), (PyCFunction)meth_wxDateProperty_ValueToString, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDateProperty_ValueToString)}
};

sipVariableDef variables_wxDateProperty[] = {
    {PropertyVariable, sipName_Format, &methods_wxDateProperty[3], &methods_wxDateProperty[6], NULL, NULL},
    {PropertyVariable, sipName_DateValue, &methods_wxDateProperty[2], &methods_wxDateProperty[5], NULL, NULL},
    {PropertyVariable, sipName_DatePickerStyle, &methods_wxDateProperty[1], NULL, NULL, NULL},
};
