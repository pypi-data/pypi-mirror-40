...
public:
     ...
     */
protected:
    void SetStringValue(const  ::wxString&);
    void PaintComboControl( ::wxDC&,const  ::wxRect&);
    void OnPopup();
    void OnDismiss();
    void OnComboKeyEvent( ::wxKeyEvent&);
    void OnComboDoubleClick();
    bool LazyCreate();
    void Init();
     ::wxString GetStringValue() const;
     ::wxWindow* GetControl();
     ::wxSize GetAdjustedSize(int,int,int);
    bool FindItem(const  ::wxString&, ::wxString*);
    void DestroyPopup();
...
sipwxComboPopup::sipwxComboPopup():  ::wxComboPopup(), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxComboPopup::sipwxComboPopup(const  ::wxComboPopup& a0):  ::wxComboPopup(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
void sipwxComboPopup::SetStringValue(const  ::wxString& value)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[0],sipPySelf,NULL,sipName_SetStringValue);
    ...
    sipVH__core_51(sipGILState, 0, sipPySelf, sipMeth, value);
}
...
void sipwxComboPopup::PaintComboControl( ::wxDC& dc,const  ::wxRect& rect)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[1],sipPySelf,NULL,sipName_PaintComboControl);
    ...
    extern void sipVH__core_171(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&,const  ::wxRect&);

    sipVH__core_171(sipGILState, 0, sipPySelf, sipMeth, dc, rect);
}
...
void sipwxComboPopup::OnPopup()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[2],sipPySelf,NULL,sipName_OnPopup);
...
void sipwxComboPopup::OnDismiss()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[3],sipPySelf,NULL,sipName_OnDismiss);
...
void sipwxComboPopup::OnComboKeyEvent( ::wxKeyEvent& event)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[4],sipPySelf,NULL,sipName_OnComboKeyEvent);
    ...
    extern void sipVH__core_170(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxKeyEvent&);

    sipVH__core_170(sipGILState, 0, sipPySelf, sipMeth, event);
}
...
void sipwxComboPopup::OnComboDoubleClick()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[5],sipPySelf,NULL,sipName_OnComboDoubleClick);
...
bool sipwxComboPopup::LazyCreate()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[6],sipPySelf,NULL,sipName_LazyCreate);
...
void sipwxComboPopup::Init()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[7],sipPySelf,NULL,sipName_Init);
 ...
 ::wxSize sipwxComboPopup::GetAdjustedSize(int minWidth,int prefHeight,int maxHeight)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[10],sipPySelf,NULL,sipName_GetAdjustedSize);

    if (!sipMeth)
        return  ::wxComboPopup::GetAdjustedSize(minWidth,prefHeight,maxHeight);

    extern  ::wxSize sipVH__core_169(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int,int,int);

    return sipVH__core_169(sipGILState, 0, sipPySelf, sipMeth, minWidth, prefHeight, maxHeight);
}
...
bool sipwxComboPopup::FindItem(const  ::wxString& item, ::wxString*trueItem)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[11],sipPySelf,NULL,sipName_FindItem);

    if (!sipMeth)
        return  ::wxComboPopup::FindItem(item,trueItem);

    extern bool sipVH__core_168(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxString&, ::wxString*);

    return sipVH__core_168(sipGILState, 0, sipPySelf, sipMeth, item, trueItem);
}
...
void sipwxComboPopup::DestroyPopup()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[12],sipPySelf,NULL,sipName_DestroyPopup);
...
static PyObject *meth_wxComboPopup_Create(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8", &sipSelf, sipType_wxComboPopup, &sipCpp, sipType_wxWindow, &parent))
        {
            bool sipRes;
    ...
    sipNoMethod(sipParseErr, sipName_ComboPopup, sipName_Create, NULL);
...
static PyObject *meth_wxComboPopup_DestroyPopup(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_ComboPopup, sipName_DestroyPopup, NULL);
...
static PyObject *meth_wxComboPopup_Dismiss(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_ComboPopup, sipName_Dismiss, NULL);
...
static PyObject *meth_wxComboPopup_FindItem(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1|J0", &sipSelf, sipType_wxComboPopup, &sipCpp, sipType_wxString,&item, &itemState, sipType_wxString,&trueItem, &trueItemState))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_ComboPopup, sipName_FindItem, NULL);
...
static PyObject *meth_wxComboPopup_GetAdjustedSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Biii", &sipSelf, sipType_wxComboPopup, &sipCpp, &minWidth, &prefHeight, &maxHeight))
        {
             ::wxSize*sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_ComboPopup, sipName_GetAdjustedSize, NULL);
...
static PyObject *meth_wxComboPopup_GetComboCtrl(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxComboPopup, &sipCpp))
        {
            ...
            return sipConvertFromType(sipRes,sipType_wxComboCtrl,NULL);
        }
    }

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_ComboPopup, sipName_GetComboCtrl, NULL);
...
static PyObject *meth_wxComboPopup_GetControl(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_ComboPopup, sipName_GetControl, NULL);
...
static PyObject *meth_wxComboPopup_GetStringValue(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_ComboPopup, sipName_GetStringValue, NULL);
...
static PyObject *meth_wxComboPopup_Init(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_ComboPopup, sipName_Init, NULL);
...
static PyObject *meth_wxComboPopup_IsCreated(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_ComboPopup, sipName_IsCreated, NULL);
...
static PyObject *meth_wxComboPopup_LazyCreate(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_ComboPopup, sipName_LazyCreate, NULL);
...
static PyObject *meth_wxComboPopup_OnComboDoubleClick(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_ComboPopup, sipName_OnComboDoubleClick, NULL);
...
static PyObject *meth_wxComboPopup_OnComboKeyEvent(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxComboPopup, &sipCpp, sipType_wxKeyEvent, &event))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_ComboPopup, sipName_OnComboKeyEvent, NULL);
...
static PyObject *meth_wxComboPopup_OnDismiss(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_ComboPopup, sipName_OnDismiss, NULL);
...
static PyObject *meth_wxComboPopup_OnPopup(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_ComboPopup, sipName_OnPopup, NULL);
...
static PyObject *meth_wxComboPopup_PaintComboControl(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9J1", &sipSelf, sipType_wxComboPopup, &sipCpp, sipType_wxDC, &dc, sipType_wxRect, &rect, &rectState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_ComboPopup, sipName_PaintComboControl, NULL);
...
static PyObject *meth_wxComboPopup_SetStringValue(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxComboPopup, &sipCpp, sipType_wxString,&value, &valueState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_ComboPopup, sipName_SetStringValue, NULL);
...
static void dealloc_wxComboPopup(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxComboPopup *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static void *init_type_wxComboPopup(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxComboPopup, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxComboPopup[] = {
    {SIP_MLNAME_CAST(sipName_Create), (PyCFunction)meth_wxComboPopup_Create, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxComboPopup_Create)},
    ...
    {SIP_MLNAME_CAST(sipName_FindItem), (PyCFunction)meth_wxComboPopup_FindItem, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxComboPopup_FindItem)},
    {SIP_MLNAME_CAST(sipName_GetAdjustedSize), (PyCFunction)meth_wxComboPopup_GetAdjustedSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxComboPopup_GetAdjustedSize)},
    ...
    {SIP_MLNAME_CAST(sipName_OnComboKeyEvent), (PyCFunction)meth_wxComboPopup_OnComboKeyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxComboPopup_OnComboKeyEvent)},
    ...
    {SIP_MLNAME_CAST(sipName_PaintComboControl), (PyCFunction)meth_wxComboPopup_PaintComboControl, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxComboPopup_PaintComboControl)},
    {SIP_MLNAME_CAST(sipName_SetStringValue), (PyCFunction)meth_wxComboPopup_SetStringValue, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxComboPopup_SetStringValue)}
};

sipVariableDef variables_wxComboPopup[] = {
    {PropertyVariable, sipName_StringValue, &methods_wxComboPopup[7], &methods_wxComboPopup[16], NULL, NULL},
    {PropertyVariable, sipName_Control, &methods_wxComboPopup[6], NULL, NULL, NULL},
    {PropertyVariable, sipName_ComboCtrl, &methods_wxComboPopup[5], NULL, NULL, NULL},
};
