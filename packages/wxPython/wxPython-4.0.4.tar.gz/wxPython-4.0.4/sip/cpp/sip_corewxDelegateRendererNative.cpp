...
public:
     ...
     */
protected:
    void DrawCheckBox( ::wxWindow*, ::wxDC&,const  ::wxRect&,int);
    void DrawComboBoxDropButton( ::wxWindow*, ::wxDC&,const  ::wxRect&,int);
    void DrawDropArrow( ::wxWindow*, ::wxDC&,const  ::wxRect&,int);
    void DrawFocusRect( ::wxWindow*, ::wxDC&,const  ::wxRect&,int);
    int DrawHeaderButton( ::wxWindow*, ::wxDC&,const  ::wxRect&,int, ::wxHeaderSortIconType, ::wxHeaderButtonParams*);
    int DrawHeaderButtonContents( ::wxWindow*, ::wxDC&,const  ::wxRect&,int, ::wxHeaderSortIconType, ::wxHeaderButtonParams*);
    void DrawItemSelectionRect( ::wxWindow*, ::wxDC&,const  ::wxRect&,int);
    void DrawPushButton( ::wxWindow*, ::wxDC&,const  ::wxRect&,int);
    void DrawSplitterBorder( ::wxWindow*, ::wxDC&,const  ::wxRect&,int);
    void DrawSplitterSash( ::wxWindow*, ::wxDC&,const  ::wxSize&, ::wxCoord, ::wxOrientation,int);
    void DrawTreeItemButton( ::wxWindow*, ::wxDC&,const  ::wxRect&,int);
    void DrawChoice( ::wxWindow*, ::wxDC&,const  ::wxRect&,int);
    void DrawComboBox( ::wxWindow*, ::wxDC&,const  ::wxRect&,int);
    void DrawTextCtrl( ::wxWindow*, ::wxDC&,const  ::wxRect&,int);
    void DrawRadioBitmap( ::wxWindow*, ::wxDC&,const  ::wxRect&,int);
    void DrawTitleBarBitmap( ::wxWindow*, ::wxDC&,const  ::wxRect&, ::wxTitleBarButton,int);
     ::wxSize GetCheckBoxSize( ::wxWindow*);
    int GetHeaderButtonHeight( ::wxWindow*);
    int GetHeaderButtonMargin( ::wxWindow*);
     ::wxSplitterRenderParams GetSplitterParams(const  ::wxWindow*);
...
sipwxDelegateRendererNative::sipwxDelegateRendererNative():  ::wxDelegateRendererNative(), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxDelegateRendererNative::sipwxDelegateRendererNative( ::wxRendererNative& rendererNative):  ::wxDelegateRendererNative(rendererNative), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
void sipwxDelegateRendererNative::DrawCheckBox( ::wxWindow*win, ::wxDC& dc,const  ::wxRect& rect,int flags)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[0],sipPySelf,NULL,sipName_DrawCheckBox);
    ...
    extern void sipVH__core_27(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*, ::wxDC&,const  ::wxRect&,int);

    sipVH__core_27(sipGILState, 0, sipPySelf, sipMeth, win, dc, rect, flags);
}
...
void sipwxDelegateRendererNative::DrawComboBoxDropButton( ::wxWindow*win, ::wxDC& dc,const  ::wxRect& rect,int flags)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[1],sipPySelf,NULL,sipName_DrawComboBoxDropButton);
...
void sipwxDelegateRendererNative::DrawDropArrow( ::wxWindow*win, ::wxDC& dc,const  ::wxRect& rect,int flags)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[2],sipPySelf,NULL,sipName_DrawDropArrow);
...
void sipwxDelegateRendererNative::DrawFocusRect( ::wxWindow*win, ::wxDC& dc,const  ::wxRect& rect,int flags)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[3],sipPySelf,NULL,sipName_DrawFocusRect);
...
int sipwxDelegateRendererNative::DrawHeaderButton( ::wxWindow*win, ::wxDC& dc,const  ::wxRect& rect,int flags, ::wxHeaderSortIconType sortArrow, ::wxHeaderButtonParams*params)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[4],sipPySelf,NULL,sipName_DrawHeaderButton);

    if (!sipMeth)
        return  ::wxDelegateRendererNative::DrawHeaderButton(win,dc,rect,flags,sortArrow,params);

    extern int sipVH__core_28(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*, ::wxDC&,const  ::wxRect&,int, ::wxHeaderSortIconType, ::wxHeaderButtonParams*);

    return sipVH__core_28(sipGILState, 0, sipPySelf, sipMeth, win, dc, rect, flags, sortArrow, params);
}
...
int sipwxDelegateRendererNative::DrawHeaderButtonContents( ::wxWindow*win, ::wxDC& dc,const  ::wxRect& rect,int flags, ::wxHeaderSortIconType sortArrow, ::wxHeaderButtonParams*params)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[5],sipPySelf,NULL,sipName_DrawHeaderButtonContents);
...
void sipwxDelegateRendererNative::DrawItemSelectionRect( ::wxWindow*win, ::wxDC& dc,const  ::wxRect& rect,int flags)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[6],sipPySelf,NULL,sipName_DrawItemSelectionRect);
...
void sipwxDelegateRendererNative::DrawPushButton( ::wxWindow*win, ::wxDC& dc,const  ::wxRect& rect,int flags)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[7],sipPySelf,NULL,sipName_DrawPushButton);
...
void sipwxDelegateRendererNative::DrawSplitterBorder( ::wxWindow*win, ::wxDC& dc,const  ::wxRect& rect,int flags)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[8],sipPySelf,NULL,sipName_DrawSplitterBorder);
...
void sipwxDelegateRendererNative::DrawSplitterSash( ::wxWindow*win, ::wxDC& dc,const  ::wxSize& size, ::wxCoord position, ::wxOrientation orient,int flags)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[9],sipPySelf,NULL,sipName_DrawSplitterSash);
    ...
    extern void sipVH__core_29(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*, ::wxDC&,const  ::wxSize&, ::wxCoord, ::wxOrientation,int);

    sipVH__core_29(sipGILState, 0, sipPySelf, sipMeth, win, dc, size, position, orient, flags);
}
...
void sipwxDelegateRendererNative::DrawTreeItemButton( ::wxWindow*win, ::wxDC& dc,const  ::wxRect& rect,int flags)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[10],sipPySelf,NULL,sipName_DrawTreeItemButton);
...
void sipwxDelegateRendererNative::DrawChoice( ::wxWindow*win, ::wxDC& dc,const  ::wxRect& rect,int flags)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[11],sipPySelf,sipName_DelegateRendererNative,sipName_DrawChoice);
...
void sipwxDelegateRendererNative::DrawComboBox( ::wxWindow*win, ::wxDC& dc,const  ::wxRect& rect,int flags)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[12],sipPySelf,sipName_DelegateRendererNative,sipName_DrawComboBox);
...
void sipwxDelegateRendererNative::DrawTextCtrl( ::wxWindow*win, ::wxDC& dc,const  ::wxRect& rect,int flags)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[13],sipPySelf,sipName_DelegateRendererNative,sipName_DrawTextCtrl);
...
void sipwxDelegateRendererNative::DrawRadioBitmap( ::wxWindow*win, ::wxDC& dc,const  ::wxRect& rect,int flags)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[14],sipPySelf,sipName_DelegateRendererNative,sipName_DrawRadioBitmap);
...
void sipwxDelegateRendererNative::DrawTitleBarBitmap( ::wxWindow*win, ::wxDC& dc,const  ::wxRect& rect, ::wxTitleBarButton button,int flags)
{
    sip_gilstate_t sipGILState;
    PyObject *sipMeth;

    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[15],sipPySelf,sipName_DelegateRendererNative,sipName_DrawTitleBarBitmap);

    if (!sipMeth)
        return;

    extern void sipVH__core_30(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*, ::wxDC&,const  ::wxRect&, ::wxTitleBarButton,int);

    sipVH__core_30(sipGILState, 0, sipPySelf, sipMeth, win, dc, rect, button, flags);
}

 ::wxSize sipwxDelegateRendererNative::GetCheckBoxSize( ::wxWindow*win)
{
    sip_gilstate_t sipGILState;
    PyObject *sipMeth;

    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[16],sipPySelf,NULL,sipName_GetCheckBoxSize);

    if (!sipMeth)
        return  ::wxDelegateRendererNative::GetCheckBoxSize(win);

    extern  ::wxSize sipVH__core_31(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*);

    return sipVH__core_31(sipGILState, 0, sipPySelf, sipMeth, win);
}
...
int sipwxDelegateRendererNative::GetHeaderButtonHeight( ::wxWindow*win)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[17],sipPySelf,NULL,sipName_GetHeaderButtonHeight);

    if (!sipMeth)
        return  ::wxDelegateRendererNative::GetHeaderButtonHeight(win);

    extern int sipVH__core_32(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*);

    return sipVH__core_32(sipGILState, 0, sipPySelf, sipMeth, win);
}
...
int sipwxDelegateRendererNative::GetHeaderButtonMargin( ::wxWindow*win)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[18],sipPySelf,NULL,sipName_GetHeaderButtonMargin);
 ...
 ::wxSplitterRenderParams sipwxDelegateRendererNative::GetSplitterParams(const  ::wxWindow*win)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[19],sipPySelf,NULL,sipName_GetSplitterParams);

    if (!sipMeth)
        return  ::wxDelegateRendererNative::GetSplitterParams(win);

    extern  ::wxSplitterRenderParams sipVH__core_33(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxWindow*);

    return sipVH__core_33(sipGILState, 0, sipPySelf, sipMeth, win);
}
 ...
 ::wxRendererVersion sipwxDelegateRendererNative::GetVersion() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[20]),sipPySelf,NULL,sipName_GetVersion);

    if (!sipMeth)
        return  ::wxDelegateRendererNative::GetVersion();

    extern  ::wxRendererVersion sipVH__core_34(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__core_34(sipGILState, 0, sipPySelf, sipMeth);
}
...
static PyObject *meth_wxDelegateRendererNative_DrawHeaderButton(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8J9J1|iEJ8", &sipSelf, sipType_wxDelegateRendererNative, &sipCpp, sipType_wxWindow, &win, sipType_wxDC, &dc, sipType_wxRect, &rect, &rectState, &flags, sipType_wxHeaderSortIconType, &sortArrow, sipType_wxHeaderButtonParams, &params))
        {
            int sipRes;
    ...
    sipNoMethod(sipParseErr, sipName_DelegateRendererNative, sipName_DrawHeaderButton, NULL);
...
static PyObject *meth_wxDelegateRendererNative_DrawHeaderButtonContents(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DelegateRendererNative, sipName_DrawHeaderButtonContents, NULL);
...
static PyObject *meth_wxDelegateRendererNative_GetHeaderButtonHeight(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8", &sipSelf, sipType_wxDelegateRendererNative, &sipCpp, sipType_wxWindow, &win))
        {
            int sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DelegateRendererNative, sipName_GetHeaderButtonHeight, NULL);
...
static PyObject *meth_wxDelegateRendererNative_GetHeaderButtonMargin(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DelegateRendererNative, sipName_GetHeaderButtonMargin, NULL);
...
static PyObject *meth_wxDelegateRendererNative_DrawTreeItemButton(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8J9J1|i", &sipSelf, sipType_wxDelegateRendererNative, &sipCpp, sipType_wxWindow, &win, sipType_wxDC, &dc, sipType_wxRect, &rect, &rectState, &flags))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DelegateRendererNative, sipName_DrawTreeItemButton, NULL);
...
static PyObject *meth_wxDelegateRendererNative_DrawSplitterBorder(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DelegateRendererNative, sipName_DrawSplitterBorder, NULL);
...
static PyObject *meth_wxDelegateRendererNative_DrawSplitterSash(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8J9J1iE|i", &sipSelf, sipType_wxDelegateRendererNative, &sipCpp, sipType_wxWindow, &win, sipType_wxDC, &dc, sipType_wxSize, &size, &sizeState, &position, sipType_wxOrientation, &orient, &flags))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DelegateRendererNative, sipName_DrawSplitterSash, NULL);
...
static PyObject *meth_wxDelegateRendererNative_DrawComboBoxDropButton(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DelegateRendererNative, sipName_DrawComboBoxDropButton, NULL);
...
static PyObject *meth_wxDelegateRendererNative_DrawDropArrow(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DelegateRendererNative, sipName_DrawDropArrow, NULL);
...
static PyObject *meth_wxDelegateRendererNative_DrawCheckBox(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DelegateRendererNative, sipName_DrawCheckBox, NULL);

    return NULL;
}


PyDoc_STRVAR(doc_wxDelegateRendererNative_GetCheckBoxSize, "GetCheckBoxSize(win) -> Size\n"
"\n"
...
static PyObject *meth_wxDelegateRendererNative_GetCheckBoxSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8", &sipSelf, sipType_wxDelegateRendererNative, &sipCpp, sipType_wxWindow, &win))
        {
            ...
            Py_BEGIN_ALLOW_THREADS
            sipRes = new  ::wxSize((sipSelfWasArg ? sipCpp-> ::wxDelegateRendererNative::GetCheckBoxSize(win) : sipCpp->GetCheckBoxSize(win)));
            Py_END_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DelegateRendererNative, sipName_GetCheckBoxSize, NULL);
...
static PyObject *meth_wxDelegateRendererNative_DrawPushButton(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DelegateRendererNative, sipName_DrawPushButton, NULL);
...
static PyObject *meth_wxDelegateRendererNative_DrawItemSelectionRect(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DelegateRendererNative, sipName_DrawItemSelectionRect, NULL);
...
static PyObject *meth_wxDelegateRendererNative_DrawFocusRect(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DelegateRendererNative, sipName_DrawFocusRect, NULL);
...
static PyObject *meth_wxDelegateRendererNative_GetSplitterParams(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DelegateRendererNative, sipName_GetSplitterParams, NULL);
...
static PyObject *meth_wxDelegateRendererNative_GetVersion(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DelegateRendererNative, sipName_GetVersion, NULL);
...
static void dealloc_wxDelegateRendererNative(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxDelegateRendererNative *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxDelegateRendererNative *sipCpp = 0;
...
static sipEncodedTypeDef supers_wxDelegateRendererNative[] = {{440, 255, 1}};


static PyMethodDef methods_wxDelegateRendererNative[] = {
    {SIP_MLNAME_CAST(sipName_DrawCheckBox), (PyCFunction)meth_wxDelegateRendererNative_DrawCheckBox, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDelegateRendererNative_DrawCheckBox)},
    {SIP_MLNAME_CAST(sipName_DrawComboBoxDropButton), (PyCFunction)meth_wxDelegateRendererNative_DrawComboBoxDropButton, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDelegateRendererNative_DrawComboBoxDropButton)},
    {SIP_MLNAME_CAST(sipName_DrawDropArrow), (PyCFunction)meth_wxDelegateRendererNative_DrawDropArrow, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDelegateRendererNative_DrawDropArrow)},
    {SIP_MLNAME_CAST(sipName_DrawFocusRect), (PyCFunction)meth_wxDelegateRendererNative_DrawFocusRect, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDelegateRendererNative_DrawFocusRect)},
    {SIP_MLNAME_CAST(sipName_DrawHeaderButton), (PyCFunction)meth_wxDelegateRendererNative_DrawHeaderButton, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDelegateRendererNative_DrawHeaderButton)},
    {SIP_MLNAME_CAST(sipName_DrawHeaderButtonContents), (PyCFunction)meth_wxDelegateRendererNative_DrawHeaderButtonContents, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDelegateRendererNative_DrawHeaderButtonContents)},
    {SIP_MLNAME_CAST(sipName_DrawItemSelectionRect), (PyCFunction)meth_wxDelegateRendererNative_DrawItemSelectionRect, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDelegateRendererNative_DrawItemSelectionRect)},
    {SIP_MLNAME_CAST(sipName_DrawPushButton), (PyCFunction)meth_wxDelegateRendererNative_DrawPushButton, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDelegateRendererNative_DrawPushButton)},
    {SIP_MLNAME_CAST(sipName_DrawSplitterBorder), (PyCFunction)meth_wxDelegateRendererNative_DrawSplitterBorder, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDelegateRendererNative_DrawSplitterBorder)},
    {SIP_MLNAME_CAST(sipName_DrawSplitterSash), (PyCFunction)meth_wxDelegateRendererNative_DrawSplitterSash, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDelegateRendererNative_DrawSplitterSash)},
    {SIP_MLNAME_CAST(sipName_DrawTreeItemButton), (PyCFunction)meth_wxDelegateRendererNative_DrawTreeItemButton, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDelegateRendererNative_DrawTreeItemButton)},
    {SIP_MLNAME_CAST(sipName_GetCheckBoxSize), (PyCFunction)meth_wxDelegateRendererNative_GetCheckBoxSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDelegateRendererNative_GetCheckBoxSize)},
    {SIP_MLNAME_CAST(sipName_GetHeaderButtonHeight), (PyCFunction)meth_wxDelegateRendererNative_GetHeaderButtonHeight, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDelegateRendererNative_GetHeaderButtonHeight)},
    {SIP_MLNAME_CAST(sipName_GetHeaderButtonMargin), (PyCFunction)meth_wxDelegateRendererNative_GetHeaderButtonMargin, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDelegateRendererNative_GetHeaderButtonMargin)},
    {SIP_MLNAME_CAST(sipName_GetSplitterParams), (PyCFunction)meth_wxDelegateRendererNative_GetSplitterParams, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDelegateRendererNative_GetSplitterParams)},
...
sipVariableDef variables_wxDelegateRendererNative[] = {
    {PropertyVariable, sipName_Version, &methods_wxDelegateRendererNative[15], NULL, NULL, NULL},
};
...
sipClassTypeDef sipTypeDef__core_wxDelegateRendererNative = {
    ...
    },
    {
        ...
        {0, 0, 1},
        16, methods_wxDelegateRendererNative,
        0, 0,
