...
static PyObject *meth_wxTreeItemId_IsOk(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_TreeItemId, sipName_IsOk, NULL);
...
static PyObject *meth_wxTreeItemId_GetID(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TreeItemId, sipName_GetID, NULL);
...
static PyObject *meth_wxTreeItemId_Unset(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TreeItemId, sipName_Unset, NULL);
...
extern "C" {static void *array_wxTreeItemId(SIP_SSIZE_T);}
static void *array_wxTreeItemId(SIP_SSIZE_T sipNrElem)
{
...
static void *init_type_wxTreeItemId(sipSimpleWrapper *, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxTreeItemId, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
sipVariableDef variables_wxTreeItemId[] = {
    {PropertyVariable, sipName_ID, &methods_wxTreeItemId[0], NULL, NULL, NULL},
};
