...
sipwxLogInterposer::sipwxLogInterposer():  ::wxLogInterposer(), sipPySelf(0)
{
...
static PyObject *meth_wxLogInterposer_DoLogRecord(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BmJ1J9", &sipSelf, sipType_wxLogInterposer, &sipCpp, &level, sipType_wxString,&msg, &msgState, sipType_wxLogRecordInfo, &info))
        {
            PyErr_Clear();
    ...
    sipNoMethod(sipParseErr, sipName_LogInterposer, sipName_DoLogRecord, NULL);
...
static PyObject *meth_wxLogInterposer_DoLogTextAtLevel(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BmJ1", &sipSelf, sipType_wxLogInterposer, &sipCpp, &level, sipType_wxString,&msg, &msgState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_LogInterposer, sipName_DoLogTextAtLevel, NULL);
...
static PyObject *meth_wxLogInterposer_DoLogText(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxLogInterposer, &sipCpp, sipType_wxString,&msg, &msgState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_LogInterposer, sipName_DoLogText, NULL);
...
static void dealloc_wxLogInterposer(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxLogInterposer *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static sipEncodedTypeDef supers_wxLogInterposer[] = {{300, 255, 1}};


static PyMethodDef methods_wxLogInterposer[] = {
    {SIP_MLNAME_CAST(sipName_DoLogRecord), (PyCFunction)meth_wxLogInterposer_DoLogRecord, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_DoLogText), (PyCFunction)meth_wxLogInterposer_DoLogText, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_DoLogTextAtLevel), (PyCFunction)meth_wxLogInterposer_DoLogTextAtLevel, METH_VARARGS|METH_KEYWORDS, NULL}
};
