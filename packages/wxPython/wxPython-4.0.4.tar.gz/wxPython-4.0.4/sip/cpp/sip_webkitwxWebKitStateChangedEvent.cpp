...
sipwxWebKitStateChangedEvent::sipwxWebKitStateChangedEvent( ::wxWindow*win):  ::wxWebKitStateChangedEvent(win), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxWebKitStateChangedEvent::sipwxWebKitStateChangedEvent(const  ::wxWebKitStateChangedEvent& a0):  ::wxWebKitStateChangedEvent(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
static PyObject *meth_wxWebKitStateChangedEvent_GetState(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_WebKitStateChangedEvent, sipName_GetState, NULL);
...
static PyObject *meth_wxWebKitStateChangedEvent_SetState(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bi", &sipSelf, sipType_wxWebKitStateChangedEvent, &sipCpp, &state))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_WebKitStateChangedEvent, sipName_SetState, NULL);
...
static PyObject *meth_wxWebKitStateChangedEvent_GetURL(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_WebKitStateChangedEvent, sipName_GetURL, NULL);
...
static PyObject *meth_wxWebKitStateChangedEvent_SetURL(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxWebKitStateChangedEvent, &sipCpp, sipType_wxString,&url, &urlState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_WebKitStateChangedEvent, sipName_SetURL, NULL);
...
static void dealloc_wxWebKitStateChangedEvent(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxWebKitStateChangedEvent *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxWebKitStateChangedEvent *sipCpp = 0;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxWebKitStateChangedEvent, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxWebKitStateChangedEvent[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SetState), (PyCFunction)meth_wxWebKitStateChangedEvent_SetState, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWebKitStateChangedEvent_SetState)},
    {SIP_MLNAME_CAST(sipName_SetURL), (PyCFunction)meth_wxWebKitStateChangedEvent_SetURL, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWebKitStateChangedEvent_SetURL)}
};

sipVariableDef variables_wxWebKitStateChangedEvent[] = {
    {PropertyVariable, sipName_URL, &methods_wxWebKitStateChangedEvent[2], &methods_wxWebKitStateChangedEvent[4], NULL, NULL},
    {PropertyVariable, sipName_State, &methods_wxWebKitStateChangedEvent[1], &methods_wxWebKitStateChangedEvent[3], NULL, NULL},
};
