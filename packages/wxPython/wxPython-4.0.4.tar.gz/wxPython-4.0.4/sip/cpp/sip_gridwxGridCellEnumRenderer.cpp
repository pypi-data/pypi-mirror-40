...
sipwxGridCellEnumRenderer::sipwxGridCellEnumRenderer(const  ::wxString& choices):  ::wxGridCellEnumRenderer(choices), sipPySelf(0)
{
...
static PyObject *meth_wxGridCellEnumRenderer_SetParameters(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxGridCellEnumRenderer, &sipCpp, sipType_wxString,&params, &paramsState))
        {
            PyErr_Clear();
    ...
    sipNoMethod(sipParseErr, sipName_GridCellEnumRenderer, sipName_SetParameters, NULL);
...
static PyObject *meth_wxGridCellEnumRenderer_Draw(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9J9J9J1iib", &sipSelf, sipType_wxGridCellEnumRenderer, &sipCpp, sipType_wxGrid, &grid, sipType_wxGridCellAttr, &attr, sipType_wxDC, &dc, sipType_wxRect, &rect, &rectState, &row, &col, &isSelected))
        {
            PyErr_Clear();
...
static PyObject *meth_wxGridCellEnumRenderer_GetBestSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9J9J9ii", &sipSelf, sipType_wxGridCellEnumRenderer, &sipCpp, sipType_wxGrid, &grid, sipType_wxGridCellAttr, &attr, sipType_wxDC, &dc, &row, &col))
        {
             ::wxSize*sipRes;
...
static void dealloc_wxGridCellEnumRenderer(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxGridCellEnumRenderer *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxGridCellEnumRenderer *sipCpp = 0;
...
static sipEncodedTypeDef supers_wxGridCellEnumRenderer[] = {{24, 255, 1}};
...
static PyMethodDef methods_wxGridCellEnumRenderer[] = {
    ...
    {SIP_MLNAME_CAST(sipName_Draw), (PyCFunction)meth_wxGridCellEnumRenderer_Draw, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridCellEnumRenderer_Draw)},
    {SIP_MLNAME_CAST(sipName_GetBestSize), (PyCFunction)meth_wxGridCellEnumRenderer_GetBestSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridCellEnumRenderer_GetBestSize)},
    {SIP_MLNAME_CAST(sipName_SetParameters), (PyCFunction)meth_wxGridCellEnumRenderer_SetParameters, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridCellEnumRenderer_SetParameters)}
};
