...
sipwxClientDC::sipwxClientDC( ::wxWindow*window):  ::wxClientDC(window), sipPySelf(0)
{
}
...
static void dealloc_wxClientDC(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxClientDC *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static sipEncodedTypeDef supers_wxClientDC[] = {{574, 255, 1}};
