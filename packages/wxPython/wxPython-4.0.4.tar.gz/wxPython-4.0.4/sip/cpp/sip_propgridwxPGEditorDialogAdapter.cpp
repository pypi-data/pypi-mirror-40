...
sipwxPGEditorDialogAdapter::sipwxPGEditorDialogAdapter():  ::wxPGEditorDialogAdapter(), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxPGEditorDialogAdapter::sipwxPGEditorDialogAdapter(const  ::wxPGEditorDialogAdapter& a0):  ::wxPGEditorDialogAdapter(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
static PyObject *meth_wxPGEditorDialogAdapter_ShowDialog(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8J8", &sipSelf, sipType_wxPGEditorDialogAdapter, &sipCpp, sipType_wxPropertyGrid, &propGrid, sipType_wxPGProperty, &property))
        {
            bool sipRes;
    ...
    sipNoMethod(sipParseErr, sipName_PGEditorDialogAdapter, sipName_ShowDialog, NULL);
...
static PyObject *meth_wxPGEditorDialogAdapter_DoShowDialog(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PGEditorDialogAdapter, sipName_DoShowDialog, NULL);
...
static PyObject *meth_wxPGEditorDialogAdapter_SetValue(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxPGEditorDialogAdapter, &sipCpp, sipType_wxPGVariant,&value, &valueState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PGEditorDialogAdapter, sipName_SetValue, NULL);
...
static PyObject *meth_wxPGEditorDialogAdapter_GetValue(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PGEditorDialogAdapter, sipName_GetValue, NULL);
...
static void dealloc_wxPGEditorDialogAdapter(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxPGEditorDialogAdapter *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxPGEditorDialogAdapter *sipCpp = 0;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxPGEditorDialogAdapter, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxPGEditorDialogAdapter[] = {
    {SIP_MLNAME_CAST(sipName_DoShowDialog), (PyCFunction)meth_wxPGEditorDialogAdapter_DoShowDialog, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPGEditorDialogAdapter_DoShowDialog)},
    ...
    {SIP_MLNAME_CAST(sipName_SetValue), (PyCFunction)meth_wxPGEditorDialogAdapter_SetValue, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPGEditorDialogAdapter_SetValue)},
    {SIP_MLNAME_CAST(sipName_ShowDialog), (PyCFunction)meth_wxPGEditorDialogAdapter_ShowDialog, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPGEditorDialogAdapter_ShowDialog)}
};
...
sipVariableDef variables_wxPGEditorDialogAdapter[] = {
    {PropertyVariable, sipName_Value, &methods_wxPGEditorDialogAdapter[1], &methods_wxPGEditorDialogAdapter[2], NULL, NULL},
    {InstanceVariable, sipName_m_clientData, (PyMethodDef *)varget_wxPGEditorDialogAdapter_m_clientData, (PyMethodDef *)varset_wxPGEditorDialogAdapter_m_clientData, NULL, NULL},
};
