...
sipwxCursor::sipwxCursor():  ::wxCursor(), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxCursor::sipwxCursor(const  ::wxString& cursorName, ::wxBitmapType type,int hotSpotX,int hotSpotY):  ::wxCursor(cursorName,type,hotSpotX,hotSpotY), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxCursor::sipwxCursor( ::wxStockCursor cursorId):  ::wxCursor(cursorId), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxCursor::sipwxCursor(const  ::wxImage& image):  ::wxCursor(image), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxCursor::sipwxCursor(const  ::wxCursor& cursor):  ::wxCursor(cursor), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
bool sipwxCursor::IsOk() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[0]),sipPySelf,NULL,sipName_IsOk);
...
static PyObject *meth_wxCursor_IsOk(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_Cursor, sipName_IsOk, NULL);
...
static PyObject *meth_wxCursor_GetHandle(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Cursor, sipName_GetHandle, NULL);
...
static PyObject *meth_wxCursor_SetHandle(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bl", &sipSelf, sipType_wxCursor, &sipCpp, &handle))
        {
            int sipIsErr = 0;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Cursor, sipName_SetHandle, NULL);
...
static PyObject *meth_wxCursor__copyFrom(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8", &sipSelf, sipType_wxCursor, &sipCpp, sipType_wxCursor, &other))
        {
            int sipIsErr = 0;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Cursor, sipName__copyFrom, NULL);
...
extern "C" {static void *array_wxCursor(SIP_SSIZE_T);}
static void *array_wxCursor(SIP_SSIZE_T sipNrElem)
{
...
static void dealloc_wxCursor(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxCursor *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static sipEncodedTypeDef supers_wxCursor[] = {{205, 255, 1}};
...
static PyMethodDef methods_wxCursor[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SetHandle), (PyCFunction)meth_wxCursor_SetHandle, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxCursor_SetHandle)},
    {SIP_MLNAME_CAST(sipName__copyFrom), (PyCFunction)meth_wxCursor__copyFrom, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxCursor__copyFrom)}
};

sipVariableDef variables_wxCursor[] = {
    {PropertyVariable, sipName_Handle, &methods_wxCursor[0], &methods_wxCursor[2], NULL, NULL},
};
