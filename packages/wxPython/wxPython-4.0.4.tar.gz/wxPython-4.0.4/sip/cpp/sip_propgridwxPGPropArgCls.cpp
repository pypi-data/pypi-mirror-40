...
static PyObject *meth_wxPGPropArgCls_GetPtr(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, NULL, NULL, "B", &sipSelf, sipType_wxPGPropArgCls, &sipCpp))
        {
             ::wxPGProperty*sipRes;
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8", &sipSelf, sipType_wxPGPropArgCls, &sipCpp, sipType_wxPropertyGridInterface, &iface))
        {
             ::wxPGProperty*sipRes;
    ...
    sipNoMethod(sipParseErr, sipName_PGPropArgCls, sipName_GetPtr, NULL);
...
static PyObject *meth_wxPGPropArgCls_GetPtr0(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PGPropArgCls, sipName_GetPtr0, NULL);
...
static PyObject *meth_wxPGPropArgCls_HasName(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PGPropArgCls, sipName_HasName, NULL);
...
static PyObject *meth_wxPGPropArgCls_GetName(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PGPropArgCls, sipName_GetName, NULL);
...
static PyMethodDef methods_wxPGPropArgCls[] = {
    ...
    {SIP_MLNAME_CAST(sipName_GetPtr), (PyCFunction)meth_wxPGPropArgCls_GetPtr, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPGPropArgCls_GetPtr)},
...
sipVariableDef variables_wxPGPropArgCls[] = {
    {PropertyVariable, sipName_Ptr0, &methods_wxPGPropArgCls[2], NULL, NULL, NULL},
    {PropertyVariable, sipName_Ptr, &methods_wxPGPropArgCls[1], NULL, NULL, NULL},
    {PropertyVariable, sipName_Name, &methods_wxPGPropArgCls[0], NULL, NULL, NULL},
};
