...
static PyObject *meth_wxMenuItemList_index(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8", &sipSelf, sipType_wxMenuItemList, &sipCpp, sipType_wxMenuItem, &obj))
        {
            int sipRes = 0;
...
static PyObject *slot_wxMenuItemList___iter__(PyObject *sipSelf)
{
...

    {
        ...
        sipRes =  new wxMenuItemList_iterator(sipCpp->GetFirst());
            ...
            return sipConvertFromNewType(sipRes,sipType_wxMenuItemList_iterator,NULL);
        }
    }
...
static int slot_wxMenuItemList___contains__(PyObject *sipSelf,PyObject *sipArg)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_MenuItemList, sipName___contains__, NULL);
...
static PyObject *slot_wxMenuItemList___getitem__(PyObject *sipSelf,PyObject *sipArg)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_MenuItemList, sipName___getitem__, NULL);
...
static void *init_type_wxMenuItemList(sipSimpleWrapper *, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxMenuItemList, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxMenuItemList[] = {
    {SIP_MLNAME_CAST(sipName_index), (PyCFunction)meth_wxMenuItemList_index, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxMenuItemList_index)}
};
