...
sipwxGridCellBoolRenderer::sipwxGridCellBoolRenderer():  ::wxGridCellBoolRenderer(), sipPySelf(0)
{
...
static PyObject *meth_wxGridCellBoolRenderer_Draw(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9J9J9J1iib", &sipSelf, sipType_wxGridCellBoolRenderer, &sipCpp, sipType_wxGrid, &grid, sipType_wxGridCellAttr, &attr, sipType_wxDC, &dc, sipType_wxRect, &rect, &rectState, &row, &col, &isSelected))
        {
            PyErr_Clear();
...
static PyObject *meth_wxGridCellBoolRenderer_GetBestSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9J9J9ii", &sipSelf, sipType_wxGridCellBoolRenderer, &sipCpp, sipType_wxGrid, &grid, sipType_wxGridCellAttr, &attr, sipType_wxDC, &dc, &row, &col))
        {
             ::wxSize*sipRes;
...
static void dealloc_wxGridCellBoolRenderer(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxGridCellBoolRenderer *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxGridCellBoolRenderer *sipCpp = 0;
...
static sipEncodedTypeDef supers_wxGridCellBoolRenderer[] = {{23, 255, 1}};
...
static PyMethodDef methods_wxGridCellBoolRenderer[] = {
    ...
    {SIP_MLNAME_CAST(sipName_Draw), (PyCFunction)meth_wxGridCellBoolRenderer_Draw, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridCellBoolRenderer_Draw)},
    {SIP_MLNAME_CAST(sipName_GetBestSize), (PyCFunction)meth_wxGridCellBoolRenderer_GetBestSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridCellBoolRenderer_GetBestSize)}
};
