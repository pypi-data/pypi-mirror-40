...
sipwxRichTextHTMLHandler::sipwxRichTextHTMLHandler(const  ::wxString& name,const  ::wxString& ext,int type):  ::wxRichTextHTMLHandler(name,ext,type), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxRichTextHTMLHandler::sipwxRichTextHTMLHandler(const  ::wxRichTextHTMLHandler& a0):  ::wxRichTextHTMLHandler(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
bool sipwxRichTextHTMLHandler::SaveFile( ::wxRichTextBuffer*buffer,const  ::wxString& filename)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[1],sipPySelf,NULL,sipName_SaveFile);
...
bool sipwxRichTextHTMLHandler::CanHandle(const  ::wxString& filename) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[2]),sipPySelf,NULL,sipName_CanHandle);
...
bool sipwxRichTextHTMLHandler::CanSave() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[3]),sipPySelf,NULL,sipName_CanSave);
...
bool sipwxRichTextHTMLHandler::IsVisible() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[5]),sipPySelf,NULL,sipName_IsVisible);
...
bool sipwxRichTextHTMLHandler::DoLoadFile( ::wxRichTextBuffer*buffer, ::wxInputStream& stream)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[7],sipPySelf,NULL,sipName_DoLoadFile);
...
bool sipwxRichTextHTMLHandler::DoSaveFile( ::wxRichTextBuffer*buffer, ::wxOutputStream& stream)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[8],sipPySelf,NULL,sipName_DoSaveFile);
...
static PyObject *meth_wxRichTextHTMLHandler_ClearTemporaryImageLocations(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_RichTextHTMLHandler, sipName_ClearTemporaryImageLocations, NULL);
...
static PyObject *meth_wxRichTextHTMLHandler_DeleteTemporaryImages(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, NULL, NULL, "B", &sipSelf, sipType_wxRichTextHTMLHandler, &sipCpp))
        {
            bool sipRes;
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "iJ1", &flags, sipType_wxArrayString,&imageLocations, &imageLocationsState))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextHTMLHandler, sipName_DeleteTemporaryImages, NULL);
...
static PyObject *meth_wxRichTextHTMLHandler_GetFontSizeMapping(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextHTMLHandler, sipName_GetFontSizeMapping, NULL);
...
static PyObject *meth_wxRichTextHTMLHandler_GetTempDir(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextHTMLHandler, sipName_GetTempDir, NULL);
...
static PyObject *meth_wxRichTextHTMLHandler_GetTemporaryImageLocations(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextHTMLHandler, sipName_GetTemporaryImageLocations, NULL);
...
static PyObject *meth_wxRichTextHTMLHandler_SetFontSizeMapping(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxRichTextHTMLHandler, &sipCpp, sipType_wxArrayInt,&fontSizeMapping, &fontSizeMappingState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextHTMLHandler, sipName_SetFontSizeMapping, NULL);
...
static PyObject *meth_wxRichTextHTMLHandler_SetTempDir(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxRichTextHTMLHandler, &sipCpp, sipType_wxString,&tempDir, &tempDirState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextHTMLHandler, sipName_SetTempDir, NULL);
...
static PyObject *meth_wxRichTextHTMLHandler_SetTemporaryImageLocations(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxRichTextHTMLHandler, &sipCpp, sipType_wxArrayString,&locations, &locationsState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextHTMLHandler, sipName_SetTemporaryImageLocations, NULL);
...
static PyObject *meth_wxRichTextHTMLHandler_SetFileCounter(PyObject *, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "i", &counter))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextHTMLHandler, sipName_SetFileCounter, NULL);
...
static PyObject *meth_wxRichTextHTMLHandler_DoLoadFile(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8J1", &sipSelf, sipType_wxRichTextHTMLHandler, &sipCpp, sipType_wxRichTextBuffer, &buffer, sipType_wxInputStream, &stream, &streamState))
        {
            bool sipRes;
...
static PyObject *meth_wxRichTextHTMLHandler_DoSaveFile(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8J1", &sipSelf, sipType_wxRichTextHTMLHandler, &sipCpp, sipType_wxRichTextBuffer, &buffer, sipType_wxOutputStream, &stream, &streamState))
        {
            bool sipRes;
...
extern "C" {static void *array_wxRichTextHTMLHandler(SIP_SSIZE_T);}
static void *array_wxRichTextHTMLHandler(SIP_SSIZE_T sipNrElem)
{
...
static void dealloc_wxRichTextHTMLHandler(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxRichTextHTMLHandler *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxRichTextHTMLHandler *sipCpp = 0;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxRichTextHTMLHandler, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxRichTextHTMLHandler[] = {
    ...
    {SIP_MLNAME_CAST(sipName_DeleteTemporaryImages), (PyCFunction)meth_wxRichTextHTMLHandler_DeleteTemporaryImages, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextHTMLHandler_DeleteTemporaryImages)},
    {SIP_MLNAME_CAST(sipName_DoLoadFile), (PyCFunction)meth_wxRichTextHTMLHandler_DoLoadFile, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextHTMLHandler_DoLoadFile)},
    {SIP_MLNAME_CAST(sipName_DoSaveFile), (PyCFunction)meth_wxRichTextHTMLHandler_DoSaveFile, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextHTMLHandler_DoSaveFile)},
    ...
    {SIP_MLNAME_CAST(sipName_SetFileCounter), (PyCFunction)meth_wxRichTextHTMLHandler_SetFileCounter, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextHTMLHandler_SetFileCounter)},
    {SIP_MLNAME_CAST(sipName_SetFontSizeMapping), (PyCFunction)meth_wxRichTextHTMLHandler_SetFontSizeMapping, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextHTMLHandler_SetFontSizeMapping)},
    {SIP_MLNAME_CAST(sipName_SetTempDir), (PyCFunction)meth_wxRichTextHTMLHandler_SetTempDir, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextHTMLHandler_SetTempDir)},
    {SIP_MLNAME_CAST(sipName_SetTemporaryImageLocations), (PyCFunction)meth_wxRichTextHTMLHandler_SetTemporaryImageLocations, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextHTMLHandler_SetTemporaryImageLocations)}
};

sipVariableDef variables_wxRichTextHTMLHandler[] = {
    {PropertyVariable, sipName_TemporaryImageLocations, &methods_wxRichTextHTMLHandler[6], &methods_wxRichTextHTMLHandler[10], NULL, NULL},
    {PropertyVariable, sipName_TempDir, &methods_wxRichTextHTMLHandler[5], &methods_wxRichTextHTMLHandler[9], NULL, NULL},
    {PropertyVariable, sipName_FontSizeMapping, &methods_wxRichTextHTMLHandler[4], &methods_wxRichTextHTMLHandler[8], NULL, NULL},
};
