...
sipwxEventFilter::sipwxEventFilter():  ::wxEventFilter(), sipPySelf(0)
{
...
static PyObject *meth_wxEventFilter_FilterEvent(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxEventFilter, &sipCpp, sipType_wxEvent, &event))
        {
            int sipRes;
    ...
    sipNoMethod(sipParseErr, sipName_EventFilter, sipName_FilterEvent, NULL);
...
static void dealloc_wxEventFilter(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxEventFilter *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static PyMethodDef methods_wxEventFilter[] = {
    {SIP_MLNAME_CAST(sipName_FilterEvent), (PyCFunction)meth_wxEventFilter_FilterEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxEventFilter_FilterEvent)}
};
