...
sipwxPNGHandler::sipwxPNGHandler():  ::wxPNGHandler(), sipPySelf(0)
{
...
int sipwxPNGHandler::GetImageCount( ::wxInputStream& stream)
{
    ...
    if (!sipMeth)
        return  ::wxPNGHandler::GetImageCount(stream);
...
static PyObject *meth_wxPNGHandler_DoGetImageCount(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxPNGHandler, &sipCpp, sipType_wxInputStream, &stream, &streamState))
        {
            int sipRes;
    ...
    sipNoMethod(sipParseErr, sipName_PNGHandler, sipName_DoGetImageCount, NULL);
...
static PyObject *meth_wxPNGHandler_LoadFile(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8J1|bi", &sipSelf, sipType_wxPNGHandler, &sipCpp, sipType_wxImage, &image, sipType_wxInputStream, &stream, &streamState, &verbose, &index))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PNGHandler, sipName_LoadFile, NULL);
...
static PyObject *meth_wxPNGHandler_SaveFile(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8J1|b", &sipSelf, sipType_wxPNGHandler, &sipCpp, sipType_wxImage, &image, sipType_wxOutputStream, &stream, &streamState, &verbose))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PNGHandler, sipName_SaveFile, NULL);
...
static PyObject *meth_wxPNGHandler_DoCanRead(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PNGHandler, sipName_DoCanRead, NULL);
...
static void dealloc_wxPNGHandler(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxPNGHandler *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static sipEncodedTypeDef supers_wxPNGHandler[] = {{256, 255, 1}};


static PyMethodDef methods_wxPNGHandler[] = {
    {SIP_MLNAME_CAST(sipName_DoCanRead), (PyCFunction)meth_wxPNGHandler_DoCanRead, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPNGHandler_DoCanRead)},
    {SIP_MLNAME_CAST(sipName_DoGetImageCount), (PyCFunction)meth_wxPNGHandler_DoGetImageCount, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_LoadFile), (PyCFunction)meth_wxPNGHandler_LoadFile, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPNGHandler_LoadFile)},
    {SIP_MLNAME_CAST(sipName_SaveFile), (PyCFunction)meth_wxPNGHandler_SaveFile, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPNGHandler_SaveFile)}
};
