...
sipwxRadioBox::sipwxRadioBox():  ::wxRadioBox(), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxRadioBox::sipwxRadioBox( ::wxWindow*parent, ::wxWindowID id,const  ::wxString& label,const  ::wxPoint& pos,const  ::wxSize& size,const  ::wxArrayString& choices,int majorDimension,long style,const  ::wxValidator& validator,const  ::wxString& name):  ::wxRadioBox(parent,id,label,pos,size,choices,majorDimension,style,validator,name), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
uint sipwxRadioBox::GetCount() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[0]),sipPySelf,NULL,sipName_GetCount);
...
void sipwxRadioBox::SetString(uint n,const  ::wxString& string)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[2],sipPySelf,NULL,sipName_SetString);
...
int sipwxRadioBox::FindString(const  ::wxString& string,bool bCase) const
{
    ...
    return sipVH__core_143(sipGILState, 0, sipPySelf, sipMeth, string, bCase);
}
...
void sipwxRadioBox::SetSelection(int n)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[4],sipPySelf,NULL,sipName_SetSelection);
 ...
 ::wxString sipwxRadioBox::GetStringSelection() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[6]),sipPySelf,NULL,sipName_GetStringSelection);
...
extern "C" {static PyObject *meth_wxRadioBox_SendDestroyEvent(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxRadioBox_SendDestroyEvent(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, NULL, NULL, "B", &sipSelf, sipType_wxRadioBox, &sipCpp))
        {
            PyErr_Clear();
    ...
    sipNoMethod(sipParseErr, sipName_RadioBox, sipName_SendDestroyEvent, NULL);
...
static PyObject *meth_wxRadioBox_Create(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJH|iJ1J1J1J1ilJ9J1", &sipSelf, sipType_wxRadioBox, &sipCpp, sipType_wxWindow, &parent, &sipOwner, &id, sipType_wxString,&label, &labelState, sipType_wxPoint, &pos, &posState, sipType_wxSize, &size, &sizeState, sipType_wxArrayString,&choices, &choicesState, &majorDimension, &style, sipType_wxValidator, &validator, sipType_wxString,&name, &nameState))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RadioBox, sipName_Create, NULL);
...
static PyObject *meth_wxRadioBox_EnableItem(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bu|b", &sipSelf, sipType_wxRadioBox, &sipCpp, &n, &enable))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RadioBox, sipName_EnableItem, NULL);
...
static PyObject *meth_wxRadioBox_FindString(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1|b", &sipSelf, sipType_wxRadioBox, &sipCpp, sipType_wxString,&string, &stringState, &bCase))
        {
            int sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RadioBox, sipName_FindString, NULL);
...
static PyObject *meth_wxRadioBox_GetColumnCount(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RadioBox, sipName_GetColumnCount, NULL);
...
static PyObject *meth_wxRadioBox_GetItemFromPoint(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxRadioBox, &sipCpp, sipType_wxPoint, &pt, &ptState))
        {
            int sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RadioBox, sipName_GetItemFromPoint, NULL);
...
static PyObject *meth_wxRadioBox_GetItemHelpText(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bu", &sipSelf, sipType_wxRadioBox, &sipCpp, &item))
        {
             ::wxString*sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RadioBox, sipName_GetItemHelpText, NULL);
...
static PyObject *meth_wxRadioBox_GetItemToolTip(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bu", &sipSelf, sipType_wxRadioBox, &sipCpp, &item))
        {
            ...
            return sipConvertFromType(sipRes,sipType_wxToolTip,NULL);
        }
    }

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RadioBox, sipName_GetItemToolTip, NULL);
...
static PyObject *meth_wxRadioBox_GetRowCount(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RadioBox, sipName_GetRowCount, NULL);
...
static PyObject *meth_wxRadioBox_IsItemEnabled(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bu", &sipSelf, sipType_wxRadioBox, &sipCpp, &n))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RadioBox, sipName_IsItemEnabled, NULL);
...
static PyObject *meth_wxRadioBox_IsItemShown(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RadioBox, sipName_IsItemShown, NULL);
...
static PyObject *meth_wxRadioBox_SetItemHelpText(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BuJ1", &sipSelf, sipType_wxRadioBox, &sipCpp, &item, sipType_wxString,&helptext, &helptextState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RadioBox, sipName_SetItemHelpText, NULL);
...
static PyObject *meth_wxRadioBox_SetItemToolTip(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BuJ1", &sipSelf, sipType_wxRadioBox, &sipCpp, &item, sipType_wxString,&text, &textState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RadioBox, sipName_SetItemToolTip, NULL);
...
static PyObject *meth_wxRadioBox_SetSelection(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bi", &sipSelf, sipType_wxRadioBox, &sipCpp, &n))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RadioBox, sipName_SetSelection, NULL);
...
static PyObject *meth_wxRadioBox_ShowItem(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bu|b", &sipSelf, sipType_wxRadioBox, &sipCpp, &item, &show))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RadioBox, sipName_ShowItem, NULL);
...
static PyObject *meth_wxRadioBox_GetCount(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RadioBox, sipName_GetCount, NULL);
...
static PyObject *meth_wxRadioBox_GetString(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RadioBox, sipName_GetString, NULL);
...
static PyObject *meth_wxRadioBox_SetString(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BuJ1", &sipSelf, sipType_wxRadioBox, &sipCpp, &n, sipType_wxString,&string, &stringState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RadioBox, sipName_SetString, NULL);
...
static PyObject *meth_wxRadioBox_GetSelection(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RadioBox, sipName_GetSelection, NULL);
...
static PyObject *meth_wxRadioBox_AddChild(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8", &sipSelf, sipType_wxRadioBox, &sipCpp, sipType_wxWindowBase, &child))
        {
            PyErr_Clear();
...
static PyObject *meth_wxRadioBox_InformFirstDirection(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Biii", &sipSelf, sipType_wxRadioBox, &sipCpp, &direction, &size, &availableOtherDir))
        {
            bool sipRes;
...
static PyObject *meth_wxRadioBox_SetCanFocus(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bb", &sipSelf, sipType_wxRadioBox, &sipCpp, &canFocus))
        {
            PyErr_Clear();
...
static PyObject *meth_wxRadioBox_SetValidator(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxRadioBox, &sipCpp, sipType_wxValidator, &validator))
        {
            PyErr_Clear();
...
static PyObject *meth_wxRadioBox_ProcessEvent(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxRadioBox, &sipCpp, sipType_wxEvent, &event))
        {
            bool sipRes;
...
static PyObject *meth_wxRadioBox_DoEnable(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bb", &sipSelf, sipType_wxRadioBox, &sipCpp, &enable))
        {
            PyErr_Clear();
...
extern "C" {static PyObject *meth_wxRadioBox_DoGetBestSize(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxRadioBox_DoGetBestSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxRadioBox_DoGetBestClientSize(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxRadioBox_DoGetBestClientSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
static PyObject *meth_wxRadioBox_DoSetSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Biiiii", &sipSelf, sipType_wxRadioBox, &sipCpp, &x, &y, &width, &height, &sizeFlags))
        {
            PyErr_Clear();
...
static PyObject *meth_wxRadioBox_DoSetClientSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bii", &sipSelf, sipType_wxRadioBox, &sipCpp, &width, &height))
        {
            PyErr_Clear();
...
static PyObject *meth_wxRadioBox_DoSetSizeHints(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Biiiiii", &sipSelf, sipType_wxRadioBox, &sipCpp, &minW, &minH, &maxW, &maxH, &incW, &incH))
        {
            PyErr_Clear();
...
extern "C" {static PyObject *meth_wxRadioBox_DoGetBorderSize(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxRadioBox_DoGetBorderSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
static PyObject *meth_wxRadioBox_DoMoveWindow(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Biiii", &sipSelf, sipType_wxRadioBox, &sipCpp, &x, &y, &width, &height))
        {
            PyErr_Clear();
...
static PyObject *meth_wxRadioBox_DoSetWindowVariant(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BE", &sipSelf, sipType_wxRadioBox, &sipCpp, sipType_wxWindowVariant, &variant))
        {
            PyErr_Clear();
...
extern "C" {static PyObject *meth_wxRadioBox_GetDefaultBorder(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxRadioBox_GetDefaultBorder(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxRadioBox_GetDefaultBorderForControl(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxRadioBox_GetDefaultBorderForControl(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxRadioBox_DoFreeze(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxRadioBox_DoFreeze(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxRadioBox_DoThaw(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxRadioBox_DoThaw(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxRadioBox_HasTransparentBackground(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxRadioBox_HasTransparentBackground(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
PyDoc_STRVAR(doc_wxRadioBox_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant = wxWINDOW_VARIANT_NORMAL) -> VisualAttributes");
...
static PyObject *meth_wxRadioBox_GetClassDefaultAttributes(PyObject *, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RadioBox, sipName_GetClassDefaultAttributes, doc_wxRadioBox_GetClassDefaultAttributes);
...
static void dealloc_wxRadioBox(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxRadioBox *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static sipEncodedTypeDef supers_wxRadioBox[] = {{90, 255, 0}, {271, 255, 1}};
...
static PyMethodDef methods_wxRadioBox[] = {
    ...
    {SIP_MLNAME_CAST(sipName_AddChild), (PyCFunction)meth_wxRadioBox_AddChild, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_AddChild)},
    {SIP_MLNAME_CAST(sipName_Create), (PyCFunction)meth_wxRadioBox_Create, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_Create)},
    {SIP_MLNAME_CAST(sipName_Destroy), meth_wxRadioBox_Destroy, METH_VARARGS, SIP_MLDOC_CAST(doc_wxRadioBox_Destroy)},
    {SIP_MLNAME_CAST(sipName_DoEnable), (PyCFunction)meth_wxRadioBox_DoEnable, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_DoEnable)},
    {SIP_MLNAME_CAST(sipName_DoFreeze), (PyCFunction)meth_wxRadioBox_DoFreeze, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_DoFreeze)},
    {SIP_MLNAME_CAST(sipName_DoGetBestClientSize), (PyCFunction)meth_wxRadioBox_DoGetBestClientSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_DoGetBestClientSize)},
    {SIP_MLNAME_CAST(sipName_DoGetBestSize), (PyCFunction)meth_wxRadioBox_DoGetBestSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_DoGetBestSize)},
    {SIP_MLNAME_CAST(sipName_DoGetBorderSize), (PyCFunction)meth_wxRadioBox_DoGetBorderSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_DoGetBorderSize)},
    {SIP_MLNAME_CAST(sipName_DoGetClientSize), (PyCFunction)meth_wxRadioBox_DoGetClientSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_DoGetClientSize)},
    {SIP_MLNAME_CAST(sipName_DoGetPosition), (PyCFunction)meth_wxRadioBox_DoGetPosition, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_DoGetPosition)},
    {SIP_MLNAME_CAST(sipName_DoGetSize), (PyCFunction)meth_wxRadioBox_DoGetSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_DoGetSize)},
    {SIP_MLNAME_CAST(sipName_DoMoveWindow), (PyCFunction)meth_wxRadioBox_DoMoveWindow, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_DoMoveWindow)},
    {SIP_MLNAME_CAST(sipName_DoSetClientSize), (PyCFunction)meth_wxRadioBox_DoSetClientSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_DoSetClientSize)},
    {SIP_MLNAME_CAST(sipName_DoSetSize), (PyCFunction)meth_wxRadioBox_DoSetSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_DoSetSize)},
    {SIP_MLNAME_CAST(sipName_DoSetSizeHints), (PyCFunction)meth_wxRadioBox_DoSetSizeHints, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_DoSetSizeHints)},
    {SIP_MLNAME_CAST(sipName_DoSetWindowVariant), (PyCFunction)meth_wxRadioBox_DoSetWindowVariant, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_DoSetWindowVariant)},
    {SIP_MLNAME_CAST(sipName_DoThaw), (PyCFunction)meth_wxRadioBox_DoThaw, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_DoThaw)},
    {SIP_MLNAME_CAST(sipName_EnableItem), (PyCFunction)meth_wxRadioBox_EnableItem, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_EnableItem)},
    {SIP_MLNAME_CAST(sipName_FindString), (PyCFunction)meth_wxRadioBox_FindString, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_FindString)},
    {SIP_MLNAME_CAST(sipName_GetClassDefaultAttributes), (PyCFunction)meth_wxRadioBox_GetClassDefaultAttributes, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_GetClassDefaultAttributes)},
    ...
    {SIP_MLNAME_CAST(sipName_GetDefaultBorder), (PyCFunction)meth_wxRadioBox_GetDefaultBorder, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_GetDefaultBorder)},
    {SIP_MLNAME_CAST(sipName_GetDefaultBorderForControl), (PyCFunction)meth_wxRadioBox_GetDefaultBorderForControl, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_GetDefaultBorderForControl)},
    {SIP_MLNAME_CAST(sipName_GetItemFromPoint), (PyCFunction)meth_wxRadioBox_GetItemFromPoint, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_GetItemFromPoint)},
    {SIP_MLNAME_CAST(sipName_GetItemHelpText), (PyCFunction)meth_wxRadioBox_GetItemHelpText, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_GetItemHelpText)},
    {SIP_MLNAME_CAST(sipName_GetItemToolTip), (PyCFunction)meth_wxRadioBox_GetItemToolTip, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_GetItemToolTip)},
    ...
    {SIP_MLNAME_CAST(sipName_GetString), (PyCFunction)meth_wxRadioBox_GetString, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_GetString)},
    ...
    {SIP_MLNAME_CAST(sipName_HasTransparentBackground), (PyCFunction)meth_wxRadioBox_HasTransparentBackground, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_HasTransparentBackground)},
    {SIP_MLNAME_CAST(sipName_InformFirstDirection), (PyCFunction)meth_wxRadioBox_InformFirstDirection, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_InformFirstDirection)},
    ...
    {SIP_MLNAME_CAST(sipName_IsItemEnabled), (PyCFunction)meth_wxRadioBox_IsItemEnabled, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_IsItemEnabled)},
    {SIP_MLNAME_CAST(sipName_IsItemShown), (PyCFunction)meth_wxRadioBox_IsItemShown, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_IsItemShown)},
    ...
    {SIP_MLNAME_CAST(sipName_ProcessEvent), (PyCFunction)meth_wxRadioBox_ProcessEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_ProcessEvent)},
    {SIP_MLNAME_CAST(sipName_RemoveChild), (PyCFunction)meth_wxRadioBox_RemoveChild, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_RemoveChild)},
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxRadioBox_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_SetCanFocus), (PyCFunction)meth_wxRadioBox_SetCanFocus, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_SetCanFocus)},
    {SIP_MLNAME_CAST(sipName_SetItemHelpText), (PyCFunction)meth_wxRadioBox_SetItemHelpText, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_SetItemHelpText)},
    {SIP_MLNAME_CAST(sipName_SetItemToolTip), (PyCFunction)meth_wxRadioBox_SetItemToolTip, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_SetItemToolTip)},
    {SIP_MLNAME_CAST(sipName_SetSelection), (PyCFunction)meth_wxRadioBox_SetSelection, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_SetSelection)},
    {SIP_MLNAME_CAST(sipName_SetString), (PyCFunction)meth_wxRadioBox_SetString, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_SetString)},
    {SIP_MLNAME_CAST(sipName_SetValidator), (PyCFunction)meth_wxRadioBox_SetValidator, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_SetValidator)},
    ...
    {SIP_MLNAME_CAST(sipName_ShowItem), (PyCFunction)meth_wxRadioBox_ShowItem, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_ShowItem)},
    ...
    {SIP_MLNAME_CAST(sipName_TryAfter), (PyCFunction)meth_wxRadioBox_TryAfter, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_TryAfter)},
    {SIP_MLNAME_CAST(sipName_TryBefore), (PyCFunction)meth_wxRadioBox_TryBefore, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRadioBox_TryBefore)},
...
sipVariableDef variables_wxRadioBox[] = {
    {PropertyVariable, sipName_Selection, &methods_wxRadioBox[33], &methods_wxRadioBox[49], NULL, NULL},
    {PropertyVariable, sipName_RowCount, &methods_wxRadioBox[32], NULL, NULL, NULL},
    {PropertyVariable, sipName_Count, &methods_wxRadioBox[25], NULL, NULL, NULL},
    {PropertyVariable, sipName_ColumnCount, &methods_wxRadioBox[24], NULL, NULL, NULL},
};
