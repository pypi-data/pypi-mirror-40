...
static PyObject *meth_wxMimeTypesManager_AddFallbacks(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8", &sipSelf, sipType_wxMimeTypesManager, &sipCpp, sipType_wxFileTypeInfo, &fallbacks))
        {
            PyErr_Clear();
    ...
    sipNoMethod(sipParseErr, sipName_MimeTypesManager, sipName_AddFallbacks, NULL);
...
static PyObject *meth_wxMimeTypesManager_GetFileTypeFromExtension(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxMimeTypesManager, &sipCpp, sipType_wxString,&extension, &extensionState))
        {
             ::wxFileType*sipRes;
            ...
            return sipConvertFromType(sipRes,sipType_wxFileType,NULL);
        }
    }

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_MimeTypesManager, sipName_GetFileTypeFromExtension, NULL);
...
static PyObject *meth_wxMimeTypesManager_GetFileTypeFromMimeType(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxMimeTypesManager, &sipCpp, sipType_wxString,&mimeType, &mimeTypeState))
        {
             ::wxFileType*sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_MimeTypesManager, sipName_GetFileTypeFromMimeType, NULL);
...
static PyObject *meth_wxMimeTypesManager_Associate(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxMimeTypesManager, &sipCpp, sipType_wxFileTypeInfo, &ftInfo))
        {
             ::wxFileType*sipRes;
            ...
            return sipConvertFromNewType(sipRes,sipType_wxFileType,NULL);
        }
    }

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_MimeTypesManager, sipName_Associate, NULL);
...
static PyObject *meth_wxMimeTypesManager_Unassociate(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8", &sipSelf, sipType_wxMimeTypesManager, &sipCpp, sipType_wxFileType, &ft))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_MimeTypesManager, sipName_Unassociate, NULL);
...
static PyObject *meth_wxMimeTypesManager_EnumAllFileTypes(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_MimeTypesManager, sipName_EnumAllFileTypes, NULL);
...
static PyObject *meth_wxMimeTypesManager_IsOfType(PyObject *, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "J1J1", sipType_wxString,&mimeType, &mimeTypeState, sipType_wxString,&wildcard, &wildcardState))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_MimeTypesManager, sipName_IsOfType, NULL);
...
static PyMethodDef methods_wxMimeTypesManager[] = {
    {SIP_MLNAME_CAST(sipName_AddFallbacks), (PyCFunction)meth_wxMimeTypesManager_AddFallbacks, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxMimeTypesManager_AddFallbacks)},
    {SIP_MLNAME_CAST(sipName_Associate), (PyCFunction)meth_wxMimeTypesManager_Associate, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxMimeTypesManager_Associate)},
    ...
    {SIP_MLNAME_CAST(sipName_GetFileTypeFromExtension), (PyCFunction)meth_wxMimeTypesManager_GetFileTypeFromExtension, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxMimeTypesManager_GetFileTypeFromExtension)},
    {SIP_MLNAME_CAST(sipName_GetFileTypeFromMimeType), (PyCFunction)meth_wxMimeTypesManager_GetFileTypeFromMimeType, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxMimeTypesManager_GetFileTypeFromMimeType)},
    {SIP_MLNAME_CAST(sipName_IsOfType), (PyCFunction)meth_wxMimeTypesManager_IsOfType, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxMimeTypesManager_IsOfType)},
    {SIP_MLNAME_CAST(sipName_Unassociate), (PyCFunction)meth_wxMimeTypesManager_Unassociate, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxMimeTypesManager_Unassociate)}
};
