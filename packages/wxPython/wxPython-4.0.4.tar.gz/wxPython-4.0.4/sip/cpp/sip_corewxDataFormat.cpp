...
static PyObject *meth_wxDataFormat_GetId(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_DataFormat, sipName_GetId, NULL);
...
static PyObject *meth_wxDataFormat_GetType(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DataFormat, sipName_GetType, NULL);
...
static PyObject *meth_wxDataFormat_SetId(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxDataFormat, &sipCpp, sipType_wxString,&format, &formatState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DataFormat, sipName_SetId, NULL);
...
static PyObject *meth_wxDataFormat_SetType(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BE", &sipSelf, sipType_wxDataFormat, &sipCpp, sipType_wxDataFormatId, &type))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DataFormat, sipName_SetType, NULL);
...
extern "C" {static void *array_wxDataFormat(SIP_SSIZE_T);}
static void *array_wxDataFormat(SIP_SSIZE_T sipNrElem)
{
...
static void *init_type_wxDataFormat(sipSimpleWrapper *, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxDataFormat, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxDataFormat[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SetId), (PyCFunction)meth_wxDataFormat_SetId, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDataFormat_SetId)},
    {SIP_MLNAME_CAST(sipName_SetType), (PyCFunction)meth_wxDataFormat_SetType, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDataFormat_SetType)}
};

sipVariableDef variables_wxDataFormat[] = {
    {PropertyVariable, sipName_Type, &methods_wxDataFormat[1], &methods_wxDataFormat[3], NULL, NULL},
    {PropertyVariable, sipName_Id, &methods_wxDataFormat[0], &methods_wxDataFormat[2], NULL, NULL},
};
