...
static PyObject *meth_wxRichTextRangeArray_append(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxRichTextRangeArray, &sipCpp, sipType_wxRichTextRange, &obj, &objState))
        {
        sipCpp->Add(*obj);
...
static int slot_wxRichTextRangeArray___contains__(PyObject *sipSelf,PyObject *sipArg)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextRangeArray, sipName___contains__, NULL);
...
static PyObject *slot_wxRichTextRangeArray___getitem__(PyObject *sipSelf,PyObject *sipArg)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextRangeArray, sipName___getitem__, NULL);
...
static void *init_type_wxRichTextRangeArray(sipSimpleWrapper *, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxRichTextRangeArray, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxRichTextRangeArray[] = {
    {SIP_MLNAME_CAST(sipName_append), (PyCFunction)meth_wxRichTextRangeArray_append, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextRangeArray_append)},
    {SIP_MLNAME_CAST(sipName_index), (PyCFunction)meth_wxRichTextRangeArray_index, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextRangeArray_index)}
};
