...
sipwxTreeEvent::sipwxTreeEvent( ::wxEventType commandType, ::wxTreeCtrl*tree,const  ::wxTreeItemId& item):  ::wxTreeEvent(commandType,tree,item), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxTreeEvent::sipwxTreeEvent(const  ::wxTreeEvent& a0):  ::wxTreeEvent(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
static PyObject *meth_wxTreeEvent_GetItem(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_TreeEvent, sipName_GetItem, NULL);
...
static PyObject *meth_wxTreeEvent_GetKeyCode(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TreeEvent, sipName_GetKeyCode, NULL);
...
static PyObject *meth_wxTreeEvent_GetKeyEvent(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxTreeEvent, &sipCpp))
        {
            ...
            return sipConvertFromNewType(sipRes,sipType_wxKeyEvent,NULL);
        }
    }

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TreeEvent, sipName_GetKeyEvent, NULL);
...
static PyObject *meth_wxTreeEvent_GetLabel(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TreeEvent, sipName_GetLabel, NULL);
...
static PyObject *meth_wxTreeEvent_GetOldItem(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TreeEvent, sipName_GetOldItem, NULL);
...
static PyObject *meth_wxTreeEvent_GetPoint(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TreeEvent, sipName_GetPoint, NULL);
...
static PyObject *meth_wxTreeEvent_IsEditCancelled(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TreeEvent, sipName_IsEditCancelled, NULL);
...
static PyObject *meth_wxTreeEvent_SetToolTip(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxTreeEvent, &sipCpp, sipType_wxString,&tooltip, &tooltipState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TreeEvent, sipName_SetToolTip, NULL);
...
static void dealloc_wxTreeEvent(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxTreeEvent *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static void *init_type_wxTreeEvent(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxTreeEvent, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxTreeEvent[] = {{356, 255, 1}};
...
static PyMethodDef methods_wxTreeEvent[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SetToolTip), (PyCFunction)meth_wxTreeEvent_SetToolTip, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeEvent_SetToolTip)}
};

sipVariableDef variables_wxTreeEvent[] = {
    {PropertyVariable, sipName_Point, &methods_wxTreeEvent[6], NULL, NULL, NULL},
    {PropertyVariable, sipName_OldItem, &methods_wxTreeEvent[5], NULL, NULL, NULL},
    {PropertyVariable, sipName_Label, &methods_wxTreeEvent[4], NULL, NULL, NULL},
    {PropertyVariable, sipName_KeyEvent, &methods_wxTreeEvent[3], NULL, NULL, NULL},
    {PropertyVariable, sipName_KeyCode, &methods_wxTreeEvent[2], NULL, NULL, NULL},
    {PropertyVariable, sipName_Item, &methods_wxTreeEvent[1], NULL, NULL, NULL},
};
