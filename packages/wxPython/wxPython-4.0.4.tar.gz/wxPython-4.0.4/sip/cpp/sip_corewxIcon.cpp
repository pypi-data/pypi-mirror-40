...
static PyObject *meth_wxIcon_CreateFromHICON(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bl", &sipSelf, sipType_wxIcon, &sipCpp, &hicon))
        {
            bool sipRes = 0;
            int sipIsErr = 0;
    ...
    sipNoMethod(sipParseErr, sipName_Icon, sipName_CreateFromHICON, NULL);
...
static PyObject *meth_wxIcon_CopyFromBitmap(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxIcon, &sipCpp, sipType_wxBitmap, &bmp))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Icon, sipName_CopyFromBitmap, NULL);
...
static PyObject *meth_wxIcon_GetDepth(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Icon, sipName_GetDepth, NULL);
...
static PyObject *meth_wxIcon_GetHeight(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Icon, sipName_GetHeight, NULL);
...
static PyObject *meth_wxIcon_GetWidth(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Icon, sipName_GetWidth, NULL);
...
static PyObject *meth_wxIcon_IsOk(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Icon, sipName_IsOk, NULL);
...
static PyObject *meth_wxIcon_LoadFile(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1|Eii", &sipSelf, sipType_wxIcon, &sipCpp, sipType_wxString,&name, &nameState, sipType_wxBitmapType, &type, &desiredWidth, &desiredHeight))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Icon, sipName_LoadFile, NULL);
...
static PyObject *meth_wxIcon_SetDepth(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bi", &sipSelf, sipType_wxIcon, &sipCpp, &depth))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Icon, sipName_SetDepth, NULL);
...
static PyObject *meth_wxIcon_SetHeight(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bi", &sipSelf, sipType_wxIcon, &sipCpp, &height))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Icon, sipName_SetHeight, NULL);
...
static PyObject *meth_wxIcon_SetWidth(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bi", &sipSelf, sipType_wxIcon, &sipCpp, &width))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Icon, sipName_SetWidth, NULL);
...
static PyObject *meth_wxIcon_GetHandle(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Icon, sipName_GetHandle, NULL);
...
static PyObject *meth_wxIcon_SetHandle(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bl", &sipSelf, sipType_wxIcon, &sipCpp, &handle))
        {
            int sipIsErr = 0;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Icon, sipName_SetHandle, NULL);
...
static sipEncodedTypeDef supers_wxIcon[] = {{205, 255, 1}};
...
static PyMethodDef methods_wxIcon[] = {
    {SIP_MLNAME_CAST(sipName_CopyFromBitmap), (PyCFunction)meth_wxIcon_CopyFromBitmap, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxIcon_CopyFromBitmap)},
    {SIP_MLNAME_CAST(sipName_CreateFromHICON), (PyCFunction)meth_wxIcon_CreateFromHICON, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxIcon_CreateFromHICON)},
    ...
    {SIP_MLNAME_CAST(sipName_LoadFile), (PyCFunction)meth_wxIcon_LoadFile, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxIcon_LoadFile)},
    {SIP_MLNAME_CAST(sipName_SetDepth), (PyCFunction)meth_wxIcon_SetDepth, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxIcon_SetDepth)},
    {SIP_MLNAME_CAST(sipName_SetHandle), (PyCFunction)meth_wxIcon_SetHandle, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxIcon_SetHandle)},
    {SIP_MLNAME_CAST(sipName_SetHeight), (PyCFunction)meth_wxIcon_SetHeight, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxIcon_SetHeight)},
    {SIP_MLNAME_CAST(sipName_SetWidth), (PyCFunction)meth_wxIcon_SetWidth, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxIcon_SetWidth)}
};

sipVariableDef variables_wxIcon[] = {
    {PropertyVariable, sipName_Width, &methods_wxIcon[5], &methods_wxIcon[11], NULL, NULL},
    {PropertyVariable, sipName_Height, &methods_wxIcon[4], &methods_wxIcon[10], NULL, NULL},
    {PropertyVariable, sipName_Handle, &methods_wxIcon[3], &methods_wxIcon[9], NULL, NULL},
    {PropertyVariable, sipName_Depth, &methods_wxIcon[2], &methods_wxIcon[8], NULL, NULL},
};
