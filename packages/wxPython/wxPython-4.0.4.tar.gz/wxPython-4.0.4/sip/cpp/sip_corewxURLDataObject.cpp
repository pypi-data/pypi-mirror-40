...
sipwxURLDataObject::sipwxURLDataObject(const  ::wxString& url):  ::wxURLDataObject(url), sipPySelf(0)
{
...
static PyObject *meth_wxURLDataObject_GetURL(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_URLDataObject, sipName_GetURL, NULL);
...
static PyObject *meth_wxURLDataObject_SetURL(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxURLDataObject, &sipCpp, sipType_wxString,&url, &urlState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_URLDataObject, sipName_SetURL, NULL);
...
static PyObject *meth_wxURLDataObject_GetAllFormats(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "B|E", &sipSelf, sipType_wxURLDataObject, &sipCpp, sipType_wxDataObject_Direction, &dir))
        {
            PyObject * sipRes = 0;
            int sipIsErr = 0;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_URLDataObject, sipName_GetAllFormats, NULL);
...
static PyObject *meth_wxURLDataObject_SetData(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9J0", &sipSelf, sipType_wxURLDataObject, &sipCpp, sipType_wxDataFormat, &format, sipType_wxPyBuffer,&buf, &bufState))
        {
            bool sipRes = 0;
            int sipIsErr = 0;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_URLDataObject, sipName_SetData, NULL);

    return NULL;
}


PyDoc_STRVAR(doc_wxURLDataObject_GetFormatCount, "GetFormatCount(self, dir: DataObject.Direction = wxDataObject.Get) -> object");
...
static PyObject *meth_wxURLDataObject_GetFormatCount(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "B|E", &sipSelf, sipType_wxURLDataObject, &sipCpp, sipType_wxDataObject_Direction, &dir))
        {
            ...
            Py_BEGIN_ALLOW_THREADS
            sipRes = new  ::size_t((sipSelfWasArg ? sipCpp-> ::wxURLDataObject::GetFormatCount(dir) : sipCpp->GetFormatCount(dir)));
            Py_END_ALLOW_THREADS
...
static PyObject *meth_wxURLDataObject_GetDataSize(PyObject *, PyObject *)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(NULL, sipName_URLDataObject, sipName_GetDataSize, NULL);
...
static PyObject *meth_wxURLDataObject_GetDataHere(PyObject *, PyObject *)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(NULL, sipName_URLDataObject, sipName_GetDataHere, NULL);
...
static void dealloc_wxURLDataObject(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxURLDataObject *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static sipEncodedTypeDef supers_wxURLDataObject[] = {{104, 255, 1}};


static PyMethodDef methods_wxURLDataObject[] = {
    {SIP_MLNAME_CAST(sipName_GetAllFormats), (PyCFunction)meth_wxURLDataObject_GetAllFormats, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxURLDataObject_GetAllFormats)},
    {SIP_MLNAME_CAST(sipName_GetDataHere), meth_wxURLDataObject_GetDataHere, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_GetDataSize), meth_wxURLDataObject_GetDataSize, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_GetFormatCount), (PyCFunction)meth_wxURLDataObject_GetFormatCount, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxURLDataObject_GetFormatCount)},
    {SIP_MLNAME_CAST(sipName_GetPreferredFormat), (PyCFunction)meth_wxURLDataObject_GetPreferredFormat, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxURLDataObject_GetPreferredFormat)},
    {SIP_MLNAME_CAST(sipName_GetURL), meth_wxURLDataObject_GetURL, METH_VARARGS, SIP_MLDOC_CAST(doc_wxURLDataObject_GetURL)},
    {SIP_MLNAME_CAST(sipName_SetData), (PyCFunction)meth_wxURLDataObject_SetData, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxURLDataObject_SetData)},
    {SIP_MLNAME_CAST(sipName_SetURL), (PyCFunction)meth_wxURLDataObject_SetURL, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxURLDataObject_SetURL)}
};

sipVariableDef variables_wxURLDataObject[] = {
    {PropertyVariable, sipName_URL, &methods_wxURLDataObject[5], &methods_wxURLDataObject[7], NULL, NULL},
    {PropertyVariable, sipName_AllFormats, &methods_wxURLDataObject[0], NULL, NULL, NULL},
};
