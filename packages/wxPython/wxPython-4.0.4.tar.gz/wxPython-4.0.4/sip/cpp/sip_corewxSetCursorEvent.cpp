...
static PyObject *meth_wxSetCursorEvent_GetCursor(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_SetCursorEvent, sipName_GetCursor, NULL);
...
static PyObject *meth_wxSetCursorEvent_GetX(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_SetCursorEvent, sipName_GetX, NULL);
...
static PyObject *meth_wxSetCursorEvent_GetY(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_SetCursorEvent, sipName_GetY, NULL);
...
static PyObject *meth_wxSetCursorEvent_HasCursor(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_SetCursorEvent, sipName_HasCursor, NULL);
...
static PyObject *meth_wxSetCursorEvent_SetCursor(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_SetCursorEvent, sipName_SetCursor, NULL);
...
static sipEncodedTypeDef supers_wxSetCursorEvent[] = {{141, 255, 1}};
...
sipVariableDef variables_wxSetCursorEvent[] = {
    {PropertyVariable, sipName_Y, &methods_wxSetCursorEvent[3], NULL, NULL, NULL},
    {PropertyVariable, sipName_X, &methods_wxSetCursorEvent[2], NULL, NULL, NULL},
    {PropertyVariable, sipName_Cursor, &methods_wxSetCursorEvent[1], &methods_wxSetCursorEvent[5], NULL, NULL},
};
