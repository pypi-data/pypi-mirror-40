...
sipwxRibbonBarEvent::sipwxRibbonBarEvent( ::wxEventType command_type,int win_id, ::wxRibbonPage*page):  ::wxRibbonBarEvent(command_type,win_id,page), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxRibbonBarEvent::sipwxRibbonBarEvent(const  ::wxRibbonBarEvent& a0):  ::wxRibbonBarEvent(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
static PyObject *meth_wxRibbonBarEvent_GetPage(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_RibbonBarEvent, sipName_GetPage, NULL);
...
static PyObject *meth_wxRibbonBarEvent_SetPage(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8", &sipSelf, sipType_wxRibbonBarEvent, &sipCpp, sipType_wxRibbonPage, &page))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RibbonBarEvent, sipName_SetPage, NULL);
...
static void dealloc_wxRibbonBarEvent(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxRibbonBarEvent *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static void *init_type_wxRibbonBarEvent(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxRibbonBarEvent, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxRibbonBarEvent[] = {{14, 0, 1}};
...
static PyMethodDef methods_wxRibbonBarEvent[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SetPage), (PyCFunction)meth_wxRibbonBarEvent_SetPage, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRibbonBarEvent_SetPage)}
};

sipVariableDef variables_wxRibbonBarEvent[] = {
    {PropertyVariable, sipName_Page, &methods_wxRibbonBarEvent[1], &methods_wxRibbonBarEvent[2], NULL, NULL},
};
