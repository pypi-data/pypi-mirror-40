...
sipwxAuiNotebookEvent::sipwxAuiNotebookEvent( ::wxEventType command_type,int win_id):  ::wxAuiNotebookEvent(command_type,win_id), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxAuiNotebookEvent::sipwxAuiNotebookEvent(const  ::wxAuiNotebookEvent& a0):  ::wxAuiNotebookEvent(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
static PyObject *meth_wxAuiNotebookEvent_Clone(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_AuiNotebookEvent, sipName_Clone, NULL);
...
static void dealloc_wxAuiNotebookEvent(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxAuiNotebookEvent *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxAuiNotebookEvent *sipCpp = 0;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxAuiNotebookEvent, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
