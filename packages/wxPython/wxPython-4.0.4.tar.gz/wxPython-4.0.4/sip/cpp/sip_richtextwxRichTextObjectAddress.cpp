...
static PyObject *meth_wxRichTextObjectAddress_Init(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_RichTextObjectAddress, sipName_Init, NULL);
...
static PyObject *meth_wxRichTextObjectAddress_Copy(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxRichTextObjectAddress, &sipCpp, sipType_wxRichTextObjectAddress, &address))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextObjectAddress, sipName_Copy, NULL);
...
static PyObject *meth_wxRichTextObjectAddress_GetObject(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8", &sipSelf, sipType_wxRichTextObjectAddress, &sipCpp, sipType_wxRichTextParagraphLayoutBox, &topLevelContainer))
        {
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextObjectAddress, sipName_GetObject, NULL);
...
static PyObject *meth_wxRichTextObjectAddress_Create(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8J8", &sipSelf, sipType_wxRichTextObjectAddress, &sipCpp, sipType_wxRichTextParagraphLayoutBox, &topLevelContainer, sipType_wxRichTextObject, &obj))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextObjectAddress, sipName_Create, NULL);
...
static PyObject *meth_wxRichTextObjectAddress_GetAddress(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextObjectAddress, sipName_GetAddress, NULL);
...
static PyObject *meth_wxRichTextObjectAddress_SetAddress(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxRichTextObjectAddress, &sipCpp, sipType_wxArrayInt,&address, &addressState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextObjectAddress, sipName_SetAddress, NULL);
...
extern "C" {static void *array_wxRichTextObjectAddress(SIP_SSIZE_T);}
static void *array_wxRichTextObjectAddress(SIP_SSIZE_T sipNrElem)
{
...
{
     ::wxRichTextObjectAddress *sipCpp = 0;
...
static PyMethodDef methods_wxRichTextObjectAddress[] = {
    {SIP_MLNAME_CAST(sipName_Copy), (PyCFunction)meth_wxRichTextObjectAddress_Copy, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextObjectAddress_Copy)},
    {SIP_MLNAME_CAST(sipName_Create), (PyCFunction)meth_wxRichTextObjectAddress_Create, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextObjectAddress_Create)},
    ...
    {SIP_MLNAME_CAST(sipName_GetObject), (PyCFunction)meth_wxRichTextObjectAddress_GetObject, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextObjectAddress_GetObject)},
    ...
    {SIP_MLNAME_CAST(sipName_SetAddress), (PyCFunction)meth_wxRichTextObjectAddress_SetAddress, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextObjectAddress_SetAddress)}
};

sipVariableDef variables_wxRichTextObjectAddress[] = {
    {PropertyVariable, sipName_Address, &methods_wxRichTextObjectAddress[2], &methods_wxRichTextObjectAddress[5], NULL, NULL},
};
