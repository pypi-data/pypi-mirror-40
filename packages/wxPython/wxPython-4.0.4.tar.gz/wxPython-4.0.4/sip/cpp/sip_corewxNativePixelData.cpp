...
sipwxNativePixelData::sipwxNativePixelData( ::wxBitmap& bmp):  ::wxNativePixelData(bmp), sipPySelf(0)
{
}

sipwxNativePixelData::sipwxNativePixelData( ::wxBitmap& bmp,const  ::wxRect& rect):  ::wxNativePixelData(bmp,rect), sipPySelf(0)
{
}

sipwxNativePixelData::sipwxNativePixelData( ::wxBitmap& bmp,const  ::wxPoint& pt,const  ::wxSize& sz):  ::wxNativePixelData(bmp,pt,sz), sipPySelf(0)
{
}

sipwxNativePixelData::sipwxNativePixelData(const  ::wxNativePixelData& a0):  ::wxNativePixelData(a0), sipPySelf(0)
{
}
...
static PyObject *meth_wxNativePixelData_GetPixels(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxNativePixelData, &sipCpp))
        {
            ...
            return sipConvertFromNewType(sipRes,sipType_wxNativePixelData_Accessor,NULL);
        }
    }

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_NativePixelData, sipName_GetPixels, NULL);
...
static void dealloc_wxNativePixelData(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxNativePixelData *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static void *init_type_wxNativePixelData(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxNativePixelData, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxNativePixelData[] = {{382, 255, 1}};
...
sipVariableDef variables_wxNativePixelData[] = {
    {PropertyVariable, sipName_Pixels, &methods_wxNativePixelData[0], NULL, NULL, NULL},
};
