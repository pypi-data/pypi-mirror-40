...
static PyObject *meth_wxGraphicsContext_Create(PyObject *, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "@J9", &metaFileDCKeep, sipType_wxMetafileDC, &metaFileDC))
        {
        ...
        if (PyErr_Occurred()) sipIsErr = 1;
            ...
            sipKeepReference(sipResObj, -14, metaFileDCKeep);
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "@J9", &imageKeep, sipType_wxImage, &image))
        {
            ...
            sipKeepReference(sipResObj, -15, imageKeep);
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "@J8", &autoPaintDCKeep, sipType_wxAutoBufferedPaintDC, &autoPaintDC))
        {
             ::wxGraphicsContext*sipRes = 0;
            PyObject *sipResObj;
            int sipIsErr = 0;
        ...
        if (PyErr_Occurred()) sipIsErr = 1;
            ...
            sipKeepReference(sipResObj, -16, autoPaintDCKeep);
...
static sipEncodedTypeDef supers_wxGraphicsContext[] = {{221, 255, 1}};
