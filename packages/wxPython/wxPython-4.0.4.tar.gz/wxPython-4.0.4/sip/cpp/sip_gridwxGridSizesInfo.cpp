...
static PyObject *meth_wxGridSizesInfo_GetSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bu", &sipSelf, sipType_wxGridSizesInfo, &sipCpp, &pos))
        {
            int sipRes;
    ...
    sipNoMethod(sipParseErr, sipName_GridSizesInfo, sipName_GetSize, NULL);
...
extern "C" {static void *array_wxGridSizesInfo(SIP_SSIZE_T);}
static void *array_wxGridSizesInfo(SIP_SSIZE_T sipNrElem)
{
...
static void *init_type_wxGridSizesInfo(sipSimpleWrapper *, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxGridSizesInfo, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxGridSizesInfo[] = {
    {SIP_MLNAME_CAST(sipName_GetSize), (PyCFunction)meth_wxGridSizesInfo_GetSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridSizesInfo_GetSize)}
};
...
sipVariableDef variables_wxGridSizesInfo[] = {
    {InstanceVariable, sipName_m_sizeDefault, (PyMethodDef *)varget_wxGridSizesInfo_m_sizeDefault, (PyMethodDef *)varset_wxGridSizesInfo_m_sizeDefault, NULL, NULL},
};
