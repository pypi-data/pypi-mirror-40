...
sipwxStockPreferencesPage::sipwxStockPreferencesPage( ::wxStockPreferencesPage::Kind kind):  ::wxStockPreferencesPage(kind), sipPySelf(0)
{
 ...
 ::wxBitmap sipwxStockPreferencesPage::GetLargeIcon() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[1]),sipPySelf,NULL,sipName_GetLargeIcon);
...
static PyObject *meth_wxStockPreferencesPage_GetKind(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_StockPreferencesPage, sipName_GetKind, NULL);
...
static PyObject *meth_wxStockPreferencesPage_GetName(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_StockPreferencesPage, sipName_GetName, NULL);
...
static PyObject *meth_wxStockPreferencesPage_GetLargeIcon(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_StockPreferencesPage, sipName_GetLargeIcon, NULL);
...
static void dealloc_wxStockPreferencesPage(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxStockPreferencesPage *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxStockPreferencesPage *sipCpp = 0;
...
static sipEncodedTypeDef supers_wxStockPreferencesPage[] = {{397, 255, 1}};
...
static sipEnumMemberDef enummembers_wxStockPreferencesPage[] = {
    {sipName_Kind_Advanced, static_cast<int>( ::wxStockPreferencesPage::Kind_Advanced), 496},
    {sipName_Kind_General, static_cast<int>( ::wxStockPreferencesPage::Kind_General), 496},
};

sipVariableDef variables_wxStockPreferencesPage[] = {
    {PropertyVariable, sipName_Name, &methods_wxStockPreferencesPage[2], NULL, NULL, NULL},
    {PropertyVariable, sipName_LargeIcon, &methods_wxStockPreferencesPage[1], NULL, NULL, NULL},
};
