...
static PyObject *meth_wxPenList_FindOrCreatePen(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1|iE", &sipSelf, sipType_wxPenList, &sipCpp, sipType_wxColour, &colour, &colourState, &width, sipType_wxPenStyle, &style))
        {
             ::wxPen*sipRes;
            ...
            return sipConvertFromType(sipRes,sipType_wxPen,NULL);
        }
    }

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PenList, sipName_FindOrCreatePen, NULL);
...
static void *init_type_wxPenList(sipSimpleWrapper *, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxPenList, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxPenList[] = {
    {SIP_MLNAME_CAST(sipName_FindOrCreatePen), (PyCFunction)meth_wxPenList_FindOrCreatePen, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPenList_FindOrCreatePen)}
};
