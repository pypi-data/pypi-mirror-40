...
sipwxRichTextPlainTextHandler::sipwxRichTextPlainTextHandler(const  ::wxString& name,const  ::wxString& ext, ::wxRichTextFileType type):  ::wxRichTextPlainTextHandler(name,ext,type), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxRichTextPlainTextHandler::sipwxRichTextPlainTextHandler(const  ::wxRichTextPlainTextHandler& a0):  ::wxRichTextPlainTextHandler(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
static PyObject *meth_wxRichTextPlainTextHandler_CanSave(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_RichTextPlainTextHandler, sipName_CanSave, NULL);
...
static PyObject *meth_wxRichTextPlainTextHandler_CanLoad(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextPlainTextHandler, sipName_CanLoad, NULL);
...
static PyObject *meth_wxRichTextPlainTextHandler_DoLoadFile(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8J1", &sipSelf, sipType_wxRichTextPlainTextHandler, &sipCpp, sipType_wxRichTextBuffer, &buffer, sipType_wxInputStream, &stream, &streamState))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextPlainTextHandler, sipName_DoLoadFile, NULL);
...
static PyObject *meth_wxRichTextPlainTextHandler_DoSaveFile(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8J1", &sipSelf, sipType_wxRichTextPlainTextHandler, &sipCpp, sipType_wxRichTextBuffer, &buffer, sipType_wxOutputStream, &stream, &streamState))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextPlainTextHandler, sipName_DoSaveFile, NULL);
...
extern "C" {static void *array_wxRichTextPlainTextHandler(SIP_SSIZE_T);}
static void *array_wxRichTextPlainTextHandler(SIP_SSIZE_T sipNrElem)
{
...
static void dealloc_wxRichTextPlainTextHandler(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxRichTextPlainTextHandler *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxRichTextPlainTextHandler *sipCpp = 0;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxRichTextPlainTextHandler, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxRichTextPlainTextHandler[] = {
    ...
    {SIP_MLNAME_CAST(sipName_DoLoadFile), (PyCFunction)meth_wxRichTextPlainTextHandler_DoLoadFile, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextPlainTextHandler_DoLoadFile)},
    {SIP_MLNAME_CAST(sipName_DoSaveFile), (PyCFunction)meth_wxRichTextPlainTextHandler_DoSaveFile, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextPlainTextHandler_DoSaveFile)}
};
