...
sipwxWindowDC::sipwxWindowDC( ::wxWindow*window):  ::wxWindowDC(window), sipPySelf(0)
{
}
...
static void dealloc_wxWindowDC(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxWindowDC *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static sipEncodedTypeDef supers_wxWindowDC[] = {{94, 255, 1}};
