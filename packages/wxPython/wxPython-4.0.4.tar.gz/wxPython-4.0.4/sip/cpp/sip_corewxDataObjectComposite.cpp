...
sipwxDataObjectComposite::sipwxDataObjectComposite():  ::wxDataObjectComposite(), sipPySelf(0)
{
...
void sipwxDataObjectComposite::GetAllFormats( ::wxDataFormat*formats, ::wxDataObject::Direction dir) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[0]),sipPySelf,NULL,sipName_GetAllFormats);
 ...
 ::size_t sipwxDataObjectComposite::GetFormatCount( ::wxDataObject::Direction dir) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[1]),sipPySelf,NULL,sipName_GetFormatCount);
 ...
 ::wxDataFormat sipwxDataObjectComposite::GetPreferredFormat( ::wxDataObject::Direction dir) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[2]),sipPySelf,NULL,sipName_GetPreferredFormat);
...
static PyObject *meth_wxDataObjectComposite_Add(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ:|b", &sipSelf, sipType_wxDataObjectComposite, &sipCpp, sipType_wxDataObjectSimple, &dataObject, &preferred))
        {
            PyErr_Clear();
    ...
    sipNoMethod(sipParseErr, sipName_DataObjectComposite, sipName_Add, NULL);
...
static PyObject *meth_wxDataObjectComposite_GetReceivedFormat(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DataObjectComposite, sipName_GetReceivedFormat, NULL);
...
static PyObject *meth_wxDataObjectComposite_GetObject(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9|E", &sipSelf, sipType_wxDataObjectComposite, &sipCpp, sipType_wxDataFormat, &format, sipType_wxDataObject_Direction, &dir))
        {
            ...
            return sipConvertFromType(sipRes,sipType_wxDataObjectSimple,NULL);
        }
    }

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DataObjectComposite, sipName_GetObject, NULL);
...
static PyObject *meth_wxDataObjectComposite_GetAllFormats(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "B|E", &sipSelf, sipType_wxDataObjectComposite, &sipCpp, sipType_wxDataObject_Direction, &dir))
        {
            PyObject * sipRes = 0;
            int sipIsErr = 0;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DataObjectComposite, sipName_GetAllFormats, NULL);
...
static PyObject *meth_wxDataObjectComposite_SetData(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9J0", &sipSelf, sipType_wxDataObjectComposite, &sipCpp, sipType_wxDataFormat, &format, sipType_wxPyBuffer,&buf, &bufState))
        {
            bool sipRes = 0;
            int sipIsErr = 0;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DataObjectComposite, sipName_SetData, NULL);

    return NULL;
}


PyDoc_STRVAR(doc_wxDataObjectComposite_GetFormatCount, "GetFormatCount(self, dir: DataObject.Direction = wxDataObject.Get) -> object");
...
static PyObject *meth_wxDataObjectComposite_GetFormatCount(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "B|E", &sipSelf, sipType_wxDataObjectComposite, &sipCpp, sipType_wxDataObject_Direction, &dir))
        {
            ...
            Py_BEGIN_ALLOW_THREADS
            sipRes = new  ::size_t((sipSelfWasArg ? sipCpp-> ::wxDataObjectComposite::GetFormatCount(dir) : sipCpp->GetFormatCount(dir)));
            Py_END_ALLOW_THREADS
...
static PyObject *meth_wxDataObjectComposite_GetDataSize(PyObject *, PyObject *)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(NULL, sipName_DataObjectComposite, sipName_GetDataSize, NULL);
...
static PyObject *meth_wxDataObjectComposite_GetDataHere(PyObject *, PyObject *)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(NULL, sipName_DataObjectComposite, sipName_GetDataHere, NULL);
...
static void dealloc_wxDataObjectComposite(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxDataObjectComposite *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxDataObjectComposite *sipCpp = 0;
...
static sipEncodedTypeDef supers_wxDataObjectComposite[] = {{104, 255, 1}};


static PyMethodDef methods_wxDataObjectComposite[] = {
    {SIP_MLNAME_CAST(sipName_Add), (PyCFunction)meth_wxDataObjectComposite_Add, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDataObjectComposite_Add)},
    {SIP_MLNAME_CAST(sipName_GetAllFormats), (PyCFunction)meth_wxDataObjectComposite_GetAllFormats, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDataObjectComposite_GetAllFormats)},
    {SIP_MLNAME_CAST(sipName_GetDataHere), meth_wxDataObjectComposite_GetDataHere, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_GetDataSize), meth_wxDataObjectComposite_GetDataSize, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_GetFormatCount), (PyCFunction)meth_wxDataObjectComposite_GetFormatCount, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDataObjectComposite_GetFormatCount)},
    {SIP_MLNAME_CAST(sipName_GetObject), (PyCFunction)meth_wxDataObjectComposite_GetObject, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDataObjectComposite_GetObject)},
    {SIP_MLNAME_CAST(sipName_GetPreferredFormat), (PyCFunction)meth_wxDataObjectComposite_GetPreferredFormat, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDataObjectComposite_GetPreferredFormat)},
    ...
    {SIP_MLNAME_CAST(sipName_SetData), (PyCFunction)meth_wxDataObjectComposite_SetData, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDataObjectComposite_SetData)}
};

sipVariableDef variables_wxDataObjectComposite[] = {
    {PropertyVariable, sipName_ReceivedFormat, &methods_wxDataObjectComposite[7], NULL, NULL, NULL},
    {PropertyVariable, sipName_AllFormats, &methods_wxDataObjectComposite[1], NULL, NULL, NULL},
};
