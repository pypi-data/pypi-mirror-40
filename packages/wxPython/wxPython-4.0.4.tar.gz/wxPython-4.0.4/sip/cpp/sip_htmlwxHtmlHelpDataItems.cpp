...
static PyObject *meth_wxHtmlHelpDataItems_append(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxHtmlHelpDataItems, &sipCpp, sipType_wxHtmlHelpDataItem, &obj))
        {
        sipCpp->Add(*obj);
...
static int slot_wxHtmlHelpDataItems___contains__(PyObject *sipSelf,PyObject *sipArg)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HtmlHelpDataItems, sipName___contains__, NULL);
...
static PyObject *slot_wxHtmlHelpDataItems___getitem__(PyObject *sipSelf,PyObject *sipArg)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArg, "1l", &index))
        {
            ...
            if (sipError == sipErrorNone)
            {
            return sipConvertFromType(sipRes,sipType_wxHtmlHelpDataItem,NULL);
            }
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HtmlHelpDataItems, sipName___getitem__, NULL);
...
static void *init_type_wxHtmlHelpDataItems(sipSimpleWrapper *, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxHtmlHelpDataItems, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxHtmlHelpDataItems[] = {
    {SIP_MLNAME_CAST(sipName_append), (PyCFunction)meth_wxHtmlHelpDataItems_append, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHtmlHelpDataItems_append)},
    {SIP_MLNAME_CAST(sipName_index), (PyCFunction)meth_wxHtmlHelpDataItems_index, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHtmlHelpDataItems_index)}
};
