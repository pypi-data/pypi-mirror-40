...
sipwxRibbonGalleryEvent::sipwxRibbonGalleryEvent( ::wxEventType command_type,int win_id, ::wxRibbonGallery*gallery, ::wxRibbonGalleryItem*item):  ::wxRibbonGalleryEvent(command_type,win_id,gallery,item), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxRibbonGalleryEvent::sipwxRibbonGalleryEvent(const  ::wxRibbonGalleryEvent& a0):  ::wxRibbonGalleryEvent(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
static PyObject *meth_wxRibbonGalleryEvent_GetGallery(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxRibbonGalleryEvent, &sipCpp))
        {
            ...
            return sipConvertFromType(sipRes,sipType_wxRibbonGallery,NULL);
        }
    }

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RibbonGalleryEvent, sipName_GetGallery, NULL);
...
static PyObject *meth_wxRibbonGalleryEvent_GetGalleryItem(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RibbonGalleryEvent, sipName_GetGalleryItem, NULL);
...
static PyObject *meth_wxRibbonGalleryEvent_SetGallery(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8", &sipSelf, sipType_wxRibbonGalleryEvent, &sipCpp, sipType_wxRibbonGallery, &gallery))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RibbonGalleryEvent, sipName_SetGallery, NULL);
...
static PyObject *meth_wxRibbonGalleryEvent_SetGalleryItem(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8", &sipSelf, sipType_wxRibbonGalleryEvent, &sipCpp, sipType_wxRibbonGalleryItem, &item))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RibbonGalleryEvent, sipName_SetGalleryItem, NULL);
...
static void dealloc_wxRibbonGalleryEvent(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxRibbonGalleryEvent *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxRibbonGalleryEvent *sipCpp = 0;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxRibbonGalleryEvent, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxRibbonGalleryEvent[] = {{5, 0, 1}};
...
static PyMethodDef methods_wxRibbonGalleryEvent[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SetGallery), (PyCFunction)meth_wxRibbonGalleryEvent_SetGallery, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRibbonGalleryEvent_SetGallery)},
    {SIP_MLNAME_CAST(sipName_SetGalleryItem), (PyCFunction)meth_wxRibbonGalleryEvent_SetGalleryItem, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRibbonGalleryEvent_SetGalleryItem)}
};

sipVariableDef variables_wxRibbonGalleryEvent[] = {
    {PropertyVariable, sipName_GalleryItem, &methods_wxRibbonGalleryEvent[2], &methods_wxRibbonGalleryEvent[4], NULL, NULL},
    {PropertyVariable, sipName_Gallery, &methods_wxRibbonGalleryEvent[1], &methods_wxRibbonGalleryEvent[3], NULL, NULL},
};
