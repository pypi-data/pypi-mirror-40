...
static PyObject *meth_wxGraphicsObject_GetRenderer(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_GraphicsObject, sipName_GetRenderer, NULL);
...
static PyObject *meth_wxGraphicsObject_IsNull(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GraphicsObject, sipName_IsNull, NULL);
...
static PyObject *meth_wxGraphicsObject_IsOk(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GraphicsObject, sipName_IsOk, NULL);
...
extern "C" {static void *array_wxGraphicsObject(SIP_SSIZE_T);}
static void *array_wxGraphicsObject(SIP_SSIZE_T sipNrElem)
{
...
static void *init_type_wxGraphicsObject(sipSimpleWrapper *, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxGraphicsObject, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxGraphicsObject[] = {{358, 255, 1}};
...
sipVariableDef variables_wxGraphicsObject[] = {
    {PropertyVariable, sipName_Renderer, &methods_wxGraphicsObject[0], NULL, NULL, NULL},
};
