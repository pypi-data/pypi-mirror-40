...
static PyObject *meth_wxDataViewItemArray_append(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxDataViewItemArray, &sipCpp, sipType_wxDataViewItem, &obj))
        {
        sipCpp->Add(*obj);
...
static int slot_wxDataViewItemArray___contains__(PyObject *sipSelf,PyObject *sipArg)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DataViewItemArray, sipName___contains__, NULL);
...
static PyObject *slot_wxDataViewItemArray___getitem__(PyObject *sipSelf,PyObject *sipArg)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArg, "1l", &index))
        {
            ...
            if (sipError == sipErrorNone)
            {
            return sipConvertFromType(sipRes,sipType_wxDataViewItem,NULL);
            }
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DataViewItemArray, sipName___getitem__, NULL);
...
extern "C" {static void *array_wxDataViewItemArray(SIP_SSIZE_T);}
static void *array_wxDataViewItemArray(SIP_SSIZE_T sipNrElem)
{
...
static void *init_type_wxDataViewItemArray(sipSimpleWrapper *, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxDataViewItemArray, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxDataViewItemArray[] = {
    {SIP_MLNAME_CAST(sipName_append), (PyCFunction)meth_wxDataViewItemArray_append, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDataViewItemArray_append)},
    {SIP_MLNAME_CAST(sipName_index), (PyCFunction)meth_wxDataViewItemArray_index, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDataViewItemArray_index)}
};
