...
sipwxWizardEvent::sipwxWizardEvent( ::wxEventType type,int id,bool direction, ::wxWizardPage*page):  ::wxWizardEvent(type,id,direction,page), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxWizardEvent::sipwxWizardEvent(const  ::wxWizardEvent& a0):  ::wxWizardEvent(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
static PyObject *meth_wxWizardEvent_GetDirection(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_WizardEvent, sipName_GetDirection, NULL);
...
static PyObject *meth_wxWizardEvent_GetPage(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_WizardEvent, sipName_GetPage, NULL);
...
static void dealloc_wxWizardEvent(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxWizardEvent *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static void *init_type_wxWizardEvent(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxWizardEvent, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
sipVariableDef variables_wxWizardEvent[] = {
    {PropertyVariable, sipName_Page, &methods_wxWizardEvent[2], NULL, NULL, NULL},
    {PropertyVariable, sipName_Direction, &methods_wxWizardEvent[1], NULL, NULL, NULL},
};
