...
sipwxGridSizeEvent::sipwxGridSizeEvent():  ::wxGridSizeEvent(), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxGridSizeEvent::sipwxGridSizeEvent(int id, ::wxEventType type, ::wxObject*obj,int rowOrCol,int x,int y,const  ::wxKeyboardState& kbd):  ::wxGridSizeEvent(id,type,obj,rowOrCol,x,y,kbd), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxGridSizeEvent::sipwxGridSizeEvent(const  ::wxGridSizeEvent& a0):  ::wxGridSizeEvent(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
static PyObject *meth_wxGridSizeEvent_AltDown(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_GridSizeEvent, sipName_AltDown, NULL);
...
static PyObject *meth_wxGridSizeEvent_ControlDown(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GridSizeEvent, sipName_ControlDown, NULL);
...
static PyObject *meth_wxGridSizeEvent_GetPosition(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GridSizeEvent, sipName_GetPosition, NULL);
...
static PyObject *meth_wxGridSizeEvent_GetRowOrCol(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GridSizeEvent, sipName_GetRowOrCol, NULL);
...
static PyObject *meth_wxGridSizeEvent_MetaDown(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GridSizeEvent, sipName_MetaDown, NULL);
...
static PyObject *meth_wxGridSizeEvent_ShiftDown(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GridSizeEvent, sipName_ShiftDown, NULL);
...
static void dealloc_wxGridSizeEvent(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxGridSizeEvent *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static void *init_type_wxGridSizeEvent(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxGridSizeEvent, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
sipVariableDef variables_wxGridSizeEvent[] = {
    {PropertyVariable, sipName_RowOrCol, &methods_wxGridSizeEvent[4], NULL, NULL, NULL},
    {PropertyVariable, sipName_Position, &methods_wxGridSizeEvent[3], NULL, NULL, NULL},
};
