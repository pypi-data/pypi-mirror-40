...
sipwxBufferedPaintDC::sipwxBufferedPaintDC( ::wxWindow*window, ::wxBitmap& buffer,int style):  ::wxBufferedPaintDC(window,buffer,style), sipPySelf(0)
{
}

sipwxBufferedPaintDC::sipwxBufferedPaintDC( ::wxWindow*window,int style):  ::wxBufferedPaintDC(window,style), sipPySelf(0)
{
}
...
static void dealloc_wxBufferedPaintDC(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxBufferedPaintDC *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static void *init_type_wxBufferedPaintDC(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (!wxPyCheckForApp()) return NULL;
            ...
            sipKeepReference((PyObject *)sipSelf, -7, bufferKeep);
