...
sipwxGCDC::sipwxGCDC(const  ::wxWindowDC& windowDC):  ::wxGCDC(windowDC), sipPySelf(0)
{
}

sipwxGCDC::sipwxGCDC(const  ::wxMemoryDC& memoryDC):  ::wxGCDC(memoryDC), sipPySelf(0)
{
}

sipwxGCDC::sipwxGCDC(const  ::wxPrinterDC& printerDC):  ::wxGCDC(printerDC), sipPySelf(0)
{
}

sipwxGCDC::sipwxGCDC( ::wxGraphicsContext*context):  ::wxGCDC(context), sipPySelf(0)
{
}

sipwxGCDC::sipwxGCDC():  ::wxGCDC(), sipPySelf(0)
{
}
...
static PyObject *meth_wxGCDC_GetGraphicsContext(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxGCDC, &sipCpp))
        {
            ...
            return sipConvertFromType(sipRes,sipType_wxGraphicsContext,NULL);
        }
    }

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GCDC, sipName_GetGraphicsContext, NULL);

    return NULL;
}


PyDoc_STRVAR(doc_wxGCDC_SetGraphicsContext, "SetGraphicsContext(ctx)\n"
"\n"
...
static PyObject *meth_wxGCDC_SetGraphicsContext(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ:", &sipSelf, sipType_wxGCDC, &sipCpp, sipType_wxGraphicsContext, &ctx))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GCDC, sipName_SetGraphicsContext, NULL);
...
static void dealloc_wxGCDC(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxGCDC *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static void *init_type_wxGCDC(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (!wxPyCheckForApp()) return NULL;
            ...
            sipKeepReference((PyObject *)sipSelf, -8, windowDCKeep);
...

    {
        ...
        if (!wxPyCheckForApp()) return NULL;
            ...
            sipKeepReference((PyObject *)sipSelf, -9, memoryDCKeep);
...

    {
        ...
        if (!wxPyCheckForApp()) return NULL;
            ...
            sipKeepReference((PyObject *)sipSelf, -10, printerDCKeep);
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, sipKwdList, sipUnused, "J:", sipType_wxGraphicsContext, &context))
        {
...
static sipEncodedTypeDef supers_wxGCDC[] = {{94, 255, 1}};
...
static PyMethodDef methods_wxGCDC[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SetGraphicsContext), (PyCFunction)meth_wxGCDC_SetGraphicsContext, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGCDC_SetGraphicsContext)}
};

sipVariableDef variables_wxGCDC[] = {
    {PropertyVariable, sipName_GraphicsContext, &methods_wxGCDC[0], &methods_wxGCDC[1], NULL, NULL},
};
