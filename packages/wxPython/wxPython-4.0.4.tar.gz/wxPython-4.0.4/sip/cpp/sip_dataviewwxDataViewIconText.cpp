...
static PyObject *meth_wxDataViewIconText_GetIcon(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_DataViewIconText, sipName_GetIcon, NULL);
...
static PyObject *meth_wxDataViewIconText_GetText(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DataViewIconText, sipName_GetText, NULL);
...
static PyObject *meth_wxDataViewIconText_SetIcon(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxDataViewIconText, &sipCpp, sipType_wxIcon, &icon))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DataViewIconText, sipName_SetIcon, NULL);
...
static PyObject *meth_wxDataViewIconText_SetText(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxDataViewIconText, &sipCpp, sipType_wxString,&text, &textState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DataViewIconText, sipName_SetText, NULL);
...
extern "C" {static void *array_wxDataViewIconText(SIP_SSIZE_T);}
static void *array_wxDataViewIconText(SIP_SSIZE_T sipNrElem)
{
...
static PyMethodDef methods_wxDataViewIconText[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SetIcon), (PyCFunction)meth_wxDataViewIconText_SetIcon, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDataViewIconText_SetIcon)},
    {SIP_MLNAME_CAST(sipName_SetText), (PyCFunction)meth_wxDataViewIconText_SetText, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDataViewIconText_SetText)}
};

sipVariableDef variables_wxDataViewIconText[] = {
    {PropertyVariable, sipName_Text, &methods_wxDataViewIconText[1], &methods_wxDataViewIconText[3], NULL, NULL},
    {PropertyVariable, sipName_Icon, &methods_wxDataViewIconText[0], &methods_wxDataViewIconText[2], NULL, NULL},
};
