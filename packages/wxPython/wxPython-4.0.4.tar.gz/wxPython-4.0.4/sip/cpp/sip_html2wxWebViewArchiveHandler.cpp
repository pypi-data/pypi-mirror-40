...
sipwxWebViewArchiveHandler::sipwxWebViewArchiveHandler(const  ::wxString& scheme):  ::wxWebViewArchiveHandler(scheme), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxWebViewArchiveHandler::sipwxWebViewArchiveHandler(const  ::wxWebViewArchiveHandler& a0):  ::wxWebViewArchiveHandler(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
 ...
 ::wxFSFile* sipwxWebViewArchiveHandler::GetFile(const  ::wxString& uri)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[0],sipPySelf,NULL,sipName_GetFile);
...
static PyObject *meth_wxWebViewArchiveHandler_GetFile(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxWebViewArchiveHandler, &sipCpp, sipType_wxString,&uri, &uriState))
        {
             ::wxFSFile*sipRes;
    ...
    sipNoMethod(sipParseErr, sipName_WebViewArchiveHandler, sipName_GetFile, NULL);
...
static void dealloc_wxWebViewArchiveHandler(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxWebViewArchiveHandler *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxWebViewArchiveHandler *sipCpp = 0;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxWebViewArchiveHandler, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxWebViewArchiveHandler[] = {
    {SIP_MLNAME_CAST(sipName_GetFile), (PyCFunction)meth_wxWebViewArchiveHandler_GetFile, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWebViewArchiveHandler_GetFile)}
};
