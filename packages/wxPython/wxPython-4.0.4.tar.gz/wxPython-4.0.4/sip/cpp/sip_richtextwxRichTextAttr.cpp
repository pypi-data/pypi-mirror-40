...
static PyObject *meth_wxRichTextAttr_Copy(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxRichTextAttr, &sipCpp, sipType_wxRichTextAttr, &attr))
        {
            PyErr_Clear();
    ...
    sipNoMethod(sipParseErr, sipName_RichTextAttr, sipName_Copy, NULL);
...
static PyObject *meth_wxRichTextAttr_EqPartial(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9|b", &sipSelf, sipType_wxRichTextAttr, &sipCpp, sipType_wxRichTextAttr, &attr, &weakTest))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextAttr, sipName_EqPartial, NULL);
...
static PyObject *meth_wxRichTextAttr_Apply(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9|J8", &sipSelf, sipType_wxRichTextAttr, &sipCpp, sipType_wxRichTextAttr, &style, sipType_wxRichTextAttr, &compareWith))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextAttr, sipName_Apply, NULL);
...
static PyObject *meth_wxRichTextAttr_CollectCommonAttributes(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9J9J9", &sipSelf, sipType_wxRichTextAttr, &sipCpp, sipType_wxRichTextAttr, &attr, sipType_wxRichTextAttr, &clashingAttr, sipType_wxRichTextAttr, &absentAttr))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextAttr, sipName_CollectCommonAttributes, NULL);
...
static PyObject *meth_wxRichTextAttr_RemoveStyle(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextAttr, sipName_RemoveStyle, NULL);
...
static PyObject *meth_wxRichTextAttr_GetTextBoxAttr(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxRichTextAttr, &sipCpp))
        {
            ...
            return sipConvertFromType(sipRes,sipType_wxTextBoxAttr,NULL);
        }
    }

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextAttr, sipName_GetTextBoxAttr, NULL);
...
static PyObject *meth_wxRichTextAttr_SetTextBoxAttr(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxRichTextAttr, &sipCpp, sipType_wxTextBoxAttr, &attr))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextAttr, sipName_SetTextBoxAttr, NULL);
...
static PyObject *meth_wxRichTextAttr_IsDefault(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichTextAttr, sipName_IsDefault, NULL);
...
extern "C" {static void *array_wxRichTextAttr(SIP_SSIZE_T);}
static void *array_wxRichTextAttr(SIP_SSIZE_T sipNrElem)
{
...
static PyMethodDef methods_wxRichTextAttr[] = {
    {SIP_MLNAME_CAST(sipName_Apply), (PyCFunction)meth_wxRichTextAttr_Apply, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextAttr_Apply)},
    {SIP_MLNAME_CAST(sipName_CollectCommonAttributes), (PyCFunction)meth_wxRichTextAttr_CollectCommonAttributes, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextAttr_CollectCommonAttributes)},
    {SIP_MLNAME_CAST(sipName_Copy), (PyCFunction)meth_wxRichTextAttr_Copy, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextAttr_Copy)},
    {SIP_MLNAME_CAST(sipName_EqPartial), (PyCFunction)meth_wxRichTextAttr_EqPartial, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextAttr_EqPartial)},
    ...
    {SIP_MLNAME_CAST(sipName_RemoveStyle), (PyCFunction)meth_wxRichTextAttr_RemoveStyle, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextAttr_RemoveStyle)},
    {SIP_MLNAME_CAST(sipName_SetTextBoxAttr), (PyCFunction)meth_wxRichTextAttr_SetTextBoxAttr, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichTextAttr_SetTextBoxAttr)}
};


extern "C" {static PyObject *varget_wxRichTextAttr_m_textBoxAttr(void *, PyObject *, PyObject *);}
static PyObject *varget_wxRichTextAttr_m_textBoxAttr(void *sipSelf, PyObject *, PyObject *)
{
    ...
    return sipConvertFromType(sipVal, sipType_wxTextBoxAttr, NULL);
}
...
static int varset_wxRichTextAttr_m_textBoxAttr(void *sipSelf, PyObject *sipPy, PyObject *)
{
    ...
    sipVal = reinterpret_cast< ::wxTextBoxAttr *>(sipForceConvertToType(sipPy,sipType_wxTextBoxAttr,NULL,SIP_NOT_NONE,NULL,&sipIsErr));
...
sipVariableDef variables_wxRichTextAttr[] = {
    {PropertyVariable, sipName_TextBoxAttr, &methods_wxRichTextAttr[4], &methods_wxRichTextAttr[7], NULL, NULL},
    {InstanceVariable, sipName_m_textBoxAttr, (PyMethodDef *)varget_wxRichTextAttr_m_textBoxAttr, (PyMethodDef *)varset_wxRichTextAttr_m_textBoxAttr, NULL, NULL},
};
