...
const char sipStrings__aui[] = {
    ...
    'w', 'x', 'A', 'u', 'i', 'P', 'a', 'n', 'e', 'B', 'u', 't', 't', 'o', 'n', 'A', 'r', 'r', 'a', 'y', 0,
    ...
    'w', 'x', 'A', 'u', 'i', 'P', 'a', 'n', 'e', 'B', 'u', 't', 't', 'o', 'n', 0,
...
bool sipVH__aui_63(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, bool show)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "b", show);
 ...
 ::wxStatusBar* sipVH__aui_62(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int number,long style, ::wxWindowID id,const  ::wxString& name)
{
 ...
 ::wxToolBar* sipVH__aui_61(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, long style, ::wxWindowID id,const  ::wxString& name)
{
     ::wxToolBar* sipRes = 0;
...
void sipVH__aui_60(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxSize& tab_ctrl_size, ::size_t tab_count)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "NN", new  ::wxSize(tab_ctrl_size), sipType_wxSize, NULL, new  ::size_t(tab_count), sipType_size_t, NULL);
}

void sipVH__aui_59(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxColour& colour)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "N", new  ::wxColour(colour), sipType_wxColour, NULL);
}

 ::wxSize sipVH__aui_58(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxDC& dc, ::wxWindow*wnd,const  ::wxString& caption,const  ::wxBitmap& bitmap,bool active,int close_button_state,int*x_extent)
{
     ::wxSize sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "DDNNbi", &dc, sipType_wxDC, NULL, wnd, sipType_wxWindow, NULL, new  ::wxString(caption), sipType_wxString, NULL, new  ::wxBitmap(bitmap), sipType_wxBitmap, NULL, active, close_button_state);
...
int sipVH__aui_57(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxWindow*a0,const  ::wxAuiNotebookPageArray& a1,const  ::wxSize& a2)
{
    int sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "DNN", a0, sipType_wxWindow, NULL, new  ::wxAuiNotebookPageArray(a1), sipType_wxAuiNotebookPageArray, NULL, new  ::wxSize(a2), sipType_wxSize, NULL);
...
void sipVH__aui_56(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxDC& dc, ::wxWindow*wnd,const  ::wxAuiNotebookPage& page,const  ::wxRect& rect,int close_button_state, ::wxRect*out_tab_rect, ::wxRect*out_button_rect,int*x_extent)
{
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "DDNNiDD", &dc, sipType_wxDC, NULL, wnd, sipType_wxWindow, NULL, new  ::wxAuiNotebookPage(page), sipType_wxAuiNotebookPage, NULL, new  ::wxRect(rect), sipType_wxRect, NULL, close_button_state, out_tab_rect, sipType_wxRect, NULL, out_button_rect, sipType_wxRect, NULL);

    sipParseResultEx(sipGILState, sipErrorHandler, sipPySelf, sipMethod, sipResObj, "i", x_extent);
}

void sipVH__aui_55(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxDC& dc, ::wxWindow*wnd,const  ::wxRect& in_rect,int bitmap_id,int button_state,int orientation, ::wxRect*out_rect)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "DDNiiiD", &dc, sipType_wxDC, NULL, wnd, sipType_wxWindow, NULL, new  ::wxRect(in_rect), sipType_wxRect, NULL, bitmap_id, button_state, orientation, out_rect, sipType_wxRect, NULL);
}

 ::wxAuiTabArt* sipVH__aui_54(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
...
void sipVH__aui_53(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxImageList*imageList)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "D", imageList, sipType_wxImageList, NULL);
}

bool sipVH__aui_52(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::size_t n,int imageId)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "Ni", new  ::size_t(n), sipType_size_t, NULL, imageId);
 ...
 ::wxString sipVH__aui_51(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::size_t page)
{
     ::wxString sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "N", new  ::size_t(page), sipType_size_t, NULL);
...
bool sipVH__aui_50(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::size_t page,const  ::wxString& text)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "NN", new  ::size_t(page), sipType_size_t, NULL, new  ::wxString(text), sipType_wxString, NULL);
...
int sipVH__aui_49(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::size_t n)
{
    int sipRes = 0;
...
bool sipVH__aui_48(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxWindow*page,const  ::wxString& text,bool select,int imageId)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "DNbi", page, sipType_wxWindow, NULL, new  ::wxString(text), sipType_wxString, NULL, select, imageId);
...
bool sipVH__aui_47(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::size_t index, ::wxWindow*page,const  ::wxString& text,bool select,int imageId)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "NDNbi", new  ::size_t(index), sipType_size_t, NULL, page, sipType_wxWindow, NULL, new  ::wxString(text), sipType_wxString, NULL, select, imageId);
...
bool sipVH__aui_46(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::size_t page)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "N", new  ::size_t(page), sipType_size_t, NULL);
 ...
 ::size_t sipVH__aui_45(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
     ::size_t sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "");

    sipParseResultEx(sipGILState, sipErrorHandler, sipPySelf, sipMethod, sipResObj, "H5", sipType_size_t, &sipRes);

    return sipRes;
}

void sipVH__aui_44(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxSize& size)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "N", new  ::wxSize(size), sipType_wxSize, NULL);
}

int sipVH__aui_43(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxPoint& pt,long*flags)
{
    int sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "N", new  ::wxPoint(pt), sipType_wxPoint, NULL);
 ...
 ::wxBorder sipVH__aui_42(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
...
void sipVH__aui_41(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxWindowVariant variant)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "F", variant, sipType_wxWindowVariant);
}

void sipVH__aui_40(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int x,int y,int width,int height)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "iiii", x, y, width, height);
}

 ::wxSize sipVH__aui_39(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
     ::wxSize sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "");
...
void sipVH__aui_38(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int minW,int minH,int maxW,int maxH,int incW,int incH)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "iiiiii", minW, minH, maxW, maxH, incW, incH);
}

void sipVH__aui_37(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int x,int y,int width,int height,int sizeFlags)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "iiiii", x, y, width, height, sizeFlags);
}

void sipVH__aui_36(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int*x,int*y)
{
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "");
 ...
 ::wxWindow* sipVH__aui_35(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
     ::wxWindow* sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "");
...
void sipVH__aui_34(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxValidator& validator)
{
 ...
 ::wxValidator* sipVH__aui_33(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
 ...
 ::wxPoint sipVH__aui_32(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
     ::wxPoint sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "");
...
bool sipVH__aui_31(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int direction,int size,int availableOtherDir)
{
    bool sipRes = 0;
...
void sipVH__aui_30(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, bool canFocus)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "b", canFocus);
}

bool sipVH__aui_29(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "");
...
void sipVH__aui_28(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxWindowBase*child)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "D", child, sipType_wxWindowBase, NULL);
}

int sipVH__aui_27(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxWindow*wnd,const  ::wxAuiToolBarItemArray& items)
{
    int sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "DN", wnd, sipType_wxWindow, NULL, new  ::wxAuiToolBarItemArray(items), sipType_wxAuiToolBarItemArray, NULL);
 ...
 ::wxSize sipVH__aui_26(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxDC& dc, ::wxWindow*wnd,const  ::wxAuiToolBarItem& item)
{
     ::wxSize sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "DDN", &dc, sipType_wxDC, NULL, wnd, sipType_wxWindow, NULL, new  ::wxAuiToolBarItem(item), sipType_wxAuiToolBarItem, NULL);
...
void sipVH__aui_25(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxDC& dc, ::wxWindow*wnd,const  ::wxRect& rect,int state)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "DDNi", &dc, sipType_wxDC, NULL, wnd, sipType_wxWindow, NULL, new  ::wxRect(rect), sipType_wxRect, NULL, state);
}

void sipVH__aui_24(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxDC& dc, ::wxWindow*wnd,const  ::wxAuiToolBarItem& item,const  ::wxRect& rect)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "DDNN", &dc, sipType_wxDC, NULL, wnd, sipType_wxWindow, NULL, new  ::wxAuiToolBarItem(item), sipType_wxAuiToolBarItem, NULL, new  ::wxRect(rect), sipType_wxRect, NULL);
}

void sipVH__aui_23(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxDC& dc, ::wxWindow*wnd,const  ::wxRect& rect)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "DDN", &dc, sipType_wxDC, NULL, wnd, sipType_wxWindow, NULL, new  ::wxRect(rect), sipType_wxRect, NULL);
}

int sipVH__aui_22(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
    int sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "");
...
void sipVH__aui_21(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int orientation)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "i", orientation);
}

 ::wxFont sipVH__aui_20(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
     ::wxFont sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "");
...
void sipVH__aui_19(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxFont& font)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "N", new  ::wxFont(font), sipType_wxFont, NULL);
}

uint sipVH__aui_18(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
    uint sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "");
...
void sipVH__aui_17(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, uint flags)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "u", flags);
}

 ::wxAuiToolBarArt* sipVH__aui_16(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
...
void sipVH__aui_15(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int id,int new_val)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "ii", id, new_val);
}

void sipVH__aui_14(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int id,const  ::wxFont& font)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "iN", id, new  ::wxFont(font), sipType_wxFont, NULL);
}

void sipVH__aui_13(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int id,const  ::wxColour& colour)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "iN", id, new  ::wxColour(colour), sipType_wxColour, NULL);
}

int sipVH__aui_12(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int id)
{
    int sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "i", id);
 ...
 ::wxFont sipVH__aui_11(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int id)
{
     ::wxFont sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "i", id);
 ...
 ::wxColour sipVH__aui_10(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int id)
{
     ::wxColour sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "i", id);
...
void sipVH__aui_9(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxDC& dc, ::wxWindow*window,int button,int button_state,const  ::wxRect& rect, ::wxAuiPaneInfo& pane)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "DDiiND", &dc, sipType_wxDC, NULL, window, sipType_wxWindow, NULL, button, button_state, new  ::wxRect(rect), sipType_wxRect, NULL, &pane, sipType_wxAuiPaneInfo, NULL);
}

void sipVH__aui_8(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxDC& dc, ::wxWindow*window,const  ::wxString& text,const  ::wxRect& rect, ::wxAuiPaneInfo& pane)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "DDNND", &dc, sipType_wxDC, NULL, window, sipType_wxWindow, NULL, new  ::wxString(text), sipType_wxString, NULL, new  ::wxRect(rect), sipType_wxRect, NULL, &pane, sipType_wxAuiPaneInfo, NULL);
}

void sipVH__aui_7(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxDC& dc, ::wxWindow*window,const  ::wxRect& rect, ::wxAuiPaneInfo& pane)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "DDND", &dc, sipType_wxDC, NULL, window, sipType_wxWindow, NULL, new  ::wxRect(rect), sipType_wxRect, NULL, &pane, sipType_wxAuiPaneInfo, NULL);
}

void sipVH__aui_6(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxDC& dc, ::wxWindow*window,int orientation,const  ::wxRect& rect)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "DDiN", &dc, sipType_wxDC, NULL, window, sipType_wxWindow, NULL, orientation, new  ::wxRect(rect), sipType_wxRect, NULL);
}

 ::wxEvent* sipVH__aui_5(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
     ::wxEvent* sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "");
 ...
 ::wxEventCategory sipVH__aui_4(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
...
bool sipVH__aui_3(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxAuiPaneInfo& target,const  ::wxAuiPaneInfo& new_pos)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "DN", &target, sipType_wxAuiPaneInfo, NULL, new  ::wxAuiPaneInfo(new_pos), sipType_wxAuiPaneInfo, NULL);
...
void sipVH__aui_2(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxRect& rect)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "N", new  ::wxRect(rect), sipType_wxRect, NULL);
}

void sipVH__aui_1(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
...
static sipEnumTypeDef enumTypes[] = {
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxAuiNotebookOption, {0}, 0}, sipNameNr_AuiNotebookOption, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxAuiToolBarToolTextOrientation, {0}, 0}, sipNameNr_AuiToolBarToolTextOrientation, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxAuiToolBarArtSetting, {0}, 0}, sipNameNr_AuiToolBarArtSetting, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxAuiToolBarStyle, {0}, 0}, sipNameNr_AuiToolBarStyle, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxAuiButtonId, {0}, 0}, sipNameNr_AuiButtonId, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxAuiPaneButtonState, {0}, 0}, sipNameNr_AuiPaneButtonState, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxAuiPaneDockArtGradients, {0}, 0}, sipNameNr_AuiPaneDockArtGradients, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxAuiPaneDockArtSetting, {0}, 0}, sipNameNr_AuiPaneDockArtSetting, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxAuiManagerOption, {0}, 0}, sipNameNr_AuiManagerOption, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxAuiManagerDock, {0}, 0}, sipNameNr_AuiManagerDock, -1, NULL},
};
...
static sipEnumMemberDef enummembers[] = {
    ...
    {sipName_AUI_BUTTON_STATE_CHECKED, static_cast<int>(::wxAUI_BUTTON_STATE_CHECKED), 24},
    {sipName_AUI_BUTTON_STATE_DISABLED, static_cast<int>(::wxAUI_BUTTON_STATE_DISABLED), 24},
    {sipName_AUI_BUTTON_STATE_HIDDEN, static_cast<int>(::wxAUI_BUTTON_STATE_HIDDEN), 24},
    {sipName_AUI_BUTTON_STATE_HOVER, static_cast<int>(::wxAUI_BUTTON_STATE_HOVER), 24},
    {sipName_AUI_BUTTON_STATE_NORMAL, static_cast<int>(::wxAUI_BUTTON_STATE_NORMAL), 24},
    {sipName_AUI_BUTTON_STATE_PRESSED, static_cast<int>(::wxAUI_BUTTON_STATE_PRESSED), 24},
    ...
    {sipName_AUI_DOCKART_ACTIVE_CAPTION_COLOUR, static_cast<int>(::wxAUI_DOCKART_ACTIVE_CAPTION_COLOUR), 26},
    {sipName_AUI_DOCKART_ACTIVE_CAPTION_GRADIENT_COLOUR, static_cast<int>(::wxAUI_DOCKART_ACTIVE_CAPTION_GRADIENT_COLOUR), 26},
    {sipName_AUI_DOCKART_ACTIVE_CAPTION_TEXT_COLOUR, static_cast<int>(::wxAUI_DOCKART_ACTIVE_CAPTION_TEXT_COLOUR), 26},
    {sipName_AUI_DOCKART_BACKGROUND_COLOUR, static_cast<int>(::wxAUI_DOCKART_BACKGROUND_COLOUR), 26},
    {sipName_AUI_DOCKART_BORDER_COLOUR, static_cast<int>(::wxAUI_DOCKART_BORDER_COLOUR), 26},
    {sipName_AUI_DOCKART_CAPTION_FONT, static_cast<int>(::wxAUI_DOCKART_CAPTION_FONT), 26},
    {sipName_AUI_DOCKART_CAPTION_SIZE, static_cast<int>(::wxAUI_DOCKART_CAPTION_SIZE), 26},
    {sipName_AUI_DOCKART_GRADIENT_TYPE, static_cast<int>(::wxAUI_DOCKART_GRADIENT_TYPE), 26},
    {sipName_AUI_DOCKART_GRIPPER_COLOUR, static_cast<int>(::wxAUI_DOCKART_GRIPPER_COLOUR), 26},
    {sipName_AUI_DOCKART_GRIPPER_SIZE, static_cast<int>(::wxAUI_DOCKART_GRIPPER_SIZE), 26},
    {sipName_AUI_DOCKART_INACTIVE_CAPTION_COLOUR, static_cast<int>(::wxAUI_DOCKART_INACTIVE_CAPTION_COLOUR), 26},
    {sipName_AUI_DOCKART_INACTIVE_CAPTION_GRADIENT_COLOUR, static_cast<int>(::wxAUI_DOCKART_INACTIVE_CAPTION_GRADIENT_COLOUR), 26},
    {sipName_AUI_DOCKART_INACTIVE_CAPTION_TEXT_COLOUR, static_cast<int>(::wxAUI_DOCKART_INACTIVE_CAPTION_TEXT_COLOUR), 26},
    {sipName_AUI_DOCKART_PANE_BORDER_SIZE, static_cast<int>(::wxAUI_DOCKART_PANE_BORDER_SIZE), 26},
    {sipName_AUI_DOCKART_PANE_BUTTON_SIZE, static_cast<int>(::wxAUI_DOCKART_PANE_BUTTON_SIZE), 26},
    {sipName_AUI_DOCKART_SASH_COLOUR, static_cast<int>(::wxAUI_DOCKART_SASH_COLOUR), 26},
    {sipName_AUI_DOCKART_SASH_SIZE, static_cast<int>(::wxAUI_DOCKART_SASH_SIZE), 26},
    {sipName_AUI_DOCK_BOTTOM, static_cast<int>(::wxAUI_DOCK_BOTTOM), 14},
    {sipName_AUI_DOCK_CENTER, static_cast<int>(::wxAUI_DOCK_CENTER), 14},
    {sipName_AUI_DOCK_CENTRE, static_cast<int>(::wxAUI_DOCK_CENTRE), 14},
    {sipName_AUI_DOCK_LEFT, static_cast<int>(::wxAUI_DOCK_LEFT), 14},
    {sipName_AUI_DOCK_NONE, static_cast<int>(::wxAUI_DOCK_NONE), 14},
    {sipName_AUI_DOCK_RIGHT, static_cast<int>(::wxAUI_DOCK_RIGHT), 14},
    {sipName_AUI_DOCK_TOP, static_cast<int>(::wxAUI_DOCK_TOP), 14},
    {sipName_AUI_GRADIENT_HORIZONTAL, static_cast<int>(::wxAUI_GRADIENT_HORIZONTAL), 25},
    {sipName_AUI_GRADIENT_NONE, static_cast<int>(::wxAUI_GRADIENT_NONE), 25},
    {sipName_AUI_GRADIENT_VERTICAL, static_cast<int>(::wxAUI_GRADIENT_VERTICAL), 25},
    {sipName_AUI_MGR_ALLOW_ACTIVE_PANE, static_cast<int>(::wxAUI_MGR_ALLOW_ACTIVE_PANE), 16},
    {sipName_AUI_MGR_ALLOW_FLOATING, static_cast<int>(::wxAUI_MGR_ALLOW_FLOATING), 16},
    {sipName_AUI_MGR_DEFAULT, static_cast<int>(::wxAUI_MGR_DEFAULT), 16},
    {sipName_AUI_MGR_HINT_FADE, static_cast<int>(::wxAUI_MGR_HINT_FADE), 16},
    {sipName_AUI_MGR_LIVE_RESIZE, static_cast<int>(::wxAUI_MGR_LIVE_RESIZE), 16},
    {sipName_AUI_MGR_NO_VENETIAN_BLINDS_FADE, static_cast<int>(::wxAUI_MGR_NO_VENETIAN_BLINDS_FADE), 16},
    {sipName_AUI_MGR_RECTANGLE_HINT, static_cast<int>(::wxAUI_MGR_RECTANGLE_HINT), 16},
    {sipName_AUI_MGR_TRANSPARENT_DRAG, static_cast<int>(::wxAUI_MGR_TRANSPARENT_DRAG), 16},
    {sipName_AUI_MGR_TRANSPARENT_HINT, static_cast<int>(::wxAUI_MGR_TRANSPARENT_HINT), 16},
    {sipName_AUI_MGR_VENETIAN_BLINDS_HINT, static_cast<int>(::wxAUI_MGR_VENETIAN_BLINDS_HINT), 16},
    {sipName_AUI_NB_BOTTOM, static_cast<int>(::wxAUI_NB_BOTTOM), 19},
    {sipName_AUI_NB_CLOSE_BUTTON, static_cast<int>(::wxAUI_NB_CLOSE_BUTTON), 19},
    {sipName_AUI_NB_CLOSE_ON_ACTIVE_TAB, static_cast<int>(::wxAUI_NB_CLOSE_ON_ACTIVE_TAB), 19},
    {sipName_AUI_NB_CLOSE_ON_ALL_TABS, static_cast<int>(::wxAUI_NB_CLOSE_ON_ALL_TABS), 19},
    {sipName_AUI_NB_DEFAULT_STYLE, static_cast<int>(::wxAUI_NB_DEFAULT_STYLE), 19},
    {sipName_AUI_NB_LEFT, static_cast<int>(::wxAUI_NB_LEFT), 19},
    {sipName_AUI_NB_MIDDLE_CLICK_CLOSE, static_cast<int>(::wxAUI_NB_MIDDLE_CLICK_CLOSE), 19},
    {sipName_AUI_NB_RIGHT, static_cast<int>(::wxAUI_NB_RIGHT), 19},
    {sipName_AUI_NB_SCROLL_BUTTONS, static_cast<int>(::wxAUI_NB_SCROLL_BUTTONS), 19},
    {sipName_AUI_NB_TAB_EXTERNAL_MOVE, static_cast<int>(::wxAUI_NB_TAB_EXTERNAL_MOVE), 19},
    {sipName_AUI_NB_TAB_FIXED_WIDTH, static_cast<int>(::wxAUI_NB_TAB_FIXED_WIDTH), 19},
    {sipName_AUI_NB_TAB_MOVE, static_cast<int>(::wxAUI_NB_TAB_MOVE), 19},
    {sipName_AUI_NB_TAB_SPLIT, static_cast<int>(::wxAUI_NB_TAB_SPLIT), 19},
    {sipName_AUI_NB_TOP, static_cast<int>(::wxAUI_NB_TOP), 19},
    {sipName_AUI_NB_WINDOWLIST_BUTTON, static_cast<int>(::wxAUI_NB_WINDOWLIST_BUTTON), 19},
    {sipName_AUI_ORIENTATION_MASK, static_cast<int>(::wxAUI_ORIENTATION_MASK), 42},
    {sipName_AUI_TBART_GRIPPER_SIZE, static_cast<int>(::wxAUI_TBART_GRIPPER_SIZE), 38},
    {sipName_AUI_TBART_OVERFLOW_SIZE, static_cast<int>(::wxAUI_TBART_OVERFLOW_SIZE), 38},
    {sipName_AUI_TBART_SEPARATOR_SIZE, static_cast<int>(::wxAUI_TBART_SEPARATOR_SIZE), 38},
    {sipName_AUI_TBTOOL_TEXT_BOTTOM, static_cast<int>(::wxAUI_TBTOOL_TEXT_BOTTOM), 43},
    {sipName_AUI_TBTOOL_TEXT_LEFT, static_cast<int>(::wxAUI_TBTOOL_TEXT_LEFT), 43},
    {sipName_AUI_TBTOOL_TEXT_RIGHT, static_cast<int>(::wxAUI_TBTOOL_TEXT_RIGHT), 43},
    {sipName_AUI_TBTOOL_TEXT_TOP, static_cast<int>(::wxAUI_TBTOOL_TEXT_TOP), 43},
    {sipName_AUI_TB_DEFAULT_STYLE, static_cast<int>(::wxAUI_TB_DEFAULT_STYLE), 42},
    {sipName_AUI_TB_GRIPPER, static_cast<int>(::wxAUI_TB_GRIPPER), 42},
    {sipName_AUI_TB_HORIZONTAL, static_cast<int>(::wxAUI_TB_HORIZONTAL), 42},
    {sipName_AUI_TB_HORZ_LAYOUT, static_cast<int>(::wxAUI_TB_HORZ_LAYOUT), 42},
    {sipName_AUI_TB_HORZ_TEXT, static_cast<int>(::wxAUI_TB_HORZ_TEXT), 42},
    {sipName_AUI_TB_NO_AUTORESIZE, static_cast<int>(::wxAUI_TB_NO_AUTORESIZE), 42},
    {sipName_AUI_TB_NO_TOOLTIPS, static_cast<int>(::wxAUI_TB_NO_TOOLTIPS), 42},
    {sipName_AUI_TB_OVERFLOW, static_cast<int>(::wxAUI_TB_OVERFLOW), 42},
    {sipName_AUI_TB_PLAIN_BACKGROUND, static_cast<int>(::wxAUI_TB_PLAIN_BACKGROUND), 42},
    {sipName_AUI_TB_TEXT, static_cast<int>(::wxAUI_TB_TEXT), 42},
    {sipName_AUI_TB_VERTICAL, static_cast<int>(::wxAUI_TB_VERTICAL), 42},
};
...
sipTypeDef *sipExportedTypes__aui[] = {
    ...
    &sipTypeDef__aui_wxAuiPaneButton.ctd_base,
    &sipTypeDef__aui_wxAuiPaneButtonArray.ctd_base,
...
static sipImportedModuleDef importsTable[] = {
    {"wx._core", sipImportedTypes__aui__core, NULL, NULL},
    {NULL, NULL, NULL, NULL}
};
