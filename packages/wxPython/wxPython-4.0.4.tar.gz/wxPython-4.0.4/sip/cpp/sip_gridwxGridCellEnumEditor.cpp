...
sipwxGridCellEnumEditor::sipwxGridCellEnumEditor(const  ::wxString& choices):  ::wxGridCellEnumEditor(choices), sipPySelf(0)
{
...
void sipwxGridCellEnumEditor::PaintBackground( ::wxDC& dc,const  ::wxRect& rectCell, ::wxGridCellAttr& attr)
{
    sip_gilstate_t sipGILState;
    PyObject *sipMeth;
...
static PyObject *meth_wxGridCellEnumEditor_BeginEdit(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BiiJ8", &sipSelf, sipType_wxGridCellEnumEditor, &sipCpp, &row, &col, sipType_wxGrid, &grid))
        {
            PyErr_Clear();
...
static PyObject *meth_wxGridCellEnumEditor_Create(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8iJ8", &sipSelf, sipType_wxGridCellEnumEditor, &sipCpp, sipType_wxWindow, &parent, &id, sipType_wxEvtHandler, &evtHandler))
        {
            PyErr_Clear();
...
static PyObject *meth_wxGridCellEnumEditor_EndEdit(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BiiJ8J1", &sipSelf, sipType_wxGridCellEnumEditor, &sipCpp, &row, &col, sipType_wxGrid, &grid, sipType_wxString,&oldval, &oldvalState))
        {
            PyObject * sipRes = 0;
            int sipIsErr = 0;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GridCellEnumEditor, sipName_EndEdit, NULL);
...
static void dealloc_wxGridCellEnumEditor(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxGridCellEnumEditor *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxGridCellEnumEditor *sipCpp = 0;
...
static sipEncodedTypeDef supers_wxGridCellEnumEditor[] = {{11, 255, 1}};


static PyMethodDef methods_wxGridCellEnumEditor[] = {
    {SIP_MLNAME_CAST(sipName_ApplyEdit), (PyCFunction)meth_wxGridCellEnumEditor_ApplyEdit, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridCellEnumEditor_ApplyEdit)},
    {SIP_MLNAME_CAST(sipName_BeginEdit), (PyCFunction)meth_wxGridCellEnumEditor_BeginEdit, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridCellEnumEditor_BeginEdit)},
    {SIP_MLNAME_CAST(sipName_Clone), meth_wxGridCellEnumEditor_Clone, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGridCellEnumEditor_Clone)},
    {SIP_MLNAME_CAST(sipName_Create), (PyCFunction)meth_wxGridCellEnumEditor_Create, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridCellEnumEditor_Create)},
    {SIP_MLNAME_CAST(sipName_EndEdit), (PyCFunction)meth_wxGridCellEnumEditor_EndEdit, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridCellEnumEditor_EndEdit)},
