...
static PyObject *meth_wxImageArray_append(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxImageArray, &sipCpp, sipType_wxImage, &obj))
        {
        sipCpp->Add(*obj);
...
static int slot_wxImageArray___contains__(PyObject *sipSelf,PyObject *sipArg)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_ImageArray, sipName___contains__, NULL);
...
static PyObject *slot_wxImageArray___getitem__(PyObject *sipSelf,PyObject *sipArg)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_ImageArray, sipName___getitem__, NULL);
...
static void *init_type_wxImageArray(sipSimpleWrapper *, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxImageArray, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxImageArray[] = {
    {SIP_MLNAME_CAST(sipName_append), (PyCFunction)meth_wxImageArray_append, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxImageArray_append)},
    {SIP_MLNAME_CAST(sipName_index), (PyCFunction)meth_wxImageArray_index, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxImageArray_index)}
};
