...
static PyObject *meth_wxPointList_index(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ0", &sipSelf, sipType_wxPointList, &sipCpp, sipType_wxPoint, &obj, &objState))
        {
            int sipRes = 0;
...
static PyObject *slot_wxPointList___iter__(PyObject *sipSelf)
{
...

    {
        ...
        sipRes =  new wxPointList_iterator(sipCpp->GetFirst());
            ...
            return sipConvertFromNewType(sipRes,sipType_wxPointList_iterator,NULL);
        }
    }
...
static int slot_wxPointList___contains__(PyObject *sipSelf,PyObject *sipArg)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PointList, sipName___contains__, NULL);
...
static PyObject *slot_wxPointList___getitem__(PyObject *sipSelf,PyObject *sipArg)
{
...

    {
        ...
        if (index < sipCpp->size() && (0 <= index)) {
            ...
            if (sipError == sipErrorNone)
            {
            return sipConvertFromType(sipRes,sipType_wxPoint,NULL);
            }
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PointList, sipName___getitem__, NULL);
...
extern "C" {static void *array_wxPointList(SIP_SSIZE_T);}
static void *array_wxPointList(SIP_SSIZE_T sipNrElem)
{
...
static void *init_type_wxPointList(sipSimpleWrapper *, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J1", sipType_wxPointList, &a0, &a0State))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxPointList[] = {
    {SIP_MLNAME_CAST(sipName_index), (PyCFunction)meth_wxPointList_index, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPointList_index)}
};
