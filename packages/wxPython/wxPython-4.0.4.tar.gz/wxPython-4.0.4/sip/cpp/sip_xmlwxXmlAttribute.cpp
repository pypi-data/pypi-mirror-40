...
sipwxXmlAttribute::sipwxXmlAttribute():  ::wxXmlAttribute(), sipPySelf(0)
{
}

sipwxXmlAttribute::sipwxXmlAttribute(const  ::wxString& name,const  ::wxString& value, ::wxXmlAttribute*next):  ::wxXmlAttribute(name,value,next), sipPySelf(0)
{
}

sipwxXmlAttribute::sipwxXmlAttribute(const  ::wxXmlAttribute& a0):  ::wxXmlAttribute(a0), sipPySelf(0)
{
}
...
static PyObject *meth_wxXmlAttribute_GetName(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_XmlAttribute, sipName_GetName, NULL);
...
static PyObject *meth_wxXmlAttribute_GetNext(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_XmlAttribute, sipName_GetNext, NULL);
...
static PyObject *meth_wxXmlAttribute_GetValue(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_XmlAttribute, sipName_GetValue, NULL);
...
static PyObject *meth_wxXmlAttribute_SetName(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxXmlAttribute, &sipCpp, sipType_wxString,&name, &nameState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_XmlAttribute, sipName_SetName, NULL);
...
static PyObject *meth_wxXmlAttribute_SetNext(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8", &sipSelf, sipType_wxXmlAttribute, &sipCpp, sipType_wxXmlAttribute, &next))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_XmlAttribute, sipName_SetNext, NULL);
...
static PyObject *meth_wxXmlAttribute_SetValue(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxXmlAttribute, &sipCpp, sipType_wxString,&value, &valueState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_XmlAttribute, sipName_SetValue, NULL);
...
extern "C" {static void *array_wxXmlAttribute(SIP_SSIZE_T);}
static void *array_wxXmlAttribute(SIP_SSIZE_T sipNrElem)
{
...
static void dealloc_wxXmlAttribute(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxXmlAttribute *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static void *init_type_wxXmlAttribute(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxXmlAttribute, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxXmlAttribute[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SetName), (PyCFunction)meth_wxXmlAttribute_SetName, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxXmlAttribute_SetName)},
    {SIP_MLNAME_CAST(sipName_SetNext), (PyCFunction)meth_wxXmlAttribute_SetNext, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxXmlAttribute_SetNext)},
    {SIP_MLNAME_CAST(sipName_SetValue), (PyCFunction)meth_wxXmlAttribute_SetValue, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxXmlAttribute_SetValue)}
};

sipVariableDef variables_wxXmlAttribute[] = {
    {PropertyVariable, sipName_Value, &methods_wxXmlAttribute[2], &methods_wxXmlAttribute[5], NULL, NULL},
    {PropertyVariable, sipName_Next, &methods_wxXmlAttribute[1], &methods_wxXmlAttribute[4], NULL, NULL},
    {PropertyVariable, sipName_Name, &methods_wxXmlAttribute[0], &methods_wxXmlAttribute[3], NULL, NULL},
};
