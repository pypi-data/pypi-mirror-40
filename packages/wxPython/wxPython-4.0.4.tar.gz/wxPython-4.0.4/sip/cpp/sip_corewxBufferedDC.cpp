...
sipwxBufferedDC::sipwxBufferedDC():  ::wxBufferedDC(), sipPySelf(0)
{
}

sipwxBufferedDC::sipwxBufferedDC( ::wxDC*dc,const  ::wxSize& area,int style):  ::wxBufferedDC(dc,area,style), sipPySelf(0)
{
}

sipwxBufferedDC::sipwxBufferedDC( ::wxDC*dc, ::wxBitmap& buffer,int style):  ::wxBufferedDC(dc,buffer,style), sipPySelf(0)
{
}
...
static PyObject *meth_wxBufferedDC_Init(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "B@J8J1|i", &sipSelf, sipType_wxBufferedDC, &sipCpp, &dcKeep, sipType_wxDC, &dc, sipType_wxSize, &area, &areaState, &style))
        {
            PyErr_Clear();
            ...
            sipKeepReference(sipSelf, -4, dcKeep);
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "B@J8|@J9i", &sipSelf, sipType_wxBufferedDC, &sipCpp, &dcKeep, sipType_wxDC, &dc, &bufferKeep, sipType_wxBitmap, &buffer, &style))
        {
            PyErr_Clear();
            ...
            sipKeepReference(sipSelf, -6, bufferKeep);
    ...
    sipNoMethod(sipParseErr, sipName_BufferedDC, sipName_Init, NULL);
...
static PyObject *meth_wxBufferedDC_UnMask(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_BufferedDC, sipName_UnMask, NULL);
...
static PyObject *meth_wxBufferedDC_SetStyle(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bi", &sipSelf, sipType_wxBufferedDC, &sipCpp, &style))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_BufferedDC, sipName_SetStyle, NULL);
...
static PyObject *meth_wxBufferedDC_GetStyle(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_BufferedDC, sipName_GetStyle, NULL);
...
static void dealloc_wxBufferedDC(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxBufferedDC *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static void *init_type_wxBufferedDC(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (!wxPyCheckForApp()) return NULL;
            ...
            sipKeepReference((PyObject *)sipSelf, -1, dcKeep);
            sipReleaseType(const_cast< ::wxSize *>(area),sipType_wxSize,areaState);
...

    {
        ...
        if (!wxPyCheckForApp()) return NULL;
            ...
            sipKeepReference((PyObject *)sipSelf, -3, bufferKeep);
...
static sipEncodedTypeDef supers_wxBufferedDC[] = {{320, 255, 1}};
...
static PyMethodDef methods_wxBufferedDC[] = {
    ...
    {SIP_MLNAME_CAST(sipName_Init), (PyCFunction)meth_wxBufferedDC_Init, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxBufferedDC_Init)},
    {SIP_MLNAME_CAST(sipName_SetStyle), (PyCFunction)meth_wxBufferedDC_SetStyle, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxBufferedDC_SetStyle)},
...
sipVariableDef variables_wxBufferedDC[] = {
    {PropertyVariable, sipName_Style, &methods_wxBufferedDC[0], &methods_wxBufferedDC[2], NULL, NULL},
};
