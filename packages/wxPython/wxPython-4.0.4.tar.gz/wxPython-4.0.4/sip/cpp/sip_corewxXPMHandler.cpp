...
sipwxXPMHandler::sipwxXPMHandler():  ::wxXPMHandler(), sipPySelf(0)
{
...
int sipwxXPMHandler::GetImageCount( ::wxInputStream& stream)
{
    ...
    if (!sipMeth)
        return  ::wxXPMHandler::GetImageCount(stream);
...
static PyObject *meth_wxXPMHandler_DoGetImageCount(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxXPMHandler, &sipCpp, sipType_wxInputStream, &stream, &streamState))
        {
            int sipRes;
    ...
    sipNoMethod(sipParseErr, sipName_XPMHandler, sipName_DoGetImageCount, NULL);
...
static PyObject *meth_wxXPMHandler_LoadFile(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8J1|bi", &sipSelf, sipType_wxXPMHandler, &sipCpp, sipType_wxImage, &image, sipType_wxInputStream, &stream, &streamState, &verbose, &index))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_XPMHandler, sipName_LoadFile, NULL);
...
static PyObject *meth_wxXPMHandler_SaveFile(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8J1|b", &sipSelf, sipType_wxXPMHandler, &sipCpp, sipType_wxImage, &image, sipType_wxOutputStream, &stream, &streamState, &verbose))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_XPMHandler, sipName_SaveFile, NULL);
...
static PyObject *meth_wxXPMHandler_DoCanRead(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_XPMHandler, sipName_DoCanRead, NULL);
...
static void dealloc_wxXPMHandler(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxXPMHandler *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static sipEncodedTypeDef supers_wxXPMHandler[] = {{256, 255, 1}};


static PyMethodDef methods_wxXPMHandler[] = {
    {SIP_MLNAME_CAST(sipName_DoCanRead), (PyCFunction)meth_wxXPMHandler_DoCanRead, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxXPMHandler_DoCanRead)},
    {SIP_MLNAME_CAST(sipName_DoGetImageCount), (PyCFunction)meth_wxXPMHandler_DoGetImageCount, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_LoadFile), (PyCFunction)meth_wxXPMHandler_LoadFile, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxXPMHandler_LoadFile)},
    {SIP_MLNAME_CAST(sipName_SaveFile), (PyCFunction)meth_wxXPMHandler_SaveFile, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxXPMHandler_SaveFile)}
};
