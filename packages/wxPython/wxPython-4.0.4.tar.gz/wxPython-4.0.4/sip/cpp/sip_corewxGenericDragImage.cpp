...
bool sipwxGenericDragImage::UpdateBackingFromWindow( ::wxDC& windowDC, ::wxMemoryDC& destDC,const  ::wxRect& sourceRect,const  ::wxRect& destRect) const
{
    ...
    extern bool sipVH__core_201(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&, ::wxMemoryDC&,const  ::wxRect&,const  ::wxRect&);

    return sipVH__core_201(sipGILState, 0, sipPySelf, sipMeth, windowDC, destDC, sourceRect, destRect);
}
 ...
 ::wxRect sipwxGenericDragImage::GetImageRect(const  ::wxPoint& pos) const
{
    ...
    extern  ::wxRect sipVH__core_200(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxPoint&);

    return sipVH__core_200(sipGILState, 0, sipPySelf, sipMeth, pos);
}
...
bool sipwxGenericDragImage::DoDrawImage( ::wxDC& dc,const  ::wxPoint& pos) const
{
    ...
    extern bool sipVH__core_199(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&,const  ::wxPoint&);

    return sipVH__core_199(sipGILState, 0, sipPySelf, sipMeth, dc, pos);
}
...
static sipEncodedTypeDef supers_wxGenericDragImage[] = {{358, 255, 1}};
