...
sipwxHtmlPrintout::sipwxHtmlPrintout(const  ::wxString& title):  ::wxHtmlPrintout(title), sipPySelf(0)
{
 ...
 ::wxString sipwxHtmlPrintout::GetTitle() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[0]),sipPySelf,NULL,sipName_GetTitle);
...
bool sipwxHtmlPrintout::IsPreview() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[1]),sipPySelf,NULL,sipName_IsPreview);
...
void sipwxHtmlPrintout::OnBeginPrinting()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[2],sipPySelf,NULL,sipName_OnBeginPrinting);
...
void sipwxHtmlPrintout::OnEndPrinting()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[4],sipPySelf,NULL,sipName_OnEndPrinting);
...
static PyObject *meth_wxHtmlPrintout_SetFonts(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1J1J1", &sipSelf, sipType_wxHtmlPrintout, &sipCpp, sipType_wxString,&normal_face, &normal_faceState, sipType_wxString,&fixed_face, &fixed_faceState, sipType_wxArrayInt,&sizes, &sizesState))
        {
            int sipIsErr = 0;
    ...
    sipNoMethod(sipParseErr, sipName_HtmlPrintout, sipName_SetFonts, NULL);
...
static PyObject *meth_wxHtmlPrintout_SetFooter(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1|i", &sipSelf, sipType_wxHtmlPrintout, &sipCpp, sipType_wxString,&footer, &footerState, &pg))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HtmlPrintout, sipName_SetFooter, NULL);
...
static PyObject *meth_wxHtmlPrintout_SetHeader(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1|i", &sipSelf, sipType_wxHtmlPrintout, &sipCpp, sipType_wxString,&header, &headerState, &pg))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HtmlPrintout, sipName_SetHeader, NULL);
...
static PyObject *meth_wxHtmlPrintout_SetHtmlFile(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxHtmlPrintout, &sipCpp, sipType_wxString,&htmlfile, &htmlfileState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HtmlPrintout, sipName_SetHtmlFile, NULL);
...
static PyObject *meth_wxHtmlPrintout_SetHtmlText(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1|J1b", &sipSelf, sipType_wxHtmlPrintout, &sipCpp, sipType_wxString,&html, &htmlState, sipType_wxString,&basepath, &basepathState, &isdir))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HtmlPrintout, sipName_SetHtmlText, NULL);
...
static PyObject *meth_wxHtmlPrintout_SetMargins(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "B|fffff", &sipSelf, sipType_wxHtmlPrintout, &sipCpp, &top, &bottom, &left, &right, &spaces))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HtmlPrintout, sipName_SetMargins, NULL);
...
static PyObject *meth_wxHtmlPrintout_AddFilter(PyObject *, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "J8", sipType_wxHtmlFilter, &filter))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HtmlPrintout, sipName_AddFilter, NULL);
...
static PyObject *meth_wxHtmlPrintout_OnPrintPage(PyObject *, PyObject *)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(NULL, sipName_HtmlPrintout, sipName_OnPrintPage, NULL);
...
static PyObject *meth_wxHtmlPrintout_HasPage(PyObject *, PyObject *)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(NULL, sipName_HtmlPrintout, sipName_HasPage, NULL);
...
static PyObject *meth_wxHtmlPrintout_GetPageInfo(PyObject *, PyObject *)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(NULL, sipName_HtmlPrintout, sipName_GetPageInfo, NULL);
...
static PyObject *meth_wxHtmlPrintout_OnBeginDocument(PyObject *, PyObject *)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(NULL, sipName_HtmlPrintout, sipName_OnBeginDocument, NULL);
...
static PyObject *meth_wxHtmlPrintout_OnPreparePrinting(PyObject *, PyObject *)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(NULL, sipName_HtmlPrintout, sipName_OnPreparePrinting, NULL);
...
static void dealloc_wxHtmlPrintout(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxHtmlPrintout *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static PyMethodDef methods_wxHtmlPrintout[] = {
    {SIP_MLNAME_CAST(sipName_AddFilter), (PyCFunction)meth_wxHtmlPrintout_AddFilter, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHtmlPrintout_AddFilter)},
    {SIP_MLNAME_CAST(sipName_GetPageInfo), meth_wxHtmlPrintout_GetPageInfo, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_HasPage), meth_wxHtmlPrintout_HasPage, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_OnBeginDocument), meth_wxHtmlPrintout_OnBeginDocument, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_OnPreparePrinting), meth_wxHtmlPrintout_OnPreparePrinting, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_OnPrintPage), meth_wxHtmlPrintout_OnPrintPage, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_SetFonts), (PyCFunction)meth_wxHtmlPrintout_SetFonts, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHtmlPrintout_SetFonts)},
    {SIP_MLNAME_CAST(sipName_SetFooter), (PyCFunction)meth_wxHtmlPrintout_SetFooter, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHtmlPrintout_SetFooter)},
    {SIP_MLNAME_CAST(sipName_SetHeader), (PyCFunction)meth_wxHtmlPrintout_SetHeader, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHtmlPrintout_SetHeader)},
    {SIP_MLNAME_CAST(sipName_SetHtmlFile), (PyCFunction)meth_wxHtmlPrintout_SetHtmlFile, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHtmlPrintout_SetHtmlFile)},
    {SIP_MLNAME_CAST(sipName_SetHtmlText), (PyCFunction)meth_wxHtmlPrintout_SetHtmlText, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHtmlPrintout_SetHtmlText)},
    {SIP_MLNAME_CAST(sipName_SetMargins), (PyCFunction)meth_wxHtmlPrintout_SetMargins, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHtmlPrintout_SetMargins)}
};
