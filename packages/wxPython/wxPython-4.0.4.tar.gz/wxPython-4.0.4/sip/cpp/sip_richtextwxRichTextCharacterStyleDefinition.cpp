...
sipwxRichTextCharacterStyleDefinition::sipwxRichTextCharacterStyleDefinition(const  ::wxString& name):  ::wxRichTextCharacterStyleDefinition(name), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxRichTextCharacterStyleDefinition::sipwxRichTextCharacterStyleDefinition(const  ::wxRichTextCharacterStyleDefinition& a0):  ::wxRichTextCharacterStyleDefinition(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
extern "C" {static void *array_wxRichTextCharacterStyleDefinition(SIP_SSIZE_T);}
static void *array_wxRichTextCharacterStyleDefinition(SIP_SSIZE_T sipNrElem)
{
...
static void dealloc_wxRichTextCharacterStyleDefinition(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxRichTextCharacterStyleDefinition *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxRichTextCharacterStyleDefinition *sipCpp = 0;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxRichTextCharacterStyleDefinition, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
