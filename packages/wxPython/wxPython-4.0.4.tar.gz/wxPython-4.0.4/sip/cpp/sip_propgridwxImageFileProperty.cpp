...
sipwxImageFileProperty::sipwxImageFileProperty(const  ::wxString& label,const  ::wxString& name,const  ::wxString& value):  ::wxImageFileProperty(label,name,value), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxImageFileProperty::sipwxImageFileProperty(const  ::wxImageFileProperty& a0):  ::wxImageFileProperty(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
static PyObject *meth_wxImageFileProperty_OnSetValue(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_ImageFileProperty, sipName_OnSetValue, NULL);
...
static PyObject *meth_wxImageFileProperty_OnMeasureImage(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bi", &sipSelf, sipType_wxImageFileProperty, &sipCpp, &item))
        {
             ::wxSize*sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_ImageFileProperty, sipName_OnMeasureImage, NULL);
...
static PyObject *meth_wxImageFileProperty_OnCustomPaint(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9J1J9", &sipSelf, sipType_wxImageFileProperty, &sipCpp, sipType_wxDC, &dc, sipType_wxRect, &rect, &rectState, sipType_wxPGPaintData, &paintdata))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_ImageFileProperty, sipName_OnCustomPaint, NULL);
...
static void dealloc_wxImageFileProperty(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxImageFileProperty *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxImageFileProperty *sipCpp = 0;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxImageFileProperty, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxImageFileProperty[] = {{11, 255, 1}};


static PyMethodDef methods_wxImageFileProperty[] = {
    {SIP_MLNAME_CAST(sipName_OnCustomPaint), (PyCFunction)meth_wxImageFileProperty_OnCustomPaint, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxImageFileProperty_OnCustomPaint)},
    {SIP_MLNAME_CAST(sipName_OnMeasureImage), (PyCFunction)meth_wxImageFileProperty_OnMeasureImage, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxImageFileProperty_OnMeasureImage)},
