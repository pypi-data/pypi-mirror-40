...
sipwxPGLongStringDialogAdapter::sipwxPGLongStringDialogAdapter():  ::wxPGLongStringDialogAdapter(), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxPGLongStringDialogAdapter::sipwxPGLongStringDialogAdapter(const  ::wxPGLongStringDialogAdapter& a0):  ::wxPGLongStringDialogAdapter(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
static PyObject *meth_wxPGLongStringDialogAdapter_DoShowDialog(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8J8", &sipSelf, sipType_wxPGLongStringDialogAdapter, &sipCpp, sipType_wxPropertyGrid, &propGrid, sipType_wxPGProperty, &property))
        {
            bool sipRes;
    ...
    sipNoMethod(sipParseErr, sipName_PGLongStringDialogAdapter, sipName_DoShowDialog, NULL);
...
static void dealloc_wxPGLongStringDialogAdapter(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxPGLongStringDialogAdapter *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxPGLongStringDialogAdapter *sipCpp = 0;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxPGLongStringDialogAdapter, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxPGLongStringDialogAdapter[] = {
    {SIP_MLNAME_CAST(sipName_DoShowDialog), (PyCFunction)meth_wxPGLongStringDialogAdapter_DoShowDialog, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPGLongStringDialogAdapter_DoShowDialog)}
};
