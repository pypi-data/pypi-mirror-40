...
sipwxLogInterposerTemp::sipwxLogInterposerTemp():  ::wxLogInterposerTemp(), sipPySelf(0)
{
...
static PyObject *meth_wxLogInterposerTemp_DoLogRecord(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BmJ1J9", &sipSelf, sipType_wxLogInterposerTemp, &sipCpp, &level, sipType_wxString,&msg, &msgState, sipType_wxLogRecordInfo, &info))
        {
            PyErr_Clear();
    ...
    sipNoMethod(sipParseErr, sipName_LogInterposerTemp, sipName_DoLogRecord, NULL);
...
static PyObject *meth_wxLogInterposerTemp_DoLogTextAtLevel(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BmJ1", &sipSelf, sipType_wxLogInterposerTemp, &sipCpp, &level, sipType_wxString,&msg, &msgState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_LogInterposerTemp, sipName_DoLogTextAtLevel, NULL);
...
static PyObject *meth_wxLogInterposerTemp_DoLogText(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxLogInterposerTemp, &sipCpp, sipType_wxString,&msg, &msgState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_LogInterposerTemp, sipName_DoLogText, NULL);
...
static void dealloc_wxLogInterposerTemp(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxLogInterposerTemp *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxLogInterposerTemp *sipCpp = 0;
...
static sipEncodedTypeDef supers_wxLogInterposerTemp[] = {{300, 255, 1}};


static PyMethodDef methods_wxLogInterposerTemp[] = {
    {SIP_MLNAME_CAST(sipName_DoLogRecord), (PyCFunction)meth_wxLogInterposerTemp_DoLogRecord, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_DoLogText), (PyCFunction)meth_wxLogInterposerTemp_DoLogText, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_DoLogTextAtLevel), (PyCFunction)meth_wxLogInterposerTemp_DoLogTextAtLevel, METH_VARARGS|METH_KEYWORDS, NULL}
};
