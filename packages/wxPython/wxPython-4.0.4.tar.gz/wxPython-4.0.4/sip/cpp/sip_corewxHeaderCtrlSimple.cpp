...
public:
     ...
     */
protected:
    int GetBestFittingWidth(uint) const;
...
sipwxHeaderCtrlSimple::sipwxHeaderCtrlSimple():  ::wxHeaderCtrlSimple(), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxHeaderCtrlSimple::sipwxHeaderCtrlSimple( ::wxWindow*parent, ::wxWindowID winid,const  ::wxPoint& pos,const  ::wxSize& size,long style,const  ::wxString& name):  ::wxHeaderCtrlSimple(parent,winid,pos,size,style,name), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
int sipwxHeaderCtrlSimple::GetBestFittingWidth(uint idx) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[0]),sipPySelf,NULL,sipName_GetBestFittingWidth);

    if (!sipMeth)
        return  ::wxHeaderCtrlSimple::GetBestFittingWidth(idx);

    extern int sipVH__core_161(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, uint);

    return sipVH__core_161(sipGILState, 0, sipPySelf, sipMeth, idx);
}
...
const  ::wxHeaderColumn& sipwxHeaderCtrlSimple::GetColumn(uint idx) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[40]),sipPySelf,NULL,sipName_GetColumn);
...
void sipwxHeaderCtrlSimple::UpdateColumnVisibility(uint idx,bool show)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[41],sipPySelf,NULL,sipName_UpdateColumnVisibility);
...
void sipwxHeaderCtrlSimple::UpdateColumnsOrder(const  ::wxArrayInt& order)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[42],sipPySelf,NULL,sipName_UpdateColumnsOrder);
...
bool sipwxHeaderCtrlSimple::UpdateColumnWidthToFit(uint idx,int widthTitle)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[43],sipPySelf,NULL,sipName_UpdateColumnWidthToFit);
...
void sipwxHeaderCtrlSimple::OnColumnCountChanging(uint count)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[44],sipPySelf,NULL,sipName_OnColumnCountChanging);
...
extern "C" {static PyObject *meth_wxHeaderCtrlSimple_SendDestroyEvent(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxHeaderCtrlSimple_SendDestroyEvent(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, NULL, NULL, "B", &sipSelf, sipType_wxHeaderCtrlSimple, &sipCpp))
        {
            PyErr_Clear();
    ...
    sipNoMethod(sipParseErr, sipName_HeaderCtrlSimple, sipName_SendDestroyEvent, NULL);
...
static PyObject *meth_wxHeaderCtrlSimple_InsertColumn(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9u", &sipSelf, sipType_wxHeaderCtrlSimple, &sipCpp, sipType_wxHeaderColumnSimple, &col, &idx))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HeaderCtrlSimple, sipName_InsertColumn, NULL);
...
static PyObject *meth_wxHeaderCtrlSimple_AppendColumn(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxHeaderCtrlSimple, &sipCpp, sipType_wxHeaderColumnSimple, &col))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HeaderCtrlSimple, sipName_AppendColumn, NULL);
...
static PyObject *meth_wxHeaderCtrlSimple_DeleteColumn(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bu", &sipSelf, sipType_wxHeaderCtrlSimple, &sipCpp, &idx))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HeaderCtrlSimple, sipName_DeleteColumn, NULL);
...
static PyObject *meth_wxHeaderCtrlSimple_ShowColumn(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bu|b", &sipSelf, sipType_wxHeaderCtrlSimple, &sipCpp, &idx, &show))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HeaderCtrlSimple, sipName_ShowColumn, NULL);
...
static PyObject *meth_wxHeaderCtrlSimple_HideColumn(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HeaderCtrlSimple, sipName_HideColumn, NULL);
...
static PyObject *meth_wxHeaderCtrlSimple_ShowSortIndicator(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bu|b", &sipSelf, sipType_wxHeaderCtrlSimple, &sipCpp, &idx, &sortOrder))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HeaderCtrlSimple, sipName_ShowSortIndicator, NULL);
...
static PyObject *meth_wxHeaderCtrlSimple_RemoveSortIndicator(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HeaderCtrlSimple, sipName_RemoveSortIndicator, NULL);
...
static PyObject *meth_wxHeaderCtrlSimple_AddChild(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8", &sipSelf, sipType_wxHeaderCtrlSimple, &sipCpp, sipType_wxWindowBase, &child))
        {
            PyErr_Clear();
...
static PyObject *meth_wxHeaderCtrlSimple_InformFirstDirection(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Biii", &sipSelf, sipType_wxHeaderCtrlSimple, &sipCpp, &direction, &size, &availableOtherDir))
        {
            bool sipRes;
...
static PyObject *meth_wxHeaderCtrlSimple_SetCanFocus(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bb", &sipSelf, sipType_wxHeaderCtrlSimple, &sipCpp, &canFocus))
        {
            PyErr_Clear();
...
static PyObject *meth_wxHeaderCtrlSimple_SetValidator(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxHeaderCtrlSimple, &sipCpp, sipType_wxValidator, &validator))
        {
            PyErr_Clear();
...
static PyObject *meth_wxHeaderCtrlSimple_ProcessEvent(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxHeaderCtrlSimple, &sipCpp, sipType_wxEvent, &event))
        {
            bool sipRes;
...
static PyObject *meth_wxHeaderCtrlSimple_DoEnable(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bb", &sipSelf, sipType_wxHeaderCtrlSimple, &sipCpp, &enable))
        {
            PyErr_Clear();
...
extern "C" {static PyObject *meth_wxHeaderCtrlSimple_DoGetBestSize(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxHeaderCtrlSimple_DoGetBestSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxHeaderCtrlSimple_DoGetBestClientSize(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxHeaderCtrlSimple_DoGetBestClientSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
static PyObject *meth_wxHeaderCtrlSimple_DoSetSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Biiiii", &sipSelf, sipType_wxHeaderCtrlSimple, &sipCpp, &x, &y, &width, &height, &sizeFlags))
        {
            PyErr_Clear();
...
static PyObject *meth_wxHeaderCtrlSimple_DoSetClientSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bii", &sipSelf, sipType_wxHeaderCtrlSimple, &sipCpp, &width, &height))
        {
            PyErr_Clear();
...
static PyObject *meth_wxHeaderCtrlSimple_DoSetSizeHints(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Biiiiii", &sipSelf, sipType_wxHeaderCtrlSimple, &sipCpp, &minW, &minH, &maxW, &maxH, &incW, &incH))
        {
            PyErr_Clear();
...
extern "C" {static PyObject *meth_wxHeaderCtrlSimple_DoGetBorderSize(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxHeaderCtrlSimple_DoGetBorderSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
static PyObject *meth_wxHeaderCtrlSimple_DoMoveWindow(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Biiii", &sipSelf, sipType_wxHeaderCtrlSimple, &sipCpp, &x, &y, &width, &height))
        {
            PyErr_Clear();
...
static PyObject *meth_wxHeaderCtrlSimple_DoSetWindowVariant(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BE", &sipSelf, sipType_wxHeaderCtrlSimple, &sipCpp, sipType_wxWindowVariant, &variant))
        {
            PyErr_Clear();
...
extern "C" {static PyObject *meth_wxHeaderCtrlSimple_GetDefaultBorder(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxHeaderCtrlSimple_GetDefaultBorder(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxHeaderCtrlSimple_GetDefaultBorderForControl(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxHeaderCtrlSimple_GetDefaultBorderForControl(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxHeaderCtrlSimple_DoFreeze(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxHeaderCtrlSimple_DoFreeze(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxHeaderCtrlSimple_DoThaw(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxHeaderCtrlSimple_DoThaw(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxHeaderCtrlSimple_HasTransparentBackground(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxHeaderCtrlSimple_HasTransparentBackground(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
PyDoc_STRVAR(doc_wxHeaderCtrlSimple_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant = wxWINDOW_VARIANT_NORMAL) -> VisualAttributes");
...
static PyObject *meth_wxHeaderCtrlSimple_GetClassDefaultAttributes(PyObject *, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HeaderCtrlSimple, sipName_GetClassDefaultAttributes, doc_wxHeaderCtrlSimple_GetClassDefaultAttributes);
...
static PyObject *meth_wxHeaderCtrlSimple_GetBestFittingWidth(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HeaderCtrlSimple, sipName_GetBestFittingWidth, NULL);
...
static PyObject *meth_wxHeaderCtrlSimple_UpdateColumnVisibility(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bub", &sipSelf, sipType_wxHeaderCtrlSimple, &sipCpp, &idx, &show))
        {
            PyErr_Clear();
...
static PyObject *meth_wxHeaderCtrlSimple_UpdateColumnsOrder(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxHeaderCtrlSimple, &sipCpp, sipType_wxArrayInt,&order, &orderState))
        {
            PyErr_Clear();
...
static PyObject *meth_wxHeaderCtrlSimple_UpdateColumnWidthToFit(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bui", &sipSelf, sipType_wxHeaderCtrlSimple, &sipCpp, &idx, &widthTitle))
        {
            bool sipRes;
...
static PyObject *meth_wxHeaderCtrlSimple_OnColumnCountChanging(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bu", &sipSelf, sipType_wxHeaderCtrlSimple, &sipCpp, &count))
        {
            PyErr_Clear();
...
static void dealloc_wxHeaderCtrlSimple(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxHeaderCtrlSimple *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxHeaderCtrlSimple *sipCpp = 0;
...
static sipEncodedTypeDef supers_wxHeaderCtrlSimple[] = {{233, 255, 1}};
...
static PyMethodDef methods_wxHeaderCtrlSimple[] = {
    ...
    {SIP_MLNAME_CAST(sipName_AddChild), (PyCFunction)meth_wxHeaderCtrlSimple_AddChild, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_AddChild)},
    {SIP_MLNAME_CAST(sipName_AppendColumn), (PyCFunction)meth_wxHeaderCtrlSimple_AppendColumn, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_AppendColumn)},
    {SIP_MLNAME_CAST(sipName_DeleteColumn), (PyCFunction)meth_wxHeaderCtrlSimple_DeleteColumn, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_DeleteColumn)},
    ...
    {SIP_MLNAME_CAST(sipName_DoEnable), (PyCFunction)meth_wxHeaderCtrlSimple_DoEnable, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_DoEnable)},
    {SIP_MLNAME_CAST(sipName_DoFreeze), (PyCFunction)meth_wxHeaderCtrlSimple_DoFreeze, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_DoFreeze)},
    {SIP_MLNAME_CAST(sipName_DoGetBestClientSize), (PyCFunction)meth_wxHeaderCtrlSimple_DoGetBestClientSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_DoGetBestClientSize)},
    {SIP_MLNAME_CAST(sipName_DoGetBestSize), (PyCFunction)meth_wxHeaderCtrlSimple_DoGetBestSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_DoGetBestSize)},
    {SIP_MLNAME_CAST(sipName_DoGetBorderSize), (PyCFunction)meth_wxHeaderCtrlSimple_DoGetBorderSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_DoGetBorderSize)},
    {SIP_MLNAME_CAST(sipName_DoGetClientSize), (PyCFunction)meth_wxHeaderCtrlSimple_DoGetClientSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_DoGetClientSize)},
    {SIP_MLNAME_CAST(sipName_DoGetPosition), (PyCFunction)meth_wxHeaderCtrlSimple_DoGetPosition, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_DoGetPosition)},
    {SIP_MLNAME_CAST(sipName_DoGetSize), (PyCFunction)meth_wxHeaderCtrlSimple_DoGetSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_DoGetSize)},
    {SIP_MLNAME_CAST(sipName_DoMoveWindow), (PyCFunction)meth_wxHeaderCtrlSimple_DoMoveWindow, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_DoMoveWindow)},
    {SIP_MLNAME_CAST(sipName_DoSetClientSize), (PyCFunction)meth_wxHeaderCtrlSimple_DoSetClientSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_DoSetClientSize)},
    {SIP_MLNAME_CAST(sipName_DoSetSize), (PyCFunction)meth_wxHeaderCtrlSimple_DoSetSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_DoSetSize)},
    {SIP_MLNAME_CAST(sipName_DoSetSizeHints), (PyCFunction)meth_wxHeaderCtrlSimple_DoSetSizeHints, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_DoSetSizeHints)},
    {SIP_MLNAME_CAST(sipName_DoSetWindowVariant), (PyCFunction)meth_wxHeaderCtrlSimple_DoSetWindowVariant, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_DoSetWindowVariant)},
    {SIP_MLNAME_CAST(sipName_DoThaw), (PyCFunction)meth_wxHeaderCtrlSimple_DoThaw, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_DoThaw)},
    {SIP_MLNAME_CAST(sipName_GetBestFittingWidth), (PyCFunction)meth_wxHeaderCtrlSimple_GetBestFittingWidth, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_GetBestFittingWidth)},
    {SIP_MLNAME_CAST(sipName_GetClassDefaultAttributes), (PyCFunction)meth_wxHeaderCtrlSimple_GetClassDefaultAttributes, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_GetClassDefaultAttributes)},
    ...
    {SIP_MLNAME_CAST(sipName_GetColumn), (PyCFunction)meth_wxHeaderCtrlSimple_GetColumn, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_GetColumn)},
    {SIP_MLNAME_CAST(sipName_GetDefaultBorder), (PyCFunction)meth_wxHeaderCtrlSimple_GetDefaultBorder, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_GetDefaultBorder)},
    {SIP_MLNAME_CAST(sipName_GetDefaultBorderForControl), (PyCFunction)meth_wxHeaderCtrlSimple_GetDefaultBorderForControl, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_GetDefaultBorderForControl)},
    ...
    {SIP_MLNAME_CAST(sipName_HasTransparentBackground), (PyCFunction)meth_wxHeaderCtrlSimple_HasTransparentBackground, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_HasTransparentBackground)},
    {SIP_MLNAME_CAST(sipName_HideColumn), (PyCFunction)meth_wxHeaderCtrlSimple_HideColumn, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_HideColumn)},
    {SIP_MLNAME_CAST(sipName_InformFirstDirection), (PyCFunction)meth_wxHeaderCtrlSimple_InformFirstDirection, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_InformFirstDirection)},
    ...
    {SIP_MLNAME_CAST(sipName_InsertColumn), (PyCFunction)meth_wxHeaderCtrlSimple_InsertColumn, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_InsertColumn)},
    {SIP_MLNAME_CAST(sipName_OnColumnCountChanging), (PyCFunction)meth_wxHeaderCtrlSimple_OnColumnCountChanging, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_OnColumnCountChanging)},
    ...
    {SIP_MLNAME_CAST(sipName_ProcessEvent), (PyCFunction)meth_wxHeaderCtrlSimple_ProcessEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_ProcessEvent)},
    {SIP_MLNAME_CAST(sipName_RemoveChild), (PyCFunction)meth_wxHeaderCtrlSimple_RemoveChild, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_RemoveChild)},
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxHeaderCtrlSimple_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_SetCanFocus), (PyCFunction)meth_wxHeaderCtrlSimple_SetCanFocus, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_SetCanFocus)},
    {SIP_MLNAME_CAST(sipName_SetValidator), (PyCFunction)meth_wxHeaderCtrlSimple_SetValidator, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_SetValidator)},
    ...
    {SIP_MLNAME_CAST(sipName_ShowColumn), (PyCFunction)meth_wxHeaderCtrlSimple_ShowColumn, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_ShowColumn)},
    {SIP_MLNAME_CAST(sipName_ShowSortIndicator), (PyCFunction)meth_wxHeaderCtrlSimple_ShowSortIndicator, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_ShowSortIndicator)},
    ...
    {SIP_MLNAME_CAST(sipName_TryAfter), (PyCFunction)meth_wxHeaderCtrlSimple_TryAfter, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_TryAfter)},
    {SIP_MLNAME_CAST(sipName_TryBefore), (PyCFunction)meth_wxHeaderCtrlSimple_TryBefore, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_TryBefore)},
    {SIP_MLNAME_CAST(sipName_UpdateColumnVisibility), (PyCFunction)meth_wxHeaderCtrlSimple_UpdateColumnVisibility, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_UpdateColumnVisibility)},
    {SIP_MLNAME_CAST(sipName_UpdateColumnWidthToFit), (PyCFunction)meth_wxHeaderCtrlSimple_UpdateColumnWidthToFit, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_UpdateColumnWidthToFit)},
    {SIP_MLNAME_CAST(sipName_UpdateColumnsOrder), (PyCFunction)meth_wxHeaderCtrlSimple_UpdateColumnsOrder, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrlSimple_UpdateColumnsOrder)},
