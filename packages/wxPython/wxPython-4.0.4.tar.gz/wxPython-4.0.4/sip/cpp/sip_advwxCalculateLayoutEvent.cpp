...
sipwxCalculateLayoutEvent::sipwxCalculateLayoutEvent( ::wxWindowID id):  ::wxCalculateLayoutEvent(id), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxCalculateLayoutEvent::sipwxCalculateLayoutEvent(const  ::wxCalculateLayoutEvent& a0):  ::wxCalculateLayoutEvent(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
static PyObject *meth_wxCalculateLayoutEvent_GetFlags(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_CalculateLayoutEvent, sipName_GetFlags, NULL);
...
static PyObject *meth_wxCalculateLayoutEvent_GetRect(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_CalculateLayoutEvent, sipName_GetRect, NULL);
...
static PyObject *meth_wxCalculateLayoutEvent_SetFlags(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bi", &sipSelf, sipType_wxCalculateLayoutEvent, &sipCpp, &flags))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_CalculateLayoutEvent, sipName_SetFlags, NULL);
...
static PyObject *meth_wxCalculateLayoutEvent_SetRect(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxCalculateLayoutEvent, &sipCpp, sipType_wxRect, &rect, &rectState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_CalculateLayoutEvent, sipName_SetRect, NULL);
...
static void dealloc_wxCalculateLayoutEvent(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxCalculateLayoutEvent *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxCalculateLayoutEvent *sipCpp = 0;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxCalculateLayoutEvent, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxCalculateLayoutEvent[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SetFlags), (PyCFunction)meth_wxCalculateLayoutEvent_SetFlags, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxCalculateLayoutEvent_SetFlags)},
    {SIP_MLNAME_CAST(sipName_SetRect), (PyCFunction)meth_wxCalculateLayoutEvent_SetRect, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxCalculateLayoutEvent_SetRect)}
};

sipVariableDef variables_wxCalculateLayoutEvent[] = {
    {PropertyVariable, sipName_Rect, &methods_wxCalculateLayoutEvent[2], &methods_wxCalculateLayoutEvent[4], NULL, NULL},
    {PropertyVariable, sipName_Flags, &methods_wxCalculateLayoutEvent[1], &methods_wxCalculateLayoutEvent[3], NULL, NULL},
};
