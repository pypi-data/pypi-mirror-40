...
static PyObject *meth_wxOutputStream_Close(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_OutputStream, sipName_Close, NULL);
...
static PyObject *meth_wxOutputStream_LastWrite(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxOutputStream, &sipCpp))
        {
            ...
            Py_BEGIN_ALLOW_THREADS
            sipRes = new  ::size_t(sipCpp->LastWrite());
            Py_END_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_OutputStream, sipName_LastWrite, NULL);
...
static PyObject *meth_wxOutputStream_PutC(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bc", &sipSelf, sipType_wxOutputStream, &sipCpp, &c))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_OutputStream, sipName_PutC, NULL);
...
static PyObject *meth_wxOutputStream_SeekO(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bn|E", &sipSelf, sipType_wxOutputStream, &sipCpp, &pos, sipType_wxSeekMode, &mode))
        {
             ::wxFileOffset sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_OutputStream, sipName_SeekO, NULL);
...
static PyObject *meth_wxOutputStream_TellO(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_OutputStream, sipName_TellO, NULL);
...
static PyObject *meth_wxOutputStream_Write(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BvJ1", &sipSelf, sipType_wxOutputStream, &sipCpp, &buffer, sipType_size_t,&size, &sizeState))
        {
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxOutputStream, &sipCpp, sipType_wxInputStream, &stream_in, &stream_inState))
        {
             ::wxOutputStream*sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_OutputStream, sipName_Write, NULL);
...
static PyObject *meth_wxOutputStream_WriteAll(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_OutputStream, sipName_WriteAll, NULL);
...
static PyObject *meth_wxOutputStream_seek(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bn|i", &sipSelf, sipType_wxOutputStream, &sipCpp, &offset, &whence))
        {
            int sipIsErr = 0;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_OutputStream, sipName_seek, NULL);
...
static PyObject *meth_wxOutputStream_tell(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_OutputStream, sipName_tell, NULL);
...
static PyObject *meth_wxOutputStream_flush(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_OutputStream, sipName_flush, NULL);
...
static PyObject *meth_wxOutputStream_eof(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_OutputStream, sipName_eof, NULL);
...
static PyObject *meth_wxOutputStream_write(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BP0", &sipSelf, sipType_wxOutputStream, &sipCpp, &data))
        {
            PyObject * sipRes = 0;
            int sipIsErr = 0;
...
static sipEncodedTypeDef supers_wxOutputStream[] = {{498, 255, 1}};
...
static PyMethodDef methods_wxOutputStream[] = {
    ...
    {SIP_MLNAME_CAST(sipName_PutC), (PyCFunction)meth_wxOutputStream_PutC, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxOutputStream_PutC)},
    {SIP_MLNAME_CAST(sipName_SeekO), (PyCFunction)meth_wxOutputStream_SeekO, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxOutputStream_SeekO)},
    {SIP_MLNAME_CAST(sipName_TellO), meth_wxOutputStream_TellO, METH_VARARGS, SIP_MLDOC_CAST(doc_wxOutputStream_TellO)},
    {SIP_MLNAME_CAST(sipName_Write), (PyCFunction)meth_wxOutputStream_Write, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxOutputStream_Write)},
    {SIP_MLNAME_CAST(sipName_WriteAll), (PyCFunction)meth_wxOutputStream_WriteAll, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxOutputStream_WriteAll)},
    {SIP_MLNAME_CAST(sipName_close), meth_wxOutputStream_close, METH_VARARGS, SIP_MLDOC_CAST(doc_wxOutputStream_close)},
    ...
    {SIP_MLNAME_CAST(sipName_seek), (PyCFunction)meth_wxOutputStream_seek, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxOutputStream_seek)},
