...
static PyObject *meth_wxAppTraits_CreateConfig(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxAppTraits, &sipCpp))
        {
            ...
            return sipConvertFromNewType(sipRes,sipType_wxConfigBase,NULL);
        }
    }

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_AppTraits, sipName_CreateConfig, NULL);
...
static PyObject *meth_wxAppTraits_CreateEventLoop(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxAppTraits, &sipCpp))
        {
            ...
            return sipConvertFromNewType(sipRes,sipType_wxEventLoopBase,NULL);
        }
    }

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_AppTraits, sipName_CreateEventLoop, NULL);
...
static PyObject *meth_wxAppTraits_CreateLogTarget(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxAppTraits, &sipCpp))
        {
            ...
            return sipConvertFromNewType(sipRes,sipType_wxLog,NULL);
        }
    }

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_AppTraits, sipName_CreateLogTarget, NULL);
...
static PyObject *meth_wxAppTraits_GetDesktopEnvironment(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_AppTraits, sipName_GetDesktopEnvironment, NULL);
...
static PyObject *meth_wxAppTraits_GetStandardPaths(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_AppTraits, sipName_GetStandardPaths, NULL);

    return NULL;
}


PyDoc_STRVAR(doc_wxAppTraits_GetToolkitVersion, "GetToolkitVersion(major=None, minor=None) -> PortId\n"
"\n"
...
static PyObject *meth_wxAppTraits_GetToolkitVersion(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, NULL, NULL, "B", &sipSelf, sipType_wxAppTraits, &sipCpp))
        {
             ::wxPortId sipRes;
            ...
            Py_BEGIN_ALLOW_THREADS
            sipRes = sipCpp->GetToolkitVersion(&major,&minor);
            Py_END_ALLOW_THREADS

            if (PyErr_Occurred())
                return 0;

            return sipBuildResult(0,"(Fii)",sipRes,sipType_wxPortId,major,minor);
        }
    }

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_AppTraits, sipName_GetToolkitVersion, NULL);
...
static PyObject *meth_wxAppTraits_HasStderr(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_AppTraits, sipName_HasStderr, NULL);
...
static PyObject *meth_wxAppTraits_IsUsingUniversalWidgets(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_AppTraits, sipName_IsUsingUniversalWidgets, NULL);
...
static PyObject *meth_wxAppTraits_ShowAssertDialog(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxAppTraits, &sipCpp, sipType_wxString,&msg, &msgState))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_AppTraits, sipName_ShowAssertDialog, NULL);
...
static PyMethodDef methods_wxAppTraits[] = {
    ...
    {SIP_MLNAME_CAST(sipName_GetToolkitVersion), (PyCFunction)meth_wxAppTraits_GetToolkitVersion, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxAppTraits_GetToolkitVersion)},
    ...
    {SIP_MLNAME_CAST(sipName_ShowAssertDialog), (PyCFunction)meth_wxAppTraits_ShowAssertDialog, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxAppTraits_ShowAssertDialog)}
};

sipVariableDef variables_wxAppTraits[] = {
    {PropertyVariable, sipName_ToolkitVersion, &methods_wxAppTraits[5], NULL, NULL, NULL},
    {PropertyVariable, sipName_StandardPaths, &methods_wxAppTraits[4], NULL, NULL, NULL},
    {PropertyVariable, sipName_DesktopEnvironment, &methods_wxAppTraits[3], NULL, NULL, NULL},
};
