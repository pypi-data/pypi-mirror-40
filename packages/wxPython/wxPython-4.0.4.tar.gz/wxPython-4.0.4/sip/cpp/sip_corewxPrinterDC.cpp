...
sipwxPrinterDC::sipwxPrinterDC(const  ::wxPrintData& printData):  ::wxPrinterDC(printData), sipPySelf(0)
{
}
...
static PyObject *meth_wxPrinterDC_GetPaperRect(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_PrinterDC, sipName_GetPaperRect, NULL);
...
static void dealloc_wxPrinterDC(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxPrinterDC *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static sipEncodedTypeDef supers_wxPrinterDC[] = {{94, 255, 1}};
...
sipVariableDef variables_wxPrinterDC[] = {
    {PropertyVariable, sipName_PaperRect, &methods_wxPrinterDC[0], NULL, NULL, NULL},
};
