...
static PyObject *meth_wxEvent_Clone(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_Event, sipName_Clone, NULL);
...
static PyObject *meth_wxEvent_GetEventObject(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Event, sipName_GetEventObject, NULL);
...
static PyObject *meth_wxEvent_GetEventType(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Event, sipName_GetEventType, NULL);
...
static PyObject *meth_wxEvent_GetEventCategory(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Event, sipName_GetEventCategory, NULL);
...
static PyObject *meth_wxEvent_GetId(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Event, sipName_GetId, NULL);

    return NULL;
}


PyDoc_STRVAR(doc_wxEvent_GetEventUserData, "GetEventUserData() -> Object\n"
"\n"
"Return the user data associated with a dynamically connected event\n"
"handler.");

extern "C" {static PyObject *meth_wxEvent_GetEventUserData(PyObject *, PyObject *);}
static PyObject *meth_wxEvent_GetEventUserData(PyObject *sipSelf, PyObject *sipArgs)
{
    PyObject *sipParseErr = NULL;

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxEvent, &sipCpp))
        {
            ...
            Py_BEGIN_ALLOW_THREADS
            sipRes = sipCpp->GetEventUserData();
            Py_END_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Event, sipName_GetEventUserData, NULL);
...
static PyObject *meth_wxEvent_GetSkipped(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Event, sipName_GetSkipped, NULL);
...
static PyObject *meth_wxEvent_GetTimestamp(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Event, sipName_GetTimestamp, NULL);
...
static PyObject *meth_wxEvent_IsCommandEvent(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Event, sipName_IsCommandEvent, NULL);
...
static PyObject *meth_wxEvent_ResumePropagation(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Event, sipName_ResumePropagation, NULL);
...
static PyObject *meth_wxEvent_SetEventObject(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Event, sipName_SetEventObject, NULL);
...
static PyObject *meth_wxEvent_SetEventType(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Event, sipName_SetEventType, NULL);
...
static PyObject *meth_wxEvent_SetId(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Event, sipName_SetId, NULL);
...
static PyObject *meth_wxEvent_SetTimestamp(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Event, sipName_SetTimestamp, NULL);
...
static PyObject *meth_wxEvent_ShouldPropagate(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Event, sipName_ShouldPropagate, NULL);
...
static PyObject *meth_wxEvent_Skip(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Event, sipName_Skip, NULL);
...
static PyObject *meth_wxEvent_StopPropagation(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Event, sipName_StopPropagation, NULL);
...
static sipEncodedTypeDef supers_wxEvent[] = {{358, 255, 1}};
...
static PyMethodDef methods_wxEvent[] = {
    ...
    {SIP_MLNAME_CAST(sipName_GetEventUserData), meth_wxEvent_GetEventUserData, METH_VARARGS, SIP_MLDOC_CAST(doc_wxEvent_GetEventUserData)},
...
sipVariableDef variables_wxEvent[] = {
    {PropertyVariable, sipName_Timestamp, &methods_wxEvent[7], &methods_wxEvent[13], NULL, NULL},
    {PropertyVariable, sipName_Skipped, &methods_wxEvent[6], NULL, NULL, NULL},
    {PropertyVariable, sipName_Id, &methods_wxEvent[5], &methods_wxEvent[12], NULL, NULL},
    {PropertyVariable, sipName_EventType, &methods_wxEvent[3], &methods_wxEvent[11], NULL, NULL},
    {PropertyVariable, sipName_EventObject, &methods_wxEvent[2], &methods_wxEvent[10], NULL, NULL},
};
