...
public:
     ...
     */
protected:
     ::wxString ReadFile(const  ::wxFSFile&) const;
    bool CanRead(const  ::wxFSFile&) const;
...
sipwxHtmlFilter::sipwxHtmlFilter():  ::wxHtmlFilter(), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxHtmlFilter::sipwxHtmlFilter(const  ::wxHtmlFilter& a0):  ::wxHtmlFilter(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
static PyObject *meth_wxHtmlFilter_CanRead(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxHtmlFilter, &sipCpp, sipType_wxFSFile, &file))
        {
            bool sipRes;
    ...
    sipNoMethod(sipParseErr, sipName_HtmlFilter, sipName_CanRead, NULL);
...
static PyObject *meth_wxHtmlFilter_ReadFile(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HtmlFilter, sipName_ReadFile, NULL);
...
static void dealloc_wxHtmlFilter(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxHtmlFilter *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static void *init_type_wxHtmlFilter(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxHtmlFilter, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxHtmlFilter[] = {
    {SIP_MLNAME_CAST(sipName_CanRead), (PyCFunction)meth_wxHtmlFilter_CanRead, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHtmlFilter_CanRead)},
    {SIP_MLNAME_CAST(sipName_ReadFile), (PyCFunction)meth_wxHtmlFilter_ReadFile, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHtmlFilter_ReadFile)}
};
