...
public:
     ...
     */
protected:
     ::wxString PreprocessTip(const  ::wxString&);
     ::wxString GetTip();
...
sipwxTipProvider::sipwxTipProvider( ::size_t currentTip):  ::wxTipProvider(currentTip), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxTipProvider::sipwxTipProvider(const  ::wxTipProvider& a0):  ::wxTipProvider(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
sipwxTipProvider::~sipwxTipProvider()
{
 ...
 ::wxString sipwxTipProvider::PreprocessTip(const  ::wxString& tip)
{
    sip_gilstate_t sipGILState;
    PyObject *sipMeth;

    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[0],sipPySelf,NULL,sipName_PreprocessTip);

    if (!sipMeth)
        return  ::wxTipProvider::PreprocessTip(tip);

    extern  ::wxString sipVH__adv_30(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxString&);

    return sipVH__adv_30(sipGILState, 0, sipPySelf, sipMeth, tip);
}
 ...
 ::wxString sipwxTipProvider::GetTip()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[1],sipPySelf,sipName_TipProvider,sipName_GetTip);
...
static PyObject *meth_wxTipProvider_GetCurrentTip(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxTipProvider, &sipCpp))
        {
            ...
            sipRes = new  ::size_t(sipCpp->GetCurrentTip());
    ...
    sipNoMethod(sipParseErr, sipName_TipProvider, sipName_GetCurrentTip, NULL);
...
static PyObject *meth_wxTipProvider_GetTip(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TipProvider, sipName_GetTip, NULL);

    return NULL;
}


PyDoc_STRVAR(doc_wxTipProvider_PreprocessTip, "PreprocessTip(tip) -> String\n"
"\n"
"Returns a modified tip.");

extern "C" {static PyObject *meth_wxTipProvider_PreprocessTip(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxTipProvider_PreprocessTip(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxTipProvider, &sipCpp, sipType_wxString,&tip, &tipState))
        {
             ::wxString*sipRes;
            ...
            Py_BEGIN_ALLOW_THREADS
            sipRes = new  ::wxString((sipSelfWasArg ? sipCpp-> ::wxTipProvider::PreprocessTip(*tip) : sipCpp->PreprocessTip(*tip)));
            Py_END_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TipProvider, sipName_PreprocessTip, NULL);
...
static void dealloc_wxTipProvider(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxTipProvider *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static void *init_type_wxTipProvider(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, sipKwdList, sipUnused, "J1", sipType_size_t,&currentTip, &currentTipState))
        {
            PyErr_Clear();
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxTipProvider, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxTipProvider[] = {
    ...
    {SIP_MLNAME_CAST(sipName_PreprocessTip), (PyCFunction)meth_wxTipProvider_PreprocessTip, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTipProvider_PreprocessTip)}
};

sipVariableDef variables_wxTipProvider[] = {
    {PropertyVariable, sipName_Tip, &methods_wxTipProvider[1], NULL, NULL, NULL},
    {PropertyVariable, sipName_CurrentTip, &methods_wxTipProvider[0], NULL, NULL, NULL},
};
