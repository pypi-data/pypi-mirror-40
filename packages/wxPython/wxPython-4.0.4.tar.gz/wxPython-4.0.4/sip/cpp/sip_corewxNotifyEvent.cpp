...
static PyObject *meth_wxNotifyEvent_Allow(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_NotifyEvent, sipName_Allow, NULL);
...
static PyObject *meth_wxNotifyEvent_IsAllowed(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_NotifyEvent, sipName_IsAllowed, NULL);
...
static PyObject *meth_wxNotifyEvent_Veto(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_NotifyEvent, sipName_Veto, NULL);
...
static sipEncodedTypeDef supers_wxNotifyEvent[] = {{78, 255, 1}};
