...
static PyObject *meth_wxTreeListItem_IsOk(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_TreeListItem, sipName_IsOk, NULL);
...
extern "C" {static void *array_wxTreeListItem(SIP_SSIZE_T);}
static void *array_wxTreeListItem(SIP_SSIZE_T sipNrElem)
{
...
static void *init_type_wxTreeListItem(sipSimpleWrapper *, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxTreeListItem, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
