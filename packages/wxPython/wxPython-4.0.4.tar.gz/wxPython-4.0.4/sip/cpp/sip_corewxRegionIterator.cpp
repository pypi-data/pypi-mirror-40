...
static PyObject *meth_wxRegionIterator_GetH(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_RegionIterator, sipName_GetH, NULL);
...
static PyObject *meth_wxRegionIterator_GetHeight(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RegionIterator, sipName_GetHeight, NULL);
...
static PyObject *meth_wxRegionIterator_GetRect(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RegionIterator, sipName_GetRect, NULL);
...
static PyObject *meth_wxRegionIterator_GetW(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RegionIterator, sipName_GetW, NULL);
...
static PyObject *meth_wxRegionIterator_GetWidth(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RegionIterator, sipName_GetWidth, NULL);
...
static PyObject *meth_wxRegionIterator_GetX(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RegionIterator, sipName_GetX, NULL);
...
static PyObject *meth_wxRegionIterator_GetY(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RegionIterator, sipName_GetY, NULL);
...
static PyObject *meth_wxRegionIterator_HaveRects(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RegionIterator, sipName_HaveRects, NULL);
...
static PyObject *meth_wxRegionIterator_Reset(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, NULL, NULL, "B", &sipSelf, sipType_wxRegionIterator, &sipCpp))
        {
            PyErr_Clear();
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxRegionIterator, &sipCpp, sipType_wxRegion, &region))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RegionIterator, sipName_Reset, NULL);
...
static PyObject *meth_wxRegionIterator_Next(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RegionIterator, sipName_Next, NULL);
...
extern "C" {static void *array_wxRegionIterator(SIP_SSIZE_T);}
static void *array_wxRegionIterator(SIP_SSIZE_T sipNrElem)
{
...
static void *init_type_wxRegionIterator(sipSimpleWrapper *, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxRegionIterator, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxRegionIterator[] = {{358, 255, 1}};
...
static PyMethodDef methods_wxRegionIterator[] = {
    ...
    {SIP_MLNAME_CAST(sipName_Reset), (PyCFunction)meth_wxRegionIterator_Reset, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRegionIterator_Reset)}
};

sipVariableDef variables_wxRegionIterator[] = {
    {PropertyVariable, sipName_Y, &methods_wxRegionIterator[6], NULL, NULL, NULL},
    {PropertyVariable, sipName_X, &methods_wxRegionIterator[5], NULL, NULL, NULL},
    {PropertyVariable, sipName_Width, &methods_wxRegionIterator[4], NULL, NULL, NULL},
    {PropertyVariable, sipName_W, &methods_wxRegionIterator[3], NULL, NULL, NULL},
    {PropertyVariable, sipName_Rect, &methods_wxRegionIterator[2], NULL, NULL, NULL},
    {PropertyVariable, sipName_Height, &methods_wxRegionIterator[1], NULL, NULL, NULL},
    {PropertyVariable, sipName_H, &methods_wxRegionIterator[0], NULL, NULL, NULL},
};
