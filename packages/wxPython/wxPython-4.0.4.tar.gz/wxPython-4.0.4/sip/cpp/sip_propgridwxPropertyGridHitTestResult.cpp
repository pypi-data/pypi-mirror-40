...
static PyObject *meth_wxPropertyGridHitTestResult_GetColumn(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_PropertyGridHitTestResult, sipName_GetColumn, NULL);
...
static PyObject *meth_wxPropertyGridHitTestResult_GetProperty(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PropertyGridHitTestResult, sipName_GetProperty, NULL);
...
static PyObject *meth_wxPropertyGridHitTestResult_GetSplitter(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PropertyGridHitTestResult, sipName_GetSplitter, NULL);
...
static PyObject *meth_wxPropertyGridHitTestResult_GetSplitterHitOffset(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PropertyGridHitTestResult, sipName_GetSplitterHitOffset, NULL);
...
extern "C" {static void *array_wxPropertyGridHitTestResult(SIP_SSIZE_T);}
static void *array_wxPropertyGridHitTestResult(SIP_SSIZE_T sipNrElem)
{
...
{
     ::wxPropertyGridHitTestResult *sipCpp = 0;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxPropertyGridHitTestResult, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
sipVariableDef variables_wxPropertyGridHitTestResult[] = {
    {PropertyVariable, sipName_SplitterHitOffset, &methods_wxPropertyGridHitTestResult[3], NULL, NULL, NULL},
    {PropertyVariable, sipName_Splitter, &methods_wxPropertyGridHitTestResult[2], NULL, NULL, NULL},
    {PropertyVariable, sipName_Property, &methods_wxPropertyGridHitTestResult[1], NULL, NULL, NULL},
    {PropertyVariable, sipName_Column, &methods_wxPropertyGridHitTestResult[0], NULL, NULL, NULL},
};
