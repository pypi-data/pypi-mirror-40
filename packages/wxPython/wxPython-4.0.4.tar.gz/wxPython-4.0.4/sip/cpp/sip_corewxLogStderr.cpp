...
sipwxLogStderr::sipwxLogStderr():  ::wxLogStderr(), sipPySelf(0)
{
...
static PyObject *meth_wxLogStderr_DoLogRecord(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BmJ1J9", &sipSelf, sipType_wxLogStderr, &sipCpp, &level, sipType_wxString,&msg, &msgState, sipType_wxLogRecordInfo, &info))
        {
            PyErr_Clear();
    ...
    sipNoMethod(sipParseErr, sipName_LogStderr, sipName_DoLogRecord, NULL);
...
static PyObject *meth_wxLogStderr_DoLogTextAtLevel(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BmJ1", &sipSelf, sipType_wxLogStderr, &sipCpp, &level, sipType_wxString,&msg, &msgState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_LogStderr, sipName_DoLogTextAtLevel, NULL);
...
static PyObject *meth_wxLogStderr_DoLogText(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxLogStderr, &sipCpp, sipType_wxString,&msg, &msgState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_LogStderr, sipName_DoLogText, NULL);
...
static void dealloc_wxLogStderr(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxLogStderr *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static sipEncodedTypeDef supers_wxLogStderr[] = {{298, 255, 1}};


static PyMethodDef methods_wxLogStderr[] = {
    {SIP_MLNAME_CAST(sipName_DoLogRecord), (PyCFunction)meth_wxLogStderr_DoLogRecord, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_DoLogText), (PyCFunction)meth_wxLogStderr_DoLogText, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_DoLogTextAtLevel), (PyCFunction)meth_wxLogStderr_DoLogTextAtLevel, METH_VARARGS|METH_KEYWORDS, NULL}
};
