...
sipwxPGChoicesData::sipwxPGChoicesData():  ::wxPGChoicesData(), sipPySelf(0)
{
}
...
static PyObject *meth_wxPGChoicesData_CopyDataFrom(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8", &sipSelf, sipType_wxPGChoicesData, &sipCpp, sipType_wxPGChoicesData, &data))
        {
            PyErr_Clear();
    ...
    sipNoMethod(sipParseErr, sipName_PGChoicesData, sipName_CopyDataFrom, NULL);
...
static PyObject *meth_wxPGChoicesData_Insert(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BiJ9", &sipSelf, sipType_wxPGChoicesData, &sipCpp, &index, sipType_wxPGChoiceEntry, &item))
        {
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PGChoicesData, sipName_Insert, NULL);
...
static PyObject *meth_wxPGChoicesData_Clear(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PGChoicesData, sipName_Clear, NULL);
...
static PyObject *meth_wxPGChoicesData_GetCount(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PGChoicesData, sipName_GetCount, NULL);
...
static PyObject *meth_wxPGChoicesData_Item(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bu", &sipSelf, sipType_wxPGChoicesData, &sipCpp, &i))
        {
             ::wxPGChoiceEntry*sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PGChoicesData, sipName_Item, NULL);
...
static void dealloc_wxPGChoicesData(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxPGChoicesData *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static PyMethodDef methods_wxPGChoicesData[] = {
    ...
    {SIP_MLNAME_CAST(sipName_CopyDataFrom), (PyCFunction)meth_wxPGChoicesData_CopyDataFrom, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPGChoicesData_CopyDataFrom)},
    {SIP_MLNAME_CAST(sipName_GetCount), meth_wxPGChoicesData_GetCount, METH_VARARGS, SIP_MLDOC_CAST(doc_wxPGChoicesData_GetCount)},
    {SIP_MLNAME_CAST(sipName_Insert), (PyCFunction)meth_wxPGChoicesData_Insert, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPGChoicesData_Insert)},
    {SIP_MLNAME_CAST(sipName_Item), (PyCFunction)meth_wxPGChoicesData_Item, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPGChoicesData_Item)}
};

sipVariableDef variables_wxPGChoicesData[] = {
    {PropertyVariable, sipName_Count, &methods_wxPGChoicesData[2], NULL, NULL, NULL},
};
