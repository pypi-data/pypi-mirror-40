...
sipwxCalendarEvent::sipwxCalendarEvent():  ::wxCalendarEvent(), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxCalendarEvent::sipwxCalendarEvent( ::wxWindow*win,const  ::wxDateTime& dt, ::wxEventType type):  ::wxCalendarEvent(win,dt,type), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxCalendarEvent::sipwxCalendarEvent(const  ::wxCalendarEvent& a0):  ::wxCalendarEvent(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
static PyObject *meth_wxCalendarEvent_GetWeekDay(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_CalendarEvent, sipName_GetWeekDay, NULL);
...
static PyObject *meth_wxCalendarEvent_SetWeekDay(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BE", &sipSelf, sipType_wxCalendarEvent, &sipCpp, sipType_wxDateTime_WeekDay, &day))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_CalendarEvent, sipName_SetWeekDay, NULL);
...
static void dealloc_wxCalendarEvent(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxCalendarEvent *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static void *init_type_wxCalendarEvent(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxCalendarEvent, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxCalendarEvent[] = {{13, 255, 1}};
...
static PyMethodDef methods_wxCalendarEvent[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SetWeekDay), (PyCFunction)meth_wxCalendarEvent_SetWeekDay, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxCalendarEvent_SetWeekDay)}
};

sipVariableDef variables_wxCalendarEvent[] = {
    {PropertyVariable, sipName_WeekDay, &methods_wxCalendarEvent[1], &methods_wxCalendarEvent[2], NULL, NULL},
};
