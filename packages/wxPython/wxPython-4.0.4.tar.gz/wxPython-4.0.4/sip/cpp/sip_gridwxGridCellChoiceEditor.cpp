...
sipwxGridCellChoiceEditor::sipwxGridCellChoiceEditor(const  ::wxArrayString& choices,bool allowOthers):  ::wxGridCellChoiceEditor(choices,allowOthers), sipPySelf(0)
{
...
void sipwxGridCellChoiceEditor::SetParameters(const  ::wxString& params)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[0],sipPySelf,NULL,sipName_SetParameters);
...
void sipwxGridCellChoiceEditor::BeginEdit(int row,int col, ::wxGrid*grid)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[1],sipPySelf,NULL,sipName_BeginEdit);
...
void sipwxGridCellChoiceEditor::Create( ::wxWindow*parent, ::wxWindowID id, ::wxEvtHandler*evtHandler)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[3],sipPySelf,NULL,sipName_Create);
...
void sipwxGridCellChoiceEditor::Destroy()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[4],sipPySelf,NULL,sipName_Destroy);
...
bool sipwxGridCellChoiceEditor::EndEdit(int row,int col,const  ::wxGrid*grid,const  ::wxString& oldval, ::wxString*newval)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[5],sipPySelf,NULL,sipName_EndEdit);
...
void sipwxGridCellChoiceEditor::ApplyEdit(int row,int col, ::wxGrid*grid)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[6],sipPySelf,NULL,sipName_ApplyEdit);
...
void sipwxGridCellChoiceEditor::PaintBackground( ::wxDC& dc,const  ::wxRect& rectCell, ::wxGridCellAttr& attr)
{
    sip_gilstate_t sipGILState;
    PyObject *sipMeth;

    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[8],sipPySelf,NULL,sipName_PaintBackground);
...
void sipwxGridCellChoiceEditor::SetSize(const  ::wxRect& rect)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[10],sipPySelf,NULL,sipName_SetSize);
...
void sipwxGridCellChoiceEditor::Show(bool show, ::wxGridCellAttr*attr)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[11],sipPySelf,NULL,sipName_Show);
...
void sipwxGridCellChoiceEditor::StartingClick()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[12],sipPySelf,NULL,sipName_StartingClick);
...
void sipwxGridCellChoiceEditor::StartingKey( ::wxKeyEvent& event)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[13],sipPySelf,NULL,sipName_StartingKey);
...
static PyObject *meth_wxGridCellChoiceEditor_SetParameters(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxGridCellChoiceEditor, &sipCpp, sipType_wxString,&params, &paramsState))
        {
            PyErr_Clear();
    ...
    sipNoMethod(sipParseErr, sipName_GridCellChoiceEditor, sipName_SetParameters, NULL);
...
static PyObject *meth_wxGridCellChoiceEditor_BeginEdit(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BiiJ8", &sipSelf, sipType_wxGridCellChoiceEditor, &sipCpp, &row, &col, sipType_wxGrid, &grid))
        {
            PyErr_Clear();
...
static PyObject *meth_wxGridCellChoiceEditor_Create(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8iJ8", &sipSelf, sipType_wxGridCellChoiceEditor, &sipCpp, sipType_wxWindow, &parent, &id, sipType_wxEvtHandler, &evtHandler))
        {
            PyErr_Clear();
...
static PyObject *meth_wxGridCellChoiceEditor_EndEdit(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BiiJ8J1", &sipSelf, sipType_wxGridCellChoiceEditor, &sipCpp, &row, &col, sipType_wxGrid, &grid, sipType_wxString,&oldval, &oldvalState))
        {
            PyObject * sipRes = 0;
            int sipIsErr = 0;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GridCellChoiceEditor, sipName_EndEdit, NULL);
...
static void dealloc_wxGridCellChoiceEditor(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxGridCellChoiceEditor *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxGridCellChoiceEditor *sipCpp = 0;
...
static sipEncodedTypeDef supers_wxGridCellChoiceEditor[] = {{15, 255, 1}};


static PyMethodDef methods_wxGridCellChoiceEditor[] = {
    {SIP_MLNAME_CAST(sipName_ApplyEdit), (PyCFunction)meth_wxGridCellChoiceEditor_ApplyEdit, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridCellChoiceEditor_ApplyEdit)},
    {SIP_MLNAME_CAST(sipName_BeginEdit), (PyCFunction)meth_wxGridCellChoiceEditor_BeginEdit, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridCellChoiceEditor_BeginEdit)},
    ...
    {SIP_MLNAME_CAST(sipName_Create), (PyCFunction)meth_wxGridCellChoiceEditor_Create, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridCellChoiceEditor_Create)},
    {SIP_MLNAME_CAST(sipName_EndEdit), (PyCFunction)meth_wxGridCellChoiceEditor_EndEdit, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridCellChoiceEditor_EndEdit)},
    ...
    {SIP_MLNAME_CAST(sipName_SetParameters), (PyCFunction)meth_wxGridCellChoiceEditor_SetParameters, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridCellChoiceEditor_SetParameters)}
};
