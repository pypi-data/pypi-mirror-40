...
sipwxDataViewDateRenderer::sipwxDataViewDateRenderer(const  ::wxString& varianttype, ::wxDataViewCellMode mode,int align):  ::wxDataViewDateRenderer(varianttype,mode,align), sipPySelf(0)
{
...
extern "C" {static PyObject *meth_wxDataViewDateRenderer_GetView(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxDataViewDateRenderer_GetView(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, NULL, NULL, "B", &sipSelf, sipType_wxDataViewDateRenderer, &sipCpp))
        {
    ...
    sipNoMethod(sipParseErr, sipName_DataViewDateRenderer, sipName_GetView, NULL);
...
static PyObject *meth_wxDataViewDateRenderer_SetValue(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxDataViewDateRenderer, &sipCpp, sipType_wxDVCVariant,&value, &valueState))
        {
            bool sipRes;
...
static void dealloc_wxDataViewDateRenderer(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxDataViewDateRenderer *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxDataViewDateRenderer *sipCpp = 0;

    {
        const  ::wxString& varianttypedef = "datetime";
...
static sipEncodedTypeDef supers_wxDataViewDateRenderer[] = {{23, 255, 1}};


static PyMethodDef methods_wxDataViewDateRenderer[] = {
    {SIP_MLNAME_CAST(sipName_GetValue), (PyCFunction)meth_wxDataViewDateRenderer_GetValue, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDataViewDateRenderer_GetValue)},
    {SIP_MLNAME_CAST(sipName_GetView), (PyCFunction)meth_wxDataViewDateRenderer_GetView, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_SetValue), (PyCFunction)meth_wxDataViewDateRenderer_SetValue, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDataViewDateRenderer_SetValue)}
};

sipVariableDef variables_wxDataViewDateRenderer[] = {
    {PropertyVariable, sipName_Value, &methods_wxDataViewDateRenderer[0], &methods_wxDataViewDateRenderer[2], NULL, NULL},
};

PyDoc_STRVAR(doc_wxDataViewDateRenderer, "DataViewDateRenderer(varianttype=\"datetime\", mode=DATAVIEW_CELL_ACTIVATABLE, align=DVR_DEFAULT_ALIGNMENT)\n"
"\n"
...
sipClassTypeDef sipTypeDef__dataview_wxDataViewDateRenderer = {
    ...
    },
    {
        ...
        {0, 0, 1},
        3, methods_wxDataViewDateRenderer,
        0, 0,
