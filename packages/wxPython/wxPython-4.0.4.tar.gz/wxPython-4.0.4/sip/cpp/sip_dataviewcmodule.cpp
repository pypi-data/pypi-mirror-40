...
const char sipStrings__dataview[] = {
    ...
    'S', 'e', 't', 'E', 'd', 'i', 't', 'C', 'a', 'n', 'c', 'e', 'l', 'e', 'd', 0,
...
int sipVH__dataview_59(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxTreeListCtrl*treelist,uint column, ::wxTreeListItem first, ::wxTreeListItem second)
{
    int sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "DuNN", treelist, sipType_wxTreeListCtrl, NULL, column, new  ::wxTreeListItem(first), sipType_wxTreeListItem, NULL, new  ::wxTreeListItem(second), sipType_wxTreeListItem, NULL);
 ...
 ::wxEvent* sipVH__dataview_58(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
     ::wxEvent* sipRes = 0;
 ...
 ::wxEventCategory sipVH__dataview_57(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
 ...
 ::wxBorder sipVH__dataview_56(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
...
void sipVH__dataview_55(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxWindowVariant variant)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "F", variant, sipType_wxWindowVariant);
}

void sipVH__dataview_54(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int x,int y,int width,int height)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "iiii", x, y, width, height);
}

void sipVH__dataview_53(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int minW,int minH,int maxW,int maxH,int incW,int incH)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "iiiiii", minW, minH, maxW, maxH, incW, incH);
}

void sipVH__dataview_52(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int width,int height)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "ii", width, height);
}

void sipVH__dataview_51(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int x,int y,int width,int height,int sizeFlags)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "iiiii", x, y, width, height, sizeFlags);
}

void sipVH__dataview_50(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int*x,int*y)
{
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "");
 ...
 ::wxWindow* sipVH__dataview_49(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
     ::wxWindow* sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "");
...
void sipVH__dataview_48(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxValidator& validator)
{
 ...
 ::wxValidator* sipVH__dataview_47(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
 ...
 ::wxPoint sipVH__dataview_46(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
     ::wxPoint sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "");
...
bool sipVH__dataview_45(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int direction,int size,int availableOtherDir)
{
    bool sipRes = 0;
...
bool sipVH__dataview_44(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxEvent& event)
{
    bool sipRes = 0;
...
void sipVH__dataview_43(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxWindowBase*child)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "D", child, sipType_wxWindowBase, NULL);
}

 ::wxAlignment sipVH__dataview_42(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
 ...
 ::wxBitmap sipVH__dataview_41(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
     ::wxBitmap sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "");
 ...
 ::wxString sipVH__dataview_40(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
     ::wxString sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "");
...
void sipVH__dataview_39(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxString& title)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "N", new  ::wxString(title), sipType_wxString, NULL);
}

void sipVH__dataview_38(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxBitmap& bitmap)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "N", new  ::wxBitmap(bitmap), sipType_wxBitmap, NULL);
}

void sipVH__dataview_37(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxAlignment align)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "F", align, sipType_wxAlignment);
}

void sipVH__dataview_36(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, bool ascending)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "b", ascending);
}

bool sipVH__dataview_35(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxPoint& cursor,const  ::wxRect& cell, ::wxDataViewModel*model,const  ::wxDataViewItem& item,uint col)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "NNDNu", new  ::wxPoint(cursor), sipType_wxPoint, NULL, new  ::wxRect(cell), sipType_wxRect, NULL, model, sipType_wxDataViewModel, NULL, new  ::wxDataViewItem(item), sipType_wxDataViewItem, NULL, col);
...
bool sipVH__dataview_34(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxRect cell, ::wxDC*dc,int state)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "NDi", new  ::wxRect(cell), sipType_wxRect, NULL, dc, sipType_wxDC, NULL, state);
...
bool sipVH__dataview_33(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxRect cell, ::wxDataViewModel*model,const  ::wxDataViewItem& item,uint col)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "NDNu", new  ::wxRect(cell), sipType_wxRect, NULL, model, sipType_wxDataViewModel, NULL, new  ::wxDataViewItem(item), sipType_wxDataViewItem, NULL, col);
...
bool sipVH__dataview_32(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxPoint cursor, ::wxRect cell, ::wxDataViewModel*model,const  ::wxDataViewItem& item,uint col)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "NNDNu", new  ::wxPoint(cursor), sipType_wxPoint, NULL, new  ::wxRect(cell), sipType_wxRect, NULL, model, sipType_wxDataViewModel, NULL, new  ::wxDataViewItem(item), sipType_wxDataViewItem, NULL, col);
 ...
 ::wxSize sipVH__dataview_31(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
     ::wxSize sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "");
...
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "NDNuD", new  ::wxRect(cell), sipType_wxRect, NULL, model, sipType_wxDataViewModel, NULL, new  ::wxDataViewItem(item), sipType_wxDataViewItem, NULL, col, const_cast< ::wxMouseEvent *>(mouseEvent), sipType_wxMouseEvent, NULL);
...
bool sipVH__dataview_29(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxWindow*editor, ::wxVariant& value)
{
    bool sipRes = 0;
    int sipIsErr = 0;
...
bool sipVH__dataview_28(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxDataViewItem& item, ::wxRect labelRect)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "NN", new  ::wxDataViewItem(item), sipType_wxDataViewItem, NULL, new  ::wxRect(labelRect), sipType_wxRect, NULL);
...
bool sipVH__dataview_27(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxWindow*editor, ::wxVariant& value)
{
    bool sipRes = 0;
...
{
     ::wxWindow* sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "DNN", parent, sipType_wxWindow, NULL, new  ::wxRect(labelRect), sipType_wxRect, NULL, new  ::wxDVCVariant(value), sipType_wxDVCVariant, NULL);
...
bool sipVH__dataview_25(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxDVCVariant& value)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "D", &value, sipType_wxDVCVariant, NULL);
...
bool sipVH__dataview_24(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxVariant& value)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "N", new  ::wxDVCVariant(value), sipType_wxDVCVariant, NULL);
...
void sipVH__dataview_23(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int align)
{
...
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "Nuu", new  ::wxDVCVariant(variant), sipType_wxDVCVariant, NULL, row, col);
...
void sipVH__dataview_18(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxDVCVariant& variant,uint row,uint col)
{
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "uu", row, col);
...
{
    uint sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "N", new  ::wxDataViewItem(item), sipType_wxDataViewItem, NULL);
...
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "uuD", row, col, &attr, sipType_wxDataViewItemAttr, NULL);
...
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "NNu", new  ::wxDVCVariant(variant), sipType_wxDVCVariant, NULL, new  ::wxDataViewItem(item), sipType_wxDataViewItem, NULL, col);
...
void sipVH__dataview_13(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxDVCVariant& variant,const  ::wxDataViewItem& item,uint col)
{
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "Nu", new  ::wxDataViewItem(item), sipType_wxDataViewItem, NULL, col);
...
{
     ::wxString sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "u", col);
...
{
    uint sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "ND", new  ::wxDataViewItem(item), sipType_wxDataViewItem, NULL, &children, sipType_wxDataViewItemArray, NULL);
...
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "NuD", new  ::wxDataViewItem(item), sipType_wxDataViewItem, NULL, col, &attr, sipType_wxDataViewItemAttr, NULL);
...
{
    int sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "NNub", new  ::wxDataViewItem(item1), sipType_wxDataViewItem, NULL, new  ::wxDataViewItem(item2), sipType_wxDataViewItem, NULL, column, ascending);
...
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "N", new  ::wxDataViewItemArray(items), sipType_wxDataViewItemArray, NULL);
...
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "NN", new  ::wxDataViewItem(parent), sipType_wxDataViewItem, NULL, new  ::wxDataViewItemArray(items), sipType_wxDataViewItemArray, NULL);
...
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "NN", new  ::wxDataViewItem(parent), sipType_wxDataViewItem, NULL, new  ::wxDataViewItem(item), sipType_wxDataViewItem, NULL);
...
static sipEnumTypeDef enumTypes[] = {
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxDataViewColumnFlags, {0}, 0}, sipNameNr_DataViewColumnFlags, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxDataViewCellRenderState, {0}, 0}, sipNameNr_DataViewCellRenderState, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxDataViewCellMode, {0}, 0}, sipNameNr_DataViewCellMode, -1, NULL},
};
...
static sipEnumMemberDef enummembers[] = {
    ...
    {sipName_DATAVIEW_COL_HIDDEN, static_cast<int>(::wxDATAVIEW_COL_HIDDEN), 6},
    {sipName_DATAVIEW_COL_REORDERABLE, static_cast<int>(::wxDATAVIEW_COL_REORDERABLE), 6},
    {sipName_DATAVIEW_COL_RESIZABLE, static_cast<int>(::wxDATAVIEW_COL_RESIZABLE), 6},
    {sipName_DATAVIEW_COL_SORTABLE, static_cast<int>(::wxDATAVIEW_COL_SORTABLE), 6},
};
...
static sipImportedModuleDef importsTable[] = {
    {"wx._core", sipImportedTypes__dataview__core, NULL, NULL},
    {NULL, NULL, NULL, NULL}
};
