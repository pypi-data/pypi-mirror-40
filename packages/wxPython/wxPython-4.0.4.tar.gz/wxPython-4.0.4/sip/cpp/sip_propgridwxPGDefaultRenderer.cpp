...
sipwxPGDefaultRenderer::sipwxPGDefaultRenderer():  ::wxPGDefaultRenderer(), sipPySelf(0)
{
...
bool sipwxPGDefaultRenderer::Render( ::wxDC& dc,const  ::wxRect& rect,const  ::wxPropertyGrid*propertyGrid, ::wxPGProperty*property,int column,int item,int flags) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[0]),sipPySelf,NULL,sipName_Render);
...
void sipwxPGDefaultRenderer::DrawCaptionSelectionRect( ::wxDC& dc,int x,int y,int w,int h) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[2]),sipPySelf,NULL,sipName_DrawCaptionSelectionRect);
...
static PyObject *meth_wxPGDefaultRenderer_Render(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9J1J8J8iii", &sipSelf, sipType_wxPGDefaultRenderer, &sipCpp, sipType_wxDC, &dc, sipType_wxRect, &rect, &rectState, sipType_wxPropertyGrid, &propertyGrid, sipType_wxPGProperty, &property, &column, &item, &flags))
        {
            bool sipRes;
    ...
    sipNoMethod(sipParseErr, sipName_PGDefaultRenderer, sipName_Render, NULL);
...
static PyObject *meth_wxPGDefaultRenderer_GetImageSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8ii", &sipSelf, sipType_wxPGDefaultRenderer, &sipCpp, sipType_wxPGProperty, &property, &column, &item))
        {
             ::wxSize*sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PGDefaultRenderer, sipName_GetImageSize, NULL);
...
static void dealloc_wxPGDefaultRenderer(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxPGDefaultRenderer *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxPGDefaultRenderer *sipCpp = 0;
...
static sipEncodedTypeDef supers_wxPGDefaultRenderer[] = {{25, 255, 1}};


static PyMethodDef methods_wxPGDefaultRenderer[] = {
    {SIP_MLNAME_CAST(sipName_GetImageSize), (PyCFunction)meth_wxPGDefaultRenderer_GetImageSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPGDefaultRenderer_GetImageSize)},
    {SIP_MLNAME_CAST(sipName_Render), (PyCFunction)meth_wxPGDefaultRenderer_Render, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPGDefaultRenderer_Render)}
};
