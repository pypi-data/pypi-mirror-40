...
public:
    sipwxGenericDirCtrl();
    sipwxGenericDirCtrl( ::wxWindow*,const  ::wxWindowID,const  ::wxString&,const  ::wxPoint&,const  ::wxSize&,long,const  ::wxString&,int,const  ::wxString&);
...
sipwxGenericDirCtrl::sipwxGenericDirCtrl():  ::wxGenericDirCtrl(), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxGenericDirCtrl::sipwxGenericDirCtrl( ::wxWindow*parent,const  ::wxWindowID id,const  ::wxString& dir,const  ::wxPoint& pos,const  ::wxSize& size,long style,const  ::wxString& filter,int defaultFilter,const  ::wxString& name):  ::wxGenericDirCtrl(parent,id,dir,pos,size,style,filter,defaultFilter,name), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
extern "C" {static PyObject *meth_wxGenericDirCtrl_SendDestroyEvent(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxGenericDirCtrl_SendDestroyEvent(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, NULL, NULL, "B", &sipSelf, sipType_wxGenericDirCtrl, &sipCpp))
        {
            PyErr_Clear();
    ...
    sipNoMethod(sipParseErr, sipName_GenericDirCtrl, sipName_SendDestroyEvent, NULL);
...
static PyObject *meth_wxGenericDirCtrl_CollapsePath(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxGenericDirCtrl, &sipCpp, sipType_wxString,&path, &pathState))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GenericDirCtrl, sipName_CollapsePath, NULL);
...
static PyObject *meth_wxGenericDirCtrl_CollapseTree(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GenericDirCtrl, sipName_CollapseTree, NULL);

    return NULL;
}


PyDoc_STRVAR(doc_wxGenericDirCtrl_Create, "Create(parent, id=ID_ANY, dir=DirDialogDefaultFolderStr, pos=DefaultPosition, size=DefaultSize, style=DIRCTRL_3D_INTERNAL, filter=EmptyString, defaultFilter=0, name=TreeCtrlNameStr) -> bool\n"
"\n"
...
static PyObject *meth_wxGenericDirCtrl_Create(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GenericDirCtrl, sipName_Create, NULL);
...
static PyObject *meth_wxGenericDirCtrl_ExpandPath(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GenericDirCtrl, sipName_ExpandPath, NULL);
...
static PyObject *meth_wxGenericDirCtrl_GetDefaultPath(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GenericDirCtrl, sipName_GetDefaultPath, NULL);
...
static PyObject *meth_wxGenericDirCtrl_GetFilePath(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GenericDirCtrl, sipName_GetFilePath, NULL);
...
static PyObject *meth_wxGenericDirCtrl_GetFilePaths(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxGenericDirCtrl, &sipCpp, sipType_wxArrayString,&paths, &pathsState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GenericDirCtrl, sipName_GetFilePaths, NULL);
...
static PyObject *meth_wxGenericDirCtrl_GetFilter(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GenericDirCtrl, sipName_GetFilter, NULL);
...
static PyObject *meth_wxGenericDirCtrl_GetFilterIndex(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GenericDirCtrl, sipName_GetFilterIndex, NULL);
...
static PyObject *meth_wxGenericDirCtrl_GetFilterListCtrl(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxGenericDirCtrl, &sipCpp))
        {
            ...
            return sipConvertFromType(sipRes,sipType_wxDirFilterListCtrl,NULL);
        }
    }

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GenericDirCtrl, sipName_GetFilterListCtrl, NULL);
...
static PyObject *meth_wxGenericDirCtrl_GetPath(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxGenericDirCtrl, &sipCpp, sipType_wxTreeItemId, &itemId))
        {
             ::wxString*sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GenericDirCtrl, sipName_GetPath, NULL);
...
static PyObject *meth_wxGenericDirCtrl_GetPaths(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GenericDirCtrl, sipName_GetPaths, NULL);
...
static PyObject *meth_wxGenericDirCtrl_GetRootId(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxGenericDirCtrl, &sipCpp))
        {
            ...
            return sipConvertFromNewType(sipRes,sipType_wxTreeItemId,NULL);
        }
    }

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GenericDirCtrl, sipName_GetRootId, NULL);
...
static PyObject *meth_wxGenericDirCtrl_GetTreeCtrl(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxGenericDirCtrl, &sipCpp))
        {
            ...
            return sipConvertFromType(sipRes,sipType_wxTreeCtrl,NULL);
        }
    }

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GenericDirCtrl, sipName_GetTreeCtrl, NULL);
...
static PyObject *meth_wxGenericDirCtrl_Init(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GenericDirCtrl, sipName_Init, NULL);
...
static PyObject *meth_wxGenericDirCtrl_ReCreateTree(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GenericDirCtrl, sipName_ReCreateTree, NULL);
...
static PyObject *meth_wxGenericDirCtrl_SetDefaultPath(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GenericDirCtrl, sipName_SetDefaultPath, NULL);
...
static PyObject *meth_wxGenericDirCtrl_SetFilter(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxGenericDirCtrl, &sipCpp, sipType_wxString,&filter, &filterState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GenericDirCtrl, sipName_SetFilter, NULL);
...
static PyObject *meth_wxGenericDirCtrl_SetFilterIndex(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bi", &sipSelf, sipType_wxGenericDirCtrl, &sipCpp, &n))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GenericDirCtrl, sipName_SetFilterIndex, NULL);
...
static PyObject *meth_wxGenericDirCtrl_SetPath(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GenericDirCtrl, sipName_SetPath, NULL);
...
static PyObject *meth_wxGenericDirCtrl_ShowHidden(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bb", &sipSelf, sipType_wxGenericDirCtrl, &sipCpp, &show))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GenericDirCtrl, sipName_ShowHidden, NULL);
...
static PyObject *meth_wxGenericDirCtrl_SelectPath(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1|b", &sipSelf, sipType_wxGenericDirCtrl, &sipCpp, sipType_wxString,&path, &pathState, &select))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GenericDirCtrl, sipName_SelectPath, NULL);
...
static PyObject *meth_wxGenericDirCtrl_SelectPaths(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GenericDirCtrl, sipName_SelectPaths, NULL);
...
static PyObject *meth_wxGenericDirCtrl_UnselectAll(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GenericDirCtrl, sipName_UnselectAll, NULL);
...
static PyObject *meth_wxGenericDirCtrl_AddChild(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8", &sipSelf, sipType_wxGenericDirCtrl, &sipCpp, sipType_wxWindowBase, &child))
        {
            PyErr_Clear();
...
static PyObject *meth_wxGenericDirCtrl_InformFirstDirection(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Biii", &sipSelf, sipType_wxGenericDirCtrl, &sipCpp, &direction, &size, &availableOtherDir))
        {
            bool sipRes;
...
static PyObject *meth_wxGenericDirCtrl_SetCanFocus(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bb", &sipSelf, sipType_wxGenericDirCtrl, &sipCpp, &canFocus))
        {
            PyErr_Clear();
...
static PyObject *meth_wxGenericDirCtrl_SetValidator(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxGenericDirCtrl, &sipCpp, sipType_wxValidator, &validator))
        {
            PyErr_Clear();
...
static PyObject *meth_wxGenericDirCtrl_ProcessEvent(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxGenericDirCtrl, &sipCpp, sipType_wxEvent, &event))
        {
            bool sipRes;
...
static PyObject *meth_wxGenericDirCtrl_DoEnable(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bb", &sipSelf, sipType_wxGenericDirCtrl, &sipCpp, &enable))
        {
            PyErr_Clear();
...
extern "C" {static PyObject *meth_wxGenericDirCtrl_DoGetBestSize(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxGenericDirCtrl_DoGetBestSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxGenericDirCtrl_DoGetBestClientSize(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxGenericDirCtrl_DoGetBestClientSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
static PyObject *meth_wxGenericDirCtrl_DoSetSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Biiiii", &sipSelf, sipType_wxGenericDirCtrl, &sipCpp, &x, &y, &width, &height, &sizeFlags))
        {
            PyErr_Clear();
...
static PyObject *meth_wxGenericDirCtrl_DoSetClientSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bii", &sipSelf, sipType_wxGenericDirCtrl, &sipCpp, &width, &height))
        {
            PyErr_Clear();
...
static PyObject *meth_wxGenericDirCtrl_DoSetSizeHints(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Biiiiii", &sipSelf, sipType_wxGenericDirCtrl, &sipCpp, &minW, &minH, &maxW, &maxH, &incW, &incH))
        {
            PyErr_Clear();
...
extern "C" {static PyObject *meth_wxGenericDirCtrl_DoGetBorderSize(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxGenericDirCtrl_DoGetBorderSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
static PyObject *meth_wxGenericDirCtrl_DoMoveWindow(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Biiii", &sipSelf, sipType_wxGenericDirCtrl, &sipCpp, &x, &y, &width, &height))
        {
            PyErr_Clear();
...
static PyObject *meth_wxGenericDirCtrl_DoSetWindowVariant(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BE", &sipSelf, sipType_wxGenericDirCtrl, &sipCpp, sipType_wxWindowVariant, &variant))
        {
            PyErr_Clear();
...
extern "C" {static PyObject *meth_wxGenericDirCtrl_GetDefaultBorder(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxGenericDirCtrl_GetDefaultBorder(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxGenericDirCtrl_GetDefaultBorderForControl(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxGenericDirCtrl_GetDefaultBorderForControl(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxGenericDirCtrl_DoFreeze(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxGenericDirCtrl_DoFreeze(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxGenericDirCtrl_DoThaw(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxGenericDirCtrl_DoThaw(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxGenericDirCtrl_HasTransparentBackground(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxGenericDirCtrl_HasTransparentBackground(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
static void dealloc_wxGenericDirCtrl(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxGenericDirCtrl *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static sipEncodedTypeDef supers_wxGenericDirCtrl[] = {{90, 255, 1}};
...
static PyMethodDef methods_wxGenericDirCtrl[] = {
    ...
    {SIP_MLNAME_CAST(sipName_AddChild), (PyCFunction)meth_wxGenericDirCtrl_AddChild, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_AddChild)},
    {SIP_MLNAME_CAST(sipName_CollapsePath), (PyCFunction)meth_wxGenericDirCtrl_CollapsePath, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_CollapsePath)},
    ...
    {SIP_MLNAME_CAST(sipName_Create), (PyCFunction)meth_wxGenericDirCtrl_Create, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_Create)},
    {SIP_MLNAME_CAST(sipName_Destroy), meth_wxGenericDirCtrl_Destroy, METH_VARARGS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_Destroy)},
    {SIP_MLNAME_CAST(sipName_DoEnable), (PyCFunction)meth_wxGenericDirCtrl_DoEnable, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_DoEnable)},
    {SIP_MLNAME_CAST(sipName_DoFreeze), (PyCFunction)meth_wxGenericDirCtrl_DoFreeze, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_DoFreeze)},
    {SIP_MLNAME_CAST(sipName_DoGetBestClientSize), (PyCFunction)meth_wxGenericDirCtrl_DoGetBestClientSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_DoGetBestClientSize)},
    {SIP_MLNAME_CAST(sipName_DoGetBestSize), (PyCFunction)meth_wxGenericDirCtrl_DoGetBestSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_DoGetBestSize)},
    {SIP_MLNAME_CAST(sipName_DoGetBorderSize), (PyCFunction)meth_wxGenericDirCtrl_DoGetBorderSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_DoGetBorderSize)},
    {SIP_MLNAME_CAST(sipName_DoGetClientSize), (PyCFunction)meth_wxGenericDirCtrl_DoGetClientSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_DoGetClientSize)},
    {SIP_MLNAME_CAST(sipName_DoGetPosition), (PyCFunction)meth_wxGenericDirCtrl_DoGetPosition, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_DoGetPosition)},
    {SIP_MLNAME_CAST(sipName_DoGetSize), (PyCFunction)meth_wxGenericDirCtrl_DoGetSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_DoGetSize)},
    {SIP_MLNAME_CAST(sipName_DoMoveWindow), (PyCFunction)meth_wxGenericDirCtrl_DoMoveWindow, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_DoMoveWindow)},
    {SIP_MLNAME_CAST(sipName_DoSetClientSize), (PyCFunction)meth_wxGenericDirCtrl_DoSetClientSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_DoSetClientSize)},
    {SIP_MLNAME_CAST(sipName_DoSetSize), (PyCFunction)meth_wxGenericDirCtrl_DoSetSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_DoSetSize)},
    {SIP_MLNAME_CAST(sipName_DoSetSizeHints), (PyCFunction)meth_wxGenericDirCtrl_DoSetSizeHints, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_DoSetSizeHints)},
    {SIP_MLNAME_CAST(sipName_DoSetWindowVariant), (PyCFunction)meth_wxGenericDirCtrl_DoSetWindowVariant, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_DoSetWindowVariant)},
    {SIP_MLNAME_CAST(sipName_DoThaw), (PyCFunction)meth_wxGenericDirCtrl_DoThaw, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_DoThaw)},
    {SIP_MLNAME_CAST(sipName_ExpandPath), (PyCFunction)meth_wxGenericDirCtrl_ExpandPath, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_ExpandPath)},
    ...
    {SIP_MLNAME_CAST(sipName_GetDefaultBorder), (PyCFunction)meth_wxGenericDirCtrl_GetDefaultBorder, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_GetDefaultBorder)},
    {SIP_MLNAME_CAST(sipName_GetDefaultBorderForControl), (PyCFunction)meth_wxGenericDirCtrl_GetDefaultBorderForControl, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_GetDefaultBorderForControl)},
    ...
    {SIP_MLNAME_CAST(sipName_GetFilePaths), (PyCFunction)meth_wxGenericDirCtrl_GetFilePaths, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_GetFilePaths)},
    ...
    {SIP_MLNAME_CAST(sipName_GetPath), (PyCFunction)meth_wxGenericDirCtrl_GetPath, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_GetPath)},
    {SIP_MLNAME_CAST(sipName_GetPaths), (PyCFunction)meth_wxGenericDirCtrl_GetPaths, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_GetPaths)},
    ...
    {SIP_MLNAME_CAST(sipName_HasTransparentBackground), (PyCFunction)meth_wxGenericDirCtrl_HasTransparentBackground, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_HasTransparentBackground)},
    {SIP_MLNAME_CAST(sipName_InformFirstDirection), (PyCFunction)meth_wxGenericDirCtrl_InformFirstDirection, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_InformFirstDirection)},
    ...
    {SIP_MLNAME_CAST(sipName_ProcessEvent), (PyCFunction)meth_wxGenericDirCtrl_ProcessEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_ProcessEvent)},
    ...
    {SIP_MLNAME_CAST(sipName_RemoveChild), (PyCFunction)meth_wxGenericDirCtrl_RemoveChild, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_RemoveChild)},
    {SIP_MLNAME_CAST(sipName_SelectPath), (PyCFunction)meth_wxGenericDirCtrl_SelectPath, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_SelectPath)},
    {SIP_MLNAME_CAST(sipName_SelectPaths), (PyCFunction)meth_wxGenericDirCtrl_SelectPaths, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_SelectPaths)},
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxGenericDirCtrl_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_SetCanFocus), (PyCFunction)meth_wxGenericDirCtrl_SetCanFocus, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_SetCanFocus)},
    {SIP_MLNAME_CAST(sipName_SetDefaultPath), (PyCFunction)meth_wxGenericDirCtrl_SetDefaultPath, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_SetDefaultPath)},
    {SIP_MLNAME_CAST(sipName_SetFilter), (PyCFunction)meth_wxGenericDirCtrl_SetFilter, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_SetFilter)},
    {SIP_MLNAME_CAST(sipName_SetFilterIndex), (PyCFunction)meth_wxGenericDirCtrl_SetFilterIndex, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_SetFilterIndex)},
    {SIP_MLNAME_CAST(sipName_SetPath), (PyCFunction)meth_wxGenericDirCtrl_SetPath, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_SetPath)},
    {SIP_MLNAME_CAST(sipName_SetValidator), (PyCFunction)meth_wxGenericDirCtrl_SetValidator, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_SetValidator)},
    ...
    {SIP_MLNAME_CAST(sipName_ShowHidden), (PyCFunction)meth_wxGenericDirCtrl_ShowHidden, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_ShowHidden)},
    ...
    {SIP_MLNAME_CAST(sipName_TryAfter), (PyCFunction)meth_wxGenericDirCtrl_TryAfter, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_TryAfter)},
    {SIP_MLNAME_CAST(sipName_TryBefore), (PyCFunction)meth_wxGenericDirCtrl_TryBefore, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGenericDirCtrl_TryBefore)},
...
sipVariableDef variables_wxGenericDirCtrl[] = {
    {PropertyVariable, sipName_TreeCtrl, &methods_wxGenericDirCtrl[36], NULL, NULL, NULL},
    {PropertyVariable, sipName_RootId, &methods_wxGenericDirCtrl[35], NULL, NULL, NULL},
    {PropertyVariable, sipName_Path, &methods_wxGenericDirCtrl[33], &methods_wxGenericDirCtrl[54], NULL, NULL},
    {PropertyVariable, sipName_FilterListCtrl, &methods_wxGenericDirCtrl[31], NULL, NULL, NULL},
    {PropertyVariable, sipName_FilterIndex, &methods_wxGenericDirCtrl[30], &methods_wxGenericDirCtrl[53], NULL, NULL},
    {PropertyVariable, sipName_Filter, &methods_wxGenericDirCtrl[29], &methods_wxGenericDirCtrl[52], NULL, NULL},
    {PropertyVariable, sipName_FilePath, &methods_wxGenericDirCtrl[27], NULL, NULL, NULL},
    {PropertyVariable, sipName_DefaultPath, &methods_wxGenericDirCtrl[26], &methods_wxGenericDirCtrl[51], NULL, NULL},
};
