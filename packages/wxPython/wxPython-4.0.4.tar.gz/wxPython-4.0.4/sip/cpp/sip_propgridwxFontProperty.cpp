...
sipwxFontProperty::sipwxFontProperty(const  ::wxString& label,const  ::wxString& name,const  ::wxFont& value):  ::wxFontProperty(label,name,value), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxFontProperty::sipwxFontProperty(const  ::wxFontProperty& a0):  ::wxFontProperty(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
static PyObject *meth_wxFontProperty_OnSetValue(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_FontProperty, sipName_OnSetValue, NULL);
...
static PyObject *meth_wxFontProperty_ValueToString(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1|i", &sipSelf, sipType_wxFontProperty, &sipCpp, sipType_wxPGVariant,&value, &valueState, &argFlags))
        {
             ::wxString*sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FontProperty, sipName_ValueToString, NULL);

    return NULL;
}


PyDoc_STRVAR(doc_wxFontProperty_OnEvent, "OnEvent(propgrid, wnd_primary, event) -> bool\n"
"\n"
"Events received by editor widgets are processed here.");

extern "C" {static PyObject *meth_wxFontProperty_OnEvent(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxFontProperty_OnEvent(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8J8J9", &sipSelf, sipType_wxFontProperty, &sipCpp, sipType_wxPropertyGrid, &propgrid, sipType_wxWindow, &wnd_primary, sipType_wxEvent, &event))
        {
            bool sipRes;
            ...
            Py_BEGIN_ALLOW_THREADS
            sipRes = (sipSelfWasArg ? sipCpp-> ::wxFontProperty::OnEvent(propgrid,wnd_primary,*event) : sipCpp->OnEvent(propgrid,wnd_primary,*event));
            Py_END_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FontProperty, sipName_OnEvent, NULL);
...
static PyObject *meth_wxFontProperty_ChildChanged(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1iJ1", &sipSelf, sipType_wxFontProperty, &sipCpp, sipType_wxPGVariant,&thisValue, &thisValueState, &childIndex, sipType_wxPGVariant,&childValue, &childValueState))
        {
             ::wxPGVariant*sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FontProperty, sipName_ChildChanged, NULL);
...
static PyObject *meth_wxFontProperty_RefreshChildren(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FontProperty, sipName_RefreshChildren, NULL);
...
extern "C" {static void *array_wxFontProperty(SIP_SSIZE_T);}
static void *array_wxFontProperty(SIP_SSIZE_T sipNrElem)
{
...
static void dealloc_wxFontProperty(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxFontProperty *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static void *init_type_wxFontProperty(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxFontProperty, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxFontProperty[] = {{43, 255, 1}};


static PyMethodDef methods_wxFontProperty[] = {
    {SIP_MLNAME_CAST(sipName_ChildChanged), (PyCFunction)meth_wxFontProperty_ChildChanged, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxFontProperty_ChildChanged)},
    {SIP_MLNAME_CAST(sipName_OnEvent), (PyCFunction)meth_wxFontProperty_OnEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxFontProperty_OnEvent)},
    ...
    {SIP_MLNAME_CAST(sipName_ValueToString), (PyCFunction)meth_wxFontProperty_ValueToString, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxFontProperty_ValueToString)}
};
