...
const char sipStrings__grid[] = {
    'G', 'R', 'I', 'D', 'T', 'A', 'B', 'L', 'E', '_', 'R', 'E', 'Q', 'U', 'E', 'S', 'T', '_', 'V', 'I', 'E', 'W', '_', 'S', 'E', 'N', 'D', '_', 'V', 'A', 'L', 'U', 'E', 'S', 0,
    ...
    'G', 'R', 'I', 'D', 'T', 'A', 'B', 'L', 'E', '_', 'R', 'E', 'Q', 'U', 'E', 'S', 'T', '_', 'V', 'I', 'E', 'W', '_', 'G', 'E', 'T', '_', 'V', 'A', 'L', 'U', 'E', 'S', 0,
    ...
    'w', 'x', 'E', 'V', 'T', '_', 'G', 'R', 'I', 'D', '_', 'R', 'A', 'N', 'G', 'E', '_', 'S', 'E', 'L', 'E', 'C', 'T', 0,
    ...
    'S', 'e', 'l', 'e', 'c', 't', 'R', 'o', 'w', 's', 'O', 'r', 'C', 'o', 'l', 'u', 'm', 'n', 's', 0,
    ...
    'w', 'x', 'G', 'r', 'i', 'd', 'D', 'i', 'r', 'e', 'c', 't', 'i', 'o', 'n', 0,
 ...
 ::wxEvent* sipVH__grid_63(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
     ::wxEvent* sipRes = 0;
 ...
 ::wxEventCategory sipVH__grid_62(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
 ...
 ::wxPen sipVH__grid_61(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
     ::wxPen sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "");
 ...
 ::wxPen sipVH__grid_60(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int col)
{
     ::wxPen sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "i", col);
 ...
 ::wxSize sipVH__grid_59(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxSize& size)
{
     ::wxSize sipRes;
...
bool sipVH__grid_58(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxScrollWinEvent& event)
{
    bool sipRes = 0;
...
void sipVH__grid_57(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxDC& dc)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "D", &dc, sipType_wxDC, NULL);
}

void sipVH__grid_56(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxWindowBase*child)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "D", child, sipType_wxWindowBase, NULL);
}

bool sipVH__grid_55(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxEvent& event)
{
    bool sipRes = 0;
...
bool sipVH__grid_54(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int direction,int size,int availableOtherDir)
{
 ...
 ::wxPoint sipVH__grid_53(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
     ::wxPoint sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "");
 ...
 ::wxValidator* sipVH__grid_52(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
 ...
 ::wxWindow* sipVH__grid_51(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
     ::wxWindow* sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "");
...
void sipVH__grid_50(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, bool enable)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "b", enable);
}

void sipVH__grid_49(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int*width,int*height)
{
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "");
...
void sipVH__grid_48(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int x,int y,int width,int height,int sizeFlags)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "iiiii", x, y, width, height, sizeFlags);
}

void sipVH__grid_47(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int width,int height)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "ii", width, height);
}

void sipVH__grid_46(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int minW,int minH,int maxW,int maxH,int incW,int incH)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "iiiiii", minW, minH, maxW, maxH, incW, incH);
}

void sipVH__grid_45(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int x,int y,int width,int height)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "iiii", x, y, width, height);
}

void sipVH__grid_44(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxWindowVariant variant)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "F", variant, sipType_wxWindowVariant);
}

 ::wxBorder sipVH__grid_43(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
 ...
 ::wxSize sipVH__grid_42(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
     ::wxSize sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "");
 ...
 ::wxString sipVH__grid_41(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int row,int col)
{
     ::wxString sipRes;
    int sipIsErr = 0;
...
bool sipVH__grid_40(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "");
 ...
 ::wxGrid* sipVH__grid_39(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
     ::wxGrid* sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "");
...
void sipVH__grid_38(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxGrid*grid)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "D", grid, sipType_wxGrid, NULL);
}

int sipVH__grid_37(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
    int sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "");
...
void sipVH__grid_36(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int row,const  ::wxString& label)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "iN", row, new  ::wxString(label), sipType_wxString, NULL);
}

 ::wxString sipVH__grid_35(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int row)
{
     ::wxString sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "i", row);
...
bool sipVH__grid_34(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::size_t numRows)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "N", new  ::size_t(numRows), sipType_size_t, NULL);
...
bool sipVH__grid_33(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::size_t pos, ::size_t numRows)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "NN", new  ::size_t(pos), sipType_size_t, NULL, new  ::size_t(numRows), sipType_size_t, NULL);
...
void sipVH__grid_31(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int row,int col,double value)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "iid", row, col, value);
}

void sipVH__grid_30(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int row,int col,long value)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "iil", row, col, value);
}

double sipVH__grid_29(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int row,int col)
{
    double sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "ii", row, col);
...
long sipVH__grid_28(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int row,int col)
{
    long sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "ii", row, col);
...
bool sipVH__grid_27(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int row,int col,const  ::wxString& typeName)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "iiN", row, col, new  ::wxString(typeName), sipType_wxString, NULL);
 ...
 ::wxString sipVH__grid_26(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int row,int col)
{
     ::wxString sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "ii", row, col);
...
void sipVH__grid_25(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int row,int col,const  ::wxString& value)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "iiN", row, col, new  ::wxString(value), sipType_wxString, NULL);
}

 ::wxString sipVH__grid_24(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int row,int col)
{
     ::wxString sipRes;
    int sipIsErr = 0;
...
bool sipVH__grid_23(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int row,int col)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "ii", row, col);
 ...
 ::wxGridCellAttr* sipVH__grid_22(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int row,int col, ::wxGridCellAttr::wxAttrKind kind)
{
     ::wxGridCellAttr* sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "iiF", row, col, kind, sipType_wxGridCellAttr_wxAttrKind);
...
const  ::wxGridCornerHeaderRenderer& sipVH__grid_21(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
    ...
    if (sipRc < 0)
    {
        static  ::wxGridCornerHeaderRenderer *sipCpp = 0;
...
const  ::wxGridRowHeaderRenderer& sipVH__grid_20(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int row)
{
    ...
    if (sipRc < 0)
    {
        static  ::wxGridRowHeaderRenderer *sipCpp = 0;
...
const  ::wxGridColumnHeaderRenderer& sipVH__grid_19(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int col)
{
    ...
    if (sipRc < 0)
    {
        static  ::wxGridColumnHeaderRenderer *sipCpp = 0;
...
void sipVH__grid_18(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxGridCellAttr*attr,int row)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "Di", attr, sipType_wxGridCellAttr, NULL, row);
}

void sipVH__grid_17(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxGridCellAttr*attr,int row,int col)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "Dii", attr, sipType_wxGridCellAttr, NULL, row, col);
}

void sipVH__grid_16(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxGrid& grid, ::wxDC& dc,const  ::wxString& value,const  ::wxRect& rect,int horizAlign,int vertAlign,int textOrientation)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "DDNNiii", const_cast< ::wxGrid *>(&grid), sipType_wxGrid, NULL, &dc, sipType_wxDC, NULL, new  ::wxString(value), sipType_wxString, NULL, new  ::wxRect(rect), sipType_wxRect, NULL, horizAlign, vertAlign, textOrientation);
}

void sipVH__grid_15(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxGrid& grid, ::wxDC& dc, ::wxRect& rect)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "DDD", const_cast< ::wxGrid *>(&grid), sipType_wxGrid, NULL, &dc, sipType_wxDC, NULL, &rect, sipType_wxRect, NULL);
}

void sipVH__grid_14(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxValidator& validator)
{
 ...
 ::wxString sipVH__grid_13(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
     ::wxString sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "");
...
void sipVH__grid_12(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, bool show, ::wxGridCellAttr*attr)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "bD", show, attr, sipType_wxGridCellAttr, NULL);
}

void sipVH__grid_11(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxRect& rect)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "N", new  ::wxRect(rect), sipType_wxRect, NULL);
}

void sipVH__grid_10(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxDC& dc,const  ::wxRect& rectCell, ::wxGridCellAttr& attr)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "DND", &dc, sipType_wxDC, NULL, new  ::wxRect(rectCell), sipType_wxRect, NULL, &attr, sipType_wxGridCellAttr, NULL);
}

void sipVH__grid_9(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxKeyEvent& event)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "D", &event, sipType_wxKeyEvent, NULL);
}

bool sipVH__grid_8(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int row,int col,const  ::wxGrid*grid,const  ::wxString& oldval, ::wxString*newval)
{
    bool sipRes = 0;
...
void sipVH__grid_7(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "");
}

void sipVH__grid_6(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxWindow*parent, ::wxWindowID id, ::wxEvtHandler*evtHandler)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "DiD", parent, sipType_wxWindow, NULL, id, evtHandler, sipType_wxEvtHandler, NULL);
}

 ::wxGridCellEditor* sipVH__grid_5(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
...
void sipVH__grid_4(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int row,int col, ::wxGrid*grid)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "iiD", row, col, grid, sipType_wxGrid, NULL);
}

void sipVH__grid_3(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxString& params)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "N", new  ::wxString(params), sipType_wxString, NULL);
}
...
{
     ::wxSize sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "DDDii", &grid, sipType_wxGrid, NULL, &attr, sipType_wxGridCellAttr, NULL, &dc, sipType_wxDC, NULL, row, col);
...
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "DDDNiib", &grid, sipType_wxGrid, NULL, &attr, sipType_wxGridCellAttr, NULL, &dc, sipType_wxDC, NULL, new  ::wxRect(rect), sipType_wxRect, NULL, row, col, isSelected);
}
...
static sipEnumTypeDef enumTypes[] = {
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxGrid__TabBehaviour, {0}, 0}, sipNameNr_TabBehaviour, 0, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxGrid__CellSpan, {0}, 0}, sipNameNr_CellSpan, 0, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxGrid__wxGridSelectionModes, {0}, 0}, sipNameNr_GridSelectionModes, 0, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxGridCellAttr__wxAttrKind, {0}, 0}, sipNameNr_AttrKind, 4, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxGridRenderStyle, {0}, 0}, sipNameNr_GridRenderStyle, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxGridTableRequest, {0}, 0}, sipNameNr_GridTableRequest, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxGridCellFloatFormat, {0}, 0}, sipNameNr_GridCellFloatFormat, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxGridDirection, {0}, 0}, sipNameNr_GridDirection, -1, NULL},
};

/* These are the enum members of all global enums. */
static sipEnumMemberDef enummembers[] = {
    {sipName_GRIDTABLE_NOTIFY_COLS_APPENDED, static_cast<int>(::wxGRIDTABLE_NOTIFY_COLS_APPENDED), 43},
    {sipName_GRIDTABLE_NOTIFY_COLS_DELETED, static_cast<int>(::wxGRIDTABLE_NOTIFY_COLS_DELETED), 43},
    {sipName_GRIDTABLE_NOTIFY_COLS_INSERTED, static_cast<int>(::wxGRIDTABLE_NOTIFY_COLS_INSERTED), 43},
    {sipName_GRIDTABLE_NOTIFY_ROWS_APPENDED, static_cast<int>(::wxGRIDTABLE_NOTIFY_ROWS_APPENDED), 43},
    {sipName_GRIDTABLE_NOTIFY_ROWS_DELETED, static_cast<int>(::wxGRIDTABLE_NOTIFY_ROWS_DELETED), 43},
    {sipName_GRIDTABLE_NOTIFY_ROWS_INSERTED, static_cast<int>(::wxGRIDTABLE_NOTIFY_ROWS_INSERTED), 43},
    {sipName_GRIDTABLE_REQUEST_VIEW_GET_VALUES, static_cast<int>(::wxGRIDTABLE_REQUEST_VIEW_GET_VALUES), 43},
    {sipName_GRIDTABLE_REQUEST_VIEW_SEND_VALUES, static_cast<int>(::wxGRIDTABLE_REQUEST_VIEW_SEND_VALUES), 43},
    {sipName_GRID_COLUMN, static_cast<int>(::wxGRID_COLUMN), 30},
    {sipName_GRID_DRAW_BOX_RECT, static_cast<int>(::wxGRID_DRAW_BOX_RECT), 35},
    {sipName_GRID_DRAW_CELL_LINES, static_cast<int>(::wxGRID_DRAW_CELL_LINES), 35},
    {sipName_GRID_DRAW_COLS_HEADER, static_cast<int>(::wxGRID_DRAW_COLS_HEADER), 35},
    {sipName_GRID_DRAW_DEFAULT, static_cast<int>(::wxGRID_DRAW_DEFAULT), 35},
    {sipName_GRID_DRAW_ROWS_HEADER, static_cast<int>(::wxGRID_DRAW_ROWS_HEADER), 35},
    {sipName_GRID_DRAW_SELECTION, static_cast<int>(::wxGRID_DRAW_SELECTION), 35},
    {sipName_GRID_FLOAT_FORMAT_COMPACT, static_cast<int>(::wxGRID_FLOAT_FORMAT_COMPACT), 19},
    {sipName_GRID_FLOAT_FORMAT_DEFAULT, static_cast<int>(::wxGRID_FLOAT_FORMAT_DEFAULT), 19},
    {sipName_GRID_FLOAT_FORMAT_FIXED, static_cast<int>(::wxGRID_FLOAT_FORMAT_FIXED), 19},
    {sipName_GRID_FLOAT_FORMAT_SCIENTIFIC, static_cast<int>(::wxGRID_FLOAT_FORMAT_SCIENTIFIC), 19},
    {sipName_GRID_FLOAT_FORMAT_UPPER, static_cast<int>(::wxGRID_FLOAT_FORMAT_UPPER), 19},
    {sipName_GRID_ROW, static_cast<int>(::wxGRID_ROW), 30},
};
...
static sipImportedModuleDef importsTable[] = {
    {"wx._core", sipImportedTypes__grid__core, NULL, NULL},
    {NULL, NULL, NULL, NULL}
};
...
static sipIntInstanceDef intInstances[] = {
    ...
    {sipName_wxEVT_GRID_RANGE_SELECT, wxEVT_GRID_RANGE_SELECT},
