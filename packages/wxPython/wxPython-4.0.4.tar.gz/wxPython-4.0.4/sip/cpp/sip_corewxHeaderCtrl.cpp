...
public:
     ...
     */
protected:
    void OnColumnCountChanging(uint);
    bool UpdateColumnWidthToFit(uint,int);
    void UpdateColumnsOrder(const  ::wxArrayInt&);
    void UpdateColumnVisibility(uint,bool);
    const  ::wxHeaderColumn& GetColumn(uint) const;
...
sipwxHeaderCtrl::sipwxHeaderCtrl():  ::wxHeaderCtrl(), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxHeaderCtrl::sipwxHeaderCtrl( ::wxWindow*parent, ::wxWindowID winid,const  ::wxPoint& pos,const  ::wxSize& size,long style,const  ::wxString& name):  ::wxHeaderCtrl(parent,winid,pos,size,style,name), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
void sipwxHeaderCtrl::OnColumnCountChanging(uint count)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[0],sipPySelf,NULL,sipName_OnColumnCountChanging);
    ...
    extern void sipVH__core_160(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, uint);

    sipVH__core_160(sipGILState, 0, sipPySelf, sipMeth, count);
}
...
bool sipwxHeaderCtrl::UpdateColumnWidthToFit(uint idx,int widthTitle)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[1],sipPySelf,NULL,sipName_UpdateColumnWidthToFit);

    if (!sipMeth)
        return  ::wxHeaderCtrl::UpdateColumnWidthToFit(idx,widthTitle);

    extern bool sipVH__core_159(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, uint,int);

    return sipVH__core_159(sipGILState, 0, sipPySelf, sipMeth, idx, widthTitle);
}
...
void sipwxHeaderCtrl::UpdateColumnsOrder(const  ::wxArrayInt& order)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[2],sipPySelf,NULL,sipName_UpdateColumnsOrder);
    ...
    extern void sipVH__core_158(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxArrayInt&);

    sipVH__core_158(sipGILState, 0, sipPySelf, sipMeth, order);
}
...
void sipwxHeaderCtrl::UpdateColumnVisibility(uint idx,bool show)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[3],sipPySelf,NULL,sipName_UpdateColumnVisibility);
    ...
    extern void sipVH__core_157(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, uint,bool);

    sipVH__core_157(sipGILState, 0, sipPySelf, sipMeth, idx, show);
}
...
const  ::wxHeaderColumn& sipwxHeaderCtrl::GetColumn(uint idx) const
{
    ...
    if (!sipMeth)
    {
        static  ::wxHeaderColumn *sipCpp = 0;
    ...
    extern const  ::wxHeaderColumn& sipVH__core_156(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, uint);

    return sipVH__core_156(sipGILState, 0, sipPySelf, sipMeth, idx);
}
...
extern "C" {static PyObject *meth_wxHeaderCtrl_SendDestroyEvent(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxHeaderCtrl_SendDestroyEvent(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, NULL, NULL, "B", &sipSelf, sipType_wxHeaderCtrl, &sipCpp))
        {
            PyErr_Clear();
    ...
    sipNoMethod(sipParseErr, sipName_HeaderCtrl, sipName_SendDestroyEvent, NULL);
...
static PyObject *meth_wxHeaderCtrl_Create(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJH|iJ1J1lJ1", &sipSelf, sipType_wxHeaderCtrl, &sipCpp, sipType_wxWindow, &parent, &sipOwner, &winid, sipType_wxPoint, &pos, &posState, sipType_wxSize, &size, &sizeState, &style, sipType_wxString,&name, &nameState))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HeaderCtrl, sipName_Create, NULL);
...
static PyObject *meth_wxHeaderCtrl_SetColumnCount(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bu", &sipSelf, sipType_wxHeaderCtrl, &sipCpp, &count))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HeaderCtrl, sipName_SetColumnCount, NULL);
...
static PyObject *meth_wxHeaderCtrl_GetColumnCount(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HeaderCtrl, sipName_GetColumnCount, NULL);
...
static PyObject *meth_wxHeaderCtrl_IsEmpty(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HeaderCtrl, sipName_IsEmpty, NULL);
...
static PyObject *meth_wxHeaderCtrl_UpdateColumn(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bu", &sipSelf, sipType_wxHeaderCtrl, &sipCpp, &idx))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HeaderCtrl, sipName_UpdateColumn, NULL);
...
static PyObject *meth_wxHeaderCtrl_SetColumnsOrder(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxHeaderCtrl, &sipCpp, sipType_wxArrayInt,&order, &orderState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HeaderCtrl, sipName_SetColumnsOrder, NULL);
...
static PyObject *meth_wxHeaderCtrl_GetColumnsOrder(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HeaderCtrl, sipName_GetColumnsOrder, NULL);
...
static PyObject *meth_wxHeaderCtrl_GetColumnAt(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bu", &sipSelf, sipType_wxHeaderCtrl, &sipCpp, &pos))
        {
            uint sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HeaderCtrl, sipName_GetColumnAt, NULL);
...
static PyObject *meth_wxHeaderCtrl_GetColumnPos(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HeaderCtrl, sipName_GetColumnPos, NULL);
...
static PyObject *meth_wxHeaderCtrl_ResetColumnsOrder(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HeaderCtrl, sipName_ResetColumnsOrder, NULL);
...
static PyObject *meth_wxHeaderCtrl_ShowColumnsMenu(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1|J1", &sipSelf, sipType_wxHeaderCtrl, &sipCpp, sipType_wxPoint, &pt, &ptState, sipType_wxString,&title, &titleState))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HeaderCtrl, sipName_ShowColumnsMenu, NULL);
...
static PyObject *meth_wxHeaderCtrl_AddColumnsItems(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9|i", &sipSelf, sipType_wxHeaderCtrl, &sipCpp, sipType_wxMenu, &menu, &idColumnsBase))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HeaderCtrl, sipName_AddColumnsItems, NULL);
...
static PyObject *meth_wxHeaderCtrl_ShowCustomizeDialog(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HeaderCtrl, sipName_ShowCustomizeDialog, NULL);
...
static PyObject *meth_wxHeaderCtrl_GetColumnTitleWidth(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxHeaderCtrl, &sipCpp, sipType_wxHeaderColumn, &col))
        {
            int sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HeaderCtrl, sipName_GetColumnTitleWidth, NULL);
...
static PyObject *meth_wxHeaderCtrl_MoveColumnInOrderArray(PyObject *, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "J1uu", sipType_wxArrayInt,&order, &orderState, &idx, &pos))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HeaderCtrl, sipName_MoveColumnInOrderArray, NULL);
...
static PyObject *meth_wxHeaderCtrl_AddChild(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8", &sipSelf, sipType_wxHeaderCtrl, &sipCpp, sipType_wxWindowBase, &child))
        {
            PyErr_Clear();
...
static PyObject *meth_wxHeaderCtrl_InformFirstDirection(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Biii", &sipSelf, sipType_wxHeaderCtrl, &sipCpp, &direction, &size, &availableOtherDir))
        {
            bool sipRes;
...
static PyObject *meth_wxHeaderCtrl_SetCanFocus(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bb", &sipSelf, sipType_wxHeaderCtrl, &sipCpp, &canFocus))
        {
            PyErr_Clear();
...
static PyObject *meth_wxHeaderCtrl_SetValidator(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxHeaderCtrl, &sipCpp, sipType_wxValidator, &validator))
        {
            PyErr_Clear();
...
static PyObject *meth_wxHeaderCtrl_ProcessEvent(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxHeaderCtrl, &sipCpp, sipType_wxEvent, &event))
        {
            bool sipRes;
...
static PyObject *meth_wxHeaderCtrl_DoEnable(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bb", &sipSelf, sipType_wxHeaderCtrl, &sipCpp, &enable))
        {
            PyErr_Clear();
...
extern "C" {static PyObject *meth_wxHeaderCtrl_DoGetBestSize(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxHeaderCtrl_DoGetBestSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxHeaderCtrl_DoGetBestClientSize(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxHeaderCtrl_DoGetBestClientSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
static PyObject *meth_wxHeaderCtrl_DoSetSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Biiiii", &sipSelf, sipType_wxHeaderCtrl, &sipCpp, &x, &y, &width, &height, &sizeFlags))
        {
            PyErr_Clear();
...
static PyObject *meth_wxHeaderCtrl_DoSetClientSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bii", &sipSelf, sipType_wxHeaderCtrl, &sipCpp, &width, &height))
        {
            PyErr_Clear();
...
static PyObject *meth_wxHeaderCtrl_DoSetSizeHints(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Biiiiii", &sipSelf, sipType_wxHeaderCtrl, &sipCpp, &minW, &minH, &maxW, &maxH, &incW, &incH))
        {
            PyErr_Clear();
...
extern "C" {static PyObject *meth_wxHeaderCtrl_DoGetBorderSize(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxHeaderCtrl_DoGetBorderSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
static PyObject *meth_wxHeaderCtrl_DoMoveWindow(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Biiii", &sipSelf, sipType_wxHeaderCtrl, &sipCpp, &x, &y, &width, &height))
        {
            PyErr_Clear();
...
static PyObject *meth_wxHeaderCtrl_DoSetWindowVariant(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BE", &sipSelf, sipType_wxHeaderCtrl, &sipCpp, sipType_wxWindowVariant, &variant))
        {
            PyErr_Clear();
...
extern "C" {static PyObject *meth_wxHeaderCtrl_GetDefaultBorder(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxHeaderCtrl_GetDefaultBorder(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxHeaderCtrl_GetDefaultBorderForControl(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxHeaderCtrl_GetDefaultBorderForControl(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxHeaderCtrl_DoFreeze(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxHeaderCtrl_DoFreeze(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxHeaderCtrl_DoThaw(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxHeaderCtrl_DoThaw(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxHeaderCtrl_HasTransparentBackground(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxHeaderCtrl_HasTransparentBackground(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
PyDoc_STRVAR(doc_wxHeaderCtrl_GetClassDefaultAttributes, "GetClassDefaultAttributes(variant: WindowVariant = wxWINDOW_VARIANT_NORMAL) -> VisualAttributes");
...
static PyObject *meth_wxHeaderCtrl_GetClassDefaultAttributes(PyObject *, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HeaderCtrl, sipName_GetClassDefaultAttributes, doc_wxHeaderCtrl_GetClassDefaultAttributes);
...
static PyObject *meth_wxHeaderCtrl_GetColumn(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bu", &sipSelf, sipType_wxHeaderCtrl, &sipCpp, &idx))
        {
            ...
            return sipConvertFromType(const_cast< ::wxHeaderColumn *>(sipRes),sipType_wxHeaderColumn,NULL);
        }
    }

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HeaderCtrl, sipName_GetColumn, NULL);
...
static PyObject *meth_wxHeaderCtrl_UpdateColumnVisibility(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bub", &sipSelf, sipType_wxHeaderCtrl, &sipCpp, &idx, &show))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HeaderCtrl, sipName_UpdateColumnVisibility, NULL);
...
static PyObject *meth_wxHeaderCtrl_UpdateColumnsOrder(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HeaderCtrl, sipName_UpdateColumnsOrder, NULL);
...
static PyObject *meth_wxHeaderCtrl_UpdateColumnWidthToFit(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bui", &sipSelf, sipType_wxHeaderCtrl, &sipCpp, &idx, &widthTitle))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HeaderCtrl, sipName_UpdateColumnWidthToFit, NULL);
...
static PyObject *meth_wxHeaderCtrl_OnColumnCountChanging(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HeaderCtrl, sipName_OnColumnCountChanging, NULL);
...
static void dealloc_wxHeaderCtrl(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxHeaderCtrl *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static sipEncodedTypeDef supers_wxHeaderCtrl[] = {{90, 255, 1}};
...
static PyMethodDef methods_wxHeaderCtrl[] = {
    ...
    {SIP_MLNAME_CAST(sipName_AddChild), (PyCFunction)meth_wxHeaderCtrl_AddChild, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_AddChild)},
    {SIP_MLNAME_CAST(sipName_AddColumnsItems), (PyCFunction)meth_wxHeaderCtrl_AddColumnsItems, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_AddColumnsItems)},
    {SIP_MLNAME_CAST(sipName_Create), (PyCFunction)meth_wxHeaderCtrl_Create, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_Create)},
    {SIP_MLNAME_CAST(sipName_Destroy), meth_wxHeaderCtrl_Destroy, METH_VARARGS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_Destroy)},
    {SIP_MLNAME_CAST(sipName_DoEnable), (PyCFunction)meth_wxHeaderCtrl_DoEnable, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_DoEnable)},
    {SIP_MLNAME_CAST(sipName_DoFreeze), (PyCFunction)meth_wxHeaderCtrl_DoFreeze, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_DoFreeze)},
    {SIP_MLNAME_CAST(sipName_DoGetBestClientSize), (PyCFunction)meth_wxHeaderCtrl_DoGetBestClientSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_DoGetBestClientSize)},
    {SIP_MLNAME_CAST(sipName_DoGetBestSize), (PyCFunction)meth_wxHeaderCtrl_DoGetBestSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_DoGetBestSize)},
    {SIP_MLNAME_CAST(sipName_DoGetBorderSize), (PyCFunction)meth_wxHeaderCtrl_DoGetBorderSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_DoGetBorderSize)},
    {SIP_MLNAME_CAST(sipName_DoGetClientSize), (PyCFunction)meth_wxHeaderCtrl_DoGetClientSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_DoGetClientSize)},
    {SIP_MLNAME_CAST(sipName_DoGetPosition), (PyCFunction)meth_wxHeaderCtrl_DoGetPosition, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_DoGetPosition)},
    {SIP_MLNAME_CAST(sipName_DoGetSize), (PyCFunction)meth_wxHeaderCtrl_DoGetSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_DoGetSize)},
    {SIP_MLNAME_CAST(sipName_DoMoveWindow), (PyCFunction)meth_wxHeaderCtrl_DoMoveWindow, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_DoMoveWindow)},
    {SIP_MLNAME_CAST(sipName_DoSetClientSize), (PyCFunction)meth_wxHeaderCtrl_DoSetClientSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_DoSetClientSize)},
    {SIP_MLNAME_CAST(sipName_DoSetSize), (PyCFunction)meth_wxHeaderCtrl_DoSetSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_DoSetSize)},
    {SIP_MLNAME_CAST(sipName_DoSetSizeHints), (PyCFunction)meth_wxHeaderCtrl_DoSetSizeHints, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_DoSetSizeHints)},
    {SIP_MLNAME_CAST(sipName_DoSetWindowVariant), (PyCFunction)meth_wxHeaderCtrl_DoSetWindowVariant, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_DoSetWindowVariant)},
    {SIP_MLNAME_CAST(sipName_DoThaw), (PyCFunction)meth_wxHeaderCtrl_DoThaw, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_DoThaw)},
    {SIP_MLNAME_CAST(sipName_GetClassDefaultAttributes), (PyCFunction)meth_wxHeaderCtrl_GetClassDefaultAttributes, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_GetClassDefaultAttributes)},
    ...
    {SIP_MLNAME_CAST(sipName_GetColumn), (PyCFunction)meth_wxHeaderCtrl_GetColumn, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_GetColumn)},
    {SIP_MLNAME_CAST(sipName_GetColumnAt), (PyCFunction)meth_wxHeaderCtrl_GetColumnAt, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_GetColumnAt)},
    ...
    {SIP_MLNAME_CAST(sipName_GetColumnPos), (PyCFunction)meth_wxHeaderCtrl_GetColumnPos, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_GetColumnPos)},
    {SIP_MLNAME_CAST(sipName_GetColumnTitleWidth), (PyCFunction)meth_wxHeaderCtrl_GetColumnTitleWidth, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_GetColumnTitleWidth)},
    ...
    {SIP_MLNAME_CAST(sipName_GetDefaultBorder), (PyCFunction)meth_wxHeaderCtrl_GetDefaultBorder, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_GetDefaultBorder)},
    {SIP_MLNAME_CAST(sipName_GetDefaultBorderForControl), (PyCFunction)meth_wxHeaderCtrl_GetDefaultBorderForControl, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_GetDefaultBorderForControl)},
    ...
    {SIP_MLNAME_CAST(sipName_HasTransparentBackground), (PyCFunction)meth_wxHeaderCtrl_HasTransparentBackground, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_HasTransparentBackground)},
    {SIP_MLNAME_CAST(sipName_InformFirstDirection), (PyCFunction)meth_wxHeaderCtrl_InformFirstDirection, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_InformFirstDirection)},
    ...
    {SIP_MLNAME_CAST(sipName_MoveColumnInOrderArray), (PyCFunction)meth_wxHeaderCtrl_MoveColumnInOrderArray, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_MoveColumnInOrderArray)},
    {SIP_MLNAME_CAST(sipName_OnColumnCountChanging), (PyCFunction)meth_wxHeaderCtrl_OnColumnCountChanging, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_OnColumnCountChanging)},
    ...
    {SIP_MLNAME_CAST(sipName_ProcessEvent), (PyCFunction)meth_wxHeaderCtrl_ProcessEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_ProcessEvent)},
    {SIP_MLNAME_CAST(sipName_RemoveChild), (PyCFunction)meth_wxHeaderCtrl_RemoveChild, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_RemoveChild)},
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxHeaderCtrl_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_SetCanFocus), (PyCFunction)meth_wxHeaderCtrl_SetCanFocus, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_SetCanFocus)},
    {SIP_MLNAME_CAST(sipName_SetColumnCount), (PyCFunction)meth_wxHeaderCtrl_SetColumnCount, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_SetColumnCount)},
    {SIP_MLNAME_CAST(sipName_SetColumnsOrder), (PyCFunction)meth_wxHeaderCtrl_SetColumnsOrder, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_SetColumnsOrder)},
    {SIP_MLNAME_CAST(sipName_SetValidator), (PyCFunction)meth_wxHeaderCtrl_SetValidator, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_SetValidator)},
    ...
    {SIP_MLNAME_CAST(sipName_ShowColumnsMenu), (PyCFunction)meth_wxHeaderCtrl_ShowColumnsMenu, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_ShowColumnsMenu)},
    ...
    {SIP_MLNAME_CAST(sipName_TryAfter), (PyCFunction)meth_wxHeaderCtrl_TryAfter, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_TryAfter)},
    {SIP_MLNAME_CAST(sipName_TryBefore), (PyCFunction)meth_wxHeaderCtrl_TryBefore, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_TryBefore)},
    {SIP_MLNAME_CAST(sipName_UpdateColumn), (PyCFunction)meth_wxHeaderCtrl_UpdateColumn, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_UpdateColumn)},
    {SIP_MLNAME_CAST(sipName_UpdateColumnVisibility), (PyCFunction)meth_wxHeaderCtrl_UpdateColumnVisibility, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_UpdateColumnVisibility)},
    {SIP_MLNAME_CAST(sipName_UpdateColumnWidthToFit), (PyCFunction)meth_wxHeaderCtrl_UpdateColumnWidthToFit, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_UpdateColumnWidthToFit)},
    {SIP_MLNAME_CAST(sipName_UpdateColumnsOrder), (PyCFunction)meth_wxHeaderCtrl_UpdateColumnsOrder, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHeaderCtrl_UpdateColumnsOrder)},
...
sipVariableDef variables_wxHeaderCtrl[] = {
    {PropertyVariable, sipName_ColumnsOrder, &methods_wxHeaderCtrl[28], &methods_wxHeaderCtrl[47], NULL, NULL},
    {PropertyVariable, sipName_ColumnCount, &methods_wxHeaderCtrl[25], &methods_wxHeaderCtrl[46], NULL, NULL},
};
