...
sipwxQueryLayoutInfoEvent::sipwxQueryLayoutInfoEvent( ::wxWindowID id):  ::wxQueryLayoutInfoEvent(id), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxQueryLayoutInfoEvent::sipwxQueryLayoutInfoEvent(const  ::wxQueryLayoutInfoEvent& a0):  ::wxQueryLayoutInfoEvent(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
static PyObject *meth_wxQueryLayoutInfoEvent_GetAlignment(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_QueryLayoutInfoEvent, sipName_GetAlignment, NULL);
...
static PyObject *meth_wxQueryLayoutInfoEvent_GetFlags(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QueryLayoutInfoEvent, sipName_GetFlags, NULL);
...
static PyObject *meth_wxQueryLayoutInfoEvent_GetOrientation(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QueryLayoutInfoEvent, sipName_GetOrientation, NULL);
...
static PyObject *meth_wxQueryLayoutInfoEvent_GetRequestedLength(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QueryLayoutInfoEvent, sipName_GetRequestedLength, NULL);
...
static PyObject *meth_wxQueryLayoutInfoEvent_GetSize(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QueryLayoutInfoEvent, sipName_GetSize, NULL);
...
static PyObject *meth_wxQueryLayoutInfoEvent_SetAlignment(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BE", &sipSelf, sipType_wxQueryLayoutInfoEvent, &sipCpp, sipType_wxLayoutAlignment, &alignment))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QueryLayoutInfoEvent, sipName_SetAlignment, NULL);
...
static PyObject *meth_wxQueryLayoutInfoEvent_SetFlags(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bi", &sipSelf, sipType_wxQueryLayoutInfoEvent, &sipCpp, &flags))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QueryLayoutInfoEvent, sipName_SetFlags, NULL);
...
static PyObject *meth_wxQueryLayoutInfoEvent_SetOrientation(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BE", &sipSelf, sipType_wxQueryLayoutInfoEvent, &sipCpp, sipType_wxLayoutOrientation, &orientation))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QueryLayoutInfoEvent, sipName_SetOrientation, NULL);
...
static PyObject *meth_wxQueryLayoutInfoEvent_SetRequestedLength(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bi", &sipSelf, sipType_wxQueryLayoutInfoEvent, &sipCpp, &length))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QueryLayoutInfoEvent, sipName_SetRequestedLength, NULL);
...
static PyObject *meth_wxQueryLayoutInfoEvent_SetSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxQueryLayoutInfoEvent, &sipCpp, sipType_wxSize, &size, &sizeState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QueryLayoutInfoEvent, sipName_SetSize, NULL);
...
static void dealloc_wxQueryLayoutInfoEvent(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxQueryLayoutInfoEvent *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxQueryLayoutInfoEvent *sipCpp = 0;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxQueryLayoutInfoEvent, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxQueryLayoutInfoEvent[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SetAlignment), (PyCFunction)meth_wxQueryLayoutInfoEvent_SetAlignment, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxQueryLayoutInfoEvent_SetAlignment)},
    {SIP_MLNAME_CAST(sipName_SetFlags), (PyCFunction)meth_wxQueryLayoutInfoEvent_SetFlags, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxQueryLayoutInfoEvent_SetFlags)},
    {SIP_MLNAME_CAST(sipName_SetOrientation), (PyCFunction)meth_wxQueryLayoutInfoEvent_SetOrientation, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxQueryLayoutInfoEvent_SetOrientation)},
    {SIP_MLNAME_CAST(sipName_SetRequestedLength), (PyCFunction)meth_wxQueryLayoutInfoEvent_SetRequestedLength, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxQueryLayoutInfoEvent_SetRequestedLength)},
    {SIP_MLNAME_CAST(sipName_SetSize), (PyCFunction)meth_wxQueryLayoutInfoEvent_SetSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxQueryLayoutInfoEvent_SetSize)}
};

sipVariableDef variables_wxQueryLayoutInfoEvent[] = {
    {PropertyVariable, sipName_Size, &methods_wxQueryLayoutInfoEvent[5], &methods_wxQueryLayoutInfoEvent[10], NULL, NULL},
    {PropertyVariable, sipName_RequestedLength, &methods_wxQueryLayoutInfoEvent[4], &methods_wxQueryLayoutInfoEvent[9], NULL, NULL},
    {PropertyVariable, sipName_Orientation, &methods_wxQueryLayoutInfoEvent[3], &methods_wxQueryLayoutInfoEvent[8], NULL, NULL},
    {PropertyVariable, sipName_Flags, &methods_wxQueryLayoutInfoEvent[2], &methods_wxQueryLayoutInfoEvent[7], NULL, NULL},
    {PropertyVariable, sipName_Alignment, &methods_wxQueryLayoutInfoEvent[1], &methods_wxQueryLayoutInfoEvent[6], NULL, NULL},
};
