...
sipwxGridCellAutoWrapStringRenderer::sipwxGridCellAutoWrapStringRenderer():  ::wxGridCellAutoWrapStringRenderer(), sipPySelf(0)
{
 ...
 ::wxSize sipwxGridCellAutoWrapStringRenderer::GetBestSize( ::wxGrid& grid, ::wxGridCellAttr& attr, ::wxDC& dc,int row,int col)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[0],sipPySelf,NULL,sipName_GetBestSize);
...
static PyObject *meth_wxGridCellAutoWrapStringRenderer_Draw(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9J9J9J1iib", &sipSelf, sipType_wxGridCellAutoWrapStringRenderer, &sipCpp, sipType_wxGrid, &grid, sipType_wxGridCellAttr, &attr, sipType_wxDC, &dc, sipType_wxRect, &rect, &rectState, &row, &col, &isSelected))
        {
            PyErr_Clear();
...
static PyObject *meth_wxGridCellAutoWrapStringRenderer_GetBestSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9J9J9ii", &sipSelf, sipType_wxGridCellAutoWrapStringRenderer, &sipCpp, sipType_wxGrid, &grid, sipType_wxGridCellAttr, &attr, sipType_wxDC, &dc, &row, &col))
        {
             ::wxSize*sipRes;
...
static void dealloc_wxGridCellAutoWrapStringRenderer(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxGridCellAutoWrapStringRenderer *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxGridCellAutoWrapStringRenderer *sipCpp = 0;
...
static sipEncodedTypeDef supers_wxGridCellAutoWrapStringRenderer[] = {{24, 255, 1}};
...
static PyMethodDef methods_wxGridCellAutoWrapStringRenderer[] = {
    ...
    {SIP_MLNAME_CAST(sipName_Draw), (PyCFunction)meth_wxGridCellAutoWrapStringRenderer_Draw, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridCellAutoWrapStringRenderer_Draw)},
    {SIP_MLNAME_CAST(sipName_GetBestSize), (PyCFunction)meth_wxGridCellAutoWrapStringRenderer_GetBestSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridCellAutoWrapStringRenderer_GetBestSize)}
};
