...
extern "C" {static void assign_wxUIActionSimulator(void *, SIP_SSIZE_T, void *);}
static void assign_wxUIActionSimulator(void *sipDst, SIP_SSIZE_T sipDstIdx, void *sipSrc)
{
    reinterpret_cast< ::wxUIActionSimulator *>(sipDst)[sipDstIdx] = *reinterpret_cast< ::wxUIActionSimulator *>(sipSrc);
}
