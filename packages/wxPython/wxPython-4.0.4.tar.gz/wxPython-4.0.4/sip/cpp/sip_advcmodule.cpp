...
const char sipStrings__adv[] = {
    ...
    'G', 'e', 'n', 'e', 'r', 'i', 'c', 'D', 'a', 't', 'e', 'P', 'i', 'c', 'k', 'e', 'r', 'C', 't', 'r', 'l', 0,
...
void wxPseudoDC::DrawToDC(wxDC *dc)
{
 ...
 ::wxBookCtrlBase* sipVH__adv_60(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
...
void sipVH__adv_59(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxSizer*sizer)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "D", sizer, sipType_wxSizer, NULL);
}

bool sipVH__adv_58(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxWizardPage*page,bool goingForward)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "Db", page, sipType_wxWizardPage, NULL, goingForward);
...
void sipVH__adv_57(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxSize& sizePage)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "N", new  ::wxSize(sizePage), sipType_wxSize, NULL);
}

bool sipVH__adv_56(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxWizardPage*page)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "D", page, sipType_wxWizardPage, NULL);
 ...
 ::wxSizer* sipVH__adv_55(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
     ::wxSizer* sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "");
...
void sipVH__adv_54(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxWizardPage*firstPage)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "D", const_cast< ::wxWizardPage *>(firstPage), sipType_wxWizardPage, NULL);
}

 ::wxWizardPage* sipVH__adv_53(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
 ...
 ::wxBitmap sipVH__adv_52(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
     ::wxBitmap sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "");
 ...
 ::wxCoord sipVH__adv_51(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::size_t item)
{
     ::wxCoord sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "N", new  ::size_t(item), sipType_size_t, NULL);
...
void sipVH__adv_50(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxDC& dc,const  ::wxRect& rect,int item,int flags)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "DNii", &dc, sipType_wxDC, NULL, new  ::wxRect(rect), sipType_wxRect, NULL, item, flags);
}

int sipVH__adv_49(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
    int sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "");
...
void sipVH__adv_48(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int n)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "i", n);
}

int sipVH__adv_47(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxString& string,bool caseSensitive)
{
    int sipRes = 0;
...
void sipVH__adv_46(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, uint n,const  ::wxString& s)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "uN", n, new  ::wxString(s), sipType_wxString, NULL);
}

 ::wxString sipVH__adv_45(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, uint n)
{
     ::wxString sipRes;
...
bool sipVH__adv_44(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxKeyEvent& event)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "N", new  ::wxKeyEvent(event), sipType_wxKeyEvent, NULL);
...
bool sipVH__adv_43(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxRect& rect,int flags)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "Ni", new  ::wxRect(rect), sipType_wxRect, NULL, flags);
...
void sipVH__adv_42(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxComboPopup*popup)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "D", popup, sipType_wxComboPopup, NULL);
}

void sipVH__adv_41(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxRect& rect,int flags)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "Ni", new  ::wxRect(rect), sipType_wxRect, NULL, flags);
}

 ::wxStatusBar* sipVH__adv_40(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int number,long style, ::wxWindowID id,const  ::wxString& name)
{
 ...
 ::wxToolBar* sipVH__adv_39(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, long style, ::wxWindowID id,const  ::wxString& name)
{
     ::wxToolBar* sipRes = 0;
...
bool sipVH__adv_38(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxString& name, ::wxAnimationType type)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "NF", new  ::wxString(name), sipType_wxString, NULL, type, sipType_wxAnimationType);
...
bool sipVH__adv_37(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxInputStream& stream, ::wxAnimationType type)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "DF", &stream, sipType_wxInputStream, NULL, type, sipType_wxAnimationType);
...
uint sipVH__adv_36(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
    uint sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "");
 ...
 ::wxImage sipVH__adv_35(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, uint i)
{
     ::wxImage sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "u", i);

    sipParseResultEx(sipGILState, sipErrorHandler, sipPySelf, sipMethod, sipResObj, "H5", sipType_wxImage, &sipRes);

    return sipRes;
}

int sipVH__adv_34(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, uint i)
{
    int sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "u", i);
...
bool sipVH__adv_32(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxIcon& icon,const  ::wxString& tooltip)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "NN", new  ::wxIcon(icon), sipType_wxIcon, NULL, new  ::wxString(tooltip), sipType_wxString, NULL);
...
bool sipVH__adv_31(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxMenu*menu)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "D", menu, sipType_wxMenu, NULL);
...
{
     ::wxString sipRes;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "N", new  ::wxString(tip), sipType_wxString, NULL);
...
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "i", sectionNo);
...
{
     ::wxFrame* sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "DD", size, sipType_wxSize, NULL, pos, sipType_wxPoint, NULL);
...
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "NF", new  ::wxString(k), sipType_wxString, NULL, mode, sipType_wxHelpSearchMode);
...
static PyObject *func_ShowTip(PyObject *,PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "J8J8|b", sipType_wxWindow, &parent, sipType_wxTipProvider, &tipProvider, &showAtStartup))
        {
            bool sipRes;
    ...
    sipNoFunction(sipParseErr, sipName_ShowTip, NULL);
...
static PyObject *func_CreateFileTipProvider(PyObject *,PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "J1J1", sipType_wxString,&filename, &filenameState, sipType_size_t,&currentTip, &currentTipState))
        {
    ...
    if (!wxPyCheckForApp()) return NULL;
            ...
            sipReleaseType(currentTip,sipType_size_t,currentTipState);

            if (PyErr_Occurred())
                return 0;

            return sipConvertFromNewType(sipRes,sipType_wxTipProvider,NULL);
        }
    }

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoFunction(sipParseErr, sipName_CreateFileTipProvider, NULL);
...
static PyObject *func_GenericAboutBox(PyObject *,PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "J9|J8", sipType_wxAboutDialogInfo, &info, sipType_wxWindow, &parent))
        {
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoFunction(sipParseErr, sipName_GenericAboutBox, NULL);
...
static PyObject *func_AboutBox(PyObject *,PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoFunction(sipParseErr, sipName_AboutBox, NULL);

    return NULL;
}
static sipEnumTypeDef enumTypes[] = {
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxPropertySheetDialogFlags, {0}, 0}, sipNameNr_PropertySheetDialogFlags, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxTipKind, {0}, 0}, sipNameNr_TipKind, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxOwnerDrawnComboBoxPaintingFlags, {0}, 0}, sipNameNr_OwnerDrawnComboBoxPaintingFlags, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxLayoutAlignment, {0}, 0}, sipNameNr_LayoutAlignment, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxLayoutOrientation, {0}, 0}, sipNameNr_LayoutOrientation, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxSashDragStatus, {0}, 0}, sipNameNr_SashDragStatus, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxSashEdgePosition, {0}, 0}, sipNameNr_SashEdgePosition, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxAnimationType, {0}, 0}, sipNameNr_AnimationType, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxTaskBarIconType, {0}, 0}, sipNameNr_TaskBarIconType, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxCalendarHitTestResult, {0}, 0}, sipNameNr_CalendarHitTestResult, -1, NULL},
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxCalendarDateBorder, {0}, 0}, sipNameNr_CalendarDateBorder, -1, NULL},
};

/* These are the enum members of all global enums. */
static sipEnumMemberDef enummembers[] = {
    {sipName_ANIMATION_TYPE_ANI, static_cast<int>(::wxANIMATION_TYPE_ANI), 3},
    {sipName_ANIMATION_TYPE_ANY, static_cast<int>(::wxANIMATION_TYPE_ANY), 3},
    {sipName_ANIMATION_TYPE_GIF, static_cast<int>(::wxANIMATION_TYPE_GIF), 3},
    {sipName_ANIMATION_TYPE_INVALID, static_cast<int>(::wxANIMATION_TYPE_INVALID), 3},
    {sipName_CAL_BORDER_NONE, static_cast<int>(::wxCAL_BORDER_NONE), 9},
    {sipName_CAL_BORDER_ROUND, static_cast<int>(::wxCAL_BORDER_ROUND), 9},
    {sipName_CAL_BORDER_SQUARE, static_cast<int>(::wxCAL_BORDER_SQUARE), 9},
    {sipName_CAL_HITTEST_DAY, static_cast<int>(::wxCAL_HITTEST_DAY), 11},
    {sipName_CAL_HITTEST_DECMONTH, static_cast<int>(::wxCAL_HITTEST_DECMONTH), 11},
    {sipName_CAL_HITTEST_HEADER, static_cast<int>(::wxCAL_HITTEST_HEADER), 11},
    {sipName_CAL_HITTEST_INCMONTH, static_cast<int>(::wxCAL_HITTEST_INCMONTH), 11},
    {sipName_CAL_HITTEST_NOWHERE, static_cast<int>(::wxCAL_HITTEST_NOWHERE), 11},
    {sipName_CAL_HITTEST_SURROUNDING_WEEK, static_cast<int>(::wxCAL_HITTEST_SURROUNDING_WEEK), 11},
    {sipName_CAL_HITTEST_WEEK, static_cast<int>(::wxCAL_HITTEST_WEEK), 11},
    {sipName_LAYOUT_BOTTOM, static_cast<int>(::wxLAYOUT_BOTTOM), 23},
    {sipName_LAYOUT_HORIZONTAL, static_cast<int>(::wxLAYOUT_HORIZONTAL), 24},
    {sipName_LAYOUT_LEFT, static_cast<int>(::wxLAYOUT_LEFT), 23},
    {sipName_LAYOUT_NONE, static_cast<int>(::wxLAYOUT_NONE), 23},
    {sipName_LAYOUT_RIGHT, static_cast<int>(::wxLAYOUT_RIGHT), 23},
    {sipName_LAYOUT_TOP, static_cast<int>(::wxLAYOUT_TOP), 23},
    {sipName_LAYOUT_VERTICAL, static_cast<int>(::wxLAYOUT_VERTICAL), 24},
    {sipName_ODCB_PAINTING_CONTROL, static_cast<int>(::wxODCB_PAINTING_CONTROL), 27},
    {sipName_ODCB_PAINTING_SELECTED, static_cast<int>(::wxODCB_PAINTING_SELECTED), 27},
    {sipName_PROPSHEET_BUTTONTOOLBOOK, static_cast<int>(::wxPROPSHEET_BUTTONTOOLBOOK), 29},
    {sipName_PROPSHEET_CHOICEBOOK, static_cast<int>(::wxPROPSHEET_CHOICEBOOK), 29},
    {sipName_PROPSHEET_DEFAULT, static_cast<int>(::wxPROPSHEET_DEFAULT), 29},
    {sipName_PROPSHEET_LISTBOOK, static_cast<int>(::wxPROPSHEET_LISTBOOK), 29},
    {sipName_PROPSHEET_NOTEBOOK, static_cast<int>(::wxPROPSHEET_NOTEBOOK), 29},
    {sipName_PROPSHEET_SHRINKTOFIT, static_cast<int>(::wxPROPSHEET_SHRINKTOFIT), 29},
    {sipName_PROPSHEET_TOOLBOOK, static_cast<int>(::wxPROPSHEET_TOOLBOOK), 29},
    {sipName_PROPSHEET_TREEBOOK, static_cast<int>(::wxPROPSHEET_TREEBOOK), 29},
    {sipName_SASH_BOTTOM, static_cast<int>(::wxSASH_BOTTOM), 34},
    {sipName_SASH_LEFT, static_cast<int>(::wxSASH_LEFT), 34},
    {sipName_SASH_NONE, static_cast<int>(::wxSASH_NONE), 34},
    {sipName_SASH_RIGHT, static_cast<int>(::wxSASH_RIGHT), 34},
    {sipName_SASH_STATUS_OK, static_cast<int>(::wxSASH_STATUS_OK), 33},
    {sipName_SASH_STATUS_OUT_OF_RANGE, static_cast<int>(::wxSASH_STATUS_OUT_OF_RANGE), 33},
    {sipName_SASH_TOP, static_cast<int>(::wxSASH_TOP), 34},
    {sipName_TBI_CUSTOM_STATUSITEM, static_cast<int>(::wxTBI_CUSTOM_STATUSITEM), 42},
    {sipName_TBI_DEFAULT_TYPE, static_cast<int>(::wxTBI_DEFAULT_TYPE), 42},
    {sipName_TBI_DOCK, static_cast<int>(::wxTBI_DOCK), 42},
    {sipName_TipKind_Auto, static_cast<int>(::wxTipKind_Auto), 44},
    {sipName_TipKind_Bottom, static_cast<int>(::wxTipKind_Bottom), 44},
    {sipName_TipKind_BottomLeft, static_cast<int>(::wxTipKind_BottomLeft), 44},
    {sipName_TipKind_BottomRight, static_cast<int>(::wxTipKind_BottomRight), 44},
    {sipName_TipKind_None, static_cast<int>(::wxTipKind_None), 44},
    {sipName_TipKind_Top, static_cast<int>(::wxTipKind_Top), 44},
    {sipName_TipKind_TopLeft, static_cast<int>(::wxTipKind_TopLeft), 44},
    {sipName_TipKind_TopRight, static_cast<int>(::wxTipKind_TopRight), 44},
};
...
static sipImportedModuleDef importsTable[] = {
    {"wx._core", sipImportedTypes__adv__core, NULL, NULL},
    {NULL, NULL, NULL, NULL}
};
...
#endif
{
    static PyMethodDef sip_methods[] = {
        {SIP_MLNAME_CAST(sipName_ShowTip), (PyCFunction)func_ShowTip, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_ShowTip)},
        {SIP_MLNAME_CAST(sipName_CreateFileTipProvider), (PyCFunction)func_CreateFileTipProvider, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_CreateFileTipProvider)},
        {SIP_MLNAME_CAST(sipName_GenericAboutBox), (PyCFunction)func_GenericAboutBox, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_GenericAboutBox)},
        {SIP_MLNAME_CAST(sipName_AboutBox), (PyCFunction)func_AboutBox, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_AboutBox)},
        {0, 0, 0, 0}
    };
