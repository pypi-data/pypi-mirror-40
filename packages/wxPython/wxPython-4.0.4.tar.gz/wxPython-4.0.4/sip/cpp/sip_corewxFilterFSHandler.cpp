...
sipwxFilterFSHandler::sipwxFilterFSHandler():  ::wxFilterFSHandler(), sipPySelf(0)
{
...
static PyObject *meth_wxFilterFSHandler_GetAnchor(PyObject *, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    sipNoMethod(sipParseErr, sipName_FilterFSHandler, sipName_GetAnchor, NULL);
...
static PyObject *meth_wxFilterFSHandler_GetLeftLocation(PyObject *, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FilterFSHandler, sipName_GetLeftLocation, NULL);
...
static PyObject *meth_wxFilterFSHandler_GetProtocol(PyObject *, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FilterFSHandler, sipName_GetProtocol, NULL);
...
static PyObject *meth_wxFilterFSHandler_GetRightLocation(PyObject *, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FilterFSHandler, sipName_GetRightLocation, NULL);
...
static PyObject *meth_wxFilterFSHandler_CanOpen(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxFilterFSHandler, &sipCpp, sipType_wxString,&location, &locationState))
        {
            bool sipRes;
...
static PyObject *meth_wxFilterFSHandler_OpenFile(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9J1", &sipSelf, sipType_wxFilterFSHandler, &sipCpp, sipType_wxFileSystem, &fs, sipType_wxString,&location, &locationState))
        {
             ::wxFSFile*sipRes;
...
static PyObject *meth_wxFilterFSHandler_FindFirst(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1|i", &sipSelf, sipType_wxFilterFSHandler, &sipCpp, sipType_wxString,&spec, &specState, &flags))
        {
             ::wxString*sipRes;
...
static void dealloc_wxFilterFSHandler(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxFilterFSHandler *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static sipEncodedTypeDef supers_wxFilterFSHandler[] = {{166, 255, 1}};


static PyMethodDef methods_wxFilterFSHandler[] = {
    {SIP_MLNAME_CAST(sipName_CanOpen), (PyCFunction)meth_wxFilterFSHandler_CanOpen, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxFilterFSHandler_CanOpen)},
    {SIP_MLNAME_CAST(sipName_FindFirst), (PyCFunction)meth_wxFilterFSHandler_FindFirst, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxFilterFSHandler_FindFirst)},
    ...
    {SIP_MLNAME_CAST(sipName_GetAnchor), (PyCFunction)meth_wxFilterFSHandler_GetAnchor, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_GetLeftLocation), (PyCFunction)meth_wxFilterFSHandler_GetLeftLocation, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_GetProtocol), (PyCFunction)meth_wxFilterFSHandler_GetProtocol, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_GetRightLocation), (PyCFunction)meth_wxFilterFSHandler_GetRightLocation, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_OpenFile), (PyCFunction)meth_wxFilterFSHandler_OpenFile, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxFilterFSHandler_OpenFile)}
};
