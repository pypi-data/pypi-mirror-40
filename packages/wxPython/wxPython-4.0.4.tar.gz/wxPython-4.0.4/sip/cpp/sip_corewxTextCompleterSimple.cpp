...
public:
     ...
     */
protected:
    void GetCompletions(const  ::wxString&, ::wxArrayString&);
...
sipwxTextCompleterSimple::sipwxTextCompleterSimple():  ::wxTextCompleterSimple(), sipPySelf(0)
{
...
void sipwxTextCompleterSimple::GetCompletions(const  ::wxString& prefix, ::wxArrayString& res)
{
    ...
    extern void sipVH__core_153(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxString&, ::wxArrayString&);

    sipVH__core_153(sipGILState, 0, sipPySelf, sipMeth, prefix, res);
}
 ...
 ::wxString sipwxTextCompleterSimple::GetNext()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[2],sipPySelf,NULL,sipName_GetNext);
...
static PyObject *meth_wxTextCompleterSimple_GetCompletions(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxTextCompleterSimple, &sipCpp, sipType_wxString,&prefix, &prefixState))
        {
            ...
            return sipConvertFromNewType(res,sipType_wxArrayString,NULL);
        }
    }

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TextCompleterSimple, sipName_GetCompletions, NULL);
...
static PyObject *meth_wxTextCompleterSimple_Start(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TextCompleterSimple, sipName_Start, NULL);
...
static PyObject *meth_wxTextCompleterSimple_GetNext(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TextCompleterSimple, sipName_GetNext, NULL);
...
static void dealloc_wxTextCompleterSimple(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxTextCompleterSimple *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxTextCompleterSimple *sipCpp = 0;
...
static sipEncodedTypeDef supers_wxTextCompleterSimple[] = {{519, 255, 1}};


static PyMethodDef methods_wxTextCompleterSimple[] = {
    {SIP_MLNAME_CAST(sipName_GetCompletions), (PyCFunction)meth_wxTextCompleterSimple_GetCompletions, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTextCompleterSimple_GetCompletions)},
    ...
    {SIP_MLNAME_CAST(sipName_Start), (PyCFunction)meth_wxTextCompleterSimple_Start, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTextCompleterSimple_Start)}
};

sipVariableDef variables_wxTextCompleterSimple[] = {
    {PropertyVariable, sipName_Next, &methods_wxTextCompleterSimple[1], NULL, NULL, NULL},
};
