...
void sipwxPyApp::MacOpenURL(const  ::wxString& url)
{
    ...
    sipVH__core_51(sipGILState, 0, sipPySelf, sipMeth, url);
}
...
void sipwxPyApp::MacOpenFiles(const  ::wxArrayString& fileNames)
{
    ...
    extern void sipVH__core_112(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxArrayString&);

    sipVH__core_112(sipGILState, 0, sipPySelf, sipMeth, fileNames);
}
