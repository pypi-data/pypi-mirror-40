...
sipwxFontPickerEvent::sipwxFontPickerEvent( ::wxObject*generator,int id,const  ::wxFont& font):  ::wxFontPickerEvent(generator,id,font), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxFontPickerEvent::sipwxFontPickerEvent(const  ::wxFontPickerEvent& a0):  ::wxFontPickerEvent(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
static PyObject *meth_wxFontPickerEvent_GetFont(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_FontPickerEvent, sipName_GetFont, NULL);
...
static PyObject *meth_wxFontPickerEvent_SetFont(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxFontPickerEvent, &sipCpp, sipType_wxFont, &f))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FontPickerEvent, sipName_SetFont, NULL);
...
static void dealloc_wxFontPickerEvent(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxFontPickerEvent *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static void *init_type_wxFontPickerEvent(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxFontPickerEvent, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxFontPickerEvent[] = {{78, 255, 1}};
...
static PyMethodDef methods_wxFontPickerEvent[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SetFont), (PyCFunction)meth_wxFontPickerEvent_SetFont, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxFontPickerEvent_SetFont)}
};

sipVariableDef variables_wxFontPickerEvent[] = {
    {PropertyVariable, sipName_Font, &methods_wxFontPickerEvent[1], &methods_wxFontPickerEvent[2], NULL, NULL},
};
