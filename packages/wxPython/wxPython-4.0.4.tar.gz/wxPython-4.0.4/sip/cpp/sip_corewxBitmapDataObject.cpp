...
sipwxBitmapDataObject::sipwxBitmapDataObject(const  ::wxBitmap& bitmap):  ::wxBitmapDataObject(bitmap), sipPySelf(0)
{
...
void sipwxBitmapDataObject::SetBitmap(const  ::wxBitmap& bitmap)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[0],sipPySelf,NULL,sipName_SetBitmap);
 ...
 ::wxBitmap sipwxBitmapDataObject::GetBitmap() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[1]),sipPySelf,NULL,sipName_GetBitmap);
 ...
 ::wxDataFormat sipwxBitmapDataObject::GetPreferredFormat( ::wxDataObject::Direction dir) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[3]),sipPySelf,NULL,sipName_GetPreferredFormat);
...
static PyObject *meth_wxBitmapDataObject_GetBitmap(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_BitmapDataObject, sipName_GetBitmap, NULL);
...
static PyObject *meth_wxBitmapDataObject_SetBitmap(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxBitmapDataObject, &sipCpp, sipType_wxBitmap, &bitmap))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_BitmapDataObject, sipName_SetBitmap, NULL);
...
static PyObject *meth_wxBitmapDataObject_GetAllFormats(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "B|E", &sipSelf, sipType_wxBitmapDataObject, &sipCpp, sipType_wxDataObject_Direction, &dir))
        {
            PyObject * sipRes = 0;
            int sipIsErr = 0;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_BitmapDataObject, sipName_GetAllFormats, NULL);
...
static PyObject *meth_wxBitmapDataObject_SetData(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9J0", &sipSelf, sipType_wxBitmapDataObject, &sipCpp, sipType_wxDataFormat, &format, sipType_wxPyBuffer,&buf, &bufState))
        {
            bool sipRes = 0;
            int sipIsErr = 0;
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1v", &sipSelf, sipType_wxBitmapDataObject, &sipCpp, sipType_size_t,&len, &lenState, &buf))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_BitmapDataObject, sipName_SetData, NULL);

    return NULL;
}


PyDoc_STRVAR(doc_wxBitmapDataObject_GetFormatCount, "GetFormatCount(self, dir: DataObject.Direction = wxDataObject.Get) -> object");
...
static PyObject *meth_wxBitmapDataObject_GetFormatCount(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "B|E", &sipSelf, sipType_wxBitmapDataObject, &sipCpp, sipType_wxDataObject_Direction, &dir))
        {
            ...
            Py_BEGIN_ALLOW_THREADS
            sipRes = new  ::size_t((sipSelfWasArg ? sipCpp-> ::wxBitmapDataObject::GetFormatCount(dir) : sipCpp->GetFormatCount(dir)));
            Py_END_ALLOW_THREADS
...
PyDoc_STRVAR(doc_wxBitmapDataObject_GetDataSize, "GetDataSize(self) -> object");
...
static PyObject *meth_wxBitmapDataObject_GetDataSize(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxBitmapDataObject, &sipCpp))
        {
            ...
            Py_BEGIN_ALLOW_THREADS
            sipRes = new  ::size_t((sipSelfWasArg ? sipCpp-> ::wxBitmapDataObject::GetDataSize() : sipCpp->GetDataSize()));
            Py_END_ALLOW_THREADS
...
static PyObject *meth_wxBitmapDataObject_GetDataHere(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bv", &sipSelf, sipType_wxBitmapDataObject, &sipCpp, &buf))
        {
            bool sipRes;
...
static void dealloc_wxBitmapDataObject(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxBitmapDataObject *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxBitmapDataObject *sipCpp = 0;
...
static sipEncodedTypeDef supers_wxBitmapDataObject[] = {{107, 255, 1}};


static PyMethodDef methods_wxBitmapDataObject[] = {
    {SIP_MLNAME_CAST(sipName_GetAllFormats), (PyCFunction)meth_wxBitmapDataObject_GetAllFormats, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxBitmapDataObject_GetAllFormats)},
    ...
    {SIP_MLNAME_CAST(sipName_GetDataHere), (PyCFunction)meth_wxBitmapDataObject_GetDataHere, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxBitmapDataObject_GetDataHere)},
    ...
    {SIP_MLNAME_CAST(sipName_GetFormatCount), (PyCFunction)meth_wxBitmapDataObject_GetFormatCount, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxBitmapDataObject_GetFormatCount)},
    {SIP_MLNAME_CAST(sipName_GetPreferredFormat), (PyCFunction)meth_wxBitmapDataObject_GetPreferredFormat, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxBitmapDataObject_GetPreferredFormat)},
    {SIP_MLNAME_CAST(sipName_SetBitmap), (PyCFunction)meth_wxBitmapDataObject_SetBitmap, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxBitmapDataObject_SetBitmap)},
    {SIP_MLNAME_CAST(sipName_SetData), (PyCFunction)meth_wxBitmapDataObject_SetData, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxBitmapDataObject_SetData)}
};

sipVariableDef variables_wxBitmapDataObject[] = {
    {PropertyVariable, sipName_Bitmap, &methods_wxBitmapDataObject[1], &methods_wxBitmapDataObject[6], NULL, NULL},
    {PropertyVariable, sipName_AllFormats, &methods_wxBitmapDataObject[0], NULL, NULL, NULL},
};
