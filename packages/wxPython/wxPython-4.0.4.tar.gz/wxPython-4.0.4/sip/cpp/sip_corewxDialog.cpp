...
sipwxDialog::sipwxDialog():  ::wxDialog(), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxDialog::sipwxDialog( ::wxWindow*parent, ::wxWindowID id,const  ::wxString& title,const  ::wxPoint& pos,const  ::wxSize& size,long style,const  ::wxString& name):  ::wxDialog(parent,id,title,pos,size,style,name), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
extern "C" {static PyObject *meth_wxDialog_SendDestroyEvent(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxDialog_SendDestroyEvent(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, NULL, NULL, "B", &sipSelf, sipType_wxDialog, &sipCpp))
        {
            PyErr_Clear();
    ...
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_SendDestroyEvent, NULL);
...
static PyObject *meth_wxDialog_AddMainButtonId(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bi", &sipSelf, sipType_wxDialog, &sipCpp, &id))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_AddMainButtonId, NULL);
...
static PyObject *meth_wxDialog_CanDoLayoutAdaptation(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_CanDoLayoutAdaptation, NULL);
...
static PyObject *meth_wxDialog_Centre(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "B|i", &sipSelf, sipType_wxDialog, &sipCpp, &direction))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_Centre, NULL);
...
static PyObject *meth_wxDialog_Create(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8|iJ1J1J1lJ1", &sipSelf, sipType_wxDialog, &sipCpp, sipType_wxWindow, &parent, &id, sipType_wxString,&title, &titleState, sipType_wxPoint, &pos, &posState, sipType_wxSize, &size, &sizeState, &style, sipType_wxString,&name, &nameState))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_Create, NULL);
...
static PyObject *meth_wxDialog_CreateButtonSizer(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bl", &sipSelf, sipType_wxDialog, &sipCpp, &flags))
        {
             ::wxSizer*sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_CreateButtonSizer, NULL);
...
static PyObject *meth_wxDialog_CreateSeparatedButtonSizer(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_CreateSeparatedButtonSizer, NULL);
...
static PyObject *meth_wxDialog_CreateSeparatedSizer(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8", &sipSelf, sipType_wxDialog, &sipCpp, sipType_wxSizer, &sizer))
        {
             ::wxSizer*sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_CreateSeparatedSizer, NULL);
...
static PyObject *meth_wxDialog_CreateStdDialogButtonSizer(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bl", &sipSelf, sipType_wxDialog, &sipCpp, &flags))
        {
            ...
            return sipConvertFromType(sipRes,sipType_wxStdDialogButtonSizer,NULL);
        }
    }

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_CreateStdDialogButtonSizer, NULL);

    return NULL;
}


PyDoc_STRVAR(doc_wxDialog_CreateTextSizer, "CreateTextSizer(message) -> Sizer\n"
"\n"
...
static PyObject *meth_wxDialog_CreateTextSizer(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxDialog, &sipCpp, sipType_wxString,&message, &messageState))
        {
             ::wxSizer*sipRes;
            ...
            Py_BEGIN_ALLOW_THREADS
            sipRes = sipCpp->CreateTextSizer(*message);
            Py_END_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_CreateTextSizer, NULL);
...
static PyObject *meth_wxDialog_DoLayoutAdaptation(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_DoLayoutAdaptation, NULL);
...
static PyObject *meth_wxDialog_EndModal(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bi", &sipSelf, sipType_wxDialog, &sipCpp, &retCode))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_EndModal, NULL);
...
static PyObject *meth_wxDialog_GetAffirmativeId(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_GetAffirmativeId, NULL);
...
static PyObject *meth_wxDialog_GetContentWindow(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_GetContentWindow, NULL);
...
static PyObject *meth_wxDialog_GetEscapeId(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_GetEscapeId, NULL);
...
static PyObject *meth_wxDialog_GetLayoutAdaptationDone(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_GetLayoutAdaptationDone, NULL);
...
static PyObject *meth_wxDialog_GetLayoutAdaptationLevel(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_GetLayoutAdaptationLevel, NULL);
...
static PyObject *meth_wxDialog_GetLayoutAdaptationMode(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_GetLayoutAdaptationMode, NULL);
...
static PyObject *meth_wxDialog_GetMainButtonIds(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxDialog, &sipCpp))
        {
            ...
            return sipConvertFromType(sipRes,sipType_wxArrayInt,NULL);
        }
    }

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_GetMainButtonIds, NULL);
...
static PyObject *meth_wxDialog_GetReturnCode(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_GetReturnCode, NULL);
...
static PyObject *meth_wxDialog_Iconize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "B|b", &sipSelf, sipType_wxDialog, &sipCpp, &iconize))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_Iconize, NULL);
...
static PyObject *meth_wxDialog_IsIconized(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_IsIconized, NULL);
...
static PyObject *meth_wxDialog_IsMainButtonId(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_IsMainButtonId, NULL);
...
static PyObject *meth_wxDialog_IsModal(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_IsModal, NULL);
...
static PyObject *meth_wxDialog_SetAffirmativeId(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_SetAffirmativeId, NULL);
...
static PyObject *meth_wxDialog_SetEscapeId(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_SetEscapeId, NULL);
...
static PyObject *meth_wxDialog_SetIcon(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxDialog, &sipCpp, sipType_wxIcon, &icon))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_SetIcon, NULL);
...
static PyObject *meth_wxDialog_SetIcons(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxDialog, &sipCpp, sipType_wxIconBundle, &icons))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_SetIcons, NULL);
...
static PyObject *meth_wxDialog_SetLayoutAdaptationDone(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bb", &sipSelf, sipType_wxDialog, &sipCpp, &done))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_SetLayoutAdaptationDone, NULL);
...
static PyObject *meth_wxDialog_SetLayoutAdaptationLevel(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bi", &sipSelf, sipType_wxDialog, &sipCpp, &level))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_SetLayoutAdaptationLevel, NULL);
...
static PyObject *meth_wxDialog_SetLayoutAdaptationMode(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BE", &sipSelf, sipType_wxDialog, &sipCpp, sipType_wxDialogLayoutAdaptationMode, &mode))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_SetLayoutAdaptationMode, NULL);
...
static PyObject *meth_wxDialog_SetReturnCode(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_SetReturnCode, NULL);

    return NULL;
}


PyDoc_STRVAR(doc_wxDialog_Show, "Show(show=1) -> bool\n"
"\n"
...
static PyObject *meth_wxDialog_Show(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "B|b", &sipSelf, sipType_wxDialog, &sipCpp, &show))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_Show, NULL);
...
static PyObject *meth_wxDialog_ShowModal(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_ShowModal, NULL);
...
static PyObject *meth_wxDialog_ShowWindowModal(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_ShowWindowModal, NULL);
...
static PyObject *meth_wxDialog_EnableLayoutAdaptation(PyObject *, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_EnableLayoutAdaptation, NULL);
...
static PyObject *meth_wxDialog_GetLayoutAdapter(PyObject *, PyObject *sipArgs)
{
...

    {
        if (sipParseArgs(&sipParseErr, sipArgs, ""))
        {
            ...
            return sipConvertFromType(sipRes,sipType_wxDialogLayoutAdapter,NULL);
        }
    }

    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_GetLayoutAdapter, NULL);
...
static PyObject *meth_wxDialog_IsLayoutAdaptationEnabled(PyObject *, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_IsLayoutAdaptationEnabled, NULL);
...
static PyObject *meth_wxDialog_SetLayoutAdapter(PyObject *, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "J8", sipType_wxDialogLayoutAdapter, &adapter))
        {
             ::wxDialogLayoutAdapter*sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Dialog, sipName_SetLayoutAdapter, NULL);
...
static PyObject *meth_wxDialog_AddChild(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8", &sipSelf, sipType_wxDialog, &sipCpp, sipType_wxWindowBase, &child))
        {
            PyErr_Clear();
...
static PyObject *meth_wxDialog_InformFirstDirection(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Biii", &sipSelf, sipType_wxDialog, &sipCpp, &direction, &size, &availableOtherDir))
        {
            bool sipRes;
...
static PyObject *meth_wxDialog_SetCanFocus(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bb", &sipSelf, sipType_wxDialog, &sipCpp, &canFocus))
        {
            PyErr_Clear();
...
static PyObject *meth_wxDialog_SetValidator(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxDialog, &sipCpp, sipType_wxValidator, &validator))
        {
            PyErr_Clear();
...
static PyObject *meth_wxDialog_ProcessEvent(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxDialog, &sipCpp, sipType_wxEvent, &event))
        {
            bool sipRes;
...
static PyObject *meth_wxDialog_DoEnable(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bb", &sipSelf, sipType_wxDialog, &sipCpp, &enable))
        {
            PyErr_Clear();
...
extern "C" {static PyObject *meth_wxDialog_DoGetBestSize(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxDialog_DoGetBestSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxDialog_DoGetBestClientSize(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxDialog_DoGetBestClientSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
static PyObject *meth_wxDialog_DoSetSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Biiiii", &sipSelf, sipType_wxDialog, &sipCpp, &x, &y, &width, &height, &sizeFlags))
        {
            PyErr_Clear();
...
static PyObject *meth_wxDialog_DoSetClientSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bii", &sipSelf, sipType_wxDialog, &sipCpp, &width, &height))
        {
            PyErr_Clear();
...
static PyObject *meth_wxDialog_DoSetSizeHints(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Biiiiii", &sipSelf, sipType_wxDialog, &sipCpp, &minW, &minH, &maxW, &maxH, &incW, &incH))
        {
            PyErr_Clear();
...
extern "C" {static PyObject *meth_wxDialog_DoGetBorderSize(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxDialog_DoGetBorderSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
static PyObject *meth_wxDialog_DoMoveWindow(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Biiii", &sipSelf, sipType_wxDialog, &sipCpp, &x, &y, &width, &height))
        {
            PyErr_Clear();
...
static PyObject *meth_wxDialog_DoSetWindowVariant(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BE", &sipSelf, sipType_wxDialog, &sipCpp, sipType_wxWindowVariant, &variant))
        {
            PyErr_Clear();
...
extern "C" {static PyObject *meth_wxDialog_GetDefaultBorder(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxDialog_GetDefaultBorder(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxDialog_GetDefaultBorderForControl(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxDialog_GetDefaultBorderForControl(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxDialog_DoFreeze(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxDialog_DoFreeze(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxDialog_DoThaw(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxDialog_DoThaw(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
extern "C" {static PyObject *meth_wxDialog_HasTransparentBackground(PyObject *, PyObject *, PyObject *);}
static PyObject *meth_wxDialog_HasTransparentBackground(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerivedClass((sipSimpleWrapper *)sipSelf));
...
static void dealloc_wxDialog(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxDialog *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static sipEncodedTypeDef supers_wxDialog[] = {{540, 255, 1}};
...
static PyMethodDef methods_wxDialog[] = {
    ...
    {SIP_MLNAME_CAST(sipName_AddChild), (PyCFunction)meth_wxDialog_AddChild, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_AddChild)},
    {SIP_MLNAME_CAST(sipName_AddMainButtonId), (PyCFunction)meth_wxDialog_AddMainButtonId, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_AddMainButtonId)},
    ...
    {SIP_MLNAME_CAST(sipName_Centre), (PyCFunction)meth_wxDialog_Centre, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_Centre)},
    {SIP_MLNAME_CAST(sipName_Create), (PyCFunction)meth_wxDialog_Create, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_Create)},
    {SIP_MLNAME_CAST(sipName_CreateButtonSizer), (PyCFunction)meth_wxDialog_CreateButtonSizer, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_CreateButtonSizer)},
    {SIP_MLNAME_CAST(sipName_CreateSeparatedButtonSizer), (PyCFunction)meth_wxDialog_CreateSeparatedButtonSizer, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_CreateSeparatedButtonSizer)},
    {SIP_MLNAME_CAST(sipName_CreateSeparatedSizer), (PyCFunction)meth_wxDialog_CreateSeparatedSizer, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_CreateSeparatedSizer)},
    {SIP_MLNAME_CAST(sipName_CreateStdDialogButtonSizer), (PyCFunction)meth_wxDialog_CreateStdDialogButtonSizer, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_CreateStdDialogButtonSizer)},
    {SIP_MLNAME_CAST(sipName_CreateTextSizer), (PyCFunction)meth_wxDialog_CreateTextSizer, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_CreateTextSizer)},
    {SIP_MLNAME_CAST(sipName_Destroy), meth_wxDialog_Destroy, METH_VARARGS, SIP_MLDOC_CAST(doc_wxDialog_Destroy)},
    {SIP_MLNAME_CAST(sipName_DoEnable), (PyCFunction)meth_wxDialog_DoEnable, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_DoEnable)},
    {SIP_MLNAME_CAST(sipName_DoFreeze), (PyCFunction)meth_wxDialog_DoFreeze, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_DoFreeze)},
    {SIP_MLNAME_CAST(sipName_DoGetBestClientSize), (PyCFunction)meth_wxDialog_DoGetBestClientSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_DoGetBestClientSize)},
    {SIP_MLNAME_CAST(sipName_DoGetBestSize), (PyCFunction)meth_wxDialog_DoGetBestSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_DoGetBestSize)},
    {SIP_MLNAME_CAST(sipName_DoGetBorderSize), (PyCFunction)meth_wxDialog_DoGetBorderSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_DoGetBorderSize)},
    {SIP_MLNAME_CAST(sipName_DoGetClientSize), (PyCFunction)meth_wxDialog_DoGetClientSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_DoGetClientSize)},
    {SIP_MLNAME_CAST(sipName_DoGetPosition), (PyCFunction)meth_wxDialog_DoGetPosition, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_DoGetPosition)},
    {SIP_MLNAME_CAST(sipName_DoGetSize), (PyCFunction)meth_wxDialog_DoGetSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_DoGetSize)},
    ...
    {SIP_MLNAME_CAST(sipName_DoMoveWindow), (PyCFunction)meth_wxDialog_DoMoveWindow, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_DoMoveWindow)},
    {SIP_MLNAME_CAST(sipName_DoSetClientSize), (PyCFunction)meth_wxDialog_DoSetClientSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_DoSetClientSize)},
    {SIP_MLNAME_CAST(sipName_DoSetSize), (PyCFunction)meth_wxDialog_DoSetSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_DoSetSize)},
    {SIP_MLNAME_CAST(sipName_DoSetSizeHints), (PyCFunction)meth_wxDialog_DoSetSizeHints, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_DoSetSizeHints)},
    {SIP_MLNAME_CAST(sipName_DoSetWindowVariant), (PyCFunction)meth_wxDialog_DoSetWindowVariant, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_DoSetWindowVariant)},
    {SIP_MLNAME_CAST(sipName_DoThaw), (PyCFunction)meth_wxDialog_DoThaw, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_DoThaw)},
    {SIP_MLNAME_CAST(sipName_EnableLayoutAdaptation), (PyCFunction)meth_wxDialog_EnableLayoutAdaptation, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_EnableLayoutAdaptation)},
    {SIP_MLNAME_CAST(sipName_EndModal), (PyCFunction)meth_wxDialog_EndModal, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_EndModal)},
    ...
    {SIP_MLNAME_CAST(sipName_GetDefaultBorder), (PyCFunction)meth_wxDialog_GetDefaultBorder, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_GetDefaultBorder)},
    {SIP_MLNAME_CAST(sipName_GetDefaultBorderForControl), (PyCFunction)meth_wxDialog_GetDefaultBorderForControl, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_GetDefaultBorderForControl)},
    ...
    {SIP_MLNAME_CAST(sipName_HasTransparentBackground), (PyCFunction)meth_wxDialog_HasTransparentBackground, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_HasTransparentBackground)},
    {SIP_MLNAME_CAST(sipName_Iconize), (PyCFunction)meth_wxDialog_Iconize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_Iconize)},
    {SIP_MLNAME_CAST(sipName_InformFirstDirection), (PyCFunction)meth_wxDialog_InformFirstDirection, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_InformFirstDirection)},
    ...
    {SIP_MLNAME_CAST(sipName_IsMainButtonId), (PyCFunction)meth_wxDialog_IsMainButtonId, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_IsMainButtonId)},
    ...
    {SIP_MLNAME_CAST(sipName_ProcessEvent), (PyCFunction)meth_wxDialog_ProcessEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_ProcessEvent)},
    {SIP_MLNAME_CAST(sipName_RemoveChild), (PyCFunction)meth_wxDialog_RemoveChild, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_RemoveChild)},
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxDialog_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_SetAffirmativeId), (PyCFunction)meth_wxDialog_SetAffirmativeId, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_SetAffirmativeId)},
    {SIP_MLNAME_CAST(sipName_SetCanFocus), (PyCFunction)meth_wxDialog_SetCanFocus, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_SetCanFocus)},
    {SIP_MLNAME_CAST(sipName_SetEscapeId), (PyCFunction)meth_wxDialog_SetEscapeId, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_SetEscapeId)},
    {SIP_MLNAME_CAST(sipName_SetIcon), (PyCFunction)meth_wxDialog_SetIcon, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_SetIcon)},
    {SIP_MLNAME_CAST(sipName_SetIcons), (PyCFunction)meth_wxDialog_SetIcons, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_SetIcons)},
    {SIP_MLNAME_CAST(sipName_SetLayoutAdaptationDone), (PyCFunction)meth_wxDialog_SetLayoutAdaptationDone, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_SetLayoutAdaptationDone)},
    {SIP_MLNAME_CAST(sipName_SetLayoutAdaptationLevel), (PyCFunction)meth_wxDialog_SetLayoutAdaptationLevel, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_SetLayoutAdaptationLevel)},
    {SIP_MLNAME_CAST(sipName_SetLayoutAdaptationMode), (PyCFunction)meth_wxDialog_SetLayoutAdaptationMode, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_SetLayoutAdaptationMode)},
    {SIP_MLNAME_CAST(sipName_SetLayoutAdapter), (PyCFunction)meth_wxDialog_SetLayoutAdapter, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_SetLayoutAdapter)},
    {SIP_MLNAME_CAST(sipName_SetReturnCode), (PyCFunction)meth_wxDialog_SetReturnCode, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_SetReturnCode)},
    {SIP_MLNAME_CAST(sipName_SetValidator), (PyCFunction)meth_wxDialog_SetValidator, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_SetValidator)},
    ...
    {SIP_MLNAME_CAST(sipName_Show), (PyCFunction)meth_wxDialog_Show, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_Show)},
    ...
    {SIP_MLNAME_CAST(sipName_TryAfter), (PyCFunction)meth_wxDialog_TryAfter, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_TryAfter)},
    {SIP_MLNAME_CAST(sipName_TryBefore), (PyCFunction)meth_wxDialog_TryBefore, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialog_TryBefore)},
...
sipVariableDef variables_wxDialog[] = {
    {PropertyVariable, sipName_ReturnCode, &methods_wxDialog[43], &methods_wxDialog[67], NULL, NULL},
    {PropertyVariable, sipName_MainButtonIds, &methods_wxDialog[41], NULL, NULL, NULL},
    {PropertyVariable, sipName_LayoutAdaptationMode, &methods_wxDialog[39], &methods_wxDialog[65], NULL, NULL},
    {PropertyVariable, sipName_LayoutAdaptationLevel, &methods_wxDialog[38], &methods_wxDialog[64], NULL, NULL},
    {PropertyVariable, sipName_LayoutAdaptationDone, &methods_wxDialog[37], &methods_wxDialog[63], NULL, NULL},
    {PropertyVariable, sipName_EscapeId, &methods_wxDialog[36], &methods_wxDialog[60], NULL, NULL},
    {PropertyVariable, sipName_ContentWindow, &methods_wxDialog[33], NULL, NULL, NULL},
    {PropertyVariable, sipName_AffirmativeId, &methods_wxDialog[31], &methods_wxDialog[58], NULL, NULL},
};
