...
{
     ::wxSplitterRenderParams *sipCpp = 0;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxSplitterRenderParams, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
sipVariableDef variables_wxSplitterRenderParams[] = {
    {InstanceVariable, sipName_border, (PyMethodDef *)varget_wxSplitterRenderParams_border, NULL, NULL, NULL},
    {InstanceVariable, sipName_isHotSensitive, (PyMethodDef *)varget_wxSplitterRenderParams_isHotSensitive, NULL, NULL, NULL},
    {InstanceVariable, sipName_widthSash, (PyMethodDef *)varget_wxSplitterRenderParams_widthSash, NULL, NULL, NULL},
};
