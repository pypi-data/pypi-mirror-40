...
sipwxHyperlinkEvent::sipwxHyperlinkEvent( ::wxObject*generator,int id,const  ::wxString& url):  ::wxHyperlinkEvent(generator,id,url), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxHyperlinkEvent::sipwxHyperlinkEvent(const  ::wxHyperlinkEvent& a0):  ::wxHyperlinkEvent(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
static PyObject *meth_wxHyperlinkEvent_GetURL(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_HyperlinkEvent, sipName_GetURL, NULL);
...
static PyObject *meth_wxHyperlinkEvent_SetURL(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxHyperlinkEvent, &sipCpp, sipType_wxString,&url, &urlState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_HyperlinkEvent, sipName_SetURL, NULL);
...
static void dealloc_wxHyperlinkEvent(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxHyperlinkEvent *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static void *init_type_wxHyperlinkEvent(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxHyperlinkEvent, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxHyperlinkEvent[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SetURL), (PyCFunction)meth_wxHyperlinkEvent_SetURL, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxHyperlinkEvent_SetURL)}
};

sipVariableDef variables_wxHyperlinkEvent[] = {
    {PropertyVariable, sipName_URL, &methods_wxHyperlinkEvent[1], &methods_wxHyperlinkEvent[2], NULL, NULL},
};
