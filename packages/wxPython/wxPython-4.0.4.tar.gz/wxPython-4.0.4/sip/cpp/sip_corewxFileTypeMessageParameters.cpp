...
public:
     ...
     */
protected:
     ::wxString GetParamValue(const  ::wxString&) const;
...
sipwxFileType_MessageParameters::sipwxFileType_MessageParameters():  ::wxFileType::MessageParameters(), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxFileType_MessageParameters::sipwxFileType_MessageParameters(const  ::wxString& filename,const  ::wxString& mimetype):  ::wxFileType::MessageParameters(filename,mimetype), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxFileType_MessageParameters::sipwxFileType_MessageParameters(const  ::wxFileType::MessageParameters& a0):  ::wxFileType::MessageParameters(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
 ...
 ::wxString sipwxFileType_MessageParameters::GetParamValue(const  ::wxString& name) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[0]),sipPySelf,NULL,sipName_GetParamValue);

    if (!sipMeth)
        return  ::wxFileType::MessageParameters::GetParamValue(name);

    extern  ::wxString sipVH__core_217(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxString&);

    return sipVH__core_217(sipGILState, 0, sipPySelf, sipMeth, name);
}
...
static PyObject *meth_wxFileType_MessageParameters_GetFileName(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_MessageParameters, sipName_GetFileName, NULL);
...
static PyObject *meth_wxFileType_MessageParameters_GetMimeType(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_MessageParameters, sipName_GetMimeType, NULL);
...
static PyObject *meth_wxFileType_MessageParameters_GetParamValue(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxFileType_MessageParameters, &sipCpp, sipType_wxString,&name, &nameState))
        {
             ::wxString*sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_MessageParameters, sipName_GetParamValue, NULL);
...
extern "C" {static void *array_wxFileType_MessageParameters(SIP_SSIZE_T);}
static void *array_wxFileType_MessageParameters(SIP_SSIZE_T sipNrElem)
{
...
static void dealloc_wxFileType_MessageParameters(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxFileType_MessageParameters *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxFileType_MessageParameters *sipCpp = 0;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxFileType_MessageParameters, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxFileType_MessageParameters[] = {
    ...
    {SIP_MLNAME_CAST(sipName_GetParamValue), (PyCFunction)meth_wxFileType_MessageParameters_GetParamValue, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxFileType_MessageParameters_GetParamValue)}
};

sipVariableDef variables_wxFileType_MessageParameters[] = {
    {PropertyVariable, sipName_MimeType, &methods_wxFileType_MessageParameters[1], NULL, NULL, NULL},
    {PropertyVariable, sipName_FileName, &methods_wxFileType_MessageParameters[0], NULL, NULL, NULL},
};
