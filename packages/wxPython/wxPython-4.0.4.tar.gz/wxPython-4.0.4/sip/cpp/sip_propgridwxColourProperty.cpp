...
sipwxColourProperty::sipwxColourProperty(const  ::wxString& label,const  ::wxString& name,const  ::wxColour& value):  ::wxColourProperty(label,name,value), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxColourProperty::sipwxColourProperty(const  ::wxColourProperty& a0):  ::wxColourProperty(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
 ...
 ::wxString sipwxColourProperty::ColourToString(const  ::wxColour& col,int index,int argFlags) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[21]),sipPySelf,NULL,sipName_ColourToString);
...
int sipwxColourProperty::GetCustomColourIndex() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[22]),sipPySelf,NULL,sipName_GetCustomColourIndex);
 ...
 ::wxColour sipwxColourProperty::GetColour(int index) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[23]),sipPySelf,NULL,sipName_GetColour);
...
static PyObject *meth_wxColourProperty_ValueToString(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1|i", &sipSelf, sipType_wxColourProperty, &sipCpp, sipType_wxPGVariant,&value, &valueState, &argFlags))
        {
             ::wxString*sipRes;
    ...
    sipNoMethod(sipParseErr, sipName_ColourProperty, sipName_ValueToString, NULL);
...
static PyObject *meth_wxColourProperty_GetColour(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bi", &sipSelf, sipType_wxColourProperty, &sipCpp, &index))
        {
             ::wxColour*sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_ColourProperty, sipName_GetColour, NULL);
...
static void dealloc_wxColourProperty(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxColourProperty *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static void *init_type_wxColourProperty(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxColourProperty, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxColourProperty[] = {{73, 255, 1}};


static PyMethodDef methods_wxColourProperty[] = {
    {SIP_MLNAME_CAST(sipName_GetColour), (PyCFunction)meth_wxColourProperty_GetColour, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxColourProperty_GetColour)},
    {SIP_MLNAME_CAST(sipName_ValueToString), (PyCFunction)meth_wxColourProperty_ValueToString, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxColourProperty_ValueToString)}
};
