...
sipwxDateEvent::sipwxDateEvent():  ::wxDateEvent(), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxDateEvent::sipwxDateEvent( ::wxWindow*win,const  ::wxDateTime& dt, ::wxEventType type):  ::wxDateEvent(win,dt,type), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxDateEvent::sipwxDateEvent(const  ::wxDateEvent& a0):  ::wxDateEvent(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
static PyObject *meth_wxDateEvent_GetDate(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_DateEvent, sipName_GetDate, NULL);
...
static PyObject *meth_wxDateEvent_SetDate(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxDateEvent, &sipCpp, sipType_wxDateTime, &date, &dateState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DateEvent, sipName_SetDate, NULL);
...
static void dealloc_wxDateEvent(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxDateEvent *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static void *init_type_wxDateEvent(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxDateEvent, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxDateEvent[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SetDate), (PyCFunction)meth_wxDateEvent_SetDate, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDateEvent_SetDate)}
};

sipVariableDef variables_wxDateEvent[] = {
    {PropertyVariable, sipName_Date, &methods_wxDateEvent[1], &methods_wxDateEvent[2], NULL, NULL},
};
