...
static PyObject *meth_wxFileTypeInfo_AddExtension(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxFileTypeInfo, &sipCpp, sipType_wxString,&ext, &extState))
        {
            PyErr_Clear();
    ...
    sipNoMethod(sipParseErr, sipName_FileTypeInfo, sipName_AddExtension, NULL);
...
static PyObject *meth_wxFileTypeInfo_SetDescription(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxFileTypeInfo, &sipCpp, sipType_wxString,&description, &descriptionState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FileTypeInfo, sipName_SetDescription, NULL);
...
static PyObject *meth_wxFileTypeInfo_SetOpenCommand(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxFileTypeInfo, &sipCpp, sipType_wxString,&command, &commandState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FileTypeInfo, sipName_SetOpenCommand, NULL);
...
static PyObject *meth_wxFileTypeInfo_SetPrintCommand(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FileTypeInfo, sipName_SetPrintCommand, NULL);
...
static PyObject *meth_wxFileTypeInfo_SetShortDesc(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxFileTypeInfo, &sipCpp, sipType_wxString,&shortDesc, &shortDescState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FileTypeInfo, sipName_SetShortDesc, NULL);
...
static PyObject *meth_wxFileTypeInfo_SetIcon(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1|i", &sipSelf, sipType_wxFileTypeInfo, &sipCpp, sipType_wxString,&iconFile, &iconFileState, &iconIndex))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FileTypeInfo, sipName_SetIcon, NULL);
...
static PyObject *meth_wxFileTypeInfo_GetMimeType(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FileTypeInfo, sipName_GetMimeType, NULL);
...
static PyObject *meth_wxFileTypeInfo_GetOpenCommand(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FileTypeInfo, sipName_GetOpenCommand, NULL);
...
static PyObject *meth_wxFileTypeInfo_GetPrintCommand(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FileTypeInfo, sipName_GetPrintCommand, NULL);
...
static PyObject *meth_wxFileTypeInfo_GetShortDesc(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FileTypeInfo, sipName_GetShortDesc, NULL);
...
static PyObject *meth_wxFileTypeInfo_GetDescription(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FileTypeInfo, sipName_GetDescription, NULL);
...
static PyObject *meth_wxFileTypeInfo_GetExtensions(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FileTypeInfo, sipName_GetExtensions, NULL);
...
static PyObject *meth_wxFileTypeInfo_GetExtensionsCount(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxFileTypeInfo, &sipCpp))
        {
            ...
            Py_BEGIN_ALLOW_THREADS
            sipRes = new  ::size_t(sipCpp->GetExtensionsCount());
            Py_END_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FileTypeInfo, sipName_GetExtensionsCount, NULL);
...
static PyObject *meth_wxFileTypeInfo_GetIconFile(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FileTypeInfo, sipName_GetIconFile, NULL);
...
static PyObject *meth_wxFileTypeInfo_GetIconIndex(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FileTypeInfo, sipName_GetIconIndex, NULL);
...
extern "C" {static void *array_wxFileTypeInfo(SIP_SSIZE_T);}
static void *array_wxFileTypeInfo(SIP_SSIZE_T sipNrElem)
{
...
static void *init_type_wxFileTypeInfo(sipSimpleWrapper *, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxFileTypeInfo, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxFileTypeInfo[] = {
    {SIP_MLNAME_CAST(sipName_AddExtension), (PyCFunction)meth_wxFileTypeInfo_AddExtension, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxFileTypeInfo_AddExtension)},
    ...
    {SIP_MLNAME_CAST(sipName_SetDescription), (PyCFunction)meth_wxFileTypeInfo_SetDescription, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxFileTypeInfo_SetDescription)},
    {SIP_MLNAME_CAST(sipName_SetIcon), (PyCFunction)meth_wxFileTypeInfo_SetIcon, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxFileTypeInfo_SetIcon)},
    {SIP_MLNAME_CAST(sipName_SetOpenCommand), (PyCFunction)meth_wxFileTypeInfo_SetOpenCommand, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxFileTypeInfo_SetOpenCommand)},
    {SIP_MLNAME_CAST(sipName_SetPrintCommand), (PyCFunction)meth_wxFileTypeInfo_SetPrintCommand, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxFileTypeInfo_SetPrintCommand)},
    {SIP_MLNAME_CAST(sipName_SetShortDesc), (PyCFunction)meth_wxFileTypeInfo_SetShortDesc, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxFileTypeInfo_SetShortDesc)}
};

sipVariableDef variables_wxFileTypeInfo[] = {
    {PropertyVariable, sipName_ShortDesc, &methods_wxFileTypeInfo[9], &methods_wxFileTypeInfo[14], NULL, NULL},
    {PropertyVariable, sipName_PrintCommand, &methods_wxFileTypeInfo[8], &methods_wxFileTypeInfo[13], NULL, NULL},
    {PropertyVariable, sipName_OpenCommand, &methods_wxFileTypeInfo[7], &methods_wxFileTypeInfo[12], NULL, NULL},
    {PropertyVariable, sipName_MimeType, &methods_wxFileTypeInfo[6], NULL, NULL, NULL},
    {PropertyVariable, sipName_IconIndex, &methods_wxFileTypeInfo[5], NULL, NULL, NULL},
    {PropertyVariable, sipName_IconFile, &methods_wxFileTypeInfo[4], NULL, NULL, NULL},
    {PropertyVariable, sipName_ExtensionsCount, &methods_wxFileTypeInfo[3], NULL, NULL, NULL},
    {PropertyVariable, sipName_Extensions, &methods_wxFileTypeInfo[2], NULL, NULL, NULL},
    {PropertyVariable, sipName_Description, &methods_wxFileTypeInfo[1], &methods_wxFileTypeInfo[10], NULL, NULL},
};
