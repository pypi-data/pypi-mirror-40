...
{
     ::wxObject* sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "N", new  ::wxString(className), sipType_wxString, NULL);
...
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(0, sipMethod, "D", node, sipType_wxXmlNode, NULL);
...
static sipEnumTypeDef enumTypes[] = {
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxXmlResourceFlags, {0}, 0}, sipNameNr_XmlResourceFlags, -1, NULL},
};

/* These are the enum members of all global enums. */
static sipEnumMemberDef enummembers[] = {
    {sipName_XRC_NO_RELOADING, static_cast<int>(::wxXRC_NO_RELOADING), 2},
    {sipName_XRC_NO_SUBCLASSING, static_cast<int>(::wxXRC_NO_SUBCLASSING), 2},
    {sipName_XRC_USE_LOCALE, static_cast<int>(::wxXRC_USE_LOCALE), 2},
};
...
static sipImportedModuleDef importsTable[] = {
    {"wx._core", sipImportedTypes__xrc__core, NULL, NULL},
    {"wx._xml", sipImportedTypes__xrc__xml, NULL, NULL},
    {NULL, NULL, NULL, NULL}
};
