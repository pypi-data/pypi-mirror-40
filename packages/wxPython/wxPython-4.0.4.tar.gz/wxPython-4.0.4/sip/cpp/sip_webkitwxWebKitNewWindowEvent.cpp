...
sipwxWebKitNewWindowEvent::sipwxWebKitNewWindowEvent( ::wxWindow*win):  ::wxWebKitNewWindowEvent(win), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxWebKitNewWindowEvent::sipwxWebKitNewWindowEvent(const  ::wxWebKitNewWindowEvent& a0):  ::wxWebKitNewWindowEvent(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
static PyObject *meth_wxWebKitNewWindowEvent_GetURL(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_WebKitNewWindowEvent, sipName_GetURL, NULL);
...
static PyObject *meth_wxWebKitNewWindowEvent_SetURL(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxWebKitNewWindowEvent, &sipCpp, sipType_wxString,&url, &urlState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_WebKitNewWindowEvent, sipName_SetURL, NULL);
...
static PyObject *meth_wxWebKitNewWindowEvent_GetTargetName(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_WebKitNewWindowEvent, sipName_GetTargetName, NULL);
...
static PyObject *meth_wxWebKitNewWindowEvent_SetTargetName(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxWebKitNewWindowEvent, &sipCpp, sipType_wxString,&name, &nameState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_WebKitNewWindowEvent, sipName_SetTargetName, NULL);
...
static void dealloc_wxWebKitNewWindowEvent(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxWebKitNewWindowEvent *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxWebKitNewWindowEvent *sipCpp = 0;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxWebKitNewWindowEvent, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxWebKitNewWindowEvent[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SetTargetName), (PyCFunction)meth_wxWebKitNewWindowEvent_SetTargetName, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWebKitNewWindowEvent_SetTargetName)},
    {SIP_MLNAME_CAST(sipName_SetURL), (PyCFunction)meth_wxWebKitNewWindowEvent_SetURL, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxWebKitNewWindowEvent_SetURL)}
};

sipVariableDef variables_wxWebKitNewWindowEvent[] = {
    {PropertyVariable, sipName_URL, &methods_wxWebKitNewWindowEvent[2], &methods_wxWebKitNewWindowEvent[4], NULL, NULL},
    {PropertyVariable, sipName_TargetName, &methods_wxWebKitNewWindowEvent[1], &methods_wxWebKitNewWindowEvent[3], NULL, NULL},
};
