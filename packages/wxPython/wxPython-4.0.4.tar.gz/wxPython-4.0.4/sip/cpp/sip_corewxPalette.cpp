...
static PyObject *meth_wxPalette_Create(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BP0P0P0", &sipSelf, sipType_wxPalette, &sipCpp, &red, &green, &blue))
        {
            PyObject * sipRes = 0;
            int sipIsErr = 0;
    ...
    sipNoMethod(sipParseErr, sipName_Palette, sipName_Create, NULL);
...
static PyObject *meth_wxPalette_GetColoursCount(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Palette, sipName_GetColoursCount, NULL);
...
static PyObject *meth_wxPalette_GetPixel(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BMMM", &sipSelf, sipType_wxPalette, &sipCpp, &red, &green, &blue))
        {
            int sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Palette, sipName_GetPixel, NULL);
...
static PyObject *meth_wxPalette_GetRGB(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bi", &sipSelf, sipType_wxPalette, &sipCpp, &pixel))
        {
            PyObject * sipRes = 0;
            int sipIsErr = 0;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Palette, sipName_GetRGB, NULL);
...
static PyObject *meth_wxPalette_IsOk(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Palette, sipName_IsOk, NULL);
...
extern "C" {static void *array_wxPalette(SIP_SSIZE_T);}
static void *array_wxPalette(SIP_SSIZE_T sipNrElem)
{
...
static sipEncodedTypeDef supers_wxPalette[] = {{205, 255, 1}};


static PyMethodDef methods_wxPalette[] = {
    {SIP_MLNAME_CAST(sipName_Create), (PyCFunction)meth_wxPalette_Create, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPalette_Create)},
    ...
    {SIP_MLNAME_CAST(sipName_GetPixel), (PyCFunction)meth_wxPalette_GetPixel, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPalette_GetPixel)},
    {SIP_MLNAME_CAST(sipName_GetRGB), (PyCFunction)meth_wxPalette_GetRGB, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPalette_GetRGB)},
...
sipVariableDef variables_wxPalette[] = {
    {PropertyVariable, sipName_RGB, &methods_wxPalette[3], NULL, NULL, NULL},
    {PropertyVariable, sipName_ColoursCount, &methods_wxPalette[1], NULL, NULL, NULL},
};
