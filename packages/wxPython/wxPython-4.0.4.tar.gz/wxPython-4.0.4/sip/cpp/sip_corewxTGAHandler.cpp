...
sipwxTGAHandler::sipwxTGAHandler():  ::wxTGAHandler(), sipPySelf(0)
{
...
int sipwxTGAHandler::GetImageCount( ::wxInputStream& stream)
{
    ...
    if (!sipMeth)
        return  ::wxTGAHandler::GetImageCount(stream);
...
static PyObject *meth_wxTGAHandler_DoGetImageCount(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxTGAHandler, &sipCpp, sipType_wxInputStream, &stream, &streamState))
        {
            int sipRes;
    ...
    sipNoMethod(sipParseErr, sipName_TGAHandler, sipName_DoGetImageCount, NULL);
...
static PyObject *meth_wxTGAHandler_LoadFile(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8J1|bi", &sipSelf, sipType_wxTGAHandler, &sipCpp, sipType_wxImage, &image, sipType_wxInputStream, &stream, &streamState, &verbose, &index))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TGAHandler, sipName_LoadFile, NULL);
...
static PyObject *meth_wxTGAHandler_SaveFile(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8J1|b", &sipSelf, sipType_wxTGAHandler, &sipCpp, sipType_wxImage, &image, sipType_wxOutputStream, &stream, &streamState, &verbose))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TGAHandler, sipName_SaveFile, NULL);
...
static PyObject *meth_wxTGAHandler_DoCanRead(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TGAHandler, sipName_DoCanRead, NULL);
...
static void dealloc_wxTGAHandler(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxTGAHandler *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static sipEncodedTypeDef supers_wxTGAHandler[] = {{256, 255, 1}};


static PyMethodDef methods_wxTGAHandler[] = {
    {SIP_MLNAME_CAST(sipName_DoCanRead), (PyCFunction)meth_wxTGAHandler_DoCanRead, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTGAHandler_DoCanRead)},
    {SIP_MLNAME_CAST(sipName_DoGetImageCount), (PyCFunction)meth_wxTGAHandler_DoGetImageCount, METH_VARARGS|METH_KEYWORDS, NULL},
    {SIP_MLNAME_CAST(sipName_LoadFile), (PyCFunction)meth_wxTGAHandler_LoadFile, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTGAHandler_LoadFile)},
    {SIP_MLNAME_CAST(sipName_SaveFile), (PyCFunction)meth_wxTGAHandler_SaveFile, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTGAHandler_SaveFile)}
};
