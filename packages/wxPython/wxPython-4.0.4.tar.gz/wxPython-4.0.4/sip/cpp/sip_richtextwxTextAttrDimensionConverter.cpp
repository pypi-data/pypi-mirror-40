...
static PyObject *meth_wxTextAttrDimensionConverter_GetPixels(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9|i", &sipSelf, sipType_wxTextAttrDimensionConverter, &sipCpp, sipType_wxTextAttrDimension, &dim, &direction))
        {
            int sipRes;
    ...
    sipNoMethod(sipParseErr, sipName_TextAttrDimensionConverter, sipName_GetPixels, NULL);
...
static PyObject *meth_wxTextAttrDimensionConverter_GetTenthsMM(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxTextAttrDimensionConverter, &sipCpp, sipType_wxTextAttrDimension, &dim))
        {
            int sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TextAttrDimensionConverter, sipName_GetTenthsMM, NULL);
...
static PyObject *meth_wxTextAttrDimensionConverter_ConvertTenthsMMToPixels(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bi", &sipSelf, sipType_wxTextAttrDimensionConverter, &sipCpp, &units))
        {
            int sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TextAttrDimensionConverter, sipName_ConvertTenthsMMToPixels, NULL);
...
static PyObject *meth_wxTextAttrDimensionConverter_ConvertPixelsToTenthsMM(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bi", &sipSelf, sipType_wxTextAttrDimensionConverter, &sipCpp, &pixels))
        {
            int sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_TextAttrDimensionConverter, sipName_ConvertPixelsToTenthsMM, NULL);
...
{
     ::wxTextAttrDimensionConverter *sipCpp = 0;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxTextAttrDimensionConverter, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxTextAttrDimensionConverter[] = {
    {SIP_MLNAME_CAST(sipName_ConvertPixelsToTenthsMM), (PyCFunction)meth_wxTextAttrDimensionConverter_ConvertPixelsToTenthsMM, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTextAttrDimensionConverter_ConvertPixelsToTenthsMM)},
    {SIP_MLNAME_CAST(sipName_ConvertTenthsMMToPixels), (PyCFunction)meth_wxTextAttrDimensionConverter_ConvertTenthsMMToPixels, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTextAttrDimensionConverter_ConvertTenthsMMToPixels)},
    {SIP_MLNAME_CAST(sipName_GetPixels), (PyCFunction)meth_wxTextAttrDimensionConverter_GetPixels, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTextAttrDimensionConverter_GetPixels)},
    {SIP_MLNAME_CAST(sipName_GetTenthsMM), (PyCFunction)meth_wxTextAttrDimensionConverter_GetTenthsMM, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTextAttrDimensionConverter_GetTenthsMM)}
};


extern "C" {static PyObject *varget_wxTextAttrDimensionConverter_m_parentSize(void *, PyObject *, PyObject *);}
static PyObject *varget_wxTextAttrDimensionConverter_m_parentSize(void *sipSelf, PyObject *, PyObject *)
{
     ::wxSize*sipVal;
...
sipVariableDef variables_wxTextAttrDimensionConverter[] = {
    {InstanceVariable, sipName_m_parentSize, (PyMethodDef *)varget_wxTextAttrDimensionConverter_m_parentSize, (PyMethodDef *)varset_wxTextAttrDimensionConverter_m_parentSize, NULL, NULL},
    {InstanceVariable, sipName_m_ppi, (PyMethodDef *)varget_wxTextAttrDimensionConverter_m_ppi, (PyMethodDef *)varset_wxTextAttrDimensionConverter_m_ppi, NULL, NULL},
    {InstanceVariable, sipName_m_scale, (PyMethodDef *)varget_wxTextAttrDimensionConverter_m_scale, (PyMethodDef *)varset_wxTextAttrDimensionConverter_m_scale, NULL, NULL},
};
