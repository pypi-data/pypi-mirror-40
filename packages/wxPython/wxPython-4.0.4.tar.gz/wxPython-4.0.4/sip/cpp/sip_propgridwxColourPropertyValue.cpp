...
sipwxColourPropertyValue::sipwxColourPropertyValue():  ::wxColourPropertyValue(), sipPySelf(0)
{
}

sipwxColourPropertyValue::sipwxColourPropertyValue(const  ::wxColourPropertyValue& v):  ::wxColourPropertyValue(v), sipPySelf(0)
{
}

sipwxColourPropertyValue::sipwxColourPropertyValue(const  ::wxColour& colour):  ::wxColourPropertyValue(colour), sipPySelf(0)
{
}

sipwxColourPropertyValue::sipwxColourPropertyValue( ::wxUint32 type):  ::wxColourPropertyValue(type), sipPySelf(0)
{
}

sipwxColourPropertyValue::sipwxColourPropertyValue( ::wxUint32 type,const  ::wxColour& colour):  ::wxColourPropertyValue(type,colour), sipPySelf(0)
{
}
...
static PyObject *meth_wxColourPropertyValue_Init(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BuJ1", &sipSelf, sipType_wxColourPropertyValue, &sipCpp, &type, sipType_wxColour, &colour, &colourState))
        {
            PyErr_Clear();
    ...
    sipNoMethod(sipParseErr, sipName_ColourPropertyValue, sipName_Init, NULL);
...
static void dealloc_wxColourPropertyValue(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxColourPropertyValue *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxColourPropertyValue *sipCpp = 0;
...
static PyMethodDef methods_wxColourPropertyValue[] = {
    {SIP_MLNAME_CAST(sipName_Init), (PyCFunction)meth_wxColourPropertyValue_Init, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxColourPropertyValue_Init)}
};
...
sipVariableDef variables_wxColourPropertyValue[] = {
    {InstanceVariable, sipName_m_colour, (PyMethodDef *)varget_wxColourPropertyValue_m_colour, (PyMethodDef *)varset_wxColourPropertyValue_m_colour, NULL, NULL},
    {InstanceVariable, sipName_m_type, (PyMethodDef *)varget_wxColourPropertyValue_m_type, (PyMethodDef *)varset_wxColourPropertyValue_m_type, NULL, NULL},
};
