...
sipwxGridEvent::sipwxGridEvent():  ::wxGridEvent(), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxGridEvent::sipwxGridEvent(int id, ::wxEventType type, ::wxObject*obj,int row,int col,int x,int y,bool sel,const  ::wxKeyboardState& kbd):  ::wxGridEvent(id,type,obj,row,col,x,y,sel,kbd), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxGridEvent::sipwxGridEvent(const  ::wxGridEvent& a0):  ::wxGridEvent(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
int sipwxGridEvent::GetRow()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[0],sipPySelf,NULL,sipName_GetRow);
...
int sipwxGridEvent::GetCol()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[1],sipPySelf,NULL,sipName_GetCol);
 ...
 ::wxEventCategory sipwxGridEvent::GetEventCategory() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[3]),sipPySelf,NULL,sipName_GetEventCategory);
...
static PyObject *meth_wxGridEvent_AltDown(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_GridEvent, sipName_AltDown, NULL);
...
static PyObject *meth_wxGridEvent_ControlDown(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GridEvent, sipName_ControlDown, NULL);
...
static PyObject *meth_wxGridEvent_GetCol(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GridEvent, sipName_GetCol, NULL);
...
static PyObject *meth_wxGridEvent_GetPosition(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GridEvent, sipName_GetPosition, NULL);
...
static PyObject *meth_wxGridEvent_GetRow(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GridEvent, sipName_GetRow, NULL);
...
static PyObject *meth_wxGridEvent_MetaDown(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GridEvent, sipName_MetaDown, NULL);
...
static PyObject *meth_wxGridEvent_Selecting(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GridEvent, sipName_Selecting, NULL);
...
static PyObject *meth_wxGridEvent_ShiftDown(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GridEvent, sipName_ShiftDown, NULL);
...
static void dealloc_wxGridEvent(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxGridEvent *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
static void *init_type_wxGridEvent(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxGridEvent, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
sipVariableDef variables_wxGridEvent[] = {
    {PropertyVariable, sipName_Row, &methods_wxGridEvent[5], NULL, NULL, NULL},
    {PropertyVariable, sipName_Position, &methods_wxGridEvent[4], NULL, NULL, NULL},
    {PropertyVariable, sipName_Col, &methods_wxGridEvent[3], NULL, NULL, NULL},
};
