...
public:
     ...
     */
protected:
    bool DoLayoutAdaptation( ::wxDialog*);
    bool CanDoLayoutAdaptation( ::wxDialog*);
...
sipwxDialogLayoutAdapter::sipwxDialogLayoutAdapter():  ::wxDialogLayoutAdapter(), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipwxDialogLayoutAdapter::sipwxDialogLayoutAdapter(const  ::wxDialogLayoutAdapter& a0):  ::wxDialogLayoutAdapter(a0), sipPySelf(0)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
bool sipwxDialogLayoutAdapter::DoLayoutAdaptation( ::wxDialog*dialog)
{
    ...
    extern bool sipVH__core_178(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDialog*);

    return sipVH__core_178(sipGILState, 0, sipPySelf, sipMeth, dialog);
}
...
static PyObject *meth_wxDialogLayoutAdapter_CanDoLayoutAdaptation(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8", &sipSelf, sipType_wxDialogLayoutAdapter, &sipCpp, sipType_wxDialog, &dialog))
        {
            bool sipRes;
    ...
    sipNoMethod(sipParseErr, sipName_DialogLayoutAdapter, sipName_CanDoLayoutAdaptation, NULL);
...
static PyObject *meth_wxDialogLayoutAdapter_DoLayoutAdaptation(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_DialogLayoutAdapter, sipName_DoLayoutAdaptation, NULL);
...
static void dealloc_wxDialogLayoutAdapter(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxDialogLayoutAdapter *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxDialogLayoutAdapter *sipCpp = 0;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, NULL, sipUnused, "J9", sipType_wxDialogLayoutAdapter, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxDialogLayoutAdapter[] = {
    {SIP_MLNAME_CAST(sipName_CanDoLayoutAdaptation), (PyCFunction)meth_wxDialogLayoutAdapter_CanDoLayoutAdaptation, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialogLayoutAdapter_CanDoLayoutAdaptation)},
    {SIP_MLNAME_CAST(sipName_DoLayoutAdaptation), (PyCFunction)meth_wxDialogLayoutAdapter_DoLayoutAdaptation, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDialogLayoutAdapter_DoLayoutAdaptation)}
};
