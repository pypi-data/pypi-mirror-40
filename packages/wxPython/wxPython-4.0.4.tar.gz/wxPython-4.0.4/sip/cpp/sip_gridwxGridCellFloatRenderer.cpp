...
sipwxGridCellFloatRenderer::sipwxGridCellFloatRenderer(int width,int precision,int format):  ::wxGridCellFloatRenderer(width,precision,format), sipPySelf(0)
{
 ...
 ::wxSize sipwxGridCellFloatRenderer::GetBestSize( ::wxGrid& grid, ::wxGridCellAttr& attr, ::wxDC& dc,int row,int col)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[1],sipPySelf,NULL,sipName_GetBestSize);
...
static PyObject *meth_wxGridCellFloatRenderer_GetFormat(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_GridCellFloatRenderer, sipName_GetFormat, NULL);
...
static PyObject *meth_wxGridCellFloatRenderer_GetPrecision(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GridCellFloatRenderer, sipName_GetPrecision, NULL);
...
static PyObject *meth_wxGridCellFloatRenderer_GetWidth(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GridCellFloatRenderer, sipName_GetWidth, NULL);
...
static PyObject *meth_wxGridCellFloatRenderer_SetFormat(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bi", &sipSelf, sipType_wxGridCellFloatRenderer, &sipCpp, &format))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GridCellFloatRenderer, sipName_SetFormat, NULL);
...
static PyObject *meth_wxGridCellFloatRenderer_SetParameters(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1", &sipSelf, sipType_wxGridCellFloatRenderer, &sipCpp, sipType_wxString,&params, &paramsState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GridCellFloatRenderer, sipName_SetParameters, NULL);
...
static PyObject *meth_wxGridCellFloatRenderer_SetPrecision(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bi", &sipSelf, sipType_wxGridCellFloatRenderer, &sipCpp, &precision))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GridCellFloatRenderer, sipName_SetPrecision, NULL);
...
static PyObject *meth_wxGridCellFloatRenderer_SetWidth(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bi", &sipSelf, sipType_wxGridCellFloatRenderer, &sipCpp, &width))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_GridCellFloatRenderer, sipName_SetWidth, NULL);
...
static PyObject *meth_wxGridCellFloatRenderer_Draw(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9J9J9J1iib", &sipSelf, sipType_wxGridCellFloatRenderer, &sipCpp, sipType_wxGrid, &grid, sipType_wxGridCellAttr, &attr, sipType_wxDC, &dc, sipType_wxRect, &rect, &rectState, &row, &col, &isSelected))
        {
            PyErr_Clear();
...
static PyObject *meth_wxGridCellFloatRenderer_GetBestSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9J9J9ii", &sipSelf, sipType_wxGridCellFloatRenderer, &sipCpp, sipType_wxGrid, &grid, sipType_wxGridCellAttr, &attr, sipType_wxDC, &dc, &row, &col))
        {
             ::wxSize*sipRes;
...
static void dealloc_wxGridCellFloatRenderer(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipwxGridCellFloatRenderer *>(sipGetAddress(sipSelf))->sipPySelf = NULL;
...
{
    sipwxGridCellFloatRenderer *sipCpp = 0;
...
static sipEncodedTypeDef supers_wxGridCellFloatRenderer[] = {{24, 255, 1}};
...
static PyMethodDef methods_wxGridCellFloatRenderer[] = {
    ...
    {SIP_MLNAME_CAST(sipName_Draw), (PyCFunction)meth_wxGridCellFloatRenderer_Draw, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridCellFloatRenderer_Draw)},
    {SIP_MLNAME_CAST(sipName_GetBestSize), (PyCFunction)meth_wxGridCellFloatRenderer_GetBestSize, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridCellFloatRenderer_GetBestSize)},
    ...
    {SIP_MLNAME_CAST(sipName_SetFormat), (PyCFunction)meth_wxGridCellFloatRenderer_SetFormat, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridCellFloatRenderer_SetFormat)},
    {SIP_MLNAME_CAST(sipName_SetParameters), (PyCFunction)meth_wxGridCellFloatRenderer_SetParameters, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridCellFloatRenderer_SetParameters)},
    {SIP_MLNAME_CAST(sipName_SetPrecision), (PyCFunction)meth_wxGridCellFloatRenderer_SetPrecision, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridCellFloatRenderer_SetPrecision)},
    {SIP_MLNAME_CAST(sipName_SetWidth), (PyCFunction)meth_wxGridCellFloatRenderer_SetWidth, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridCellFloatRenderer_SetWidth)}
};

sipVariableDef variables_wxGridCellFloatRenderer[] = {
    {PropertyVariable, sipName_Width, &methods_wxGridCellFloatRenderer[5], &methods_wxGridCellFloatRenderer[9], NULL, NULL},
    {PropertyVariable, sipName_Precision, &methods_wxGridCellFloatRenderer[4], &methods_wxGridCellFloatRenderer[8], NULL, NULL},
    {PropertyVariable, sipName_Format, &methods_wxGridCellFloatRenderer[3], &methods_wxGridCellFloatRenderer[6], NULL, NULL},
};
