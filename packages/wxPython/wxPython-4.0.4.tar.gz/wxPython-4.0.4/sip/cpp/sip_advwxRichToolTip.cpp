...
static PyObject *meth_wxRichToolTip_SetIcon(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "B|i", &sipSelf, sipType_wxRichToolTip, &sipCpp, &icon))
        {
            PyErr_Clear();
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxRichToolTip, &sipCpp, sipType_wxIcon, &icon))
        {
            PyErr_Clear();
    ...
    sipNoMethod(sipParseErr, sipName_RichToolTip, sipName_SetIcon, NULL);
...
static PyObject *meth_wxRichToolTip_SetBackgroundColour(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ1|J1", &sipSelf, sipType_wxRichToolTip, &sipCpp, sipType_wxColour, &col, &colState, sipType_wxColour, &colEnd, &colEndState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichToolTip, sipName_SetBackgroundColour, NULL);
...
static PyObject *meth_wxRichToolTip_SetTimeout(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "Bu|u", &sipSelf, sipType_wxRichToolTip, &sipCpp, &millisecondsTimeout, &millisecondsDelay))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichToolTip, sipName_SetTimeout, NULL);
...
static PyObject *meth_wxRichToolTip_SetTipKind(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BE", &sipSelf, sipType_wxRichToolTip, &sipCpp, sipType_wxTipKind, &tipKind))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichToolTip, sipName_SetTipKind, NULL);
...
static PyObject *meth_wxRichToolTip_SetTitleFont(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxRichToolTip, &sipCpp, sipType_wxFont, &font))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichToolTip, sipName_SetTitleFont, NULL);
...
static PyObject *meth_wxRichToolTip_ShowFor(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ8|J0", &sipSelf, sipType_wxRichToolTip, &sipCpp, sipType_wxWindow, &win, sipType_wxRect, &rect, &rectState))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_RichToolTip, sipName_ShowFor, NULL);
...
static PyMethodDef methods_wxRichToolTip[] = {
    {SIP_MLNAME_CAST(sipName_SetBackgroundColour), (PyCFunction)meth_wxRichToolTip_SetBackgroundColour, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichToolTip_SetBackgroundColour)},
    {SIP_MLNAME_CAST(sipName_SetIcon), (PyCFunction)meth_wxRichToolTip_SetIcon, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichToolTip_SetIcon)},
    {SIP_MLNAME_CAST(sipName_SetTimeout), (PyCFunction)meth_wxRichToolTip_SetTimeout, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichToolTip_SetTimeout)},
    {SIP_MLNAME_CAST(sipName_SetTipKind), (PyCFunction)meth_wxRichToolTip_SetTipKind, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichToolTip_SetTipKind)},
    {SIP_MLNAME_CAST(sipName_SetTitleFont), (PyCFunction)meth_wxRichToolTip_SetTitleFont, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichToolTip_SetTitleFont)},
    {SIP_MLNAME_CAST(sipName_ShowFor), (PyCFunction)meth_wxRichToolTip_ShowFor, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxRichToolTip_ShowFor)}
};
