...
storage_path_pumpBase_run = "/var/www/raspberry_reactjs/logs/pumpBase_run"

storage_path_pumpAcid = "/var/www/raspberry_reactjs/logs/pumpAcid"
storage_path_pumpAcid_run = "/var/www/raspberry_reactjs/logs/pumpAcid_run"

run = True
runPump = 0
pumpAcid = False

ph = pihy.AtlasPH.AtlasPH()
ph.set_i2c_address(99)

pumpBase = pihy.AtlasPump.AtlasPump()
pumpBase.set_i2c_address(51)

pumpAcid = pihy.AtlasPump.AtlasPump()
pumpAcid.set_i2c_address(52)
