...
from Pyautomators.BDT._types import ChainedExceptionUtil, ExceptionUtil
from Pyautomators.BDT.model_core import Argument, FileLocation, Replayable
...
def register_type(**kw):
    ...
    .. code-block:: python
        ...
        from Pyautomators.BDT import register_type, given
        import parse
...
matcher_mapping = {
    ...
    #   from Pyautomators.BDT import use_step_matcher
