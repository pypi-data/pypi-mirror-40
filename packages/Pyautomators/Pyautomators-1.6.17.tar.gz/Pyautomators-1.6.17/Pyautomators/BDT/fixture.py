...
.. sourcecode:: python
    ...
    from Pyautomators.BDT import fixture
...
.. sourcecode:: python
    ...
    from Pyautomators.BDT import use_fixture
    from TESTE.BDT4my_project.fixtures import browser_firefox
...
def use_fixture_by_tag(tag, context, fixture_registry):
    ...
    .. code-block:: python
        ...
        # -- FILE: features/environment.py
        from Pyautomators.BDT.fixture import use_fixture_by_tag
        from TESTE.BDT4my_project.fixtures import browser_firefox, browser_chrome
