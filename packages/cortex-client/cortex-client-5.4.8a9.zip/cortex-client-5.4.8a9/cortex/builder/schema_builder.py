...
class SchemaBuilder:
    ...
    """
    A builder utility to aid in programmatic creation of Cortex Schemas (Types).  Not meant to be directly instantiated
    by clients.
    """
    ...
    def title(self, title: str):
        ...
        :param title: The human friendly name of the Schema.
    ...
    def description(self, description: str):
        ...
        :param description: The human friendly long description of the Schema.
        :return: The builder instance.
        """
