...
class InsightsProvider(BaseProviderWithDependencies):
    ...
    def __init__(self, *args, insight_types:Mapping[str, List[str]]=defaults.INSIGHT_TYPES_PER_APP, concept_limits_per_insight:Optional[Mapping[str, Mapping[str, int]]]=defaults.LIMITS_ON_COUNTS_CONCEPTS_OF_TYPE_PER_CONCEPT_SET, **kwargs):
    ...
    def tags(self, insightId:str, taggedOn:str, tagged_concepts:Optional[List[Link]]=None) -> List[InsightTag]:
        tagged_concepts = tagged_concepts if tagged_concepts else [None]*10
