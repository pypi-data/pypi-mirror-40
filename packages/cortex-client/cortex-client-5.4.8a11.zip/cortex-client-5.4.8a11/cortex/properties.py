...
class PropertyManager:
    ...
    def load(self, config_file, replace=False) -> bool:
        ...
        :param replace: If the file is to be added or replaced.
        :return:
            True if the file was found, opened, and loaded. False if an exception occurs.
    ...
    def get_all(self) -> dict:
        ...
        :returns:
            A deep copy of the key-value pairs.
        """
        with threading.Lock():
