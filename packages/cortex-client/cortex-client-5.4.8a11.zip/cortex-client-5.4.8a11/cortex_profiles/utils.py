...
def get_until(
        yielder:Callable[[], object],
        appender:Callable[[object, ToYeild], object],
        ignore_condition:Callable[[object, ToYeild], bool],
...
def group_by_key(l:List[object], key_deriver:Callable[[object], str]) -> Mapping[str, List[object]]:
