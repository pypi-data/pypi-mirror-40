...
class ActionClient(_Client):
    ...
    def get_job_stats(self, action_name):
        """
        Get execution stats for tasks associated with action `action_name` of type job.
    ...
    def get_tasks(self, action_name):
        """
        Get list of tasks associated with the give job `action_name`.
    ...
    def delete_task(self, action_name, task_id):
        """
        Delete a task associated with a job action.
