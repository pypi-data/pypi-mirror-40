...
def jupyter_lab_runtime_detected():
    parent_pid = os.getppid()
    parent_process = psutil.Process(parent_pid)
    return any(["jupyter-lab" in x for x in parent_process.cmdline()])


InteractableJson = InteractableJson if not jupyter_lab_runtime_detected() else JSON