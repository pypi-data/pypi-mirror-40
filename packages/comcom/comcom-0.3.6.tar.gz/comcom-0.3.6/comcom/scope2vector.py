...
class ComScoper:
    ...
    def __init__(self):
        ...
        self.stop_list   = jsonfiler.load(os.path.join(self.module_path,"data","stop_list.json"))
        self.scopeverbs  = jsonfiler.load(os.path.join(self.module_path,"data","scopeverbs.json"))
        self.ignores     = jsonfiler.load(os.path.join(self.module_path,"data","ignores.json"))
        self.gbbs_dict   = jsonfiler.load(os.path.join(self.module_path,"data","gbt4547.json"))
        rmap_files = [
            "rmap_其它.json",
            "rmap_咨询.json",
            "rmap_基本.json",
        ...
        for rmap_file_name in rmap_files:
            ...
            rmap_json =  jsonfiler.load(os.path.join(self.module_path,"rmap",rmap_file_name))
 ...
 #       scopeverbs  = self.scopeverbs
  ...
  #      gbbs_rmap   = self.gbbs_rmap
    ...
    def scope2vector(self,scope_str_original):
        ...
        gbt4547_tmpl = jsonfiler.load(os.path.join(module_path,"data","gbt4547_tmpl.json"))
...
def main():
    #com_list = jsonfiler.load("com_list_demo.json")
