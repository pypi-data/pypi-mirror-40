...
def getcomlogoname(com_name):
    ...
    city_list = jsonfiler.load(os.path.join(module_path,"json","com_cities.json"))
    city_flag = False
    province_flag = False
    ...
    #兰州中力商情信息咨询有限公司
    com_types = jsonfiler.load(os.path.join(module_path,"json","com_types.json"))
    ...
    com_tails = jsonfiler.load(os.path.join(module_path,"json","com_tails.json"))
