...
setup(
    name='steamers-misago',
    version='0.0.2',
    license='GPLv2',
    description=(
        "Steamers-Misago is modern, fully featured forum application written in "
    ...
    url='https://github.com/Trievo/steamers-misago',
    author=u'Mark Tripoli',
    author_email='mark.tripoli@trievosoftware.com',
