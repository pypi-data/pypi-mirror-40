...
class Cliff:
    ...
    PARSE_TEXT_PATH = "/cliff-2.4.2/parse/text"
    PARSE_NLP_JSON_PATH = "/cliff-2.4.2/parse/json"
    PARSE_SENTENCES_PATH = "/cliff-2.4.2/parse/sentences"
    GEONAMES_LOOKUP_PATH = "/cliff-2.4.2/geonames"
    EXTRACT_TEXT_PATH = "/cliff-2.4.2/extract"
