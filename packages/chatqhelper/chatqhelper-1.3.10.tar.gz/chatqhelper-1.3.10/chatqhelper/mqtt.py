...
class MqttClient(mqtt.Client):
    ...
    def reply(self, msg, status, qos=1, **kwargs):
    ...
    def success(self, msg, qos=1, **kwargs):
        self.reply(msg, constants.STATUS_SUCCESS, qos=qos, **kwargs)

    def failure(self, msg, qos=1, **kwargs):
        self.reply(msg, constants.STATUS_FAILURE, qos=qos, **kwargs)
