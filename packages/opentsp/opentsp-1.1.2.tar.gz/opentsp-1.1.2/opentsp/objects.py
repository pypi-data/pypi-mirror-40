...
import time  # Solver
from functools import reduce  # Solver
...
class Edge:
    ...
    def __eq__(self, other):
        ...
        Undirected edges are considered equal if they have the same two nodes, regardles of position.
        ...
        if len(instance.nodes) > 3:
            ...
            for i in range(perm_range):  # exhaust the generator without throwing an error
                ...
                if total_length <= shortest_path_length:
                    ...
                    shortest_path = Path(permutation)
