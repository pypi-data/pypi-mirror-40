...
setup(
    name='benchsuite.scheduler',
    version='.'.join(map(str, VERSION)),

    description='A scheduler to start Benchmarking Suite jobs at defined intervals',
    long_description=open(os.path.join(os.path.dirname(__file__), 'README.rst')).read(),

    url='https://github.com/benchmarking-suite/benchsuite-scheduler',
    ...
    install_requires=['apscheduler', 'pymongo', 'docker==3.3.0']
