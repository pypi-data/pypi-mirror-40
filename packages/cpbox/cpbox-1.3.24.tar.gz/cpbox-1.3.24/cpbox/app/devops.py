...
class DevOpsApp(object):
    ...
    def __init__(self, app_name, log_level='info', exit_on_error=True):
        ...
        self.prepare_app_dirs()

        self.app_storage_dir = '/opt/data/' + self.app_name
    ...
    def prepare_app_dirs(self):
        app_root_dir = self.roles_dir + '/' + self.app_name
    ...
    def _ensure_dir_and_write_permision(self):
        ...
        file.ensure_dir(self.app_logs_dir, mode=0o755)
