...
class WorkerBase(ServerNode):
    def __init__(self, scheduler_ip=None, scheduler_port=None,
        ...
        pc = PeriodicCallback(self.test_alive, 1000, io_loop=self.io_loop)
        self.periodic_callbacks['test_alive'] = pc
    ...
    @gen.coroutine
    def test_alive(self):
        logger.debug("test_alive")

    @gen.coroutine
    def heartbeat(self):
        logger.debug("heartbeat_worker {} {}".format(self.agent_id, self.contact_address))
        try:
