...
def getWorksList():
	...
	for hit in es.scrollSearch('works_video_read', 'video', {"query": {"bool": {"must": [{"term": {"state": {"value": 0}}}, {"term": {"authorstate": {"value": 0}}}, {"range": {"publishtime": {"gte": long(time.time()) - 14 * 24 * 60 * 60}}}]}}, "size":1000}):
