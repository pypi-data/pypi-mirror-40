...
class Works(object):
	...
	def getDataByVid(self, vid, startTime, endTime):
		baseBody = {"query": {"bool": {"must": [{"range": {"createTime": {"gte": startTime, "lt": endTime}}}, {"term": {"vid": vid}}, {"terms": {"action": [1, 2, 12, 13, 14, 15, 16, 17]}}]}}, "size": 0, "aggs": {}}
		baseBody['aggs']['uid_diff'] = {"terms": {"field": "action", "size": 8}, "aggs": {}}
