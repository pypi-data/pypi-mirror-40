...
class Works(object):
	...
	def getDataByVid(self, vid, startTime, endTime):
		...
		body = {"query": {"bool": {"must": [{"range": {"createTime": {"gte": startTime, "lt": endTime}}}, {"term": {"vid": vid}}, {"terms": {"action": [2, 12, 13, 14, 15, 16, 17]}}]}}, "size": 0, "aggs": {}}
		...
		counts = {2: 0, 12: 0, 13: 0, 14: 0, 15: 0, 16: 0, 17: 0}
		...
		print(es.searchStatisticsDataByBody("works_players", {"query": {"term": {"vid": vid}}, "size": 10000}, True, True, True))

		print(0, counts[12], counts[13], 0, counts[16] - counts[17], counts[14] - counts[15], counts[2], timeAvg if timeAvg != None else 0)
		return 0, counts[12], counts[13], 0, counts[16] - counts[17], counts[14] - counts[15], counts[2], timeAvg if timeAvg != None else 0
