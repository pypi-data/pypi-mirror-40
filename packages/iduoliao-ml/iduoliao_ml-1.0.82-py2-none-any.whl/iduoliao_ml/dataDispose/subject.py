...
class Subject(object):
	...
	def getDataByAid(self, aid, startTime, endTime):
		hits = es.searchStatisticsDataByBody("works_actions", {"query": {"bool": {"must": [{"range": {"createTime": {"gte": startTime, "lt": endTime}}}, {"term": {"aid": aid}}, {"terms": {"action": [1, 3, 4, 5]}}]}}}, True, True)
		count = 0
		playUids = []
		replayUids = set()
		recShow = 0
