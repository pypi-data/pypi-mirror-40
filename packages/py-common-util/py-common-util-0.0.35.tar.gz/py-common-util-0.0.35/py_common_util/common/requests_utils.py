...
class RequestsUtils:
    ...
    def get(self, url, params=None, retry_count=0, retry_count_max=0, hooks_exception_callback=None):
        # print("get=" + url)
        try:
            ...
            if hooks_exception_callback:
                ...
                if retry_count < retry_count_max:
                    ...
                    return self.get(url, params, retry_count, retry_count_max, hooks_exception_callback)

    def post(self, url, data=None, retry_count=0, retry_count_max=0, hooks_exception_callback=None):
        # print("post=" + url)
        try:
            if self.headers.get("Host") is None or len(self.headers.get("Host")) < 1:
                self.headers["Host"] = self.url_parse(url).hostname
            ...
            if hooks_exception_callback:
                ...
                if retry_count < retry_count_max:
                    ...
                    return self.post(url, data, retry_count, retry_count_max, hooks_exception_callback)
...
if __name__ == '__main__':
    ...
    # print(r.json())
    try:
        r = req.get(url='https://www.facebook.com', retry_count_max=2, hooks_exception_callback=hooks_callback)
        print(r)
    except:
