...
class OrderingTests(LinqTestBase):
    ...
    def test_order_by(self):
        self.check(Query.args('ccc', 'bb', 'a').order_by(len), 'a', 'bb', 'ccc')


    def test_order_by_descending(self):
        self.check(Query.args('ccc', 'bb', 'a').order_by_descending(len), 'ccc', 'bb', 'a')

    def test_order_then_1(self):
        self.check(Query.args('a2', 'b1', 'b2', 'a1').order_by(lambda z: z[0]).then_by(lambda z: z[1]), 'a1',
                   'a2', 'b1', 'b2')
