...
def version():
    print('''
Currently running Version tiquations 0.0.3
Changelog:
-Created tiquations website
-Added weight/mass/gravitational field strength equations
-Added circle area equations
-Added circle diameter equations
-Added change in velocity/acceleration/time equations
-Added tiquations.vars() command
-Added tiquations.help() command
-Added variables for mathematical and scientific fixed values. Planet gravitational pulls/pi
''')
