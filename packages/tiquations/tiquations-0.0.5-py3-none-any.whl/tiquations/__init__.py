...
def version():
    print('''
Currently running Version tiquations 0.0.5
Changelog:
-Finally uploaded to pypi official website!
-Added trapezoid, circle, cylinder, pressure/force/area, acceleration/time/Delta time equations
-Created and uploaded documentation website
-Improved layout of pypi page
''')
