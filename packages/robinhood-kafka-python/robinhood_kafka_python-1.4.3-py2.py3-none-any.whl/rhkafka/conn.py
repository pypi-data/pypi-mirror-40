...
from rhkafka.protocol.admin import SaslHandShakeRequest
from rhkafka.protocol.commit import OffsetFetchRequest
from rhkafka.protocol.metadata import MetadataRequest
from rhkafka.protocol.parser import KafkaProtocol
from rhkafka.protocol.types import Int32, Int8
...
class BrokerConnection(object):
    ...
    def check_version(self, timeout=2, strict=False):
        ...
        from rhkafka.protocol.admin import ApiVersionRequest, ListGroupsRequest
        from rhkafka.protocol.commit import OffsetFetchRequest, GroupCoordinatorRequest
