...
from rhkafka.vendor.six.moves import queue # pylint: disable=import-error

from rhkafka.consumer.base import (
    Consumer,
...
from rhkafka.protocol.message import PartialMessage
