...
try:
    ...
    from rhkafka.vendor import selectors34 as selectors
...
from rhkafka.conn import BrokerConnection, ConnectionStates, collect_hosts, get_ip_port_afi
from rhkafka import errors as Errors
from rhkafka.future import Future
from rhkafka.metrics import AnonMeasurable
from rhkafka.metrics.stats import Avg, Count, Rate
from rhkafka.metrics.stats.rate import TimeUnit
from rhkafka.protocol.metadata import MetadataRequest
from rhkafka.util import Dict, WeakMethod
# Although this looks unused, it actually monkey-patches socket.socketpair()
# and should be left in as long as we're using socket.socketpair() in this file
from rhkafka.vendor import socketpair
