...
from rhkafka.coordinator.base import BaseCoordinator, Generation
...
from rhkafka.protocol.commit import OffsetCommitRequest, OffsetFetchRequest
from rhkafka.structs import OffsetAndMetadata, TopicPartition
