...
class MLP(Mesh):
    ...
    def renew_estimator(self):
        ...
        self.best_estimator_.load_model(self.save_model())
    ...
    def get_score(self, eval_set, metric):
        if metric == 'accuracy':
    ...
    def fit(self, in_arr=None, target_arr=None, eval_set=None, eval_metric='accuracy'):
        ...
        while self.count_ < self.total_:
            ...
            for idx in idx_range:
                ...
                if (self.count_ % self.iteration_check_ == 0):
