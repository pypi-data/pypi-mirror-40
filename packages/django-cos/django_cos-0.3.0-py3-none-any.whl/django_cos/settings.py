...
PROJECT_DIR = getattr(settings, 'PROJECT_DIR', os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
BASE_DIR = getattr(settings, 'BASE_DIR', os.path.dirname(PROJECT_DIR))
...
DEFAULTS = {
    ...
    'FRONTEND_NAVBAR_FORMAT_CHOICES': (
        ...
        ('django-cos-navbar-center', 'Centered logo at top'),
    ),
    ...
    'FRONTEND_TEMPLATES_BLOCKS': {
        'cardblock': (
            ('django_cos/blocks/card_block.html', 'Card'),
            ('django_cos/blocks/card_head.html', 'Card with header'),
            ('django_cos/blocks/card_foot.html', 'Card with footer'),
            ('django_cos/blocks/card_head_foot.html', 'Card with header and footer'),
            ('django_cos/blocks/card_blurb.html', 'Blurb - rounded image and no border'),
            ('django_cos/blocks/card_img.html', 'Cover image - use image as background'),
        ),
        'cardgridblock': (
            ('django_cos/blocks/cardgrid_group.html', 'Card group - attached cards of equal size'),
            ('django_cos/blocks/cardgrid_deck.html', 'Card deck - separate cards of equal size'),
            ('django_cos/blocks/cardgrid_columns.html', 'Card masonry - fluid brick pattern'),
        ),
        'pagelistblock': (
            ('django_cos/blocks/pagelist_block.html', 'General, simple list'),
            ('django_cos/blocks/pagelist_list_group.html', 'General, list group navigation panel'),
            ('django_cos/blocks/pagelist_article_media.html', 'Article, media format'),
            ('django_cos/blocks/pagelist_article_card_group.html', 'Article, card group - attached cards of equal size'),
            ('django_cos/blocks/pagelist_article_card_deck.html', 'Article, card deck - separate cards of equal size'),
            ('django_cos/blocks/pagelist_article_card_columns.html', 'Article, card masonry - fluid brick pattern'),
        ),
    ...
    'FRONTEND_TEMPLATES_PAGES': {
        ...
        '*': (
            ('', 'Default'),
            ('django_cos/pages/web_page.html', 'Web page showing title and cover image'),
            ('django_cos/pages/web_page_notitle.html', 'Web page without title and cover image'),
            ('django_cos/pages/base.html', 'Blank page - no navbar or footer'),
        ),
