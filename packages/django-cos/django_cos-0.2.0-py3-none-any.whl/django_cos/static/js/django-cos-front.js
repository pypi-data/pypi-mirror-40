libs = {
    ...
    djangocosmaps: {
        url: "/static/js/django-cos-maps.js",
        integrity: "",
    },
    lazysizes: {
        url: 'https://cdnjs.cloudflare.com/ajax/libs/lazysizes/4.1.4/lazysizes.min.js',
        integrity: ''
    },
    katex: {
        url: '/static/draftail_katex/js/katex.min.js',
        head: "<link rel='stylesheet' href='/static/draftail_katex/css/katex.min.css'/>",
        renderer: {
            url: '/static/draftail_katex/js/katex_frontend_renderer.js'
        }
    }
}
...
$(document).ready(function()
{
    ...
    /*** KaTeX Rendering **/
    if ( document.querySelectorAll("[data-katex-text]").length > 0) {
        load_script(libs.katex, function() {
            load_script(libs.katex.renderer, function() {
    ...
    if ($('#cr-map').length > 0) {
        load_script(libs.djangocosmaps, function() {
            $.ajax({
    ...
    if ($(".lazyload").length > 0) {
        load_script(libs.lazysizes, function() {
        });
    }
