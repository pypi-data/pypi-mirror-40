...
from django_cos.blocks import HTML_STREAMBLOCKS, LAYOUT_STREAMBLOCKS, NAVIGATION_STREAMBLOCKS
...
class DjangoCOSEmail(ClusterableModel):
    """
    ...
    class Meta:
        abstract = True
        verbose_name = _('Django COS Email')
