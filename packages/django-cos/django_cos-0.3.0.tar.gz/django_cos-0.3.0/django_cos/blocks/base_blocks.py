...
class DjangoCOSAdvSettings(blocks.StructBlock):
    """
...
class DjangoCOSAdvTrackingSettings(DjangoCOSAdvSettings):
    """
    DjangoCOSAdvSettings plus additional tracking fields.
    """
...
class DjangoCOSAdvColumnSettings(DjangoCOSAdvSettings):
    """
...
class BaseBlock(blocks.StructBlock):
    """
    Common attributes for all blocks used in Django COS.
    """
    # subclasses can override this to determine the advanced settings class
    advsettings_class = DjangoCOSAdvSettings
...
class BaseLinkBlock(BaseBlock):
    ...
    new_window = blocks.BooleanBlock(
        ...
        required=False,
        label=_('New Window'),
        help_text=_('Open in new window?')
    )
