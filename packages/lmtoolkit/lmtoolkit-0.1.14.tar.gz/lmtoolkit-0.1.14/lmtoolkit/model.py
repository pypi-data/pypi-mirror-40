...
class Estimator(object):
    def __init__(self, cv=None, objective='regression', metric=None, verbose_eval=-1, num_boost_round=200, early_stopping_rounds=200, param={}):
...
class FeatureSelector:
    ...
    def get_dependent_features(self):
        ...
        try:
            interaction_values = explainer.shap_interaction_values(self.train.values)
