...
class CreateCollectionRequest(object):
    ...
    def name(self, name):
        ...
        :type: str
        """
        if name is not None and not re.search('^[a-z0-9A-Z][a-z0-9A-Z-_.]*$', name):  # noqa: E501
            raise ValueError("Invalid value for `name`, must be a follow pattern or equal to `/^[a-z0-9A-Z][a-z0-9A-Z-_.]*$/`")  # noqa: E501
