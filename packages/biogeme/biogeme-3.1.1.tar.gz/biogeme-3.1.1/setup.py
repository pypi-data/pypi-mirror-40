...
extensions = [Extension("biogeme.cbiogeme", ["src/cbiogeme"+ext]+source,include_dirs=[numpy.get_include()],extra_compile_args=extra_compile_args,
            language='c++11', extra_link_args = extra_link_args)]

#extensions = [Extension("biogeme.cbiogeme", ["src/cbiogeme"+ext]+source,include_dirs=[numpy.get_include()],extra_link_args=["-lprofiler"])]
...
setup(name = "biogeme",
      ...
      install_requires=['scipy','pandas','unidecode'],
