...
long_description="""Spoken Language Identification is the process of determining and classifying natural language 
...
THIS version of myspokenlanguagedetection was trained to detect "French", "English", "Spanih", 
"Italian", "Deutsch", "Russian", "Portuguese", "Swedish", and "Japanese" and to some lower 
extent other 40 languages. We will complete the machine training sessions for morelanguages 
along with increaing the accuracy of the languages identification process.

=============
Installation
=============
Mypokenlanguage can be installed like any other Python library, using (a recent version of) the
...
Voice Recognition and Acoustic & Language modelling Project in MYSOLUTIONS Lab. That is planned to 
...
setup(name='myspokenlanguagedetection',
      version='3',
      description='Spoken language identification with CNN and RNN - Early Stage',
	  ...
	  keywords='speech signal processing , Naural Langguage Processing and Understanding',
	  install_requires=[
		'numpy>=1.15.2',
		'SpeechRecognition>=3.8.1',
		'langdetect>=1.0.7',
		],
	  packages=['myspokenlanguagedetection'],
      zip_safe=False)
