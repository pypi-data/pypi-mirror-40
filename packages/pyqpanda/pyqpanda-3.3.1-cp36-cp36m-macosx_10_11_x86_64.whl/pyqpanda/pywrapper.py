...
def init(backend_type=pyQPanda.QuantumMachine_type.CPU_SINGLE_THREAD):
    """
    `QPanda Basic API` \n
...
def init_quantum_machine(backend_type):
    """
    `QPanda Basic API`
    Create and initialize a quantum machine
    
    QuantumMachine_type -> QuantumMachine
    """
    return pyQPanda.init_quantum_machine(backend_type)
