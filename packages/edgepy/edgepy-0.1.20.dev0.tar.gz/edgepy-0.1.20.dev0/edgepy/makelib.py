...
def __init__(location='', xid=''):
    ...
    sdir = util.__file__  # .../edgepy/util.py
    sdir = sdir.rstrip('/util.py')
    sdir = sdir + '/docs/genelib/%s.csv' % xid
    ...
    if os.path.exists(sdir):
        ...
        d = {'geneID': gene_ids, 'dbxref': dbxrefs, 'geneName': gene_names, 'locus_tag': locus_tags}
        df = pd.DataFrame(d)
