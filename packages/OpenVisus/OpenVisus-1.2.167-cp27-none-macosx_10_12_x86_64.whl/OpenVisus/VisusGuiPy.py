...
def cstring(*args):
    return _VisusGuiPy.cstring(*args)
cstring = _VisusGuiPy.cstring

def cdouble(*args):
    return _VisusGuiPy.cdouble(*args)
cdouble = _VisusGuiPy.cdouble

def cint(*args):
    return _VisusGuiPy.cint(*args)
cint = _VisusGuiPy.cint
