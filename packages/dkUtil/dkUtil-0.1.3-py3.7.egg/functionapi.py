...
class functionapi(object):
    ...
    def http_post_req(requrl,post_data):
        ...
        :return:
        '''
        post_data_urlencode = parse.urlencode(post_data).encode(encoding='UTF8')
        req = request.Request(url=requrl, data=post_data_urlencode)
    ...
    @staticmethod
    def decipheringPhone(host, phonelist, pre_page_count=100):
        '''
        批量解密MD5手机号
        :param host:接口api地址
