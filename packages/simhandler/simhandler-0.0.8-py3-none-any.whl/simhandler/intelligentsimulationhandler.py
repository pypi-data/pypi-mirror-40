...
from simhandler.datageneration import generateJson
...
class IntelligentSimulationHandler():
    ...
    def gatherJsonFiles(self):
        ...
        config_files = []
        for root, _, files in os.walk('./data/network_configurations/'):
            for file in files:
...
ish = IntelligentSimulationHandler('./data/network_configurations/3node.json')