...
class Recognizer(AudioSource):
    def __init__(self):
        ...
        self.dynamic_energy_ratio = 1.75
    ...
    def listen(self, source, timeout=None, phrase_time_limit=None, snowboy_configuration=None):
        ...
        self.audio_length = 0  # number of seconds of audio read
        ...
        while True:
            ...
            if snowboy_configuration is None:
                ...
                while True:
                    ...
                    self.audio_length += seconds_per_buffer
                    if timeout and self.audio_length > timeout:
                ...
                self.audio_length += delta_time
                if len(buffer) == 0: break  # reached end of the stream
                frames.append(buffer)

            # read audio input until the phrase ends
            pause_count, phrase_count = 0, 0
            phrase_start_time = self.audio_length
            while True:
                # handle phrase being too long by cutting off the audio
                self.audio_length += seconds_per_buffer
                if phrase_time_limit and self.audio_length - phrase_start_time > phrase_time_limit:
                    break
