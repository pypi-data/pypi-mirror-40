...
ICountingSupport_VERSION = "4.1.35436"
...
class ICountingSupport(BaseEndpoint):
    ...
    def count (self, filter ):
        ...
        response = requests.get( self.base + postUri, params = queryParams, verify=False, headers = {'X-BM-ApiKey' : self.apiKey, 'Accept' : 'application/json', 'X-BM-ClientVersion' : ICountingSupport_VERSION}, data = __encoded__);
