...
class SubPlotsAnimator(Animator):
    ...
    def add_axes(self, restrictions={}, **kwargs):
        ...
        After adding the axes, the registry hook ``"after-adding-axes"`` is
        ...
        self.call_registered_functions("after-adding-axes", ax)
        return ax
    ...
    @Animator.register_method("after-adding-axes")
