...
class IPu:
    def __init__(self, path_to_config: str = 'config.ini'):
        ...
        self._cfg.init('ip_utils.timeout', 10)
        self._cfg.sync()
    ...
    def query_by_ip_api(self, ip_address: str = None, requests_proxies: dict = None):
        ...
        try:
            resp = requests.post(url,
                                 ...
                                 timeout=self._cfg['ip_utils.timeout'])
            ...
            xp.error('IPUtils-query_by_ip_api error: {}'.format(e))
            return None
    ...
    def get_by_myip(self, requests_proxies: dict = None):
        try:
            ...
            xp.error('IPUtils-get_by_myip error: {}'.format(e))
            return None
    ...
    def geoip(self, ip_address):
        ...
        try:
            ...
            xp.error('IPUtils-geoip error: {}'.format(e))
            return None
