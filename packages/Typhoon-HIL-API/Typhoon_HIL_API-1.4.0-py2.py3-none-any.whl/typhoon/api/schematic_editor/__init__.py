...
class SchematicAPI(SchematicAPIBase):
    ...
    def create_property(self, item_handle, name, label="", widget=WIDGET_EDIT,
                        combo_values=(), button_label="",
                        evaluate=True, enabled=True, visible=True,
                        tab_name="", unit=""):
        """
        ...
        Args:
            ...
            button_label(str): When widget is set to WIDGET_BUTTON
                this parameter specifies buton label.
