...
#            print(mytext)
        ...
        try:
            ...
            try:
                ...
                pyqtlib.info_message(translate('csveditor', "Fehler"), translate('csveditor', "Datei ")+fileName+translate('csveditor', " konnte nicht gelesen werden."), translate('csveditor', "Stellen Sie sicher, dass die CSV-Datei korrekt ist und die Trennzeichen korrekt sind"))
    ...
    def addSignal(self, setup=['','',0,0,'']):
        ...
        #itemN.setSizeHint(self.signals[-1].sizeHint())
