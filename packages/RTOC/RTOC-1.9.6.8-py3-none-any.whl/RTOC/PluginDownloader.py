        ...
        for content in contents:
            ...
            if content.type == 'dir' and '__pycache__' not in content.path:
                ...
                try:
                    ...
                    urllib.request.urlretrieve ('https://github.com/Haschtl/RTOC-Plugins/blob/master/'+url, path)
                except IOError as exc:
                    print('Error processing %s: %s', self.userpath+"/devices/"+content.path, exc)
