...
#            print(mytext)
    ...
    def showAboutMessage(self):
        pyqtlib.info_message(self.tr("Über"), "RealTime OpenControl 1.9.7.6", self.tr(
    ...
    def openPluginDownloader(self):
        self.pluginDownloader = PluginDownloader(self.config['documentfolder'],'Haschtl/RTOC-Plugins',self)
