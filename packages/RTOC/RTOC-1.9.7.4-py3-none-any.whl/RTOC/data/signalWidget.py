...
class QLine(QtWidgets.QLabel):
    ...
    def styleIt(self, symbol={}, brush={}):
        ...
        #     if key == "style":
        #         if brush["style"] != "":
        #             painter.setSymbol(brush["style"])
        #         else:
        #             painter.setSymbol(None)
        #     elif key == "color":
        #         c = brush["color"]
        #         painter.setSymbolBrush(c)
        #     elif key == "size":
        #         painter.setSymbolSize(brush["size"])
        #     elif key == "fillLevel":
        #         painter.setFillLevel(brush["fillLevel"])
        #     elif key == "fillBrush":
        #         painter.setFillBrush(brush["fillBrush"])
        #     elif key == "pen":
        #         painter.setSymbolPen(brush["pen"])
