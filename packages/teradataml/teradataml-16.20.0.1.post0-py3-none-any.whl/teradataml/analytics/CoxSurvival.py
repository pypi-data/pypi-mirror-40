...
class CoxSurvival:
    ...
    def __init__(self,
        ...
        EXAMPLES:
            ...
            # Print the results.
            cox_survival_out.output
            cox_survival_out.survival_probability
        ...
        self.__arg_info_matrix.append(["predict_feature_columns", self.predict_feature_columns, False, "str"])
        self.__arg_info_matrix.append(["accumulate", self.accumulate, True, "str"])
        self.__arg_info_matrix.append(["cox_model_table_sequence_column", self.cox_model_table_sequence_column, True, "str"])
        self.__arg_info_matrix.append(["object_sequence_column", self.object_sequence_column, True, "str"])
        self.__arg_info_matrix.append(["predict_table_sequence_column", self.predict_table_sequence_column, True, "str"])
    ...
    def __validate(self) :
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.predict_feature_columns, "predict_feature_columns", self.predict_table, "predict_table")
        
        self.__awu._validate_input_columns_not_empty(self.accumulate, "accumulate")
        self.__awu._validate_dataframe_has_argument_columns(self.accumulate, "accumulate", self.predict_table, "predict_table")
        
        self.__awu._validate_input_columns_not_empty(self.cox_model_table_sequence_column, "cox_model_table_sequence_column")
        self.__awu._validate_dataframe_has_argument_columns(self.cox_model_table_sequence_column, "cox_model_table_sequence_column", self.cox_model_table, "cox_model_table")
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.predict_table_sequence_column, "predict_table_sequence_column", self.predict_table, "predict_table")
