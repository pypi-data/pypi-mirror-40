...
# Secondary Owner: Rohit Khurd (rohit.khurd@teradata.com)
# 
# Version: 1.2
...
class AdaBoostPredict:
    ...
    def __init__(self,
        ...
        PARAMETERS:
            ...
            object_order_column:
                ...
                Default Value: ["classifier_id", "node_id"]
            ...
            output_response_probdist:
                ...
                When set to True, need to specify output_responses also.
    ...
    def __validate(self):
        ...
        if self.__awu._is_default_or_not(self.newdata_partition_column, "1"):
