...
class POSTagger:
    ...
    def __init__(self,
        ...
        PARAMETERS:
            ...
            language:
                Optional Argument.
                Specifies the language of the input text. The supported values are: 
                en (English), zh_CN (Simplified Chinese)
                Default Value: en
                Permitted Values: en, zh_CN
                Types: str
            ...
            accumulate:
                ...
                input to the function "TextChunker", then this argument must specify the input 
                teradataml DataFrame columns that comprise the partition key.
                Types: str OR list of Strings (str)
    ...
    def __execute(self):
        ...
        try:
            ...
            node_id_list = self.__aed_utils._aed_ml_query(self.__input_nodeids, self.sqlmr_query, self.__func_output_args, "POSTagger")
