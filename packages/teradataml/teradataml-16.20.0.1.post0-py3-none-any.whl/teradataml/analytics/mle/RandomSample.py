...
class RandomSample:
    ...
    def __init__(self,
        ...
        self.__arg_info_matrix.append(["num_sample", self.num_sample, False, "int"])
        ...
        self.__arg_info_matrix.append(["input_columns", self.input_columns, True, "str"])
        self.__arg_info_matrix.append(["as_categories", self.as_categories, True, "str"])
        self.__arg_info_matrix.append(["category_weights", self.category_weights, True, "float"])
        ...
        self.__arg_info_matrix.append(["seed_column", self.seed_column, True, "str"])
    ...
    def __validate(self) :
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.weight_column, "weight_column", self.data, "data")
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.as_categories, "as_categories", self.data, "data")
        
        self.__awu._validate_input_columns_not_empty(self.seed_column, "seed_column")
        self.__awu._validate_dataframe_has_argument_columns(self.seed_column, "seed_column", self.data, "data")
    ...
    def __form_tdml_query(self) :
        ...
        if self.over_sampling_rate is not None and self.over_sampling_rate != 1:
