...
class KNN:
    ...
    def __init__(self,
        ...
        PARAMETERS:
            ...
            parblock_size:
                ...
                partition_block_size is 1/n billion, where n is an integer that 
        ...
        self.__arg_info_matrix.append(["distance_features", self.distance_features, False, "str"])
        self.__arg_info_matrix.append(["voting_weight", self.voting_weight, True, "float"])
        self.__arg_info_matrix.append(["customized_distance", self.customized_distance, True, "str"])
        ...
        self.__arg_info_matrix.append(["train_sequence_column", self.train_sequence_column, True, "str"])
        self.__arg_info_matrix.append(["test_sequence_column", self.test_sequence_column, True, "str"])
    ...
    def __validate(self) :
        ...
        if self.customized_distance:
            raise TeradataMlException(Messages.get_message(MessageCodes.UNSUPPORTED_ARGUMENT, "customized_distance", "customized_distance"),
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.response_column, "response_column", self.train, "train")
        
        self.__awu._validate_input_columns_not_empty(self.id_column, "id_column")
        self.__awu._validate_dataframe_has_argument_columns(self.id_column, "id_column", self.test, "test")
        
        self.__awu._validate_input_columns_not_empty(self.distance_features, "distance_features")
        self.__awu._validate_dataframe_has_argument_columns(self.distance_features, "distance_features", self.train, "train")
      
        self.__awu._validate_input_columns_not_empty(self.train_sequence_column, "train_sequence_column")
        self.__awu._validate_dataframe_has_argument_columns(self.train_sequence_column, "train_sequence_column", self.train, "train")
        
        self.__awu._validate_input_columns_not_empty(self.test_sequence_column, "test_sequence_column")
        self.__awu._validate_dataframe_has_argument_columns(self.test_sequence_column, "test_sequence_column", self.test, "test")
