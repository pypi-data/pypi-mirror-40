...
class HMMSupervised:
    ...
    def __validate(self) :
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.state_key, "state_key", self.vertices, "vertices")
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.skip_key, "skip_key", self.vertices, "vertices")
