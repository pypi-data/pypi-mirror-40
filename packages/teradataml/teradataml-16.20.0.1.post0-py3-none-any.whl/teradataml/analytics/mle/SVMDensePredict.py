...
class SVMDensePredict:
    ...
    def __init__(self,
        ...
        EXAMPLES:
            ...
            svm_iris_test = DataFrame.from_table("svm_iris_test")
            svm_iris_train DataFrame.from_table("svm_iris_train")
            
            # Example 1 - Linear Model
            # Create SVMDense object
            svm_dense_out_linear = SVMDense(data = svm_iris_train,
                                    sample_id_column = "id",
            ...
            svm_dense_out_polynomial = SVMDense(data = svm_iris_train,
                                    sample_id_column = "id",
                                    attribute_columns = ["[1:4]"],
    ...
    def __validate(self) :
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.attribute_columns, "attribute_columns", self.newdata, "newdata")
    ...
    def __execute(self) :
        ...
        try:
            ...
            node_id_list = self.__aed_utils._aed_ml_query(self.__input_nodeids, self.sqlmr_query, self.__func_output_args, "SVMDensePredict")
    ...
    def __process_output_column_info(self) :
        ...
        for column_name, column_type in self.__awu._retrieve_column_info(df_input=self.newdata, parameter=self.sample_id_column, columns=None):
            stdout_column_info_name.append(column_name)
            stdout_column_info_type.append(column_type)
            
        stdout_column_info_name.append("predict_value")
        stdout_column_info_type.append(self.__awu._get_json_to_sqlalchemy_mapping("varchar"))
        
        stdout_column_info_name.append("predict_confidence")
        stdout_column_info_type.append(self.__awu._get_json_to_sqlalchemy_mapping("double precision"))
        
        if self.accumulate_label is not None:
            for column_name, column_type in self.__awu._retrieve_column_info(df_input=self.newdata, parameter=self.accumulate_label, columns=None):
                stdout_column_info_name.append(column_name)
                stdout_column_info_type.append(column_type)
