...
class LDA:
    ...
    def __validate(self) :
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.docid_column, "docid_column", self.data, "data")
        
        self.__awu._validate_input_columns_not_empty(self.word_column, "word_column")
        self.__awu._validate_dataframe_has_argument_columns(self.word_column, "word_column", self.data, "data")
        
        self.__awu._validate_input_columns_not_empty(self.count_column, "count_column")
        self.__awu._validate_dataframe_has_argument_columns(self.count_column, "count_column", self.data, "data")
