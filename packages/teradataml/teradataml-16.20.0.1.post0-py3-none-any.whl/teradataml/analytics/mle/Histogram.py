...
class Histogram:
    ...
    def __init__(self,
        ...
        self.__arg_info_matrix.append(["groupby_columns", self.groupby_columns, True, "str"])
        self.__arg_info_matrix.append(["data_sequence_column", self.data_sequence_column, True, "str"])
        self.__arg_info_matrix.append(["custom_bin_table_sequence_column", self.custom_bin_table_sequence_column, True, "str"])
    ...
    def __validate(self) :
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.custom_bin_column, "custom_bin_column", self.custom_bin_table, "custom_bin_table")
        
        self.__awu._validate_input_columns_not_empty(self.groupby_columns, "groupby_columns")
        self.__awu._validate_dataframe_has_argument_columns(self.groupby_columns, "groupby_columns", self.data, "data")
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.custom_bin_table_sequence_column, "custom_bin_table_sequence_column", self.custom_bin_table, "custom_bin_table")
