...
class SentimentExtractor:
    ...
    def __validate(self) :
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.text_column, "text_column", self.newdata, "newdata")
        
        self.__awu._validate_input_columns_not_empty(self.accumulate, "accumulate")
        self.__awu._validate_dataframe_has_argument_columns(self.accumulate, "accumulate", self.newdata, "newdata")
        
        self.__awu._validate_input_columns_not_empty(self.newdata_sequence_column, "newdata_sequence_column")
        self.__awu._validate_dataframe_has_argument_columns(self.newdata_sequence_column, "newdata_sequence_column", self.newdata, "newdata")
        
        self.__awu._validate_input_columns_not_empty(self.dict_data_sequence_column, "dict_data_sequence_column")
        self.__awu._validate_dataframe_has_argument_columns(self.dict_data_sequence_column, "dict_data_sequence_column", self.dict_data, "dict_data")
        
        self.__awu._validate_input_columns_not_empty(self.newdata_order_column, "newdata_order_column")
        self.__awu._validate_dataframe_has_argument_columns(self.newdata_order_column, "newdata_order_column", self.newdata, "newdata")
        
        self.__awu._validate_input_columns_not_empty(self.dict_data_order_column, "dict_data_order_column")
        self.__awu._validate_dataframe_has_argument_columns(self.dict_data_order_column, "dict_data_order_column", self.dict_data, "dict_data")
    ...
    def __form_tdml_query(self) :
        ...
        if self.dict_data is not None:
            self.__table_ref = self.__awu._teradata_on_clause_from_dataframe(self.dict_data)
    ...
    def __execute(self) :
        ...
        if self.dict_data is not None:
            self.__input_nodeids.append(self.dict_data._nodeid)
        ...
        try:
            ...
            node_id_list = self.__aed_utils._aed_ml_query(self.__input_nodeids, self.sqlmr_query, self.__func_output_args, "SentimentExtractor")
    ...
    def __process_output_column_info(self) :
        ...
        stdout_column_info_name.append("out_polarity")
        stdout_column_info_type.append(self.__awu._get_json_to_sqlalchemy_mapping("varchar"))
        
        stdout_column_info_name.append("out_strength")
        stdout_column_info_type.append(self.__awu._get_json_to_sqlalchemy_mapping("integer"))
        
        if self.level is not None and self.level == "sentence":
            insertion_index = [col.lower() for col in stdout_column_info_name].index("out_polarity")
            stdout_column_info_name.insert(insertion_index, "out_content")
            stdout_column_info_type.insert(insertion_index, self.__awu._get_json_to_sqlalchemy_mapping("varchar"))
        ...
        if self.object is not None and "dictionary".lower() in self.object.lower():
            stdout_column_info_name.append("out_sentiment_words")
            stdout_column_info_type.append(self.__awu._get_json_to_sqlalchemy_mapping("varchar"))
