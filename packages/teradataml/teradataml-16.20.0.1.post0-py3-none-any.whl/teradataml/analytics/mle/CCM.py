...
class CCM:
    ...
    def __init__(self,
        ...
        self.__arg_info_matrix.append(["cause_columns", self.cause_columns, False, "str"])
        self.__arg_info_matrix.append(["effect_columns", self.effect_columns, False, "str"])
        self.__arg_info_matrix.append(["library_size", self.library_size, True, "int"])
        self.__arg_info_matrix.append(["embedding_dimension", self.embedding_dimension, True, "int"])
    ...
    def __validate(self) :
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.sequence_id_column, "sequence_id_column", self.data, "data")
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.cause_columns, "cause_columns", self.data, "data")
        
        self.__awu._validate_input_columns_not_empty(self.effect_columns, "effect_columns")
        self.__awu._validate_dataframe_has_argument_columns(self.effect_columns, "effect_columns", self.data, "data")
