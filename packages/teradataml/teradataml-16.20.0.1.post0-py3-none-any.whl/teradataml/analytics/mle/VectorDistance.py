...
class VectorDistance:
    ...
    def __init__(self,
        ...
        self.__arg_info_matrix.append(["target_data_partition_column", self.target_data_partition_column, False, "str"])
        self.__arg_info_matrix.append(["ref_data", self.ref_data, False, "DataFrame"])
        self.__arg_info_matrix.append(["target_id", self.target_id, False, "str"])
        ...
        self.__arg_info_matrix.append(["ref_id", self.ref_id, True, "str"])
        ...
        self.__arg_info_matrix.append(["distance_measure", self.distance_measure, True, "str"])
        ...
        self.__arg_info_matrix.append(["max_distance", self.max_distance, True, "float"])
        self.__arg_info_matrix.append(["target_data_sequence_column", self.target_data_sequence_column, True, "str"])
        self.__arg_info_matrix.append(["ref_data_sequence_column", self.ref_data_sequence_column, True, "str"])
    ...
    def __validate(self) :
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.target_id, "target_id", self.target_data, "target_data")
        
        self.__awu._validate_input_columns_not_empty(self.target_feature, "target_feature")
        self.__awu._validate_dataframe_has_argument_columns(self.target_feature, "target_feature", self.target_data, "target_data")
        
        self.__awu._validate_input_columns_not_empty(self.target_value, "target_value")
        self.__awu._validate_dataframe_has_argument_columns(self.target_value, "target_value", self.target_data, "target_data")
        
        self.__awu._validate_input_columns_not_empty(self.ref_id, "ref_id")
        self.__awu._validate_dataframe_has_argument_columns(self.ref_id, "ref_id", self.ref_data, "ref_data")
        
        self.__awu._validate_input_columns_not_empty(self.ref_feature, "ref_feature")
        self.__awu._validate_dataframe_has_argument_columns(self.ref_feature, "ref_feature", self.ref_data, "ref_data")
        
        self.__awu._validate_input_columns_not_empty(self.ref_value, "ref_value")
        self.__awu._validate_dataframe_has_argument_columns(self.ref_value, "ref_value", self.ref_data, "ref_data")
        
        self.__awu._validate_input_columns_not_empty(self.target_data_sequence_column, "target_data_sequence_column")
        self.__awu._validate_dataframe_has_argument_columns(self.target_data_sequence_column, "target_data_sequence_column", self.target_data, "target_data")
        
        self.__awu._validate_input_columns_not_empty(self.ref_data_sequence_column, "ref_data_sequence_column")
        self.__awu._validate_dataframe_has_argument_columns(self.ref_data_sequence_column, "ref_data_sequence_column", self.ref_data, "ref_data")
        
        self.__awu._validate_input_columns_not_empty(self.target_data_partition_column, "target_data_partition_column")
        self.__awu._validate_dataframe_has_argument_columns(self.target_data_partition_column, "target_data_partition_column", self.target_data, "target_data")
    ...
    def __form_tdml_query(self) :
        ...
        # Process target_data
        target_data_partition_column = UtilFuncs._teradata_collapse_arglist(self.target_data_partition_column,"\"")
        ...
        self.__func_input_partition_by_cols.append(target_data_partition_column)
