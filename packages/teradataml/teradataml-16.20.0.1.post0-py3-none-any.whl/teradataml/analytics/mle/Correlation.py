...
class Correlation:
    ...
    def __init__(self,
        ...
        PARAMETERS:
            ...
            reduce_partition_column:
                ...
                value must be [key_name, group_by_columns].
                Default Value: 1
                Types: str OR list of Strings (str)
        ...
        self.__arg_info_matrix.append(["reduce_partition_column", self.reduce_partition_column, True, (str, list)])
    ...
    def __validate(self) :
        ...
        if self.__awu._is_default_or_not(self.reduce_partition_column, "1"):
            ...
            self.__awu._validate_dataframe_has_argument_columns(list(set(self.reduce_partition_column)-set([self.key_name])),
    ...
    def __form_tdml_query(self) :
        ...
        aqg_obj = AnalyticQueryGenerator("CorrelationReduce" 
                ,self.__func_input_arg_sql_names 
                ,self.__func_input_table_view_query 
                ,self.__func_input_dataframe_type 
                ,self.__func_input_distribution 
