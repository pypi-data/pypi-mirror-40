...
class HMMUnsupervised:
    ...
    def __init__(self,
        ...
        PARAMETERS:
            ...
            model_key:
                ...
                specifying this argument, the model_attribute must match a model_key in
                the vertices_partition_column. The values in the column can be
                integers or strings.
                Types: str OR list of Strings (str)
        ...
        self.__arg_info_matrix.append(["vertices_partition_column", self.vertices_partition_column, False, "str"])
        self.__arg_info_matrix.append(["vertices_order_column", self.vertices_order_column, False, "str"])
        ...
        self.__arg_info_matrix.append(["init_methods", self.init_methods, True, "str"])
        self.__arg_info_matrix.append(["init_params", self.init_params, True, "str"])
        self.__arg_info_matrix.append(["vertices_sequence_column", self.vertices_sequence_column, True, "str"])
    ...
    def __validate(self) :
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.sequence_key, "sequence_key", self.vertices, "vertices")
        
        self.__awu._validate_input_columns_not_empty(self.observed_key, "observed_key")
        self.__awu._validate_dataframe_has_argument_columns(self.observed_key, "observed_key", self.vertices, "vertices")
        
        self.__awu._validate_input_columns_not_empty(self.model_key, "model_key")
        self.__awu._validate_dataframe_has_argument_columns(self.model_key, "model_key", self.vertices, "vertices")
        
        self.__awu._validate_input_columns_not_empty(self.skip_column, "skip_column")
        self.__awu._validate_dataframe_has_argument_columns(self.skip_column, "skip_column", self.vertices, "vertices")
        
        self.__awu._validate_input_columns_not_empty(self.vertices_sequence_column, "vertices_sequence_column")
        self.__awu._validate_dataframe_has_argument_columns(self.vertices_sequence_column, "vertices_sequence_column", self.vertices, "vertices")
        
        self.__awu._validate_input_columns_not_empty(self.vertices_partition_column, "vertices_partition_column")
        self.__awu._validate_dataframe_has_argument_columns(self.vertices_partition_column, "vertices_partition_column", self.vertices, "vertices")
        
        self.__awu._validate_input_columns_not_empty(self.vertices_order_column, "vertices_order_column")
        self.__awu._validate_dataframe_has_argument_columns(self.vertices_order_column, "vertices_order_column", self.vertices, "vertices")
    ...
    def __form_tdml_query(self) :
        ...
        # Process vertices
        vertices_partition_column = UtilFuncs._teradata_collapse_arglist(self.vertices_partition_column,"\"")
        ...
        self.__func_input_partition_by_cols.append(vertices_partition_column)
