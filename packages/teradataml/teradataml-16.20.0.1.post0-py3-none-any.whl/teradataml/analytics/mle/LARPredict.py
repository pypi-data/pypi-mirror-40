...
class LARPredict:
    ...
    def __init__(self,
        ...
        EXAMPLES:
            ...
            copy_to_sql(lar_predict_out2.result, name = "result_td_lar_predict_out2")
        ...
        self.__arg_info_matrix.append(["s", self.s, True, "float"])
        self.__arg_info_matrix.append(["target_col", self.target_col, True, "str"])
    ...
    def __validate(self) :
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.target_col, "target_col", self.newdata, "newdata")
