...
class Burst:
    ...
    def __init__(self,
        ...
        self.__arg_info_matrix.append(["data_order_column", self.data_order_column, True, "str"])
        self.__arg_info_matrix.append(["time_data", self.time_data, True, "DataFrame"])
        self.__arg_info_matrix.append(["time_data_partition_column", self.time_data_partition_column, True, "str"])
        self.__arg_info_matrix.append(["time_data_order_column", self.time_data_order_column, True, "str"])
        self.__arg_info_matrix.append(["time_column", self.time_column, False, "str"])
        self.__arg_info_matrix.append(["value_columns", self.value_columns, False, "str"])
        ...
        self.__arg_info_matrix.append(["value_datatype", self.value_datatype, True, "str"])
        ...
        self.__arg_info_matrix.append(["values_before_first", self.values_before_first, True, "str"])
        self.__arg_info_matrix.append(["values_after_last", self.values_after_last, True, "str"])
        ...
        self.__arg_info_matrix.append(["time_data_sequence_column", self.time_data_sequence_column, True, "str"])
    ...
    def __validate(self) :
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.time_column, "time_column", self.data, "data")
        
        self.__awu._validate_input_columns_not_empty(self.value_columns, "value_columns")
        self.__awu._validate_dataframe_has_argument_columns(self.value_columns, "value_columns", self.data, "data")
        
        self.__awu._validate_input_columns_not_empty(self.accumulate, "accumulate")
        self.__awu._validate_dataframe_has_argument_columns(self.accumulate, "accumulate", self.data, "data")
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.time_data_sequence_column, "time_data_sequence_column", self.time_data, "time_data")
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.time_data_partition_column, "time_data_partition_column", self.time_data, "time_data")
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.time_data_order_column, "time_data_order_column", self.time_data, "time_data")
    ...
    def __form_tdml_query(self) :
        ...
        if self.time_data is not None:
            time_data_partition_column = UtilFuncs._teradata_collapse_arglist(self.time_data_partition_column,"\"")
            ...
            self.__func_input_table_view_query.append(self.__table_ref["ref"])
            self.__func_input_dataframe_type.append(self.__table_ref["ref_type"])
            self.__func_input_partition_by_cols.append(time_data_partition_column)
