...
class PathSummarizer:
    ...
    def __init__(self,
        ...
        self.__arg_info_matrix.append(["object_partition_column", self.object_partition_column, True, (str,list)])
    ...
    def __validate(self):
        ...
        if self.__awu._is_default_or_not(self.object_partition_column, "1"):
