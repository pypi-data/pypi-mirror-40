...
class MinHash:
    ...
    def __init__(self,
        ...
        EXAMPLES:
            # Load example data.
            loadExampleData("minhash", "salesdata")
        ...
        self.__arg_info_matrix.append(["seed_table_sequence_column", self.seed_table_sequence_column, True, "str"])
    ...
    def __validate(self) :
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.items_column, "items_column", self.data, "data")
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.seed_table_sequence_column, "seed_table_sequence_column", self.seed_table, "seed_table")
    ...
    def __form_tdml_query(self) :
        ...
        if self.seed_table is None:
            self.__save_seed_to_temp_tablename = UtilFuncs._generate_temp_table_name(prefix = "td_minhash1", use_default_database = True, gc_on_quit = True, quote=False, table_type = TeradataConstants.TERADATA_TABLE)
        else:
    ...
    def __execute(self) :
        ...
        if self.__save_seed_to_temp_tablename is not None:
