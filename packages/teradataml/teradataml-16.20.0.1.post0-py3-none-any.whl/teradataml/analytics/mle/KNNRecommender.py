...
class KNNRecommender:
    ...
    def __init__(self,
        ...
        self.__arg_info_matrix.append(["rating_table_sequence_column", self.rating_table_sequence_column, True, "str"])
    ...
    def __validate(self) :
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.userid_column, "userid_column", self.rating_table, "rating_table")
        
        self.__awu._validate_input_columns_not_empty(self.itemid_column, "itemid_column")
        self.__awu._validate_dataframe_has_argument_columns(self.itemid_column, "itemid_column", self.rating_table, "rating_table")
        
        self.__awu._validate_input_columns_not_empty(self.rating_column, "rating_column")
        self.__awu._validate_dataframe_has_argument_columns(self.rating_column, "rating_column", self.rating_table, "rating_table")
        
        self.__awu._validate_input_columns_not_empty(self.rating_table_sequence_column, "rating_table_sequence_column")
        self.__awu._validate_dataframe_has_argument_columns(self.rating_table_sequence_column, "rating_table_sequence_column", self.rating_table, "rating_table")
