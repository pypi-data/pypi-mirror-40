...
class NamedEntityFinderEvaluator:
    ...
    def __init__(self,
        ...
        EXAMPLES:
            # Load example data.
            load_example_data("namedentityfinderevaluator", ["nermem_sports_train",
                                                                            "nermem_sports_test"])
        ...
        self.__arg_info_matrix.append(["newdata_sequence_column", self.newdata_sequence_column, True, "str"])
