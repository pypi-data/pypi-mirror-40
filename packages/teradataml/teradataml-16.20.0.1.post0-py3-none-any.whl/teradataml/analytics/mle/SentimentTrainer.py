...
class SentimentTrainer:
    ...
    def __init__(self,
        ...
        EXAMPLES:
            # Load example data.
            loadExampleData("sentimenttrainer", "sentiment_train")
    ...
    def __validate(self) :
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.sentiment_column, "sentiment_column", self.data, "data")
