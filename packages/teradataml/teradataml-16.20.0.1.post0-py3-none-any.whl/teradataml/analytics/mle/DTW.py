...
class DTW:
    ...
    def __init__(self,
        ...
        mapping_data_partition_column = "1",
        ...
        PARAMETERS:
            ...
            dist_method:
                Optional Argument.
                Specifies the metric for computing the warping distance. Note
        ...
        EXAMPLES:
            ...
            # Load example data.
            load_example_data("dtw", ["timeseriesdata", "templatedata",
                                           "mappingdata"])
        ...
        self.__arg_info_matrix.append(["mapping_data_partition_column", self.mapping_data_partition_column, True, (str,list)])
    ...
    def __validate(self) :
        ...
        if len(self.mapping_data_partition_column) > 1 or self.mapping_data_partition_column != "1":
