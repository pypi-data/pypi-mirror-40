...
class GLM:
    ...
    def __init__(self,
        ...
        EXAMPLES:
            ...
            # Example 3 -
            glm_out3 = GLM(formula = "price  ~ recroom  + lotsize  + stories  + garagepl + gashw \
    ...
    def __form_tdml_query(self) :
        """
        Function to generate the analaytical function queries. The function defines 
