...
class SVMSparsePredict:
    ...
    def __init__(self,
        ...
        EXAMPLES:
            ...
            svm_sparse_predict_result1.result
            ...
            # Print the result DataFrame
            svm_sparse_predict_result2.result
