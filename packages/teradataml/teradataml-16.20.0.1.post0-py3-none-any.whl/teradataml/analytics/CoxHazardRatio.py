...
class CoxHazardRatio:
    ...
    def __init__(self,
        ...
        predicts_partition_column = None,
        refs_partition_column = None) :
        """
        DESCRIPTION:
        ...
        PARAMETERS:
            ...
            ref_feature_columns:
                ...
                feature value combinations. Note: The function ignores this argument
                if you specify predict_feature_units_columns.
                Types: str OR list of Strings (str)
        ...
        self.__arg_info_matrix.append(["predicts_partition_column", self.predicts_partition_column, False, "str"])
        self.__arg_info_matrix.append(["refs", self.refs, True, "DataFrame"])
        self.__arg_info_matrix.append(["refs_partition_column", self.refs_partition_column, True, "str"])
        self.__arg_info_matrix.append(["predict_feature_names", self.predict_feature_names, False, "str"])
        self.__arg_info_matrix.append(["predict_feature_columns", self.predict_feature_columns, True, "str"])
        self.__arg_info_matrix.append(["predict_feature_units_columns", self.predict_feature_units_columns, True, "str"])
        self.__arg_info_matrix.append(["ref_feature_columns", self.ref_feature_columns, True, "str"])
        ...
        self.__arg_info_matrix.append(["predicts_sequence_column", self.predicts_sequence_column, True, "str"])
        self.__arg_info_matrix.append(["refs_sequence_column", self.refs_sequence_column, True, "str"])
    ...
    def __validate(self) :
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.predict_feature_columns, "predict_feature_columns", self.predicts, "predicts")
        
        self.__awu._validate_input_columns_not_empty(self.predict_feature_units_columns, "predict_feature_units_columns")
        self.__awu._validate_dataframe_has_argument_columns(self.predict_feature_units_columns, "predict_feature_units_columns", self.predicts, "predicts")
        
        self.__awu._validate_input_columns_not_empty(self.ref_feature_columns, "ref_feature_columns")
        self.__awu._validate_dataframe_has_argument_columns(self.ref_feature_columns, "ref_feature_columns", self.refs, "refs")
        
        self.__awu._validate_input_columns_not_empty(self.accumulate, "accumulate")
        self.__awu._validate_dataframe_has_argument_columns(self.accumulate, "accumulate", self.predicts, "predicts")
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.predicts_sequence_column, "predicts_sequence_column", self.predicts, "predicts")
        
        self.__awu._validate_input_columns_not_empty(self.refs_sequence_column, "refs_sequence_column")
        self.__awu._validate_dataframe_has_argument_columns(self.refs_sequence_column, "refs_sequence_column", self.refs, "refs")
        
        self.__awu._validate_input_columns_not_empty(self.predicts_partition_column, "predicts_partition_column")
        self.__awu._validate_dataframe_has_argument_columns(self.predicts_partition_column, "predicts_partition_column", self.predicts, "predicts")
        
        self.__awu._validate_input_columns_not_empty(self.refs_partition_column, "refs_partition_column")
        self.__awu._validate_dataframe_has_argument_columns(self.refs_partition_column, "refs_partition_column", self.refs, "refs")
    ...
    def __form_tdml_query(self) :
        ...
        # Process predicts
        # if partition column is not specified, use partition by 1.
        if self.predicts_partition_column is None:
            self.predicts_partition_column = '1'
        else:
        ...
        if self.refs is not None:
            # if partition column is not specified, use partition by 1.
            if self.refs_partition_column is None:
                self.refs_partition_column = '1'
            else:
    ...
    def __execute(self) :
        ...
        try:
            ...
            node_id_list = self.__aed_utils._aed_ml_query(self.__input_nodeids, self.sqlmr_query, self.__func_output_args, "CoxHazardRatio")
    ...
    def __process_output_column_info(self) :
        ...
        for column_name, column_type in self.__awu._retrieve_column_info(df_input=self.predicts, parameter=None, columns=["Accumulate"]):
            stdout_column_info_name.append(column_name)
            stdout_column_info_type.append(column_type)
            
        for column_name, column_type in self.__awu._retrieve_column_info(df_input=self.predicts, parameter=None, columns=["PredictFeatureNames"]):
            stdout_column_info_name.append(column_name)
            stdout_column_info_type.append(column_type)
            
        for column_name, column_type in self.__awu._retrieve_column_info(df_input=self.refs, parameter=None, columns=["RefFeatureColumns"]):
            stdout_column_info_name.append(column_name)
            stdout_column_info_type.append(column_type)
            
        
        for column_name, column_type in self.__awu._retrieve_column_info(df_input=self.predicts, parameter=None, columns=["PredictFeatureUnitsColumns"]):
            stdout_column_info_name.append(column_name)
            stdout_column_info_type.append(column_type)
