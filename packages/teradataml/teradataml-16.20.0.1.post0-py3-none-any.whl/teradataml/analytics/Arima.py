...
class Arima:
    ...
    def __init__(self,
        ...
        PARAMETERS:
            ...
            include_mean:
                ...
                to the ta.arima model. Note: If include_mean is "true", then both d
            ...
            include_drift:
                Optional Argument.
                Specifies whether drift term is included in the ARIMA model. Note that
        ...
        EXAMPLES:
            ...
            arima_out1.coefficient
            arima_out1.residual_table
            arima_out1.output
            ...
            arima_out2.coefficient
            arima_out2.residual_table
            arima_out2.output
        ...
        self.__arg_info_matrix.append(["timestamp_columns", self.timestamp_columns, False, "str"])
        ...
        self.__arg_info_matrix.append(["orders_table_sequence_column", self.orders_table_sequence_column, True, "str"])
    ...
    def __validate(self) :
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.timestamp_columns, "timestamp_columns", self.data, "data")
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.orders_table_sequence_column, "orders_table_sequence_column", self.orders_table, "orders_table")
