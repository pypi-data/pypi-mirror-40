...
class ArimaPredictor:
    ...
    def __init__(self,
        ...
        """
        DESCRIPTION:
            The ArimaPredictor function takes as input the ARIMA model produced 
        ...
        RETURNS:
            Instance of ArimaPredictor.
            Output teradataml DataFrames can be accessed using attribute 
            references, such as ArimaPredictorObj.<attribute_name>.
        ...
        EXAMPLES:
            ...
            arima_predict_out1 = ArimaPredictor(object = arima_out,
            ...
            # Find prediction.
            arima_predict_out2 = ArimaPredictor(object=arima_coefficients,
                                                 object_partition_column='td_arima_partition_id',
        ...
        self.__arg_info_matrix.append(["residual_table_partition_column", self.residual_table_partition_column, False, "str"])
        self.__arg_info_matrix.append(["residual_table_order_column", self.residual_table_order_column, False, "str"])
        self.__arg_info_matrix.append(["n_ahead", self.n_ahead, True, "int"])
        ...
        self.__arg_info_matrix.append(["residual_table_sequence_column", self.residual_table_sequence_column, True, "str"])
    ...
    def __validate(self) :
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.partition_columns, "partition_columns", self.object, "object")
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.residual_table_sequence_column, "residual_table_sequence_column", self.residual_table, "residual_table")
        ...
        self.__awu._validate_dataframe_has_argument_columns(self.residual_table_partition_column, "residual_table_partition_column", self.residual_table, "residual_table")
        
        self.__awu._validate_input_columns_not_empty(self.residual_table_order_column, "residual_table_order_column")
        self.__awu._validate_dataframe_has_argument_columns(self.residual_table_order_column, "residual_table_order_column", self.residual_table, "residual_table")
    ...
    def __form_tdml_query(self) :
        ...
        residual_table_partition_column = UtilFuncs._teradata_collapse_arglist(self.residual_table_partition_column,"\"")
        ...
        self.__func_input_table_view_query.append(self.__table_ref["ref"])
        self.__func_input_dataframe_type.append(self.__table_ref["ref_type"])
        self.__func_input_partition_by_cols.append(residual_table_partition_column)
    ...
    def __repr__(self) :
        """
        Returns the string representation for a ArimaPredictor class instance.
        """
