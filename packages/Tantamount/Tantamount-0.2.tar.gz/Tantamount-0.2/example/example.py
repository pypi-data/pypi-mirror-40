...
machine.addstate("A", SimpleState("State A"), "abc")
machine.addstate("B", SimpleState("State B"), "abc")
machine.addstate("C", SimpleState("State C"), "abc")
machine.addstate("D", SimpleState("State D"), "d")
