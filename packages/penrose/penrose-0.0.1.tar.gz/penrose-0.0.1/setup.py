...
def get_lookup():
    '''get version by way of penrose.version, returns a 
       lookup dictionary with several global variables without
       needing to import expfactory
    '''
    lookup = dict()
    version_file = os.path.join('penrose', 'version.py')
...
if __name__ == "__main__":
    ...
    setup(name=NAME,
          ...
          entry_points = {'console_scripts': [ 'penrose-lib=penrose.clint:main' ] })
