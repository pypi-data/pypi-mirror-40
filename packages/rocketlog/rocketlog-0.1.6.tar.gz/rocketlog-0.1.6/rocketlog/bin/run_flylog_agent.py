...
import rocketlog
from rocketlog import Agent, constants
from rocketlog.agent.log import logger
...
LOG_FILE_PATH = "/tmp/rocketlog_agent.log"
...
LOGGING = {
    ...
    'loggers': {
        rocketlog.constants.AGENT_LOGGER_NAME: {
...
def build_parser():
    ...
    parser.add_argument('-v', '--version', action='version', version='%s' % rocketlog.__version__)
    return parser
