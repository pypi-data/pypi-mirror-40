...
class SensorEvent:
    ...
    def __init__(self, Frame):
        ...
        if isinstance(Frame, parser.WeatherStation):
            ...
            self.values['BMP280 pressure'] = Frame.BME280_pres
            self.values['BMP280 temperature'] = Frame.BME280_temp
            self.values['BMP280 humidity'] = Frame.BME280_hum
