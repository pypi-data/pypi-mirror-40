...
def makeform(root, fields):
	...
	for field in fields:
		...
		if  field =='Merge CellProfiler Segmented Objects' or field == 'Create Registry' or field == 'Model' or field =='': 
			...
			elif field == 'Locate list of image sets' or field == 'Locate segmented images':
...
def createobjectlist(entries,progress_bar):
	...
	#################################################################
	# input definition
	folder = entries['Locate segmented images'].get()
...
def Model(entries,BuildModel,progress_bar):
	...
	folder = entries['Locate list of image sets'].get() #'C:\\Users\\kuki\\Desktop\\cpoutput315'
...
def vampire(): 
	...
	fields = ('Merge CellProfiler Segmented Objects','Locate CellProfiler objects','',
		'Create Registry','Locate segmented images','',
		'Model','Locate list of image sets', 'Number of eigen-shapes','Model name','','Status')
	...
	b3 = Button(rows[4],text='load csv', width=12,command=(lambda e=ents: getcsv(e,'Locate segmented images')))
	...
	#####################################################################################################################
	#function 5 : Model 
	b5 = Button(rows[7],text='load csv', width=12,command=(lambda e=ents: getcsv(e,'Locate list of image sets')))
