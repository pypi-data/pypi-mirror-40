...
class TFAugmentor(DLPAugmentor):
  ...
  def func(self,
    ...
    x = sess.run(self._augmentation_nodes.augmented_image_node,
                 feed_dict={
                   self._augmentation_nodes.augmented_image_placeholder:data
                   })
  ...
  def __init__(self,
    ...
    super().__init__(input,C=C,**kwargs)
  ...
  def add_input_augmentation(input_height,
    ...
    brightened_image = tf.multiply(flipped_image, brightness_value, name='augmented_image_node')
    augmented_image_node = brightened_image
    # augmented_image_node = tf.expand_dims(brightened_image, 0, name='augmented_image_node')

    return NOD.dict_of(augmented_image_placeholder, augmented_image_node)
