...
class JobPathHelper():
    ...
    def get_demand_prediction_dirs(self, dt_hour_str, update_time_str=''):
        ...
        return self.get_dirs_by_demand_prediction_key(job_key, dt_hour_str, update_time_str=update_time_str)

    def get_demand_prediction_2h_dirs(self, dt_hour_str, update_time_str=''):
        job_key = self.get_job_key('demand_prediction_2h')
        return self.get_dirs_by_demand_prediction_key(job_key, dt_hour_str, update_time_str=update_time_str)

    def get_demand_prediction_4h_dirs(self, dt_hour_str, update_time_str=''):
        job_key = self.get_job_key('demand_prediction_4h')
        return self.get_dirs_by_demand_prediction_key(job_key, dt_hour_str, update_time_str=update_time_str)

    def get_demand_prediction_1d_dirs(self, dt_hour_str, update_time_str=''):
        job_key = self.get_job_key('demand_prediction_1d')
        return self.get_dirs_by_demand_prediction_key(job_key, dt_hour_str, update_time_str=update_time_str)

    def get_dirs_by_demand_prediction_key(self, job_key, dt_hour_str, update_time_str=''):
        path = {}
