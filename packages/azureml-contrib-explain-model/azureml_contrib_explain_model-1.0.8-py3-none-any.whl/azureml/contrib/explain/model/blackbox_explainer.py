...
class AggregateBlackBoxExplainer(BlackBoxExplainer, AggregateExplainer):
    ...
    def _pipeline_subset_wrapper(self, original_data_ref, explain_subset, f, current_index_list):
        ...
        def wrapper(data):
            ...
            if current_index_list is None or not current_index_list:
    ...
    def _prepare_pipeline_and_summary(self, pipeline, original_data_ref,
        ...
        if explain_subset:
            summary_original_examples = self.initialization_examples.summary_dataset
            if isinstance(summary_original_examples, DenseData):
                summary_original_examples = summary_original_examples.data
            original_data_ref[0] = summary_original_examples
