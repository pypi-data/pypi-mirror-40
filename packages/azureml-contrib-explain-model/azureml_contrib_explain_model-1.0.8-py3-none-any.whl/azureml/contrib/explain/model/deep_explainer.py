...
from .structured_model_explainer import TabularStructuredInitModelExplainer
from .explanation_utils import _get_dense_examples, _convert_to_list
from .scoring_model import KNNScoringModel
from .explanation import create_local_explanation
...
class DeepExplainer(TabularStructuredInitModelExplainer, AggregateExplainer):
    ...
    def _explain_local(self, evaluation_examples, explain_subset=None, silent=True, nsamples=Defaults.AUTO,
        ...
        feature_importance_values = _convert_to_list(shap_values)
        scoring_model = None
        if self.create_scoring_model:
            scoring_model = KNNScoringModel(evaluation_examples, feature_importance_values)
