...
from .text_explainer_utils import _find_golden_doc
...
from .structured_model_explainer import TextStructuredInitModelExplainer
...
class HANTextExplainer(TextStructuredInitModelExplainer):
    ...
    def explain_local(self, evaluation_examples, classes=None, tune_epochs=5, **kwargs):
        ...
        feature_importance_values = _convert_to_list(np.array(shap_values))
