...
from .blackbox_explainer import AggregateBlackBoxExplainer
from .scoring_model import KNNScoringModel
from .explanation import create_local_explanation
from azureml.explain.model._internal.constants import Defaults, ExplainParams, ExplainType
...
class LIMEExplainer(AggregateBlackBoxExplainer):
    ...
    def _explain_local(self, evaluation_examples, explain_subset=None, silent=True,
        ...
        return create_local_explanation(feature_importance_values=lime_values,
