...
class KNNScoringModel(ScoringModel):
    ...
    def __init__(self, evaluation_examples, feature_importance_values, **kwargs):
        ...
        self.nn_feature_importance = feature_importance_values
    ...
    def explain(self, evaluation_examples):
        ...
        classification = isinstance(self.nn_feature_importance, list)
        if classification:
            shap_values = []
            for i in range(len(self.nn_feature_importance)):
                shap_values.append(np.array(self.nn_feature_importance[i])[indices].tolist())
            return shap_values
        else:
