...
for old_type in tqdm(OLD_TYPES):
    if old_type not in etypes_json.keys() and len(old_type) >= 2:
        etypes_json[old_type] = ""
        print(old_type)
jsonfiler.dump(etypes_json,"user_dict/user_dict_com_etypes.json",indent=4)
