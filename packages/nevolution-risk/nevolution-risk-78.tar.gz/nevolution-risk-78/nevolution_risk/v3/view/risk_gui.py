...
class Gui(object):
    ...
    def render(self, mode="human"):
        ...
        pygame.draw.rect(self.game_display, (255, 0, 0), ((width - 150, 0), (width, 150)))
        pygame.draw.rect(self.game_display, (0, 255, 0), ((width - 150, 150), (width, 300)))
        pygame.draw.rect(self.game_display, (0, 0, 255), ((width - 150, 300), (width, 450)))
    ...
    def draw_node(self, node):
        ...
        if node.capital:
            pygame.draw.circle(self.game_display, (255,255,0), self.coordinates[node.id], int(radius*1.3))
