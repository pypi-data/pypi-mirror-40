...
class Cubesatsim(KaitaiStruct):
    ...
    class UiFrame(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.ax25_info = self._root.CubesatsimData(io, self, self._root)
    ...
    class CubesatsimData(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
        ...
        def _read(self):
            ...
            _on = self.data_type
            if _on == 26729:
                self.payload = self._root.CubesatsimAo7(self._io, self, self._root)
            else:
                self.payload = self._root.CubesatsimAo7(self._io, self, self._root)
    ...
    class CubesatsimAo7(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
        ...
        def channel_1a_val(self):
            ...
            self._m_channel_1a_val = ((((self.channel_1a_val_raw[0] - 48) * 10) + (self.channel_1a_val_raw[1] - 48)) * 29.5)
            return self._m_channel_1a_val if hasattr(self, '_m_channel_1a_val') else None
        ...
        def channel_6a_val(self):
            ...
            self._m_channel_6a_val = (((((self.channel_6a_val_raw[0] - 48) * 10) + (self.channel_6a_val_raw[1] - 48)) * (((self.channel_6a_val_raw[0] - 48) * 10) + (self.channel_6a_val_raw[1] - 48))) / 1.56)
            return self._m_channel_6a_val if hasattr(self, '_m_channel_6a_val') else None
        ...
        def channel_1c_val(self):
            ...
            self._m_channel_1c_val = (1970 - (20 * (((self.channel_1c_val_raw[0] - 48) * 10) + (self.channel_1c_val_raw[1] - 48))))
            return self._m_channel_1c_val if hasattr(self, '_m_channel_1c_val') else None
        ...
        def channel_4a_val(self):
            ...
            self._m_channel_4a_val = (95.8 - (1.48 * (((self.channel_4a_val_raw[0] - 48) * 10) + (self.channel_4a_val_raw[1] - 48))))
            return self._m_channel_4a_val if hasattr(self, '_m_channel_4a_val') else None
        ...
        def channel_5a_val(self):
            ...
            self._m_channel_5a_val = (95.8 - (1.48 * (((self.channel_5a_val_raw[0] - 48) * 10) + (self.channel_5a_val_raw[1] - 48))))
            return self._m_channel_5a_val if hasattr(self, '_m_channel_5a_val') else None
        ...
        def channel_2b_val(self):
            ...
            self._m_channel_2b_val = (8 * ((1 - (0.01 * (((self.channel_2b_val_raw[0] - 48) * 10) + (self.channel_2b_val_raw[1] - 48)))) * (1 - (0.01 * (((self.channel_2b_val_raw[0] - 48) * 10) + (self.channel_2b_val_raw[1] - 48))))))
            return self._m_channel_2b_val if hasattr(self, '_m_channel_2b_val') else None
        ...
        def channel_6b_val(self):
            ...
            self._m_channel_6b_val = ((0.1 * ((((self.channel_6b_val_raw[0] - 48) * 10) + (self.channel_6b_val_raw[1] - 48)) * (((self.channel_6b_val_raw[0] - 48) * 10) + (self.channel_6b_val_raw[1] - 48)))) + 35)
            return self._m_channel_6b_val if hasattr(self, '_m_channel_6b_val') else None
        ...
        def channel_6c_val(self):
            ...
            self._m_channel_6c_val = (0.041 * ((((self.channel_6c_val_raw[0] - 48) * 10) + (self.channel_6c_val_raw[1] - 48)) * (((self.channel_6c_val_raw[0] - 48) * 10) + (self.channel_6c_val_raw[1] - 48))))
            return self._m_channel_6c_val if hasattr(self, '_m_channel_6c_val') else None
        ...
        def channel_3a_val(self):
            ...
            self._m_channel_3a_val = ((0.1 * (((self.channel_3a_val_raw[0] - 48) * 10) + (self.channel_3a_val_raw[1] - 48))) + 6.4)
            return self._m_channel_3a_val if hasattr(self, '_m_channel_3a_val') else None
        ...
        def channel_2d_val(self):
            ...
            self._m_channel_2d_val = (40 * ((((self.channel_2d_val_raw[0] - 48) * 10) + (self.channel_2d_val_raw[1] - 48)) - 50))
            return self._m_channel_2d_val if hasattr(self, '_m_channel_2d_val') else None
        ...
        def channel_5d_val(self):
            ...
            self._m_channel_5d_val = (11 + (0.82 * (((self.channel_5d_val_raw[0] - 48) * 10) + (self.channel_5d_val_raw[1] - 48))))
            return self._m_channel_5d_val if hasattr(self, '_m_channel_5d_val') else None
        ...
        def channel_2c_val(self):
            ...
            self._m_channel_2c_val = (15.16 * (((self.channel_2c_val_raw[0] - 48) * 10) + (self.channel_2c_val_raw[1] - 48)))
            return self._m_channel_2c_val if hasattr(self, '_m_channel_2c_val') else None
        ...
        def channel_6d_val(self):
            ...
            self._m_channel_6d_val = (0.01 * (((self.channel_6d_val_raw[0] - 48) * 10) + (self.channel_6d_val_raw[1] - 48)))
            return self._m_channel_6d_val if hasattr(self, '_m_channel_6d_val') else None
        ...
        def channel_1b_val(self):
            ...
            self._m_channel_1b_val = (1970 - (20 * (((self.channel_1b_val_raw[0] - 48) * 10) + (self.channel_1b_val_raw[1] - 48))))
            return self._m_channel_1b_val if hasattr(self, '_m_channel_1b_val') else None
        ...
        def channel_3b_val(self):
            ...
            self._m_channel_3b_val = (0.1 * (((self.channel_3b_val_raw[0] - 48) * 10) + (self.channel_3b_val_raw[1] - 48)))
            return self._m_channel_3b_val if hasattr(self, '_m_channel_3b_val') else None
        ...
        def channel_4c_val(self):
            ...
            self._m_channel_4c_val = (95.8 - (1.48 * (((self.channel_4c_val_raw[0] - 48) * 10) + (self.channel_4c_val_raw[1] - 48))))
            return self._m_channel_4c_val if hasattr(self, '_m_channel_4c_val') else None
        ...
        def channel_5c_val(self):
            ...
            self._m_channel_5c_val = (95.8 - (1.48 * (((self.channel_5c_val_raw[0] - 48) * 10) + (self.channel_5c_val_raw[1] - 48))))
            return self._m_channel_5c_val if hasattr(self, '_m_channel_5c_val') else None
        ...
        def channel_4b_val(self):
            ...
            self._m_channel_4b_val = (95.8 - (1.48 * (((self.channel_4b_val_raw[0] - 48) * 10) + (self.channel_4b_val_raw[1] - 48))))
            return self._m_channel_4b_val if hasattr(self, '_m_channel_4b_val') else None
        ...
        def channel_3d_val(self):
            ...
            self._m_channel_3d_val = (95.8 - (1.48 * (((self.channel_3d_val_raw[0] - 48) * 10) + (self.channel_3d_val_raw[1] - 48))))
            return self._m_channel_3d_val if hasattr(self, '_m_channel_3d_val') else None
        ...
        def channel_2a_val(self):
            ...
            self._m_channel_2a_val = (1970 - (20 * (((self.channel_2a_val_raw[0] - 48) * 10) + (self.channel_2a_val_raw[1] - 48))))
            return self._m_channel_2a_val if hasattr(self, '_m_channel_2a_val') else None
        ...
        def channel_4d_val(self):
            ...
            self._m_channel_4d_val = (95.8 - (1.48 * (((self.channel_4d_val_raw[0] - 48) * 10) + (self.channel_4d_val_raw[1] - 48))))
            return self._m_channel_4d_val if hasattr(self, '_m_channel_4d_val') else None
        ...
        def channel_3c_val(self):
            ...
            self._m_channel_3c_val = (0.15 * (((self.channel_3c_val_raw[0] - 48) * 10) + (self.channel_3c_val_raw[1] - 48)))
            return self._m_channel_3c_val if hasattr(self, '_m_channel_3c_val') else None
        ...
        def channel_5b_val(self):
            ...
            self._m_channel_5b_val = (11.67 * (((self.channel_5b_val_raw[0] - 48) * 10) + (self.channel_5b_val_raw[1] - 48)))
            return self._m_channel_5b_val if hasattr(self, '_m_channel_5b_val') else None
