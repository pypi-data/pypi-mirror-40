...
class Manager:
    ...
    def _connect_to_broker(self):
        try:
            ...
            self.mqtt_client = mqtt.Client(client_id=self.mqtt_client_config.get_client_id(), clean_session=False,
                                           protocol=mqtt.MQTTv311, transport="tcp")
            self.mqtt_client.username_pw_set(self.mqtt_client_config.get_username(),
                                             self.mqtt_client_config.get_password())
            ...
            self.mqtt_client.connect(self.current_mqtt_host, self.mqtt_broker_config.get_port(),
