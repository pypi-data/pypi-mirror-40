...
class Client(object):
    ...
    def __init__(self, id=None, amity_key=None, client_ids=None, code=None, colors=None, dataset_metadata=None, dt_u=None, features=None, field_metadata=None, integrations=None, name=None, nav_page_ids=None, null_default_value=None, schedule=None, short_name=None, spark_conf=None, sso=None, status=None):  # noqa: E501
