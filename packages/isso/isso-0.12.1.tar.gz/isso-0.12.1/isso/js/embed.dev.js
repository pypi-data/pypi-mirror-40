...
buf.push("<div class=\"isso-postbox\"><div class=\"form-wrapper\"><div class=\"textarea-wrapper\"><div contenteditable=\"true\" class=\"textarea placeholder\">" + (jade.escape(null == (jade_interp = i18n('postbox-text')) ? "" : jade_interp)) + "</div><div class=\"preview\"><div class=\"isso-comment\"><div class=\"text-wrapper\"><div class=\"text\"></div></div></div></div></div><section class=\"auth-section\"><p class=\"input-wrapper\"><label for=\"isso-postbox__author\">" + (jade.escape(null == (jade_interp = i18n('postbox-author')) ? "" : jade_interp)) + "</label><input type=\"text\" id=\"isso-postbox__author\" name=\"author\"" + (jade.attr("value", author !== null ? '' + (author) + '' : '', true, false)) + "/></p><p class=\"input-wrapper\"><label for=\"isso-postbox__email\">" + (jade.escape(null == (jade_interp = i18n('postbox-email')) ? "" : jade_interp)) + "</label><input type=\"email\" id=\"isso-postbox__email\" name=\"email\"" + (jade.attr("value", email != null ? '' + (email) + '' : '', true, false)) + "/></p><p class=\"input-wrapper\"><label for=\"isso-postbox__website\">" + (jade.escape(null == (jade_interp = i18n('postbox-website')) ? "" : jade_interp)) + "</label><input type=\"text\" id=\"isso-postbox__website\" name=\"website\"" + (jade.attr("value", website != null ? '' + (website) + '' : '', true, false)) + "/></p><p class=\"post-action\"><input type=\"submit\"" + (jade.attr("value", i18n('postbox-submit'), true, false)) + "/></p><p class=\"post-action\"><input type=\"button\" name=\"preview\"" + (jade.attr("value", i18n('postbox-preview'), true, false)) + "/></p><p class=\"post-action\"><input type=\"button\" name=\"edit\"" + (jade.attr("value", i18n('postbox-edit'), true, false)) + "/></p></section><section class=\"notification-section\"><label><input type=\"checkbox\" name=\"notification\"/>" + (jade.escape(null == (jade_interp = i18n('postbox-notification')) ? "" : jade_interp)) + "</label></section></div></div>");}("i18n" in locals_for_with?locals_for_with.i18n:typeof i18n!=="undefined"?i18n:undefined,"author" in locals_for_with?locals_for_with.author:typeof author!=="undefined"?author:undefined,"email" in locals_for_with?locals_for_with.email:typeof email!=="undefined"?email:undefined,"website" in locals_for_with?locals_for_with.website:typeof website!=="undefined"?website:undefined));;return buf.join("");
