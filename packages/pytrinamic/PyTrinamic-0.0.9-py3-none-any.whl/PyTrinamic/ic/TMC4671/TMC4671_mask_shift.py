...
class TMC4671_mask_shift(object):
    ...
    SI_TYPE_SHIFT               = 0
    SI_VERSION_MASK             = 0xFFFFFFFF
    SI_VERSION_SHIFT            = 0
    SI_DATE_MASK                = 0xFFFFFFFF
    SI_DATE_SHIFT               = 0
    SI_TIME_MASK                = 0xFFFFFFFF
    SI_TIME_SHIFT               = 0
    SI_VARIANT_MASK             = 0xFFFFFFFF
    SI_VARIANT_SHIFT            = 0
    SI_BUILD_MASK               = 0xFFFFFFFF
    SI_BUILD_SHIFT              = 0
    CHIP_INFO_ADDRESS_MASK      = 0xFF
    CHIP_INFO_ADDRESS_SHIFT     = 0
    ADC_I0_RAW_MASK             = 0xFFFF        # raw phase current I0
    ADC_I0_RAW_SHIFT            = 0
    ADC_I1_RAW_MASK             = 0xFFFF0000    # raw phase current I1
    ADC_I1_RAW_SHIFT            = 16
    ADC_VM_RAW_MASK             = 0x0000FFFF    # raw supply voltage value 
    ADC_VM_RAW_SHIFT            = 0
    ADC_AGPI_A_RAW_MASK         = 0xFFFF0000    # raw analog gpi A value
    ADC_AGPI_A_RAW_SHIFT        = 16
    ADC_AGPI_B_RAW_MASK         = 0x0000FFFF    # raw analog gpi B value
    ADC_AGPI_B_RAW_SHIFT        = 0
    ADC_AENC_UX_RAW_MASK        = 0xFFFF0000    # raw analog encoder signal
    ADC_AENC_UX_RAW_SHIFT       = 16
    ADC_AENC_VN_RAW_MASK        = 0x0000FFFF    # raw analog encoder signal
    ADC_AENC_VN_RAW_SHIFT       = 0
    ADC_AENC_WY_RAW_MASK        = 0xFFFF0000    # raw analog encoder signal
    ADC_AENC_WY_RAW_SHIFT       = 16
    ADC_RAW_ADDR_MASK           = 0xFF
