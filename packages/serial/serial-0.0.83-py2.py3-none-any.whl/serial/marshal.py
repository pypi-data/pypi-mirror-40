...
class _Unmarshal(object):
    ...
    def __init__(
        ...
        if (types is not None) and not isinstance(types, collections_abc.Sequence):
            types = (types,)

        if (value_types is not None) and not isinstance(value_types, collections_abc.Sequence):
            value_types = (value_types,)

        if (item_types is not None) and not isinstance(item_types, collections_abc.Sequence):
