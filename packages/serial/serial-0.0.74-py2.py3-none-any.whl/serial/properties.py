...
class Property(object):
    ...
    @property
    def versions(self):
        # type: () -> Optional[Sequence[serial.meta.Version]]
        return self._versions

    @versions.setter
    def versions(
        self,
        versions  # type: Optional[Sequence[Union[str, collections_abc.Iterable, serial.meta.Version]]]
    ):
            ...
            if isinstance(versions, collections_abc.Iterable):
                ...
                raise TypeError(
                    (
                        ...
                        '`%s` instances, not' % qualified_name(serial.meta.Version)
                    ) + (
                        ':\n' + repr_versions
