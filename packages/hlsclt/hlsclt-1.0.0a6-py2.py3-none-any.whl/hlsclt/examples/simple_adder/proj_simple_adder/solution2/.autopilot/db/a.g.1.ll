; ModuleID = '/mnt/centos_share/Vivado_Projects/hlsclt/hlsclt/examples/simple_adder/proj_simple_adder/solution2/.autopilot/db/a.g.1.bc'
...
define i32 @simple_adder(i32 %a, i32 %b) nounwind uwtable {
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !29 ; [debug line = 2:1]
  %c = add nsw i32 %b, %a, !dbg !31               ; [#uses=1 type=i32] [debug line = 4:2]
  call void @llvm.dbg.value(metadata !{i32 %c}, i64 0, metadata !32), !dbg !31 ; [debug line = 4:2] [debug variable = c]
  ret i32 %c, !dbg !33                            ; [debug line = 5:2]
}
...
!29 = metadata !{i32 2, i32 1, metadata !30, null}
!30 = metadata !{i32 786443, metadata !5, i32 1, i32 32, metadata !6, i32 0} ; [ DW_TAG_lexical_block ]
!31 = metadata !{i32 4, i32 2, metadata !30, null}
!32 = metadata !{i32 786688, metadata !30, metadata !"c", metadata !6, i32 3, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!33 = metadata !{i32 5, i32 2, metadata !30, null}
