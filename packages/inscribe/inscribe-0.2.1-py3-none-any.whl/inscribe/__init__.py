...
class Client(object):
    ...
    def create_blacklist_entry(self, name: str = None, phone: str = None, address: str = None, file = None) -> dict:
        """
        Create a single blacklist entry
        """
        url = "/blacklist"
        payload = {"name": name, "phone": phone, "address": address, "file": file}
        return self._post(url, json=payload)

    def update_blacklist_entry(self, blacklist_id: int, name: str = None, phone: str = None, address: str = None) -> dict:
        """
