...
class SPSSMachineLearningAsset(KnownServiceAsset):
    ...
    def __init__(self, source_uid, binding_uid=None, input_data_type=None, problem_type=None, label_column=None,
        ...
        validate_type(input_data_type, 'input_data_type', [str, enumerate], mandatory=True)
        validate_type(problem_type, 'problem_type', [str, enumerate], mandatory=True)
        ...
        KnownServiceAsset.__init__(self, source_uid=source_uid, binding_uid=binding_uid, input_data_type=input_data_type,
                                   problem_type=problem_type, label_column=label_column,
