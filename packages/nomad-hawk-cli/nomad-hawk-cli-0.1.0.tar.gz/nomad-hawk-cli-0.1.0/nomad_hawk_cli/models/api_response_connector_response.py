...
class ApiResponseConnectorResponse(object):
    ...
    def __init__(self, code=None, response=None, response_en=None, platform=None):  # noqa: E501
        """ApiResponseConnectorResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ApiResponseConnectorResponse, dict):
