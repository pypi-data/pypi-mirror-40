...
class dingTalk():
	...
	def __init__(self, configfile='/etc/.dingtalk.conf', section='dingding', content=None, userlist=None, robottoken=None, msgtype="text", title=None, picurl=None, msgurl=None, mobiles=None):
	# def __init__(self, configfile='/etc/.dingtalk.conf', section='dingding', content=None, userlist=None):
	...
	def getConfig(self):
		...
		"""
		configdict['token'] = config[self.section]['token']
		configdict['msgtype'] = config[self.section]['msgtype']
		configdict['title'] = config[self.section]['title']
		configdict['picurl'] = config[self.section]['picurl']
		configdict['msgurl'] = config[self.section]['msgurl']
		configdict['mobiles'] = config[self.section]['mobiles']
		"""
	...
	def sendRobot(self):
		...
		}""" % (self.msgtype, self.msgtype, self.title, self.content, self.picurl, self.msgurl, self.content, self.mobiles)
