...
Create user and database::
    ...
    createdb --owner hiveeyes ldi_meta
...
Create read-only user::
    ...
    postgres=# \c ldi_meta
    ldi_meta=# CREATE ROLE readonly WITH LOGIN PASSWORD 'readonly';
    ldi_meta=# GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA public TO readonly;
    ldi_meta=# GRANT SELECT ON ALL TABLES IN SCHEMA public TO readonly;
