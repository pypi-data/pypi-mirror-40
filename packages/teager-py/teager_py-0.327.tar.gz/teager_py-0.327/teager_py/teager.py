        ...
        # 2 dimensional np.array
            ...
            if (teager_angle_two == None):
                ...
                if (teager_angle_one.lower() == 'horizontal' and teager_angle_two.lower() == 'vertical'):
                    ...
                    temp_array_one = crop_center(temp_array_one, len(temp_array_one[0]), len(temp_array_one[0])) # - teager_two_spread in y

                    temp_array_two = vertical_teager(teager_array, teager_two_spread)
                    temp_array_two = crop_center(temp_array_two, len(temp_array_two), len(temp_array_two)) # - teager_one_spread in x
