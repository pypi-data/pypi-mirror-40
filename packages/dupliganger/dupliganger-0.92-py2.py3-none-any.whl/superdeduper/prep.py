...
"""
Usage:
    superdeduper prep [options] <input.fastq>
    superdeduper prep [options] <in1.fastq> <in2.fastq>
    superdeduper prep [options] <input.bam>
...
Options:
    ...
    superdeduper qtrim [options] <in1.fastq> <in2.fastq>
Options:
    -h, --help
    -v, --verbose           Be verbose.
    -o OUT_DIR              Place results in directory OUT_DIR.
