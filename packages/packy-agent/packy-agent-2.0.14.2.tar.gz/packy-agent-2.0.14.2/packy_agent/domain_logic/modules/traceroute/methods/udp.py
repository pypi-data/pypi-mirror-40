...
class TracerouteUDP(Traceroute):
    ...
    @staticmethod
    def buffer_icmp_response(packet_data, probe_packet, receive_time):
        ...
        # 2. Greentet 1 receives reply for port 33439
        ...
        if probe_packet and probe_packet.dst_port not in used_udp_ports:
            return
