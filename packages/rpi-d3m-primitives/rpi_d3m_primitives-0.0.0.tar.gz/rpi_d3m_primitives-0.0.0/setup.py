...
setup(
	...
	author='Andrew James Soszynski, Deniz Koyuncu, Zijun Cui, Qiang Ji',
	...
	entry_points = {
		'd3m.primitives': [
			...
			'classification.tree_augmented_naive_bayes.RPI = rpi_d3m_primitives.TAN:TAN'
			#'feature_selection = workaround_ignore_error',
			#'classification = workaround_ignore_error'
		],
	},
	install_requires=[
		'd3m'
