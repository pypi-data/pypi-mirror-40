    ...
    **Custom OPF Formulations:** The system model serves as a builder for the
    ...
    def __init__(self, scenario, verify_scenario=True):
        ...
        if verify_scenario:
            scenario.verify()
        self._scr = scenario
        self._is_acyclic = self._scr.has_acyclic_subgrids()
        self._ac_subgrids = self._scr.get_ac_subgrids()
        self._dc_subgrids = self._scr.get_dc_subgrids()
    ...
    def ac_subgrids(self):
        ...
        **Remark:** This is determined at object construction and stored as a
        property for performance reasons.
        """
        return self._ac_subgrids

    @property
    def dc_subgrids(self):
        """
    ...
    def _select_constraint_normalization(scenario):
        ...
        See Also
        --------
        SystemModel.get_balance_constraints
        SystemModel.get_ampacity_constraints
        """
    ...
    def calc_dynamic_losses(self, operating_point):
        ...
        return np.asscalar(v.conj().dot(C.dot(v)) + c.transpose().dot(f)).real
