...
class AccountAPI(Client):
    def __init__(self, apikey, secret, phrase, use_server_time=False):
        Client.__init__(self, apikey, secret, phrase, use_server_time)
    ...
    # coin withdraw
    def coin_withdraw(self, currency, amount, destination, withdraw_address, trade_pwd, fee):
        params = {'currency': currency, 'amount': amount, 'destination': destination, 'withdraw_address': withdraw_address, 'trade_pwd': trade_pwd, 'fee': fee}
