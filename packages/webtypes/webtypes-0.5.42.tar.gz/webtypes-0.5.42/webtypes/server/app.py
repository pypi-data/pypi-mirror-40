...
from webtypes.http import HTMLResponse, JSONResponse, PathParams, Response
from webtypes.server.adapters import ASGItoWSGIAdapter
from webtypes.server.asgi import (
    ASGI_COMPONENTS, ASGIReceive, ASGIScope, ASGISend
)
from webtypes.server.components import Component, ReturnValue
from webtypes.server.core import Route, generate_document
from webtypes.server.injector import ASyncInjector, Injector
from webtypes.server.router import Router
from webtypes.server.staticfiles import ASyncStaticFiles, StaticFiles
from webtypes.server.templates import Templates
from webtypes.server.validation import VALIDATION_COMPONENTS
from webtypes.server.wsgi import (
...
class App():
    ...
    def include_extra_routes(self, schema_url=None, docs_url=None, static_url=None):
        ...
        from webtypes.server.handlers import serve_documentation, serve_schema, serve_static_wsgi
...
class ASyncApp(App):
    ...
    def include_extra_routes(self, schema_url=None, docs_url=None, static_url=None):
        ...
        from webtypes.server.handlers import serve_documentation, serve_schema, serve_static_asgi
