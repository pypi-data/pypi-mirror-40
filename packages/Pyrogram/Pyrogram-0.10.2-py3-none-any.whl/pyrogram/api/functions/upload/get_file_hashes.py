...
class GetFileHashes(Object):
    ...
    Args:
        location: Either :obj:`InputFileLocation <pyrogram.api.types.InputFileLocation>`, :obj:`InputEncryptedFileLocation <pyrogram.api.types.InputEncryptedFileLocation>`, :obj:`InputDocumentFileLocation <pyrogram.api.types.InputDocumentFileLocation>`, :obj:`InputSecureFileLocation <pyrogram.api.types.InputSecureFileLocation>` or :obj:`InputTakeoutFileLocation <pyrogram.api.types.InputTakeoutFileLocation>`
        offset: ``int`` ``32-bit``
