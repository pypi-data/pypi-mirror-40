...
class ChannelFull(Object):
    ...
    def read(b: BytesIO, *args) -> "ChannelFull":
        ...
        return ChannelFull(id, about, read_inbox_max_id, read_outbox_max_id, unread_count, chat_photo, notify_settings, exported_invite, bot_info, can_view_participants, can_set_username, can_set_stickers, hidden_prehistory, can_view_stats, participants_count, admins_count, kicked_count, banned_count, online_count, migrated_from_chat_id, migrated_from_max_id, pinned_msg_id, stickerset, available_min_id)
