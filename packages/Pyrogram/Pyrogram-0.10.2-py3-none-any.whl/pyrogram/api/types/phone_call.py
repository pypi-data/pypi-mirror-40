...
class PhoneCall(Object):
    ...
    def read(b: BytesIO, *args) -> "PhoneCall":
        ...
        return PhoneCall(id, access_hash, date, admin_id, participant_id, g_a_or_b, key_fingerprint, protocol, connection, alternative_connections, start_date, p2p_allowed)
