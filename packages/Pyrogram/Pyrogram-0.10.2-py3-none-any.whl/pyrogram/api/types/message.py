...
class Message(Object):
    ...
    def read(b: BytesIO, *args) -> "Message":
        ...
        return Message(id, to_id, date, message, out, mentioned, media_unread, silent, post, from_scheduled, from_id, fwd_from, via_bot_id, reply_to_msg_id, media, reply_markup, entities, views, edit_date, post_author, grouped_id)
