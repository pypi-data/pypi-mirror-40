...
class UserFull(Object):
    ...
    def read(b: BytesIO, *args) -> "UserFull":
        ...
        return UserFull(user, link, notify_settings, common_chats_count, blocked, phone_calls_available, phone_calls_private, can_pin_message, about, profile_photo, bot_info, pinned_msg_id)
