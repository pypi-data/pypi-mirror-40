...
def fetch_dataset(dataset, unit, multiplehits='ignore', spath='default'):
    r"""
    ...
    tnet = TemporalNetwork(from_df=df, nettype=nettype, unit=unit, starttime=starttime, desc=desc, diagonal=True)
    if spath: 
        print('---Saving---')
