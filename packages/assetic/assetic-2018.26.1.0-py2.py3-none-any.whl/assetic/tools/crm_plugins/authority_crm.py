...
class AuthorityCrmDTO(object):
    ...
    def __init__(self, formatted_account=None, workflow=None, category1=None
                 ...
                 , det_date=None, firstname=None, familyname=None
                 , business_phone=None, home_phone=None, mobile_phone=None
                 , description=None, due_date=None,latitude=None
                 , longitude=None, created=None, precis=None
...
class AuthorityCommon(object):
    ...
    def prepare_new_wr_object(self, authority_obj, wr_sub_type_id_mappings):
        ...
        # display name restricted to 50 chars so build and truncate
        wrreq.display_name = "{0} {1}".format(
            authority_obj.firstname,authority_obj.familyname)[0:50]
