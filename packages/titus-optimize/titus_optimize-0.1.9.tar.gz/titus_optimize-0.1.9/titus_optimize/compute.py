...
def optimize_ip(requested_cus, total_available_cus, num_sockets, previous_allocation=None, verbose=False, solver='GLPK_MI'):
    """
    ...
    # 2) Penalize empty sockets (because it means more LLC trashing)
