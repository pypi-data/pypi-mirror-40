...
@click.command('export', help='Exports an experience to a JSON file')
@click.option('--profile', '-p', prompt=True, help='The name of the profile to use as the context for the command.', autocompletion=pyke.auth.get_profile_names)
@click.option('--label', '-l', prompt=True, help='The label of the experience being exported')
@click.option('--namespace', '-n', default='', help='The namespace of the experience being exported')
@click.option('--filename', '-f', prompt=True, help='The location to save the export file. Not supported if --json is specified.')
@click.option('--json', is_flag=True, help='Return raw json from the platform.')
@pyke.auth.profile_context_required
def export(**kwargs):
...
@click.option('--profile', '-p', prompt=True, help='The name of the profile to use as the context for the command.', autocompletion=pyke.auth.get_profile_names)
@click.option('--label', '-l', prompt=True, help='The label for the new experience')
@click.option('--description', '-d', prompt=True, help='The description for the new experience')
@click.option('--collection-id', '-ci', default='', help='The experience collection ID for the new experience')
@click.option('--collection-name', '-cn', prompt=True, help='The experience collection name for the new experience')
...
@click.option('--filename', '-f', prompt=True, help='The location of the experience file to import')
@click.option('--json', is_flag=True, help='Return raw json from the platform.')
@pyke.auth.profile_context_required
def import_(**kwargs):
