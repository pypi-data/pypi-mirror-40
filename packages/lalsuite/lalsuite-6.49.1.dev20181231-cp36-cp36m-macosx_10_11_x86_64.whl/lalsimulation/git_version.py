...
id = "73af516559953447a7abbbbccb41abfb95f7d702"
date = "2018-12-31 00:04:13 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "73af516559953447a7abbbbccb41abfb95f7d702":
        return
    msg = "Program id (73af516559953447a7abbbbccb41abfb95f7d702) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
