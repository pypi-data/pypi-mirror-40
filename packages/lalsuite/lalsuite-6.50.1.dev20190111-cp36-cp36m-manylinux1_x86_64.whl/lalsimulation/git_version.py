...
id = "7b9842592cf16bd544a336a3d676e58d818895cd"
date = "2019-01-9 13:41:54 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "7b9842592cf16bd544a336a3d676e58d818895cd":
        return
    msg = "Program id (7b9842592cf16bd544a336a3d676e58d818895cd) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
