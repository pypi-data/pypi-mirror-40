...
id = "043c4ec2ed0b5e8403d51f0554230319b3790a11"
date = "2018-12-31 22:24:47 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "043c4ec2ed0b5e8403d51f0554230319b3790a11":
        return
    msg = "Program id (043c4ec2ed0b5e8403d51f0554230319b3790a11) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
