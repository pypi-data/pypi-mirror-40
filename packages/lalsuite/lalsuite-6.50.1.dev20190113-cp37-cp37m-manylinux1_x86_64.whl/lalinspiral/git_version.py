...
id = "fcf97216d988fc3f3e08c65bf280af6746faaa66"
date = "2019-01-11 10:05:38 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "fcf97216d988fc3f3e08c65bf280af6746faaa66":
        return
    msg = "Program id (fcf97216d988fc3f3e08c65bf280af6746faaa66) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
