...
id = "3c41434aacab00e069369e90c14dac6697b3cb54"
date = "2019-01-9 04:40:19 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "3c41434aacab00e069369e90c14dac6697b3cb54":
        return
    msg = "Program id (3c41434aacab00e069369e90c14dac6697b3cb54) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
