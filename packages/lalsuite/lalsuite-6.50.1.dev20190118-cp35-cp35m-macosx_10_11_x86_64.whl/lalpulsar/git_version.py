...
id = "24322407cb6d92269bc3d89b380a16f2635845de"
date = "2019-01-16 14:08:18 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "24322407cb6d92269bc3d89b380a16f2635845de":
        return
    msg = "Program id (24322407cb6d92269bc3d89b380a16f2635845de) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
