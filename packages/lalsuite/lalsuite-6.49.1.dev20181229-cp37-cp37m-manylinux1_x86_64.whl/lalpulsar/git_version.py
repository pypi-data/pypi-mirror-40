...
id = "8717a8794d13d2c101d72cb6f68ae2aba0659056"
date = "2018-12-29 10:35:02 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "8717a8794d13d2c101d72cb6f68ae2aba0659056":
        return
    msg = "Program id (8717a8794d13d2c101d72cb6f68ae2aba0659056) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
