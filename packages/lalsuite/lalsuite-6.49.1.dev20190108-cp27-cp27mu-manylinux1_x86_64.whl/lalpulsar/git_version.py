...
id = "c02551935a9a627bd76f58d834446905092a10c8"
date = "2019-01-7 13:03:26 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "c02551935a9a627bd76f58d834446905092a10c8":
        return
    msg = "Program id (c02551935a9a627bd76f58d834446905092a10c8) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
