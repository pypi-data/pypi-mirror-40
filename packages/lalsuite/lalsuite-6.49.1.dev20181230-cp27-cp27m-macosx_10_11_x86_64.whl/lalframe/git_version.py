...
id = "68e0a58f3cc4a460fd24fe216b97b9016c473b8f"
date = "2018-12-29 13:25:43 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "68e0a58f3cc4a460fd24fe216b97b9016c473b8f":
        return
    msg = "Program id (68e0a58f3cc4a460fd24fe216b97b9016c473b8f) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
