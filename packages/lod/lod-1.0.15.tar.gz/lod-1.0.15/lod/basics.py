...
class ObjectManager(object):
    ...
    def find_latest_tag(self, symbol_name, min_weight=None, max_weight=None, comment=None, step=None, arguments=[], not_nullified=True):
        ...
        Arguments are provided in a list, either as objects or as the identifiers of those objects. If an argument should be skipped and not be checked for a match, set it to None.
        """
