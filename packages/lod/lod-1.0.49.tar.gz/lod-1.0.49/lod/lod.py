...
def option(starting_confidence, name, description, trigger, display, actions, existing_variables=None):
    ...
    :param float starting_confidence: If this is not None, also creates a `!set_option_confidence https://elody.com/symbol/view/!set_option_confidence/`_ Tag with this weight and applies it to the Option.
