...
def option(name, description, trigger, display, actions, existing_variables=None, starting_confidence=None):
    """
    Creates an :class:`lod.basics.Option` and adds it to the list of objects.

    :param str name, description, trigger, display, actions, existing_variables: See

    :param float starting_confidence: If this is not None, also creates a !set_option_confidence Tag with this weight.
