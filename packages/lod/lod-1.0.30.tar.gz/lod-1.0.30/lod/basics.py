...
def parse_tag(dictionary):
    ...
    symbol_identifier = None if dictionary['symbol_identifier'] is None else parse_identifier(dictionary['symbol_identifier'])
...
class ObjectManager(object):
    ...
    def get_tag_backreferences(self, obj_or_identifier):
        """
        Returns an ordered list of all Tags that have the requested object as an argument.
