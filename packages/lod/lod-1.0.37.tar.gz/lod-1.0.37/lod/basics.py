...
class ObjectManager(object):
    ...
    def get_tags(self, *args, **kwargs):
        ...
        return res
    def check_tag_conditions(self, candidate_tag, symbol_name, min_weight=None, max_weight=None, comment=None, step=None, arguments=[], nullified=False):
        """
        Checks if a given Tag matches all conditions specified here.
        ...
        * arguments : A list of arguments. None values are skipped. For each not-None value in this list, the Tag must have that object as an argument at that position. The objects may be given as objects or as their :class:`Identifier`s.
