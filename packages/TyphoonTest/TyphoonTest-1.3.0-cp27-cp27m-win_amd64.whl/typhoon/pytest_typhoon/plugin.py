...
class PytestTyphoon(object):
    ...
    def __init__(self, config):
        ...
        decorators.decorate_module_public_attr(typhoon.test.signals, decorators.allure_plot_and_attach_analysis_decorator, inclusion_list=["is_step", "is_constant", "is_ramp", "follows_reference"])
