...
class MMLBaseEstimatorRunConfig(RunConfiguration):
    ...
    :type inputs: list
    :param framework: The framework. Allowed values: "Python", "PySpark", "CNTK", "TensorFlow", and "PyTorch".
    :type framework: str
    ...
    def __init__(self, compute_target, vm_size=None, vm_priority=None,
        ...
        :param inputs: Data references as input.
        :type inputs: list
        :param framework: The framework. Allowed values: "Python", "PythonMpi", "TensorFlowParameterServer".
        :type framework: str
        :param source_directory_data_store: The backing data store for the project share.
