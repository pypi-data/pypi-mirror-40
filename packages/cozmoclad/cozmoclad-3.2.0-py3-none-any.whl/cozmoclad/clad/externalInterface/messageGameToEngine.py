...
class SetDeterminantData(object):
  ...
  __slots__ = (
    '_installDateTimestamp', # uint_32
  )

  @property
  def installDateTimestamp(self):
    "uint_32 installDateTimestamp struct property."
  ...
  def installDateTimestamp(self, value):
    self._installDateTimestamp = msgbuffers.validate_integer(
      'SetDeterminantData.installDateTimestamp', value, 0, 4294967295)

  def __init__(self, installDateTimestamp=0):
  ...
  def unpack_from(cls, reader):
    ...
    return cls(_installDateTimestamp)
  ...
  def __eq__(self, other):
    if type(self) is type(other):
      return self._installDateTimestamp == other._installDateTimestamp
    else:
      return NotImplemented
  ...
  def __str__(self):
    return '{type}(installDateTimestamp={installDateTimestamp})'.format(
      type=type(self).__name__,
