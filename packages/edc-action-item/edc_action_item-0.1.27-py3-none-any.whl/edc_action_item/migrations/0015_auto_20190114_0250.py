...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('edc_action_item', '0014_auto_20181121_1738'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action_type', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_action_item.ActionType', verbose_name='Action')),
        ...
        migrations.AlterField(
            ...
            name='action_type',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_action_item.ActionType', verbose_name='Action'),
        ),
        migrations.AlterField(
            model_name='historicalactionitem',
            name='parent_action_item',
            field=models.ForeignKey(blank=True, db_constraint=False, editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_action_item.HistoricalActionItem'),
        ),
        migrations.AlterField(
            model_name='historicalactionitem',
