...
class TestUtils(TestCase):
    ...
    def test_fix_null_related_action_items2(self):
        ...
        self.assertEqual(
            form_one.action_item,
            form_two_b.related_action_item)
        ...
        self.assertEqual(
            form_one.action_item,
            form_two_b.action_item.related_action_item)
        self.assertEqual(
            form_one.action_item,
            form_two_b.related_action_item)
        self.assertEqual(
            form_two_a.action_item,
            form_two_b.parent_action_item)
    ...
    def test_fix_null_related_action_items3(self):
        ...
        self.assertEqual(
            form_one.action_item,
            form_two_b.action_item.parent_action_item)
        ...
        self.assertEqual(
            form_one.action_item,
            form_two_a.action_item.related_action_item)
        self.assertEqual(
            form_one.action_item,
            form_two_b.related_action_item)

        self.assertEqual(
            form_two_a.parent_action_item,
        ...
        self.assertEqual(
            form_one.action_item,
            form_two_a.action_item.parent_action_item)
