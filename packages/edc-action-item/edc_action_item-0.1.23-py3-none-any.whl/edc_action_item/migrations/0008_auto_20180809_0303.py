...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('edc_action_item', '0007_auto_20180707_1715'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action_type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='action', to='edc_action_item.ActionType', verbose_name='Action')),
            ],
            options={
                'abstract': False,
            },
