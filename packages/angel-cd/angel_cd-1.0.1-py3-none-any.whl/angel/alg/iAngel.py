...
class Angel(object):
    ...
    def execute(self):
        ...
        for ego in tqdm.tqdm(list(range(0, self.total_nodes)), ncols=35, bar_format='Exec: {l_bar}{bar}', disable=not self.verbose):
        ...
        cms = {}
        idc = 0
        for c in list(self.all_communities.values()):
