...
class ArchAngel(object):
    ...
    def __tpr_match(self, fr, to):
        ...
        # From past to future
        node_to_com_to = {n: cid for cid, nlist in list(community_to_nodes_to.items()) for n in nlist}
        ...
        for c in community_to_nodes_from:
            ...
            if len(most_common_coms) > 0:
                ...
                if similarity >= self.match_threshold:
                    for cf in list(most_common_coms.keys()):
        ...
        # From future to past
        node_to_com_from = {n: cid for cid, nlist in list(community_to_nodes_from.items()) for n in nlist}
