...
RESULTS = [
    ...
    (73, 8, 'P667 Invalid value "wrong" of the "testSteps" field'),
    (74, 8, 'P667 Invalid value "" of the "expectedResults" field'),
    ...
    (43, 12, 'P664 Ignoring field "description": use test docstring instead'),
]
