...
class PredictionExplanations(APIObject):
    ...
    def __init__(self, id, project_id, model_id, dataset_id, max_explanations, num_columns,
                 finish_time, prediction_explanations_location, threshold_low=None,
                 threshold_high=None):
        self.project_id = project_id
        self.model_id = model_id
    ...
    def create(cls, project_id, model_id, dataset_id,
               max_explanations=None, threshold_low=None, threshold_high=None):
        """
    ...
    def get_all_as_dataframe(self, exclude_adjusted_predictions=True):
        ...
        rows = self.get_rows(batch_size=1,
                             exclude_adjusted_predictions=exclude_adjusted_predictions)
        first_row = next(rows)
        ...
        for i in range(self.max_explanations):
            columns.extend(['explanation_{}_feature'.format(i),
    ...
    def get_prediction_explanations_page(self, limit=None, offset=None,
...
class PredictionExplanationsRow(object):
    ...
    * ``qualitative_strength`` : a human-readable description of how strongly the feature
    ...
    """
    def __init__(self, row_id, prediction, prediction_values, prediction_explanations=None,
                 adjusted_prediction=None, adjusted_prediction_values=None):
        self.row_id = row_id
...
class PredictionExplanationsPage(APIObject):
    ...
    def __init__(self, id, count=None, previous=None, next=None, data=None,
                 prediction_explanations_record_location=None, adjustment_method=None):
        self.id = id
        self.count = count
    ...
    @classmethod
    def get(cls, project_id, prediction_explanations_id, limit=None, offset=0,
            exclude_adjusted_predictions=True):
        """
