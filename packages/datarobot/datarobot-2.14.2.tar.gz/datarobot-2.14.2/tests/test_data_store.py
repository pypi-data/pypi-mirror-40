...
def test_get_access_list(data_stores_endpoint, postgresql_data_store_server_resp,
                         extra_keys):
    ...
    responses.add(responses.GET, '{}{}/accessControl/'.format(data_stores_endpoint, data_store.id),
                  json=access_list)
...
def test_share_with_grant(data_stores_endpoint, postgresql_data_store_server_resp):
    ...
    data_store.share([SharingAccess('me@datarobot.com', 'EDITOR', can_share=True),
