...
@responses.activate
@pytest.mark.usefixtures('client')
def test_set_target_with_cross_series(datetime_partition_spec_with_cross_series, holdout_start_date,
                                      project_with_target_json, project_without_target,
                                      unittest_endpoint, project_id):
    project_url = '{}/projects/{}/'.format(unittest_endpoint, project_id)
    aim_url = project_url + 'aim/'
    ...
    expected_backtests = [{
        ...
        'validationStartDate': bt.validation_start_date.isoformat(),
        'validationDuration': bt.validation_duration
    } for bt in datetime_partition_spec_with_cross_series.backtests]

    expected_payload = {
        'datetimePartitionColumn':
            datetime_partition_spec_with_cross_series.datetime_partition_column,
        'useTimeSeries': datetime_partition_spec_with_cross_series.use_time_series,
        'defaultToKnownInAdvance':
            datetime_partition_spec_with_cross_series.default_to_known_in_advance,
        'autopilotDataSelectionMethod':
            datetime_partition_spec_with_cross_series.autopilot_data_selection_method,
        'validationDuration': datetime_partition_spec_with_cross_series.validation_duration,
        'holdoutStartDate': holdout_start_date.isoformat(),
        'holdoutDuration': datetime_partition_spec_with_cross_series.holdout_duration,
        'gapDuration': datetime_partition_spec_with_cross_series.gap_duration,
        'numberOfBacktests': datetime_partition_spec_with_cross_series.number_of_backtests,
        'backtests': expected_backtests,
        'cvMethod': 'datetime',
        'target': 'target',
        'mode': 'auto',
    ...
    project_without_target.set_target('target',
                                      partitioning_method=datetime_partition_spec_with_cross_series)
