...
@pytest.fixture
def datetime_partition_spec_with_cross_series(datetime_partition_spec):
    spec = datetime_partition_spec
    spec.use_cross_series_features = True
    spec.aggregation_type = 'total'
...
def datetime_partition_spec_feature_settings(
    ...
    return DatetimePartitioningSpecification(
        ...
        feature_settings=[FeatureSettings(fs['featureName'], fs['knownInAdvance'])
