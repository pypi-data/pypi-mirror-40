...
from datarobot.enums import (CV_METHOD, DEFAULT_MAX_WAIT, PERIODICITY_MAX_TIME_STEP,
                             PERIODICITY_TIME_UNITS, TREAT_AS_EXPONENTIAL, DIFFERENCING_METHOD)
from datarobot.errors import InvalidUsageError
from datarobot.utils import from_api, parse_time, deprecated, deprecation_warning
...
_periodicity_converter = t.Dict({
    ...
    t.Key('time_unit'): t.Enum(
        PERIODICITY_TIME_UNITS.SECOND,
        PERIODICITY_TIME_UNITS.MINUTE,
        PERIODICITY_TIME_UNITS.HOUR,
        PERIODICITY_TIME_UNITS.DAY,
        PERIODICITY_TIME_UNITS.WEEK,
        PERIODICITY_TIME_UNITS.MONTH,
        PERIODICITY_TIME_UNITS.QUARTER,
        PERIODICITY_TIME_UNITS.YEAR
    )
}).ignore_extra('*')
...
_feature_settings_converter = t.Dict({
    ...
    t.Key('a_priori', optional=True, default=False): t.Bool(),
    t.Key('known_in_advance', optional=True, default=False): t.Bool()
}).ignore_extra('*')
...
class FeatureSettings(object):
    ...
    feature_name : string
        name of the feature
    a_priori : bool
        (Deprecated in v2.11) Optional, renamed to `known_in_advance`, see below for more detail.
    known_in_advance : bool
        (New in version v2.11) Optional, whether the feature is
        known in advance, i.e. expected to be known for dates in the future at prediction time.
        Features that don't have a feature setting specifying whether they are known in advance use
        the value from the `default_to_known_in_advance` flag.
    """
    def __init__(self, feature_name, known_in_advance=False, a_priori=None):
        # Some users could still use a_priori in 2.11 after upgrade from 2.9
        if a_priori is None:
            a_priori = False
        else:
            deprecation_warning(
                'a_priori',
                deprecated_since_version='v2.11',
                will_remove_version='v2.13',
                message='Use known_in_advance instead.'
            )
        ...
        self.known_in_advance = known_in_advance or a_priori

    @classmethod
    def from_server_data(cls, feature_name, known_in_advance=False, a_priori=False):
        return cls(feature_name, known_in_advance=known_in_advance or a_priori)
    ...
    @property
    @deprecated(deprecated_since_version='v2.11', will_remove_version='v2.13',
                message='Use known_in_advance instead.')
    def a_priori(self):
        return self.known_in_advance

    def __eq__(self, other):
        return (self.feature_name == other.feature_name and
                self.known_in_advance == other.known_in_advance)

    def __repr__(self):
        return 'FeatureSettings(feature_name=\'{}\', known_in_advance={})'.format(
            self.feature_name, self.known_in_advance)
...
class DatetimePartitioningSpecification(PartitioningMethod):
    ...
    default_to_a_priori : bool
        (Deprecated in version v2.11) Optional, renamed to `default_to_known_in_advance`,
        see below for more detail.
    default_to_known_in_advance : bool
        (New in version v2.11) Optional, only used for time series projects. Whether to default
        to treating features as known in advance. If not specified, defaults to False.
        Known in advance features are expected to be known for dates in the future
        when making predictions, e.g. "is this a holiday".
    ...
    periodicities : list of Periodicity, optional
        (New in version v2.9) a list of :py:class:`datarobot.Periodicity`
    ...
    def __init__(self, datetime_partition_column, autopilot_data_selection_method=None,
                 ...
                 use_time_series=False, default_to_a_priori=False,
                 default_to_known_in_advance=False, feature_derivation_window_start=None,
                 feature_derivation_window_end=None, feature_settings=None,
                 forecast_window_start=None, forecast_window_end=None, treat_as_exponential=None,
        ...
        self.default_to_known_in_advance = default_to_known_in_advance or default_to_a_priori
    ...
    @property
    @deprecated(deprecated_since_version='v2.11', will_remove_version='v2.13',
                message='Use default_to_known_in_advance instead.')
    def default_to_a_priori(self):
        return self.default_to_known_in_advance
...
class DatetimePartitioning(object):
    ...
    use_time_series : bool
        ...
        project.
    default_to_a_priori : bool
        (Deprecated in version v2.11) Optional, renamed to `defaultToKnownInAdvance`,
        see below for more detail.
    default_to_a_priori : bool
        (Deprecated in version v2.11) Optional, renamed to `default_to_known_in_advance`,
        see below for more detail.
    ...
    periodicities : list of Periodicity, optional
        ...
        :py:class:`datarobot.Periodicity`
    multiseries_id_columns : list of str or null
        (New in version v2.11) a list of the names of multiseries id columns to define series
        within the training data.  Currently only one multiseries id column is supported.
    """
    ...
    _converter = t.Dict({
        ...
        t.Key('default_to_a_priori', optional=True, default=False): t.Bool(),
