...
class ArtifactOperations(object):
    ...
    def list_in_container(
        ...
        return deserialized
    list_in_container.metadata = {'url': '/artifact/v2.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/artifacts/origins/{origin}/containers/{container}'}
    ...
    def list_in_path(
        ...
        return deserialized
    list_in_path.metadata = {'url': '/artifact/v2.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/artifacts/origins/{origin}/containers/{container}/{path}'}
