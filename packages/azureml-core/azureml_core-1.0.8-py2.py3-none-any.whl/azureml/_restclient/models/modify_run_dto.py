...
class ModifyRunDto(Model):
    ...
    def __init__(self, name=None, description=None, hidden=None, run_type=None, properties=None, script_name=None, target=None, tags=None, data_container_id=None):
        super(ModifyRunDto, self).__init__()
        self.name = name
