...
class AbstractAzureStorageDatastore(AbstractDatastore):
    """
    Azure Storage Container datastore class. You should only create this class by calling Datastore() or
    Datastore.register*.
    """
    ...
    def download(self, target_path, prefix=None, overwrite=False, show_progress=True):
        """
        Downloads paths with prefix to target_path
        :param target_path:
        :param prefix:
        :param overwrite:
        :param show_progress:
    ...
    def upload(self, src_dir, target_path=None, overwrite=False, show_progress=True):
        """
        Uploads src_dir to target_path
        :param src_dir:
        :param target_path:
        :param overwrite:
        :param show_progress:
...
class AzureFileDatastore(AbstractAzureStorageDatastore):
    ...
    def __init__(self, workspace, name, container_name, account_name, sas_token=None,
        ...
        """
        Initializes a new Azure File Share Datastore
    ...
    def download(self, target_path, prefix=None, overwrite=False, show_progress=True):
        """
        Downloads the data from the file share to the local file system

        :param target_path: the local directory to download the file to
        :type target_path: str
        :param prefix: path to the folder in the file share to
        download. If set to None, will download everything in the file share
        defaults to None
    ...
    def upload(self, src_dir, target_path=None, overwrite=False, show_progress=True):
        """
        Uploads the data from the local file system to the file share this datastore points to

        :param src_dir: the local directory to upload
        :type src_dir: str
        :param target_path: the location in file share to upload to, if
        None then upload to root, defaults to None
        :type target_path: str
        :param overwrite: overwrite existing file, defaults to False
        :type overwrite: bool, optional
...
class AzureBlobDatastore(AbstractAzureStorageDatastore):
    ...
    def __init__(self, workspace, name, container_name, account_name, sas_token=None,
                 account_key=None, protocol=None, endpoint=None, request_session=None):
        """
        Initializes a new Azure Blob Datastore
    ...
    def download(self, target_path, prefix=None, overwrite=False, show_progress=True):
        """
        Downloads the data from the blob container to the local file system

        :param target_path: the local directory to download the file to
        :type target_path: str
        :param prefix: path to the folder in the blob container to
        download. If set to None, will download everything in the blob
        defaults to None
        :type prefix: str, optional
        :param overwrite: overwrite existing file, defaults to False
        :type overwrite: bool, optional
    ...
    def upload(self, src_dir, target_path=None, overwrite=False, show_progress=True):
        """
        Uploads the data from the local file system to blob container this data
        store points to

        :param src_dir: the local directory to upload
        :type src_dir: str
        :param target_path: the location in blob container to upload to, if
        None then upload to root, defaults to None
        :type target_path: str
        :param overwrite: overwrite existing file, defaults to False
        :type overwrite: bool, optional
    ...
    def upload_files(self, files, relative_root=None, target_path=None, overwrite=False, show_progress=True):
        """
        Uploads the data from the local file system to the blob container this datastore points to
