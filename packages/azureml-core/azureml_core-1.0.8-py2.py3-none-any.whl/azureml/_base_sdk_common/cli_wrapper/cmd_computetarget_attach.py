...
def attach_remote(name, address, ssh_port, username, password='', private_key_file='',
    ...
    attach_config = RemoteCompute.attach_configuration(username, address, ssh_port, password, private_key_file,
...
def attach_hdi(name, address, ssh_port, username, password='', private_key_file='',
    ...
    attach_config = HDInsightCompute.attach_configuration(username, address, ssh_port, password, private_key_file,
                                                          private_key_passphrase)
    ComputeTarget.attach(workspace, name, attach_config)
