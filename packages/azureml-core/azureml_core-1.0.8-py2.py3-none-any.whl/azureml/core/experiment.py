...
class Experiment(ChainedIdentity, HasExperimentPortal):
    ...
    .. remarks::
        ...
        There are two ways to execute an experiment trial.  If you are interactively experimenting in a notebook,
        use  :func:`start_logging`   If you are submitting an experiment from source code or some other type
        of configured trial, use func:`submit`
    ...
    def submit(self, config, tags=None, **kwargs):
        ...
        .. remarks::
            ...
            Submit is an asynchronous call to the AzureML platform to execute a trial on local
            ...
            An example of how to submit an experiment from your local machine is here:
        ...
        :type config: object
        :param tags: Tags to be added to the submitted run
        :type tags: dict
        :param kwargs:
        :type kwargs: list
        :return: run
    ...
    def start_logging(self, *args, **kwargs):
        ...
        .. remarks::
            ...
            **start_logging** creates an interactive run for use in scenarios such as notebooks.
            Any metrics that are logged during the session are added to the run record in the experiment.
            If an outputs directory is specified, the contents of that directory are uploaded as run
    ...
    def from_directory(path, auth=None):
        """
        DEPRECATED
        Load an experiment from the specified path.
        ...
        info_dict = _commands.get_project_info(None, path)
    ...
    def get_runs(self, type=None, tags=None, properties=None, include_children=False):
        """
        Return the list of runs for this experiment.

        :param type: Filter the returned list of runs by the provided type
        :type type: string
    ...
    def list(workspace):
        ...
        :rtype: list[azureml.core.Experiment]
        """
    ...
    def get_docs_url(cls):
        """
        The url to the documentation for this class
