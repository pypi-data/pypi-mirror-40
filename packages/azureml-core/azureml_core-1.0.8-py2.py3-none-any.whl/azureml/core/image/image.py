...
class Image(ABC):
    """
    Abstract parent class for AzureML images.
    ...
    :type name: str
    :param id: The specific ID of the image to retrieve
    :type id: str
    ...
    :param version: When specified with name, will return the specific version of the image
    :type version: str
    """
    ...
    def _initialize(self, workspace, obj_dict):
        ...
        self.id = obj_dict['id']
        self.image_build_log_uri = obj_dict['imageBuildLogUri'] if 'imageBuildLogUri' in obj_dict else None
        self.image_flavor = obj_dict['imageFlavor'] if 'imageFlavor' in obj_dict else None
