...
# ---------------------------------------------------------
"""Manages Datafactory Compute Targets in Azure ML"""
...
class DataFactoryCompute(ComputeTarget):
    """
    Manages DataFactory target objects.
    """
    ...
    def delete(self):
        """
        Removes the Datafactory object from its associated workspace.
    ...
    def detach(self):
        """
        Detaches the Datafactory object from its associated workspace. No underlying cloud object will be deleted, the
...
class DataFactoryAttachConfiguration(ComputeTargetAttachConfiguration):
    """
    Attach configuration object for DataFactory compute targets. This objects is used to define the configuration
    parameters for attaching DataFactoryCompute objects.
