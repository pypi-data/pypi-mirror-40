...
# ---------------------------------------------------------
"""Manages DSVM Compute Targets in Azure ML"""
...
class DsvmCompute(ComputeTarget):
    ...
    def delete(self):
        """
        Removes the DSVM object from its associated workspace.
    ...
    def deserialize(workspace, object_dict):
        """
        Convert a json object into a DsvmCompute object. Will fail if the provided workspace is not the
...
class DsvmProvisioningConfiguration(ComputeTargetProvisioningConfiguration):
    """
    Provisioning configuration object for DSVM compute targets. This object is used to
    define the configuration parameters for provisioning DsvmCompute objects.
