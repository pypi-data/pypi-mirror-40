...
# ---------------------------------------------------------
"""Manages Databricks Compute Targets in Azure ML"""
...
class DatabricksCompute(ComputeTarget):
    """
    Manages Databricks target objects.
    """
...
class DatabricksAttachConfiguration(ComputeTargetAttachConfiguration):
    """
    Attach configuration object for Databricks compute targets. This objects is used to define the configuration
    parameters for attaching DatabricksCompute objects.
