...
# ---------------------------------------------------------
"""Manages Remote Compute Targets in Azure ML"""
...
class RemoteCompute(ComputeTarget):
    """
    Manages RemoteCompute target objects.
    """
    ...
    def detach(self):
        """
        Detaches the RemoteCompute object from its associated workspace.
...
class RemoteComputeAttachConfiguration(ComputeTargetAttachConfiguration):
    """
    Attach configuration object for Remote compute targets. This objects is used to define the configuration
    parameters for attaching RemoteCompute objects.
