...
The Azure Machine Learning Workspace provides multiple functionalities including
    Serves as container for Azure ML assets.
    Provides ACLIng mechanism using ARM RBAC.
    Provides region affinity to all ML data saved with-in the workspace.
    Provides the means for billing.
"""
...
class Workspace(object):
    ...
    def __init__(self, subscription_id, resource_group, workspace_name, auth=None, _location=None,
        ...
        """
        The constructor loads an existing Azure ML Workspace.
    ...
    def from_config(path=None, auth=None):
        """
        Returns a workspace object for an existing Azure ML Workspace by reading workspace configs from a config file.
    ...
    def create(name, auth=None, subscription_id=None, resource_group=None,
        ...
        """
        Creates a new Azure Machine Learning Workspace. Throws an exception if the workspace already exists or
        any of the workspace requirement are not satisfied.
    ...
    def get(name, auth=None, subscription_id=None, resource_group=None):
        ...
        Throws an exception if the workspace doesn't exist or the required fields
        doesn't leads to a uniquely identifiable workspace.
    ...
    def _get_or_create(name, auth=None, subscription_id=None, resource_group=None,
        ...
        """
        Gets or creates a workspace if it doesn't exist. Throws an exception if the required
    ...
    def list(subscription_id, auth=None, resource_group=None):
        """
        Lists all workspaces that the user has access to in the subscription. The list of workspaces can be
        filtered based on the resource group.
        ...
        :type resource_group: str
        :return: A dictionary, where a key is a workspace name, and the value is the list of
        workspaces with that name.
        :rtype: dict
        """
        if not auth:
            auth = InteractiveLoginAuthentication()
    ...
    def write_config(self, path=None, file_name=None):
        """
        Writes out the Workspace ARM properties to a config file, from which it can be loaded later using from_config.
        The path defaults to the current working directory and file_name defaults to 'config.json'.
    ...
    def subscription_id(self):
        """
        Returns the subscription id for this workspace.
    ...
    def resource_group(self):
        """
        Returns the resource group name for this workspace.
    ...
    def location(self):
        """
        Returns the location of this workspace.
    ...
    def delete(self, delete_dependent_resources=False):
        """
        Deletes the workspace azure resource.
    ...
    def get_details(self):
        """
        Returns details of this workspace.
    ...
    def _get_create_status_dict(self):
        """
        Returns the create status in dict format.
    ...
    def _get_scope_details(workspace_arm_scope):
        """
        Parses the arm scope of a workspace and returns
        WorkspaceScopeInfo tuple.
    ...
    def _process_autorest_workspace_list(auth, workspace_autorest_list, result_dict):
        """
        Process a list of workspaces returned by the autorest client
        and adds those to result_dict, where a key is a workspace name, value is
    ...
    def _to_dict(self):
        """
        Serializes this workspace information into a dictionary.
    ...
    def datastores(self):
        ...
        :return: Dict with keys as datastore name and value as datastore within the workspace
    ...
    def experiments(self):
        """
        Lists all experiments in the workspace.

        :return: Dict of experiments in the workspace
    ...
    def images(self):
        """
        Returns a list of images that fit the filtering criteria
    ...
    def models(self):
        """
        Returns a list of models that fit the filtering criteria
    ...
    def webservices(self):
        """
        Returns a list of webservices that fit the filtering criteria
    ...
    def _fetch_subscription(auth):
        """
        Gets all subscriptions a user has access to, and if a user
        has access to only one subscription than that is returned, otherwise
