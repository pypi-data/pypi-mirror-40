...
public:
  ...
  ctre::phoenix::ErrorCode destroy() {
    
    auto __ret = c_MotController_Destroy(m_handle );
    return __ret;
  }
  ...
  int getActiveTrajectoryPosition_3(int pidIdx) {
    int param;
  ...
  int getActiveTrajectoryVelocity_3(int pidIdx) {
    int param;
  ...
  double getActiveTrajectoryArbFeedFwd_3(int pidIdx) {
    double param;
  ...
  std::tuple<int, int, double> getActiveTrajectoryAll_5(int pidIdx) {
  ...
  ctre::phoenix::ErrorCode pushMotionProfileTrajectory_3(double position, double velocity, double arbFeedFwd, double auxiliaryPos, double auxiliaryVel, double auxiliaryArbFeedFwd, uint32_t profileSlotSelect0, uint32_t profileSlotSelect1, bool isLastPoint, bool zeroPos0, uint32_t timeDur, bool useAuxPID) {
