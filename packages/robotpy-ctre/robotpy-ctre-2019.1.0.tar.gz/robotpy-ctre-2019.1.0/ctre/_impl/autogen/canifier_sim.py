...
class CANifier:
    ...
    def setQuadraturePosition(self, pos: int, timeoutMs: int = 0) -> ErrorCode:
    ...
    def getQuadratureSensor(self) -> typing.Tuple[int, int]:
        raise NotImplementedError("getQuadratureSensor not implemented in simulation (file a bug on github if you need it)")
    ...
    def configVelocityMeasurementWindow(self, window: int, timeoutMs: int = 0) -> ErrorCode:
    ...
    def configClearPositionOnLimitF(self, clearPositionOnLimitF: bool, timeoutMs: int = 0) -> ErrorCode:
        ...
        assert isinstance(timeoutMs, int)
        retval = ErrorCode.OK
        raise NotImplementedError("configClearPositionOnLimitF not implemented in simulation (file a bug on github if you need it)")
    ...
    def configClearPositionOnLimitR(self, clearPositionOnLimitR: bool, timeoutMs: int = 0) -> ErrorCode:
        ...
        assert isinstance(timeoutMs, int)
        retval = ErrorCode.OK
        raise NotImplementedError("configClearPositionOnLimitR not implemented in simulation (file a bug on github if you need it)")
