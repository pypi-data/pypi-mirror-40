...
class MotController:
    ...
    def configForwardLimitSwitchSource(self, type: int, normalOpenOrClose: int, deviceID: int, timeoutMs: int = 0) -> ErrorCode:
    ...
    def configReverseLimitSwitchSource(self, type: int, normalOpenOrClose: int, deviceID: int, timeoutMs: int = 0) -> ErrorCode:
    ...
    def startMotionProfile(self, stream: "BufferedTrajectoryPointStream", minBufferedPts: int, controlMode: ControlMode) -> ErrorCode:
        ...
        '''
        assert isinstance(minBufferedPts, int) and minBufferedPts < 4294967296 and minBufferedPts >= 0
        retval = ErrorCode.OK
