...
class SmartBook(dict):
    """Create a dictionary that represents values with units of measure and alerts when setting an item out of bounds. If `inclusive` pairs are not given for a key in `bounds`, the SmartBook assumes bounds are inclusive.
    ...
    **Parameters**
        ...
        **inclusive:** [dict] Dictionary of (lblim, ublim) value pairs where [-]:
    ...
    **Examples**
    ...
    SmartBook objects assume bounds are inclusive, but may be set otherwise through the *inclusive* argument.
        ...
        Create SmarBook object excluding bounds, with value at lower bound limit:
    ...
    def __init__(self, units={}, bounds={}, *args,
        ...
        self._bounds = bounds
        self._source = source
        self.inclusive = inclusive #: Dictionary of (lblim, ublim) value pairs
        super().__init__(*args, **kwargs)
        
        # Make sure bounds are arrays
    ...
    def boundscheck(self, key, value, units=None):
        """Issue RuntimeWarning if value is out of bounds."""
        Q_ = self.Quantity
        ...
        if bounds is not None:
            ...
            if inclusive:
                ...
                lbcheck = lb.__lt__ if lb_include else lb.__le__
                ubcheck = ub.__gt__ if ub_include else ub.__le__
            else:
                lbcheck = lb.__lt__
                ubcheck = ub.__gt__
