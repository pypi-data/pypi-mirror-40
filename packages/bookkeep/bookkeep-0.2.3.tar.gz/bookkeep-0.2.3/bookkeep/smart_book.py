...
class SmartBook(dict):
    ...
    **Examples**
    ...
    SmartBook objects provide an easy way to keep track of units of measure and enforce bounds. The units attribute is a :doc:`UnitManager` object which can change the units of the SmartBook object.
