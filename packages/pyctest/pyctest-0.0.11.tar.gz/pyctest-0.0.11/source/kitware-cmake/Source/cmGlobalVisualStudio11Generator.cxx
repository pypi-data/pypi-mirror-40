...
static const char*
cmVS11GenName(const std::string& name, std::string& genName)
{
...
class cmGlobalVisualStudio11Generator::Factory : public cmGlobalGeneratorFactory
{
public:
...
bool
cmGlobalVisualStudio11Generator::InitializeWindowsPhone(cmMakefile* mf)
{
    if(!this->SelectWindowsPhoneToolset(this->DefaultPlatformToolset))
    {
        ...
        {
            e << "A Windows Phone component with CMake requires both the "
                 "Windows "
...
cmGlobalVisualStudio11Generator::InitializeWindowsStore(cmMakefile* mf)
{
    if(!this->SelectWindowsStoreToolset(this->DefaultPlatformToolset))
    {
        ...
        {
            e << "A Windows Store component with CMake requires both the "
                 "Windows "
...
bool
cmGlobalVisualStudio11Generator::UseFolderProperty()
{
...
bool
cmGlobalVisualStudio11Generator::NeedsDeploy(
