...
static const char*
cmVS12GenName(const std::string& name, std::string& genName)
{
...
class cmGlobalVisualStudio12Generator::Factory : public cmGlobalGeneratorFactory
{
public:
...
bool
cmGlobalVisualStudio12Generator::InitializeWindowsPhone(cmMakefile* mf)
{
