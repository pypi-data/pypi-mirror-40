static cmVS7FlagTable cmVS140LinkFlagTable[] = {
    ...
    { "GenerateDebugInformation", "DEBUG:FULL", "Optimize for debugging",
      "true", cmVS7FlagTable::CaseInsensitive },
    ...
    { "LinkTimeCodeGeneration", "LTCG:incremental",
      "Use Fast Link Time Code Generation", "UseFastLinkTimeCodeGeneration",
      0 },
    ...
    { "WindowsMetadataSignHash", "WINMDSIGNHASH:SHA256", "SHA256", "SHA256",
      0 },
    { "WindowsMetadataSignHash", "WINMDSIGNHASH:SHA384", "SHA384", "SHA384",
      0 },
    { "WindowsMetadataSignHash", "WINMDSIGNHASH:SHA512", "SHA512", "SHA512",
      0 },
    ...
    { "WindowsMetadataLinkKeyFile", "WINMDKEYFILE:",
      "Windows Metadata Key File", "", cmVS7FlagTable::UserValue },
