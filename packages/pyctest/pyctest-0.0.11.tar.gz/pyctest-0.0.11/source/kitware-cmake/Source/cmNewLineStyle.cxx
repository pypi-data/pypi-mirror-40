...
bool
cmNewLineStyle::ReadFromArguments(const std::vector<std::string>& args,
...
const std::string
cmNewLineStyle::GetCharacters() const
{
    switch(NewLineStyle)
    {
        case Invalid:
...
void
cmNewLineStyle::SetStyle(Style style)
{
    NewLineStyle = style;
}

cmNewLineStyle::Style
cmNewLineStyle::GetStyle() const
{
    return NewLineStyle;
}
