...
void
cmGlobalWatcomWMakeGenerator::EnableLanguage(std::vector<std::string> const& l,
...
void
cmGlobalWatcomWMakeGenerator::GetDocumentation(cmDocumentationEntry& entry)
{
...
void
cmGlobalWatcomWMakeGenerator::PrintBuildCommandAdvice(std::ostream& os,
                                                      int           jobs) const
{
