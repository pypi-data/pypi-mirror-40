...
void
cmGlobalBorlandMakefileGenerator::EnableLanguage(
...
void
cmGlobalBorlandMakefileGenerator::GetDocumentation(cmDocumentationEntry& entry)
{
...
void
cmGlobalBorlandMakefileGenerator::PrintBuildCommandAdvice(std::ostream& os,
                                                          int jobs) const
{
