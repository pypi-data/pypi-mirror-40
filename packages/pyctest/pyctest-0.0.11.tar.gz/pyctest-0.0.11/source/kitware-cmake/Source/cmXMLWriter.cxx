...
void
cmXMLWriter::StartElement(std::string const& name)
{
...
void
cmXMLWriter::Element(const char* name)
{
    this->CloseStartElement();
    this->ConditionalLineBreak(!this->IsContent);
    this->Output << '<' << name << "/>";
...
void
cmXMLWriter::BreakAttributes()
{
    this->BreakAttrib = true;
}

void
cmXMLWriter::Comment(const char* comment)
{
    this->CloseStartElement();
    this->ConditionalLineBreak(!this->IsContent);
    this->Output << "<!-- " << comment << " -->";
...
void
cmXMLWriter::CData(std::string const& data)
{
    this->PreContent();
...
void
cmXMLWriter::Doctype(const char* doctype)
{
    this->CloseStartElement();
    this->ConditionalLineBreak(!this->IsContent);
...
void
cmXMLWriter::ProcessingInstruction(const char* target, const char* data)
{
    this->CloseStartElement();
    this->ConditionalLineBreak(!this->IsContent);
...
void
cmXMLWriter::FragmentFile(const char* fname)
{
    this->CloseStartElement();
...
void
cmXMLWriter::SetIndentationElement(std::string const& element)
{
    this->IndentationElement = element;
}

void
cmXMLWriter::ConditionalLineBreak(bool condition)
{
    if(condition)
    {
        this->Output << '\n';
