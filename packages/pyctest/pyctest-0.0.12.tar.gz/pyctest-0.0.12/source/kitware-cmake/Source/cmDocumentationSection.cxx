...
void
cmDocumentationSection::Append(const char* data[][2])
{
    int i = 0;
    while(data[i][1])
    {
...
void
cmDocumentationSection::Prepend(const char* data[][2])
{
...
void
cmDocumentationSection::Append(const char* n, const char* b)
{
