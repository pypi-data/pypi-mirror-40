...
void
cmComputeLinkDepends::SetOldLinkDirMode(bool b)
{
...
cmComputeLinkDepends::Compute()
{
        ...
        li != le; ++li)
    {
        ...
        // Entries that we know the linker will re-use do not need to be
        // repeated.
...
int
cmComputeLinkDepends::AddLinkEntry(cmLinkItem const& item)
{
...
void
cmComputeLinkDepends::FollowLinkEntry(BFSEntry qe)
{
...
void
cmComputeLinkDepends::FollowSharedDeps(int                    depender_index,
...
void
cmComputeLinkDepends::AddVarLinkEntries(int depender_index, const char* value)
{
    ...
    for(std::string const& d : deplist)
    {
        ...
        } else if(!d.empty())
        {
            ...
            {
                actual_libs.emplace_back(
                    this->ResolveLinkItem(depender_index, d));
...
void
cmComputeLinkDepends::DisplayConstraintGraph()
{
...
void
cmComputeLinkDepends::OrderLinkEntires()
{
...
void
cmComputeLinkDepends::VisitEntry(int index)
{
...
int
cmComputeLinkDepends::ComputeComponentCount(NodeList const& nl)
{
...
void
cmComputeLinkDepends::DisplayFinalEntries()
{
...
void
cmComputeLinkDepends::CheckWrongConfigItem(cmLinkItem const& item)
{
