...
void
cmGlobalNMakeMakefileGenerator::EnableLanguage(
...
void
cmGlobalNMakeMakefileGenerator::GetDocumentation(cmDocumentationEntry& entry)
{
...
void
cmGlobalNMakeMakefileGenerator::PrintCompilerAdvice(std::ostream&      os,
...
void
cmGlobalNMakeMakefileGenerator::PrintBuildCommandAdvice(std::ostream& os,
                                                        int jobs) const
{
