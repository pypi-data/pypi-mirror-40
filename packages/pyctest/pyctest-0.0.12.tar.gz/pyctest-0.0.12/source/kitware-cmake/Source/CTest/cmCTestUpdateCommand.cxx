...
cmCTestUpdateCommand::InitializeHandler()
{
    ...
    this->CTest->SetCTestConfigurationFromCMakeVariable(
        ...
        this->Quiet);
    this->CTest->SetCTestConfigurationFromCMakeVariable(
        this->Makefile, "GITUpdateCustom", "CTEST_GIT_UPDATE_CUSTOM",
        this->Quiet);
    this->CTest->SetCTestConfigurationFromCMakeVariable(
    ...
    this->CTest->SetCTestConfigurationFromCMakeVariable(
        this->Makefile, "HGUpdateOptions", "CTEST_HG_UPDATE_OPTIONS",
        this->Quiet);
    this->CTest->SetCTestConfigurationFromCMakeVariable(
        this->Makefile, "P4Command", "CTEST_P4_COMMAND", this->Quiet);
    this->CTest->SetCTestConfigurationFromCMakeVariable(
        this->Makefile, "P4UpdateOptions", "CTEST_P4_UPDATE_OPTIONS",
        this->Quiet);
    this->CTest->SetCTestConfigurationFromCMakeVariable(
    ...
    {
        this->SetError(
            "internal CTest error. Cannot instantiate update handler");
        return nullptr;
    }
