    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            if request.user.is_active:
                ...
                subject = 'Feedback.' + form.cleaned_data['subject'] + '=>' + file_name_hash
...
class PaymentNotificationView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            file_name_hash = hashlib.sha256(f_name.encode('utf-8')).hexdigest()
            subject = 'Сообщение об оплате.' + customer_name + '.' + sum + currency_abbr + '=>' + file_name_hash
        ...
        if request.POST:
            ...
            try:
                res = stem_feedback.utils.get_json_moneyback(feed_back_type, subject, message, doc_number, doc_date,
                       ...
                       reason_for_the_return, ship, tracking_number, orders)
