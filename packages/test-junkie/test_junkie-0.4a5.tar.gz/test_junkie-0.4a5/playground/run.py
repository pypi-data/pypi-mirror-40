...
from playground.suiteA import Login
from playground.suiteD import API
from test_junkie.runner import Runner

runner = Runner([Login], monitor_resources=True,
                html_report="E:\Development\\test_junkie\\playground\\report.html")

aggregator = runner.run(test_multithreading_limit=10, tag_config=[])
