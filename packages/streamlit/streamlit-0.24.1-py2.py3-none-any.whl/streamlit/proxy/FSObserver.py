...
class FSObserver(object):
    ...
    def get_key(connection):
        """Get a unique identifier for the file being observed.
    ...
    def __init__(self, connection, consumer_key, callback):
        """Constructor.
        ...
        self._consumers = set()
        self.register_consumer(consumer_key)
    ...
    def register_consumer(self, consumer_key):
        ...
        """
        self._consumers.add(consumer_key)
        LOGGER.debug(
            f'Registered consumers. Now have {len(self._consumers)}')

    def deregister_consumer(self, consumer_key):
        ...
        if consumer_key in self._consumers:
            self._consumers.remove(consumer_key)
