...
def main():
    ...
    elif args.linha == 'universidade' and args.saida in ['bairro', 'ufsm', 'campus', 'universidade'] and dia == 'sabado':
        getData(UFSM_CENTRO, SABADO, args.re, args.fv,  args.fn)
    elif args.linha == 'universidade' and args.saida in ['bairro', 'ufsm', 'campus', 'universidade'] and dia == 'domingo':
        getData(UFSM_CENTRO, DOMINGO, args.re, args.fv,  args.fn)

    elif args.linha == 'universidade' and args.saida == 'centro' and dia == 'util':
        getData(CENTRO_UFSM, DIAS_UTEIS, args.re, args.fv,  args.fn)
    elif args.linha == 'universidade' and args.saida == 'centro' and dia == 'sabado':
        getData(CENTRO_UFSM, SABADO, args.re, args.fv,  args.fn)
    elif args.linha == 'universidade' and args.saida == 'centro' and dia == 'domingo':
