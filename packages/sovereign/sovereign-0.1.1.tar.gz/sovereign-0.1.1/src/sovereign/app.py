...
def init_app():
    ...
    application.host = os.getenv('ENVOY_CONTROLPLANE_HOST', '0.0.0.0')
    application.port = int(os.getenv('ENVOY_CONTROLPLANE_PORT', '8080'))
    ...
    def add_logger():
        g.log = LOG.bind(
            ...
            env=os.getenv('ENVOY_CONTROLPLANE_ENVTYPE', 'local'),
