        ...
        try:
            ...
            if asset == 'E':
                ...
                if adj is not None:
                    ...
                    df['pct_chg'] = df['close'].pct_change(-1) * 100
                else:
                    data = df
            elif asset == 'I':
                if freq == 'D':
                ...
                if freq == 'D':
                    ...
                    print(data.shape, start_date, end_date)
            if asset == 'C':
                if freq == 'd':
                    freq = 'daily'
                elif freq == 'w':
...
#     df = pro_bar(ts_code='002398.SZ', pro_api=pro, adj='qfq', start_date='20120101')
#     df = pro_bar(ts_code='600862.SH', pro_api=pro, start_date='20150118', end_date='20150615', factors=['tor', 'vr'])
#     df = pro_bar(pro_api=pro, ts_code='000001.SZ', adj='hfq', start_date='20130501', end_date='20131001', freq='W')
    df = pro_bar(pro_api=pro, ts_code='510050.SH', start_date='20170101', end_date='20190103', asset='FD')
    print(df)
