...
class WatsonMachineLearningEngine:
    ...
    def _create_model(self, model_name, model_metadata_file):
        ...
        model_props = {
            ...
            self._client.repository.ModelMetaNames.TRAINING_DATA_REFERENCE: metadata['training_data_reference'][0],
            ...
            self._client.repository.ModelMetaNames.OUTPUT_DATA_SCHEMA: metadata['output_data_schema'],
            self._client.repository.ModelMetaNames.EVALUATION_METHOD: metadata['evaluation']['method'],
            self._client.repository.ModelMetaNames.EVALUATION_METRICS: metadata['evaluation']['metrics'],
