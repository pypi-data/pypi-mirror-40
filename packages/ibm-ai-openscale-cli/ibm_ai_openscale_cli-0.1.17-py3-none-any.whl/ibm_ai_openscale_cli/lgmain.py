...
from ibm_ai_openscale_cli.aios_client_lg import AIOSClientLG
...
def process_args():
    ...
    parser.add_argument('--lg_model', default='DrugSelectionModel', help='Default "DrugSelectionModel"', choices=['DrugSelectionModel','GermanCreditRiskModel'])
