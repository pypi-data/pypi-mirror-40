...
class Object(SignatureField):
    '''SIGNATURE object, used to specify limits/controls of input/output
    data from an API. see FOOTNOTE[1]'''
    ...
    def package(self, response):
        '''Converts member data into a dict to send back via the API,
