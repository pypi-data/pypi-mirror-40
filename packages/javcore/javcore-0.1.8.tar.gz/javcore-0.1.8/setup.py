...
setup(
    ...
    description='Scraping Jav Core',  # Optional
    ...
    # project.
    author='Juichi Hirao',  # Optional

    # This should be a valid email address corresponding to the author listed
    # above.
    author_email='hirao@theta-inc.co.jp',  # Optional
    ...
    install_requires=['javcore'],  # Optional
