def main():
    ...
    parser.add_argument('-b', '--output_encoding', default=getpreferredencoding(),
                        help="Encoding of the output file. Default value is system default.")
    # Model arguments
    parser.add_argument('-m', '--model', default='en_core_web_sm', help="spaCy model to use (e.g. 'es_core_news_md').")
    ...
    parser.add_argument('-c', '--include_headers', default=False, action="store_true",
