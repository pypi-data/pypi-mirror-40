...
def build_krunner_env():
    ...
    dockerfiles = [
        (base_path / fn, tag)
        for fn, tag in [
            ('python36.ubuntu1604.dockerfile', 'backendai-krunner-python:ubuntu16.04'),  # noqa
            ('env.ubuntu1604.dockerfile', 'backendai-krunner-env:ubuntu16.04'),
        ]
    ]
