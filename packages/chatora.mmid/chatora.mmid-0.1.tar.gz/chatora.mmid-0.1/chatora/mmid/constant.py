__all__ = (
    ...
    'EPOCH_TSNS_DIFF_BETWEEN_UUID1_AND_UNIX',
    'MAX_CLOCK_SEQ',
    'NODE_MASK',
    'UTC',
    'UUID_TS_DECIMAL_CTX',
...
EPOCH_TSNS_DIFF_BETWEEN_UUID1_AND_UNIX: int = EPOCH_TSNS100_DIFF_BETWEEN_UUID1_AND_UNIX * 100
...
UUID_TS_DECIMAL_CTX = decimal.Context(
    prec=decimal.DefaultContext.prec,
    rounding=decimal.ROUND_DOWN,
    traps=[
