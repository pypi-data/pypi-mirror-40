...
class Trainer:
    ...
    def __init__(self, project_name = None, model_function = None, db_url = None, db_name = None, models_table_name = None, data_host = None, transform_function = None, feature_dimension = None, sequence_length = None):
