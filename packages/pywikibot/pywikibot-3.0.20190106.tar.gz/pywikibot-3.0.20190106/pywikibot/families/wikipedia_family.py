...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'vi', 'ja', 'zh', 'pt', 'uk', 'ar', 'fa', 'sr', 'ca', 'no', 'fi', 'id',
        'sh', 'hu', 'ko', 'cs', 'ro', 'ms', 'tr', 'eu', 'eo', 'hy', 'bg', 'da',
        'he', 'sk', 'zh-min-nan', 'kk', 'min', 'ce', 'hr', 'lt', 'et', 'sl',
        'be', 'el', 'gl', 'ur', 'simple', 'nn', 'az', 'uz', 'la', 'hi', 'th',
        'ka', 'vo', 'ta', 'azb', 'cy', 'ast', 'mk', 'tg', 'mg', 'lv', 'oc',
        'tt', 'ky', 'bs', 'tl', 'sq', 'new', 'zh-yue', 'te', 'af', 'br',
        'be-tarask', 'pms', 'bn', 'ml', 'lb', 'jv', 'ht', 'sco', 'mr', 'ga',
        'sw', 'pnb', 'is', 'ba', 'my', 'cv', 'fy', 'nds', 'su', 'lmo', 'an',
        'yo', 'ne', 'pa', 'gu', 'io', 'bar', 'scn', 'als', 'bpy', 'kn', 'ku',
        'ckb', 'ia', 'qu', 'arz', 'mn', 'bat-smg', 'wuu', 'si', 'wa', 'gd',
        'nap', 'yi', 'or', 'am', 'bug', 'cdo', 'hsb', 'map-bms', 'mai', 'fo',
        'mzn', 'xmf', 'li', 'sah', 'eml', 'ilo', 'sa', 'vec', 'os', 'sd',
        'mrj', 'mhr', 'hif', 'ps', 'roa-tara', 'diq', 'hak', 'pam', 'bcl',
        'zh-classical', 'frr', 'nso', 'szl', 'ace', 'se', 'mi', 'km', 'nv',
        'nah', 'rue', 'nds-nl', 'vls', 'bh', 'gan', 'crh', 'sc', 'vep', 'bo',
        'glk', 'co', 'so', 'tk', 'fiu-vro', 'myv', 'lrc', 'kv', 'csb', 'as',
        'gv', 'zea', 'udm', 'ay', 'ie', 'pcd', 'sn', 'ug', 'nrm', 'stq', 'lez',
        'kw', 'lad', 'mwl', 'gn', 'gom', 'rm', 'lij', 'ab', 'koi', 'mt', 'fur',
        'frp', 'shn', 'haw', 'dsb', 'lo', 'lfn', 'ang', 'ln', 'dv', 'ext',
        'cbk-zam', 'dty', 'kab', 'ksh', 'olo', 'gag', 'ha', 'pi', 'pag', 'pfl',
        'av', 'bxr', 'xal', 'krc', 'pap', 'gor', 'bjn', 'kaa', 'za', 'pdc',
        'rw', 'tyv', 'to', 'kl', 'nov', 'jam', 'arc', 'kbd', 'tpi', 'kbp',
        'tet', 'ig', 'ki', 'na', 'jbo', 'lbe', 'roa-rup', 'ty', 'mdf', 'kg',
        'bi', 'wo', 'lg', 'srn', 'zu', 'tcy', 'chr', 'ltg', 'sm', 'inh', 'om',
        'xh', 'pih', 'cu', 'rmy', 'tw', 'bm', 'tn', 'atj', 'chy', 'rn', 'got',
        'ts', 'tum', 'ak', 'st', 'sat', 'ny', 'ch', 'pnt', 'ss', 'fj', 'ady',
