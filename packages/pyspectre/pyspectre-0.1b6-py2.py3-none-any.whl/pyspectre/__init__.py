...
__version__ = "0.1b6"  # this version is used as the definitive version for distribution
...
from .Pyspectre import set_spectre_binary, set_spectre_env, set_rcfile, run_batch
