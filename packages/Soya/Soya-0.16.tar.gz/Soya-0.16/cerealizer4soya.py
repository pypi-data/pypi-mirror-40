...
cerealizer.register_class(soya.VertexBufferedModel, SavedInAPathHandler(soya.VertexBufferedModel))
cerealizer.register_class(soya.CellShadingVertexBufferedModel, SavedInAPathHandler(soya.CellShadingVertexBufferedModel))
