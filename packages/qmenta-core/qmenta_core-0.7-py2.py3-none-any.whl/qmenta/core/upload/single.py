...
class SingleUpload():
    ...
    def __init__(self, auth, path, file_info, anonymise=True,
                 upload_index=-1):
        self.auth = auth
        self.path = path
        ...
        if os.path.isfile(self.path):
            ...
            self.input_filename = None  # to be set when zipping
    ...
    def _zip_directory(self):
        ...
        to_anonymise = self.status == UploadStatus.TO_ZIP_AND_ANONYMISE
    ...
    def _upload_file(self):
        ...
        fname = os.path.split(self.upload_filename)[1]
