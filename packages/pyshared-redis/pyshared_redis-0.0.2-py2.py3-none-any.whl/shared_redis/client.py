...
class RedisShardingClient:
    """
    python redis client for sharding requests to redis cluster.
    Provide set,expire and execute methods,and hash keys to match
    cluster nodes,process them in a pipeline.
    """
