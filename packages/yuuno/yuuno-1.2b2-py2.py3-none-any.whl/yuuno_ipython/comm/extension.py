...
class YuunoKernelCommExtension(Extension):
    ...
    def initialize(self):
        from yuuno_ipython.comm.comms import YuunoCommManager
        from yuuno_ipython.comm.output_mirror import OutputMirror
        from yuuno_ipython.comm.handlers import CommProtocolHandler
