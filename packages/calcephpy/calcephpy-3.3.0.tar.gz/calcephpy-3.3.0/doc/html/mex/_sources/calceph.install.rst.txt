...
.. ifconfig:: calcephapi in ('Python')
    ...
    If you use the python interface of the library,  it requires that numpy is already installed and the steps are :
...
A python interpreter, compliant at least with the Python 2.6 or Python 3.0  specifications, and Numpy are required to compile the python interface of the library.
