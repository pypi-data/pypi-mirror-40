...
* Note: I planed Aitla can be work with application server independently.
...
Atila parameters are comceptually seperated 3 groups: URL, query string and form data.
