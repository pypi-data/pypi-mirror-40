...
from tmg_etl_library.components.configClasses import BQTableConfig

from google.api_core.exceptions import NotFound
from google.cloud.bigquery.table import TimePartitioning, TimePartitioningType
from google.cloud.bigquery.job import ExtractJobConfig, CopyJobConfig, QueryJobConfig
...
class BQClient(Database):
    ...
    def run_query(self, query, destination=None, write_disposition=None, use_legacy_sql=False):
        """
        ...
        """
        if not query:
            raise Exception("Query should be provided.")
