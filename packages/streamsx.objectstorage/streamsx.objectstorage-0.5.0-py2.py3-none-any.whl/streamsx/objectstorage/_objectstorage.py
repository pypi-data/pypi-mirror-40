...
def scan(topology, bucket, pattern='.*', directory='/', endpoint='s3-api.us-geo.objectstorage.softlayer.net', credentials=None, vm_arg=None, name=None):
...
def read(stream, bucket, endpoint='s3-api.us-geo.objectstorage.softlayer.net', credentials=None, vm_arg=None, name=None):
...
def write(stream, bucket, object, endpoint='s3-api.us-geo.objectstorage.softlayer.net', time_per_object=10.0, credentials=None, vm_arg=None, name=None):
...
def write_parquet(stream, bucket, object, endpoint='s3-api.us-geo.objectstorage.softlayer.net', time_per_object=10.0, credentials=None, vm_arg=None, name=None):
