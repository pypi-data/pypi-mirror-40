...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputPeer, TypeInputGeoPoint, TypeMessagesFilter, TypeInputUser, TypeInputDocument, TypeSendMessageAction, TypeInputEncryptedChat, TypeBool, TypeInputBotInlineMessageID, TypeInputStickerSet, TypeInputMedia, TypeInputMessage, TypeInlineBotSwitchPM, TypeInputStickeredMedia, TypeInputDialogPeer, TypeReportReason, TypeInputEncryptedFile, TypeReplyMarkup, TypeShippingOption, TypeInputChatPhoto, TypeInputBotInlineResult, TypeMessageEntity, TypeInputSingleMedia
