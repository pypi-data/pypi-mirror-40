...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputChannel, TypeChannelAdminLogEventsFilter, TypeChannelBannedRights, TypeInputUser, TypeChannelParticipantsFilter, TypeInputChatPhoto, TypeInputStickerSet, TypeChannelAdminRights, TypeInputMessage, TypeBool
