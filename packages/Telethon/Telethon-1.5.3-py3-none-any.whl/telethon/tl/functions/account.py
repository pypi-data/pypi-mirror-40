...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputPeer, TypeSecureValueHash, TypeInputCheckPasswordSRP, TypeInputNotifyPeer, TypeSecureCredentialsEncrypted, TypeInputPrivacyRule, TypeAccountDaysTTL, TypeReportReason, TypeInputPeerNotifySettings, TypeSecureValueType, TypeInputSecureValue, TypeInputPrivacyKey, TypeBool
