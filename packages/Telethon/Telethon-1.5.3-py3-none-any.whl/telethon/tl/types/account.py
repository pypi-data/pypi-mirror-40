...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeSecurePasswordKdfAlgo, TypeSecureRequiredType, TypeAuthorization, TypeSecureValueError, TypeUser, TypeSecureSecretSettings, TypePasswordKdfAlgo, TypePrivacyRule, TypeWebAuthorization, TypeSecureValue
