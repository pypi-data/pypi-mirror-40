...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeUser, TypeChat, TypePeer, TypeContactBlocked, TypeTopPeerCategoryPeers, TypeImportedContact, TypeContactLink, TypePopularContact, TypeContact
