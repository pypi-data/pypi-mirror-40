...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeDocument, TypeHighScore, TypeDialog, TypeInlineBotSwitchPM, TypeUser, TypeMessage, TypeStickerSet, TypeFoundGif, TypeStickerPack, TypeChat, TypeChatFull, TypeBotInlineResult, TypeEncryptedFile, TypeStickerSetCovered
