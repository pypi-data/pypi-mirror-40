...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeContactBlocked, TypePopularContact, TypeTopPeerCategoryPeers, TypeContactLink, TypeImportedContact, TypeChat, TypePeer, TypeContact, TypeUser
