...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeEncryptedFile, TypeChatFull, TypeStickerPack, TypeStickerSetCovered, TypeStickerSet, TypeDocument, TypeMessage, TypeChat, TypeDialog, TypeFoundGif, TypeBotInlineResult, TypeInlineBotSwitchPM, TypeUser, TypeHighScore
