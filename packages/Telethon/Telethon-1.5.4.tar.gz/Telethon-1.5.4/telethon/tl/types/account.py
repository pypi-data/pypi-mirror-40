...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeSecurePasswordKdfAlgo, TypeSecureSecretSettings, TypePasswordKdfAlgo, TypeSecureRequiredType, TypePrivacyRule, TypeSecureValue, TypeWebAuthorization, TypeUser, TypeSecureValueError, TypeAuthorization
