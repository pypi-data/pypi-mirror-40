...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeMessagesFilter, TypeInputMedia, TypeInputUser, TypeSendMessageAction, TypeInputDialogPeer, TypeInputDocument, TypeInputBotInlineMessageID, TypeShippingOption, TypeInputChatPhoto, TypeInputStickerSet, TypeInputBotInlineResult, TypeBool, TypeInputGeoPoint, TypeReportReason, TypeInputEncryptedFile, TypeInputEncryptedChat, TypeInputPeer, TypeReplyMarkup, TypeInputMessage, TypeMessageEntity, TypeInputSingleMedia, TypeInputStickeredMedia, TypeInlineBotSwitchPM
