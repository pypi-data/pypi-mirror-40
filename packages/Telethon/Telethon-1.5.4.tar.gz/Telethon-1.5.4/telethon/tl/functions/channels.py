...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChannelAdminRights, TypeInputStickerSet, TypeChannelBannedRights, TypeInputMessage, TypeInputUser, TypeBool, TypeInputChannel, TypeInputChatPhoto, TypeChannelParticipantsFilter, TypeChannelAdminLogEventsFilter
