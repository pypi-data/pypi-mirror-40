...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputPeerNotifySettings, TypeSecureCredentialsEncrypted, TypeInputPeer, TypeInputCheckPasswordSRP, TypeInputNotifyPeer, TypeBool, TypeInputSecureValue, TypeInputPrivacyKey, TypeReportReason, TypeSecureValueHash, TypeInputPrivacyRule, TypeSecureValueType, TypeAccountDaysTTL
