...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeStickerPack, TypeFoundGif, TypeHighScore, TypeStickerSet, TypeStickerSetCovered, TypeChat, TypeDialog, TypeDocument, TypeInlineBotSwitchPM, TypeMessage, TypeUser, TypeEncryptedFile, TypeBotInlineResult, TypeChatFull
