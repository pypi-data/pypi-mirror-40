...
import struct
if TYPE_CHECKING:
    from ...tl.types import Typefuture_salt, TypeBool, Typedouble
...
class ChatFull(TLObject):
    CONSTRUCTOR_ID = 0xedd2a791
    SUBCLASS_OF_ID = 0xd49a2697

    def __init__(self, id, participants, notify_settings, exported_invite, chat_photo=None, bot_info=None, pinned_msg_id=None):
        """
        :param int id:
    ...
    def __bytes__(self):
        return b''.join((
            b'\x91\xa7\xd2\xed',
            struct.pack('<I', (0 if self.chat_photo is None or self.chat_photo is False else 4) | (0 if self.bot_info is None or self.bot_info is False else 8) | (0 if self.pinned_msg_id is None or self.pinned_msg_id is False else 64)),
            struct.pack('<i', self.id),
    ...
    def from_reader(cls, reader):
        ...
        if flags & 64:
            ...
            _pinned_msg_id = None
        return cls(id=_id, participants=_participants, notify_settings=_notify_settings, exported_invite=_exported_invite, chat_photo=_chat_photo, bot_info=_bot_info, pinned_msg_id=_pinned_msg_id)
...
class Document(TLObject):
    CONSTRUCTOR_ID = 0x59534e4c
    SUBCLASS_OF_ID = 0x211fe820

    def __init__(self, id, access_hash, file_reference, date, mime_type, size, thumb, dc_id, attributes):
        """
        :param int id:
        :param int access_hash:
    ...
    def from_reader(cls, reader):
        ...
        return cls(id=_id, access_hash=_access_hash, file_reference=_file_reference, date=_date, mime_type=_mime_type, size=_size, thumb=_thumb, dc_id=_dc_id, attributes=_attributes)
