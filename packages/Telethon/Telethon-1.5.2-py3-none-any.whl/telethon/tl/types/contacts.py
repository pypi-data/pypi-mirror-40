...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChat, TypeImportedContact, TypePeer, TypeContact, TypeContactBlocked, TypeContactLink, TypeTopPeerCategoryPeers, TypePopularContact, TypeUser
