...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypePrivacyRule, TypePasswordKdfAlgo, TypeSecurePasswordKdfAlgo, TypeSecureValueError, TypeWebAuthorization, TypeAuthorization, TypeSecureRequiredType, TypeSecureValue, TypeSecureSecretSettings, TypeUser
