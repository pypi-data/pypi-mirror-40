...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeShippingOption, TypeInputGeoPoint, TypeSendMessageAction, TypeInputUser, TypeInputChatPhoto, TypeInputMessage, TypeReplyMarkup, TypeInputBotInlineResult, TypeInputStickerSet, TypeInputPeer, TypeInlineBotSwitchPM, TypeInputDocument, TypeInputBotInlineMessageID, TypeReportReason, TypeInputMedia, TypeMessagesFilter, TypeInputEncryptedChat, TypeMessageEntity, TypeInputStickeredMedia, TypeInputEncryptedFile, TypeInputSingleMedia, TypeBool, TypeInputDialogPeer
