...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputPeerNotifySettings, TypeInputNotifyPeer, TypeSecureValueType, TypeInputCheckPasswordSRP, TypeInputPrivacyRule, TypeSecureCredentialsEncrypted, TypeInputPrivacyKey, TypeInputPeer, TypeSecureValueHash, TypeBool, TypeInputSecureValue, TypeAccountDaysTTL, TypeReportReason
