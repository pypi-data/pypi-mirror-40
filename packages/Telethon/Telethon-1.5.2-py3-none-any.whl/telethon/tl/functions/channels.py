...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChannelBannedRights, TypeInputChannel, TypeInputStickerSet, TypeInputUser, TypeInputChatPhoto, TypeChannelAdminRights, TypeInputMessage, TypeBool, TypeChannelParticipantsFilter, TypeChannelAdminLogEventsFilter
