...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputMessage, TypeChannelParticipantsFilter, TypeInputChannel, TypeInputStickerSet, TypeBool, TypeChannelBannedRights, TypeChannelAdminLogEventsFilter, TypeChannelAdminRights, TypeInputChatPhoto, TypeInputUser
