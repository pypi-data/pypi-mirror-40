...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputStickerSet, TypeBool, TypeMessagesFilter, TypeInputStickeredMedia, TypeInputSingleMedia, TypeInputDocument, TypeInputGeoPoint, TypeReportReason, TypeReplyMarkup, TypeInputPeer, TypeInputDialogPeer, TypeShippingOption, TypeSendMessageAction, TypeInputMedia, TypeInlineBotSwitchPM, TypeInputEncryptedFile, TypeInputMessage, TypeInputBotInlineMessageID, TypeMessageEntity, TypeInputBotInlineResult, TypeInputEncryptedChat, TypeInputChatPhoto, TypeInputUser
