...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeReportReason, TypeSecureValueType, TypeBool, TypeInputPrivacyRule, TypeSecureCredentialsEncrypted, TypeInputCheckPasswordSRP, TypeInputPeer, TypeInputNotifyPeer, TypeInputPrivacyKey, TypeSecureValueHash, TypeInputSecureValue, TypeInputPeerNotifySettings, TypeAccountDaysTTL
