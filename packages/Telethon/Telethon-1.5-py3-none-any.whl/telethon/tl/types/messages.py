...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeBotInlineResult, TypeDialog, TypeStickerSetCovered, TypeMessage, TypeChat, TypeDocument, TypeEncryptedFile, TypeUser, TypeFoundGif, TypeStickerSet, TypeInlineBotSwitchPM, TypeChatFull, TypeStickerPack, TypeHighScore
