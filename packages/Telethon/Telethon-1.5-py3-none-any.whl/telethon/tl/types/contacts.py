...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeContactLink, TypeContact, TypePeer, TypePopularContact, TypeChat, TypeUser, TypeTopPeerCategoryPeers, TypeImportedContact, TypeContactBlocked
