...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeBotInlineResult, TypeFoundGif, TypeStickerSetCovered, TypeUser, TypeChat, TypeDialog, TypeDocument, TypeStickerPack, TypeMessage, TypeEncryptedFile, TypeInlineBotSwitchPM, TypeHighScore, TypeStickerSet, TypeChatFull
