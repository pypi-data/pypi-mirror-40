...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypePopularContact, TypeContactBlocked, TypeUser, TypeChat, TypeContactLink, TypePeer, TypeTopPeerCategoryPeers, TypeImportedContact, TypeContact
