...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeAuthorization, TypePrivacyRule, TypeUser, TypeSecureValueError, TypeSecureValue, TypeWebAuthorization, TypeSecurePasswordKdfAlgo, TypeSecureRequiredType, TypeSecureSecretSettings, TypePasswordKdfAlgo
