...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputUser, TypeInputDialogPeer, TypeInputGeoPoint, TypeReplyMarkup, TypeSendMessageAction, TypeInputBotInlineResult, TypeInputBotInlineMessageID, TypeInputStickeredMedia, TypeInputEncryptedChat, TypeShippingOption, TypeInputPeer, TypeReportReason, TypeInputSingleMedia, TypeInputMessage, TypeInputEncryptedFile, TypeInlineBotSwitchPM, TypeInputStickerSet, TypeMessagesFilter, TypeBool, TypeInputChatPhoto, TypeInputMedia, TypeMessageEntity, TypeInputDocument
