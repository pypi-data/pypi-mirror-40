...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputPrivacyKey, TypeInputPeer, TypeInputNotifyPeer, TypeReportReason, TypeInputSecureValue, TypeAccountDaysTTL, TypeInputPrivacyRule, TypeInputPeerNotifySettings, TypeSecureCredentialsEncrypted, TypeSecureValueHash, TypeSecureValueType, TypeBool, TypeInputCheckPasswordSRP
