...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputUser, TypeInputChannel, TypeChannelAdminLogEventsFilter, TypeChannelParticipantsFilter, TypeInputChatPhoto, TypeInputMessage, TypeInputStickerSet, TypeChannelAdminRights, TypeChannelBannedRights, TypeBool
