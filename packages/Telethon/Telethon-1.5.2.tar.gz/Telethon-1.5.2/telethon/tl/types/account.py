...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeUser, TypeSecureSecretSettings, TypeAuthorization, TypeSecureRequiredType, TypeSecureValueError, TypeWebAuthorization, TypePrivacyRule, TypePasswordKdfAlgo, TypeSecureValue, TypeSecurePasswordKdfAlgo
