...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChat, TypeUser, TypeEncryptedFile, TypeStickerSet, TypeDialog, TypeStickerSetCovered, TypeInlineBotSwitchPM, TypeHighScore, TypeChatFull, TypeBotInlineResult, TypeDocument, TypeFoundGif, TypeMessage, TypeStickerPack
