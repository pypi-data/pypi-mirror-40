...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChat, TypeUser, TypePopularContact, TypeContactLink, TypePeer, TypeImportedContact, TypeContactBlocked, TypeTopPeerCategoryPeers, TypeContact
