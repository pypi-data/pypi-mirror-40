...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeBool, TypeInputUser, TypeChannelParticipantsFilter, TypeChannelAdminLogEventsFilter, TypeChannelBannedRights, TypeInputStickerSet, TypeInputMessage, TypeChannelAdminRights, TypeInputChatPhoto, TypeInputChannel
