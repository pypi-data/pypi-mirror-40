...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputEncryptedChat, TypeInputBotInlineResult, TypeInputDialogPeer, TypeInputMessage, TypeMessagesFilter, TypeInputChatPhoto, TypeMessageEntity, TypeInputUser, TypeInputBotInlineMessageID, TypeReplyMarkup, TypeReportReason, TypeBool, TypeInputStickerSet, TypeSendMessageAction, TypeInputSingleMedia, TypeInputMedia, TypeShippingOption, TypeInputStickeredMedia, TypeInputDocument, TypeInlineBotSwitchPM, TypeInputGeoPoint, TypeInputEncryptedFile, TypeInputPeer
