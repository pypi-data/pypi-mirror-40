...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputCheckPasswordSRP, TypeBool, TypeInputNotifyPeer, TypeSecureCredentialsEncrypted, TypeSecureValueHash, TypeAccountDaysTTL, TypeInputPeerNotifySettings, TypeReportReason, TypeInputSecureValue, TypeInputPrivacyKey, TypeInputPeer, TypeSecureValueType, TypeInputPrivacyRule
