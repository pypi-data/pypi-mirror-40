...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeStickerSetCovered, TypeStickerPack, TypeUser, TypeMessage, TypeDocument, TypeFoundGif, TypeStickerSet, TypeInlineBotSwitchPM, TypeBotInlineResult, TypeEncryptedFile, TypeChatFull, TypeHighScore, TypeDialog, TypeChat
