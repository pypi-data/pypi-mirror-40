...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeContactBlocked, TypeUser, TypePeer, TypePopularContact, TypeContact, TypeTopPeerCategoryPeers, TypeContactLink, TypeImportedContact, TypeChat
