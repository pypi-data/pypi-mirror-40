...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeWebAuthorization, TypePasswordKdfAlgo, TypeSecurePasswordKdfAlgo, TypeUser, TypePrivacyRule, TypeSecureValueError, TypeSecureRequiredType, TypeSecureSecretSettings, TypeSecureValue, TypeAuthorization
