...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeReportReason, TypeInputCheckPasswordSRP, TypeSecureCredentialsEncrypted, TypeInputNotifyPeer, TypeBool, TypeInputPrivacyRule, TypeInputPeerNotifySettings, TypeSecureValueType, TypeSecureValueHash, TypeAccountDaysTTL, TypeInputPrivacyKey, TypeInputSecureValue, TypeInputPeer
