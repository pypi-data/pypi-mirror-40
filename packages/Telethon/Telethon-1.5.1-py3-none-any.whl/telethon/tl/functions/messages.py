...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeReportReason, TypeInputStickerSet, TypeInputChatPhoto, TypeInputEncryptedFile, TypeInputDocument, TypeInlineBotSwitchPM, TypeInputUser, TypeBool, TypeMessagesFilter, TypeSendMessageAction, TypeInputMedia, TypeInputEncryptedChat, TypeReplyMarkup, TypeInputStickeredMedia, TypeShippingOption, TypeInputGeoPoint, TypeMessageEntity, TypeInputSingleMedia, TypeInputBotInlineMessageID, TypeInputBotInlineResult, TypeInputMessage, TypeInputDialogPeer, TypeInputPeer
