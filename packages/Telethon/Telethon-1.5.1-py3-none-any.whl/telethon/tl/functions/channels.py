...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChannelAdminLogEventsFilter, TypeBool, TypeChannelAdminRights, TypeInputStickerSet, TypeInputChannel, TypeChannelBannedRights, TypeInputChatPhoto, TypeChannelParticipantsFilter, TypeInputMessage, TypeInputUser
