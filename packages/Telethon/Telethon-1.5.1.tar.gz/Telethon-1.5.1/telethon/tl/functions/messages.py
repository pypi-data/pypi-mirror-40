...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputUser, TypeReportReason, TypeInputMessage, TypeBool, TypeMessagesFilter, TypeInputDocument, TypeInputSingleMedia, TypeInputEncryptedFile, TypeInputPeer, TypeInputChatPhoto, TypeInputMedia, TypeReplyMarkup, TypeInputGeoPoint, TypeInputEncryptedChat, TypeInputStickeredMedia, TypeInlineBotSwitchPM, TypeInputStickerSet, TypeSendMessageAction, TypeShippingOption, TypeInputBotInlineResult, TypeInputBotInlineMessageID, TypeMessageEntity, TypeInputDialogPeer
