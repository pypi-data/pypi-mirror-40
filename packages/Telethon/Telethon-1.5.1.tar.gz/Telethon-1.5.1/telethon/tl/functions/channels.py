...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputUser, TypeBool, TypeChannelParticipantsFilter, TypeInputChatPhoto, TypeChannelAdminRights, TypeInputStickerSet, TypeInputChannel, TypeChannelAdminLogEventsFilter, TypeChannelBannedRights, TypeInputMessage
