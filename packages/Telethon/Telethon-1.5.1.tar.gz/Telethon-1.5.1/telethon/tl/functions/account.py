...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeSecureCredentialsEncrypted, TypeBool, TypeInputPeer, TypeSecureValueType, TypeInputPrivacyKey, TypeInputCheckPasswordSRP, TypeInputNotifyPeer, TypeInputPrivacyRule, TypeSecureValueHash, TypeReportReason, TypeInputSecureValue, TypeAccountDaysTTL, TypeInputPeerNotifySettings
