...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeWebAuthorization, TypeUser, TypeAuthorization, TypePrivacyRule, TypeSecureValue, TypeSecurePasswordKdfAlgo, TypeSecureRequiredType, TypeSecureValueError, TypeSecureSecretSettings, TypePasswordKdfAlgo
