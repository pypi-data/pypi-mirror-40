...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeContactBlocked, TypeContact, TypeTopPeerCategoryPeers, TypePeer, TypeContactLink, TypePopularContact, TypeUser, TypeChat, TypeImportedContact
