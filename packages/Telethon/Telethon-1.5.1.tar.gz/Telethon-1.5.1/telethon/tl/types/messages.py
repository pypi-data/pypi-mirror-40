...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeHighScore, TypeInlineBotSwitchPM, TypeMessage, TypeChatFull, TypeDialog, TypeDocument, TypeBotInlineResult, TypeStickerSetCovered, TypeStickerPack, TypeStickerSet, TypeEncryptedFile, TypeUser, TypeChat, TypeFoundGif
