...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputSingleMedia, TypeInputBotInlineMessageID, TypeInputBotInlineResult, TypeShippingOption, TypeMessagesFilter, TypeInputGeoPoint, TypeBool, TypeInlineBotSwitchPM, TypeReportReason, TypeSendMessageAction, TypeInputEncryptedChat, TypeInputMessage, TypeInputUser, TypeMessageEntity, TypeInputChatPhoto, TypeInputStickeredMedia, TypeReplyMarkup, TypeInputPeer, TypeInputStickerSet, TypeInputDocument, TypeInputMedia, TypeInputEncryptedFile, TypeInputDialogPeer
