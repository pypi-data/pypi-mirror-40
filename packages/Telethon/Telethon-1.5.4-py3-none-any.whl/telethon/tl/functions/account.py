...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeSecureCredentialsEncrypted, TypeInputPrivacyKey, TypeBool, TypeInputNotifyPeer, TypeInputPrivacyRule, TypeInputPeer, TypeAccountDaysTTL, TypeSecureValueType, TypeSecureValueHash, TypeInputPeerNotifySettings, TypeInputCheckPasswordSRP, TypeInputSecureValue, TypeReportReason
