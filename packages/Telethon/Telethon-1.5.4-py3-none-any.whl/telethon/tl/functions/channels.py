...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputChannel, TypeChannelAdminLogEventsFilter, TypeChannelParticipantsFilter, TypeBool, TypeInputMessage, TypeInputStickerSet, TypeInputUser, TypeChannelBannedRights, TypeInputChatPhoto, TypeChannelAdminRights
