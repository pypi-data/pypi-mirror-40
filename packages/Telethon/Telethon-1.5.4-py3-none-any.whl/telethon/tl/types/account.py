...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeSecureRequiredType, TypeAuthorization, TypeSecureValueError, TypeSecureSecretSettings, TypeWebAuthorization, TypeUser, TypePasswordKdfAlgo, TypeSecureValue, TypeSecurePasswordKdfAlgo, TypePrivacyRule
