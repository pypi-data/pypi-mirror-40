...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChat, TypePopularContact, TypeTopPeerCategoryPeers, TypeImportedContact, TypeUser, TypeContactLink, TypePeer, TypeContact, TypeContactBlocked
