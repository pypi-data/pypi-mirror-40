...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChatFull, TypeStickerPack, TypeChat, TypeStickerSet, TypeStickerSetCovered, TypeFoundGif, TypeDocument, TypeInlineBotSwitchPM, TypeBotInlineResult, TypeUser, TypeMessage, TypeDialog, TypeHighScore, TypeEncryptedFile
