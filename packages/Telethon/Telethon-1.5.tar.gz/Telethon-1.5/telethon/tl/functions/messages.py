...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputBotInlineMessageID, TypeShippingOption, TypeInputStickerSet, TypeInputDocument, TypeInputMessage, TypeInputGeoPoint, TypeInlineBotSwitchPM, TypeInputPeer, TypeMessagesFilter, TypeInputMedia, TypeInputEncryptedFile, TypeBool, TypeInputStickeredMedia, TypeMessageEntity, TypeInputUser, TypeInputDialogPeer, TypeInputEncryptedChat, TypeReplyMarkup, TypeInputBotInlineResult, TypeSendMessageAction, TypeInputChatPhoto, TypeInputSingleMedia, TypeReportReason
