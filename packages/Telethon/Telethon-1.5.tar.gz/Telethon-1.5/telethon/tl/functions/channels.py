...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChannelAdminRights, TypeInputChannel, TypeChannelAdminLogEventsFilter, TypeChannelParticipantsFilter, TypeInputStickerSet, TypeInputMessage, TypeInputUser, TypeInputChatPhoto, TypeBool, TypeChannelBannedRights
