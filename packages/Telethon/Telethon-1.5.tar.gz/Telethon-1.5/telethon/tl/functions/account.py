...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputSecureValue, TypeAccountDaysTTL, TypeInputNotifyPeer, TypeInputCheckPasswordSRP, TypeInputPeerNotifySettings, TypeInputPrivacyKey, TypeInputPrivacyRule, TypeSecureCredentialsEncrypted, TypeSecureValueHash, TypeInputPeer, TypeBool, TypeReportReason, TypeSecureValueType
