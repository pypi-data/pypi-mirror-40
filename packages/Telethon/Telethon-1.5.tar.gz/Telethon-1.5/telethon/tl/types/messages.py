...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeDialog, TypeUser, TypeFoundGif, TypeDocument, TypeMessage, TypeChatFull, TypeEncryptedFile, TypeHighScore, TypeStickerSet, TypeChat, TypeStickerPack, TypeInlineBotSwitchPM, TypeStickerSetCovered, TypeBotInlineResult
