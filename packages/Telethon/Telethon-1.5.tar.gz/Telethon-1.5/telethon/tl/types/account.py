...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeUser, TypePasswordKdfAlgo, TypeSecureRequiredType, TypePrivacyRule, TypeSecureSecretSettings, TypeWebAuthorization, TypeSecureValue, TypeSecureValueError, TypeAuthorization, TypeSecurePasswordKdfAlgo
