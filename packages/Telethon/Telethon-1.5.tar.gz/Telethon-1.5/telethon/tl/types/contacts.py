...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeUser, TypePopularContact, TypePeer, TypeTopPeerCategoryPeers, TypeContactLink, TypeContactBlocked, TypeImportedContact, TypeChat, TypeContact
