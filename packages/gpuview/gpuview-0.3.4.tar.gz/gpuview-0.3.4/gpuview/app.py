...
from .utils import arg_parser, install_service
...
def main():
    ...
    if 'start' == args.action:
        ...
        print(args.safe_zone, args.exclude_self)
        install_service(safe_zone=args.safe_zone, exclude_self=args.exclude_self)
    else:
        parser.print_help()
