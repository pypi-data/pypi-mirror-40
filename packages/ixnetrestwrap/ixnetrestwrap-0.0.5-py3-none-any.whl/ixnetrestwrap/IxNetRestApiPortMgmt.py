...
class PortMgmt(object):
    ...
    def assignPorts(self, portList, createVports=False, rawTraffic=False, configPortName=True, timeout=180):
        """
        Description
    ...
    def resetPortCpu(self, vportList=None, portList=None, timeout=120):
        """
        Description
    ...
    def verifyPortState(self, timeout=80):
        """
        Description
