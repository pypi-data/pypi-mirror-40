...
setup(
    ...
    name='bob.thesis.tiago',
    version=open("version.txt").read().rstrip(),
    description='Tools to reproduce the experiments of the Ph.D. thesis from Tiago de Freitas Pereira',

    url='https://gitlab.idiap.ch/bob/bob.thesis.tiago',
    license='BSD',
