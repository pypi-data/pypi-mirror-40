...
nc2 = r'N:\nasa\precip\gpm_3IMERGHHL\gpm_3IMERGHHL_v07_20180101-20181231.nc4'

grid1 = xr.open_dataset(nc2)
da1 = (grid1[data_name] * 0.5).copy()
grid1.close()

da2 = da1.resample(time='H', closed='left', label='left').sum('time')

max_day = da2.groupby('time').sum().to_dataframe().idxmax()[0]

da3 = da2.loc['2018-01-17':'2018-01-24']

grid2d.plot.pcolormesh(x='lon', y='lat')

plt1 = da3.plot(x='lon', y='lat', col='time', col_wrap=4)

save1 = r'E:\ecan\git\hydrointerp\hydrointerp\datasets\nasa_gpm_2018-01-17.nc'
save2 = r'E:\ecan\git\hydrointerp\hydrointerp\datasets\nasa_gpm_2018-01-17.tif'

da4 = da1.loc['2018-01-17':'2018-01-18 00:00']
...
df5 = da5.to_dataframe().reset_index()
