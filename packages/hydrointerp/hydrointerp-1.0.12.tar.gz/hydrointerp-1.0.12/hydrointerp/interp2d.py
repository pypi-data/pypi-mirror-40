...
def points_to_grid(df, time_name, x_name, y_name, data_name, grid_res, from_crs, to_crs=None, bbox=None, method='cubic', extrapolation='contstant', fill_val=np.nan, digits=2, min_val=None):
    """
...
def points_to_points(df, time_name, x_name, y_name, data_name, point_data, from_crs, to_crs=None, method='cubic', digits=2, min_val=None):
    """
    Function to take a dataframe of point value inputs (df) and interpolate to other points (point_data). Uses the `scipy griddata function <https://docs.scipy.org/doc/scipy/reference/generated/scipy.interpolate.griddata.html>`_ for interpolation.
