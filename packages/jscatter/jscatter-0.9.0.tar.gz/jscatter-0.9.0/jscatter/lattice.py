...
class lattice(object):
    ...
    def show(self,R=None,cmap='rainbow',fig=None,ax=None):
        ...
        ax.scatter(points[:,0],points[:,1],points[:,2],c=points[:,3],s=10,cmap=cmap,vmin=bmin, vmax=bmax,depthshade=False)
        try:
...
class pseudoRandomLattice(lattice):
    ...
    def _makeLattice(self, size, N ,pb=None ,skip=None ):
        ...
        if useFortran:
            ...
            seq = parallel.haltonSequence(skip + N - 1, dim).T[skip-1:]
...
class rhombicLattice(lattice):
    ...
    def __init__(self, latticeVectors, size, unitCellAtoms=None, b=None):
        ...
        lattice object
            ...
            .unitCellAtoms_b     : Scattering lngth of specific unit cell atoms
