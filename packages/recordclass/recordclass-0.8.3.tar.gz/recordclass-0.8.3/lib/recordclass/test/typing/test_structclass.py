...
import pickle
import typing
from recordclass import StructClass, ArrayClass
...
class StructClassTypingTest(unittest.TestCase):
    ...
    def test_recordclass_basics(self):
        ...
        #self.assertIsSubclass(Emp, ArrayClass)
        joe = Emp('Joe', 42)
        jim = Emp(name='Jim', id=1)
        self.assertIsInstance(joe, Emp)
        self.assertIsInstance(joe, ArrayClass)
    ...
    def test_annotation_usage(self):
        ...
        self.assertIsInstance(tim, ArrayClass)
    ...
    def test_annotation_usage_with_default(self):
        ...
        self.assertIsInstance(jelle, ArrayClass)
...
""")
    ...
    def test_recordclass_keyword_usage(self):
        ...
        self.assertIsInstance(nick, ArrayClass)
