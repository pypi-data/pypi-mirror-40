...
def structclass(typename, field_names, rename=False, defaults=None, 
                 readonly=False, usedict=False, gc=False, weakref=False, module=None):
    """Returns a new subclass of array with named fields.
...
def arrayclass(typename, n, readonly=False, usedict=False, gc=False, weakref=False, module=None):
    new_func_template = """\
...
def join_classes(name, classes, readonly=False, usedict=False, gc=False, weakref=False, module=None):
    ...
    return structclass(name, _attrs, 
                       readonly=readonly, usedict=usedict, gc=gc, weakref=weakref, module=module)
