...
class ExternalAuthorizationProvider(object):
    ...
    def unknown_access(self, user_id, user_category, category, zone=None):
        ...
        res = self.access(user_id, user_category, start, category, end, zone=zone)
        print(res)
        return res

    def access(self, user_id, user_category, start, category, end=None, recurrence=None, zone=None):
        result = {
            "category": category,
