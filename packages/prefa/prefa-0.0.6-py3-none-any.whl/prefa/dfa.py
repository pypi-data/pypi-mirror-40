import sys  # Allow importing .py files under same directory.
sys.path.append('.')

import fa   # FA prototype
import nfa  # NFA class
import re   # Regular Expression class
...
if __name__ == '__main__':
    ...
    rexpr = re.Regex('ab(b*)*(a+b)*a*b')
    print(rexpr)
    print(DFiniteAutomata(rexpr))

    print(DFiniteAutomata(rexpr).minimalDFA())
