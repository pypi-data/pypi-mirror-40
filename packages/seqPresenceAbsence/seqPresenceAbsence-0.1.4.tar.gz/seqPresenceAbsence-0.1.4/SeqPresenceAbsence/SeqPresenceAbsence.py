...
def parse_blastn(blastn_file: Path, perc_identity: float, keep_db_seqs: bool = None,
                 header: list = None) -> pd.DataFrame:
    """
    ...
    :param keep_db_seqs: Flag to determine if we should get sseq strand aware as well
