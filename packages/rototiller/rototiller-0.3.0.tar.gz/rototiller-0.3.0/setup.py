"""Setup file for rototiller project."""
...
setuptools.setup(
    ...
    keywords="coroutines generators test assert record replay restore utility",
    install_requires=[
        'din',
    ],
    extras_require={
        'test': [
            ...
            'flake8-logging-format',  # imported by flake8
