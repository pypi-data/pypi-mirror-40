...
class TestCompleteItemMetaclass(TestBase):
    ...
    def test_aliases_process(self):
        ...
        value = self.ItemGeneralOne.process_field('alias_2', '2')
        ...
        self.assertTrue(item.to_dict(), expect)
        ...
        bulk.gen(alias_1='1',
                 ...
                 two_1_1__alias_2__post='5',
                 two_1_1__alias_3__post='5.5')
        bulk['two_1_1__alias_3__post'] = '6.6'
        bulk.process()
        expect = {
            'bulk': [item.to_dict()],
            'defaults': {
                # two_1_1__alias_3__post
                'two_1_1__one_x_x__two_1_x__f_float': 6.6
            }
        }
