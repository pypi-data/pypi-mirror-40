...
OFFLINE = False
NODE = 'https://nodes.unidex.online'
...
CHAIN = 'unidex'
CHAIN_ID = 'X'
MATCHER = 'https://matcher.unidex.online'
MATCHER_PUBLICKEY = ''

DATAFEED = 'https://datafeed.unidex.online'
...
def symbols():
    return wrapper('/datafeed/symbols', host=DATAFEED)

def markets():
    return wrapper('/datafeed/markets', host=DATAFEED)
