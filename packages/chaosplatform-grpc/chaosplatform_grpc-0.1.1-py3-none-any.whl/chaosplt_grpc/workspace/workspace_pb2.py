...
_DELETEREQUEST = _descriptor.Descriptor(
  name='DeleteRequest',
  full_name='chaoshub.workspace.DeleteRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='workspace', full_name='chaoshub.workspace.DeleteRequest.workspace', index=0,
...
_DELETEREPLY = _descriptor.Descriptor(
  name='DeleteReply',
  full_name='chaoshub.workspace.DeleteReply',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_GETBYUSERREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='user_id', full_name='chaoshub.workspace.GetByUserRequest.user_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DeleteRequest = _reflection.GeneratedProtocolMessageType('DeleteRequest', (_message.Message,), dict(
  ...
  __module__ = 'workspace.workspace_pb2'
  # @@protoc_insertion_point(class_scope:chaoshub.workspace.DeleteRequest)
  ))
...
DeleteReply = _reflection.GeneratedProtocolMessageType('DeleteReply', (_message.Message,), dict(
  ...
  __module__ = 'workspace.workspace_pb2'
  # @@protoc_insertion_point(class_scope:chaoshub.workspace.DeleteReply)
  ))
