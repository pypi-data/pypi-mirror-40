...
setup(
    ...
    description='Tools to reproduce the paper "Heterogeneous Face Recognition Using Domain Specific Units"',

    url='https://gitlab.idiap.ch/bob/bob.paper.tifs2018_dsu',
    license='BSD',
