...
class ProductService:
    ...
    def create_item(self, gid, chain_item_base_d_t_o):
        """
        添加连锁总店商品
        :param gid:连锁总店商品分组Id
        :param chainItemBaseDTO:商品创建信息
        """
        return self.__client.call("eleme.product.chain.item.createItem", {"gid": gid, "chainItemBaseDTO": chain_item_base_d_t_o})
