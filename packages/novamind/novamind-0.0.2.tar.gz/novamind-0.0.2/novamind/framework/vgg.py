...
"""
VGG_16:
    input:[224, 224, 3]  大小224*224的RGB图像
    convolution1:
          convolution1_1:
                weights_size:[3, 3, 3, 64]  卷积核大小3*3 输入RGB三维，输出64维
                out_put_size: [224, 224, 64]
          convolution1_2:
    ...
    convolution2:
          convolution2_1:
                ...
                out_put_size: [112, 112, 128]
          convolution2_2:
                weights_size:[3, 3, 128, 128]  卷积核大小3*3 128维，输出128维
                out_put_size: [112, 112, 128]
          pooling_2:
                 stride = 2   做一个2*2最大池化
                 out_put_size: [56, 56, 128]
    convolution3:
          convolution3_1:
    ...
    convolution5:
          ...
          pooling_5:
                 stride = 2   做一个2*2最大池化
                 out_put_size: [7, 7, 512]
    reshape: 7*7*512=25088-------4096
    fully connected_1:
          in_put -- out_put = 25088 -- 4096
    fully connected_2:
          in_put -- out_put = 4096 -- 4096
    fully connected_3:
          in_put -- out_put = 4096 -- 1000
    softmax(不是sigmoid):
          1000 -- 1000
"""
class vgg16:
