...
class Ui_LogicSettingsWindow(object):
    ...
    def retranslateUi(self, LogicSettingsWindow):
        ...
        self.skytemple_description.setText(QtWidgets.QApplication.translate("LogicSettingsWindow", "<html><head/><body><p>Controls where the Sky Temple Keys will be located.</p></body></html>", None, -1))
        self.skytemple_vanilla_radio.setText(QtWidgets.QApplication.translate("LogicSettingsWindow", "Vanilla Locations (Not Randomized)", None, -1))
        self.skytemple_vanilla_label.setText(QtWidgets.QApplication.translate("LogicSettingsWindow", "<html><head/><body><p>All Sky Temple Keys are inside the Ing Caches they were in originally.</p></body></html>", None, -1))
        self.skytemple_randomized_radio.setText(QtWidgets.QApplication.translate("LogicSettingsWindow", "Randomized", None, -1))
        self.skytemple_randomized_label.setText(QtWidgets.QApplication.translate("LogicSettingsWindow", "<html><head/><body><p>Sky Temple Keys are shuffled along with everything else.</p></body></html>", None, -1))
