...
class Ui_SeedDetailsWindow(object):
    ...
    def retranslateUi(self, SeedDetailsWindow):
        ...
        SeedDetailsWindow.setWindowTitle(_translate("SeedDetailsWindow", "Seed Details"))
        self.layout_keys_text_label.setText(_translate("SeedDetailsWindow", "Sky Temple Keys:"))
        self.layout_trick_text_label.setText(_translate("SeedDetailsWindow", "Trick Level"))
        self.layout_elevators_value_label.setText(_translate("SeedDetailsWindow", "TextLabel"))
        self.layout_keys_value_label.setText(_translate("SeedDetailsWindow", "TextLabel"))
        self.layout_item_loss_text_label.setText(_translate("SeedDetailsWindow", "Item Loss:"))
        self.layout_elevators_text_label.setText(_translate("SeedDetailsWindow", "Elevators: "))
        self.layout_item_loss_value_label.setText(_translate("SeedDetailsWindow", "TextLabel"))
        self.layout_seed_value_label.setText(_translate("SeedDetailsWindow", "TextLabel"))
        self.layout_seed_text_label.setText(_translate("SeedDetailsWindow", "Seed:"))
        self.layout_trick_value_label.setText(_translate("SeedDetailsWindow", "layout_trick_value_label"))
        self.layout_info_tab.setTabText(self.layout_info_tab.indexOf(self.details_tab), _translate("SeedDetailsWindow", "Configuration"))
        self.pickup_spoiler_pickup_combobox.setItemText(0, _translate("SeedDetailsWindow", "None"))
        self.pickup_spoiler_label.setToolTip(_translate("SeedDetailsWindow", "Enter text to the right to filter the list below"))
        self.pickup_spoiler_label.setText(_translate("SeedDetailsWindow", "Search Pickup"))
        self.pickup_spoiler_show_all_button.setText(_translate("SeedDetailsWindow", "Show All"))
        self.layout_info_tab.setTabText(self.layout_info_tab.indexOf(self.pickup_tab), _translate("SeedDetailsWindow", "Spoiler: Pickups"))
        self.label.setText(_translate("SeedDetailsWindow", "Check the exported log file."))
        self.layout_info_tab.setTabText(self.layout_info_tab.indexOf(self.solver_path), _translate("SeedDetailsWindow", "Spoiler: Solver Path"))
