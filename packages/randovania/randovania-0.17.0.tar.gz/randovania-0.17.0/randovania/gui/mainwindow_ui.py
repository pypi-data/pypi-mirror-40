...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.progress_box.setTitle(_translate("MainWindow", "Progress"))
        self.stop_background_process_button.setText(_translate("MainWindow", "Stop"))
        self.menu_open.setTitle(_translate("MainWindow", "Open"))
        self.menu_action_data_visualizer.setText(_translate("MainWindow", "Data Visualizer"))
        self.menu_action_existing_seed_details.setText(_translate("MainWindow", "Existing Seed Details"))
        self.menu_action_tracker.setText(_translate("MainWindow", "Tracker"))
