...
class Ui_ItemQuantitiesWindow(object):
    ...
    def retranslateUi(self, ItemQuantitiesWindow):
        ...
        ItemQuantitiesWindow.setWindowTitle(_translate("ItemQuantitiesWindow", "Someone forgot to name this"))
        self.itemquantity_reset_button.setText(_translate("ItemQuantitiesWindow", "Reset"))
        self.itemquantity_description_label.setText(_translate("ItemQuantitiesWindow", "<html><head/><body><p align=\"justify\">Choose how many of each item will appear in the game. Adding more than one for major upgrades makes it more likely you\'ll find that upgrade, but additional copies are useless.</p><p align=\"justify\">The total of configured items must be less than how many spots are in the game: trying to add more will fail when generating.</p><p align=\"justify\">If removing items, the remaning spots are filled with Energy Transfer Module.</p></body></html>"))
        self.itemquantity_total_label.setText(_translate("ItemQuantitiesWindow", "Total Pickups: 0/0"))
