...
from sense_data.dictobj import list_to_object_list
        ...
        with grpc.insecure_channel(self._host+":"+self._port) as channel:
            ...
            if len(args) ==3:
                response = stub.get_stock_price_day(
                    stock_pb2.StockCode(var_num=len(args), stock_code=args[0], start_time=args[1], end_time=args[2]))
            elif len(args) ==2:
                response = stub.get_stock_price_day(
                    stock_pb2.StockCode(var_num=len(args), stock_code=args[0], start_time=args[1]))
            elif len(args) ==1:
                response = stub.get_stock_price_day(
...
if __name__ == '__main__':
    ...
    print(xw, '\n')
    #
    # xw = get_company_info(stock_code)
    # print(type(xw))
    # print(xw, '\n')
    # xw = get_industry_concept(stock_code)
    # print(type(xw))
    # print(xw, '\n')
    # xw = get_stock_price_day(stock_code)
    # print(type(xw))
    # print(type(xw[0]))
    # print(xw)
    # print(xw[0], '\n')

    # xw = get_company_alias(company_code)
    # print(type(xw))
    # print(type(xw[0]))
    # print(xw)
    # print(xw[0], '\n')
    # xw = get_chairman_supervisor(company_code)
    # print(type(xw))
    # print(type(xw[0]))
    # print(xw)
    # print(xw[0], '\n')
    # xw =get_stockholder(company_code)
    # print(type(xw))
    # print(type(xw[0]))
    # print(xw)
    # print(xw[0], '\n')
    # xw = get_subcompany(company_code)
    # print(type(xw))
    # print(type(xw[0]))
    # print(xw)
    # print(xw[0])
