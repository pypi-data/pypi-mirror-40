...
class StockInfStub(object):
  ...
  def __init__(self, channel):
    ...
    self.get_stock_price_tick = channel.unary_unary(
        ...
        request_serializer=stock__pb2.StockCode.SerializeToString,
        response_deserializer=stock__pb2.FinanceInfo.FromString,
        )
...
def add_StockInfServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'get_stock_price_tick': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=stock__pb2.StockCode.FromString,
          response_serializer=stock__pb2.FinanceInfo.SerializeToString,
      ),
