...
def check_if_elody_credentials_are_configured(args):
    ...
    if os.path.isfile(_CONFIG_FILE):
        ...
        raise ValueError("Email and password for Elody must be specified. Either use a configuration file for this or provide them as arguments. See --help for details.")
...
subparser.add_argument('-p', '--password', required=True,
    help="the password of your LOD account.")
