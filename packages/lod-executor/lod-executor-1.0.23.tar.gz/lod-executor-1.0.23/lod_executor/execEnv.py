...
class ExecEnv(threading.Thread):
        ...
        try:
            ...
            if not is_benign_error:
                ...
                if not _the_manager.config['debug_mode']:
                    error_message = "An error occurred. Activate debug mode for details."
                status_update = {
                    'type' : 'exec_env_error',
    ...
    def get_status_updates(self, next_io_event_index):
        ...
        with self.lock:
            ...
            last_set_status_message_tag = self.latest_object_manager.find_latest_tag('!set_status_message', not_nullified=True)
