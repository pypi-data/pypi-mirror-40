...
class VirtualNetworkGatewayConnectionsOperations(object):
    ...
    def create_or_update(
        ...
        :rtype:
         ...
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2015_06_15.models.VirtualNetworkGatewayConnection]]
    ...
    def reset_shared_key(
            self, resource_group_name, virtual_network_gateway_connection_name, key_length=None, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :rtype:
         ...
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2015_06_15.models.ConnectionResetSharedKey]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def set_shared_key(
            self, resource_group_name, virtual_network_gateway_connection_name, value=None, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :rtype:
         ...
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2015_06_15.models.ConnectionSharedKey]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
