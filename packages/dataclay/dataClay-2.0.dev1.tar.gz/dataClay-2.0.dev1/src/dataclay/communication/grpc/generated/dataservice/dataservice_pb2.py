...
_DATASERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='newLMBackup',
    full_name='dataclay.communication.grpc.dataservice.DataService.newLMBackup',
    index=37,
    containing_service=None,
    input_type=dataclay_dot_communication_dot_grpc_dot_messages_dot_dataservice_dot_dataservice__messages__pb2._NEWLMBACKUPREQUEST,
    output_type=dataclay_dot_communication_dot_grpc_dot_messages_dot_common_dot_common__messages__pb2._EXCEPTIONINFO,
    options=None,
  ),
  _descriptor.MethodDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='dataclay.communication.grpc.dataservice.DataService.createParaverTraces',
    index=39,
    containing_service=None,
    input_type=dataclay_dot_communication_dot_grpc_dot_messages_dot_common_dot_common__messages__pb2._EMPTYMESSAGE,
    output_type=dataclay_dot_communication_dot_grpc_dot_messages_dot_common_dot_common__messages__pb2._EXCEPTIONINFO,
  ...
  _descriptor.MethodDescriptor(
    ...
    index=40,
    containing_service=None,
    input_type=dataclay_dot_communication_dot_grpc_dot_messages_dot_dataservice_dot_dataservice__messages__pb2._ACTIVATETRACTINGREQUEST,
    output_type=dataclay_dot_communication_dot_grpc_dot_messages_dot_common_dot_common__messages__pb2._EXCEPTIONINFO,
    options=None,
  ),
  _descriptor.MethodDescriptor(
