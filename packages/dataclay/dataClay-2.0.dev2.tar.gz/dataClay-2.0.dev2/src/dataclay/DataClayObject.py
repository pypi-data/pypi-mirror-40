...
class DataClayObject(object):
    ...
    def get_federation(self):
        """ Retrieve dataClay instances where the object is federated
        :return: dataClay instances where this object is federated
        :rtype: set of UUID
        """
        return getRuntime().get_federation(self.get_object_id())
    ...
    def __reduce__(self):
        ...
        if not dco_extradata.persistent_flag:
            # TODO: Decide whether we explicitly make_persistent the object or use volatile mechanism
            logger.warning("Trying to pickle a non-persistent object. Default->make_persistent")
