...
from dataclay.serialization.lib.DeserializationLibUtils import deserialize_params, deserialize_params_or_return
...
from dataclay.serialization.lib.SerializationLibUtils import serialize_params_or_return, serialize_dcobj_with_data, \
    serialize_for_db, serialize_for_db_gc
...
class ExecutionEnvironment(object):
    ...
    def store_in_memory(self, session_id, objects_to_store):
        ...
        return deserialize_params(objects_to_store, None, None, None, getRuntime())
    ...
    def unfederate(self, session_id, object_id):
        """ This function is called when an object is unfederated.
        :param session_id: ID of session of federation call
        :param object_id: ID of the object to unfederate
        :returns: None
        :type session_id: Session ID
    ...
    def update_object(self, session_id, into_object_id, from_object):
        ...
        object_from = deserialize_params_or_return(from_object, None, None, None, getRuntime())[0]
    ...
    def get_object_internal(self, oid, moving):
        ...
        try:
            ...
            if current_obj.is_pending_to_register():
                ...
                obj_bytes = serialize_for_db_gc(current_obj, False, None)
