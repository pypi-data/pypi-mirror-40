...
class MyStrategy(StrategyTemplate):
    ...
    def TaskCallback(self):
        ...
        self.Unsubscribe(["j1905.DCE.Tick.0", "j1905.DCE.Bar.60"])
        self.Unsubscribe(["j1909.DCE.Tick.0", "j1909.DCE.Bar.60"])

        self.Subscribe(["jm1905.DCE.Tick.0", "jm1905.DCE.Bar.60"])
        self.Subscribe(["jm1909.DCE.Tick.0", "jm1909.DCE.Bar.60"])
...
if __name__ == '__main__':
    ...
    #创建定时任务
    strategy.CreateScheduler(strategy.TaskCallback, [110250, 164400, 164300])
    ...
    strategy.Subscribe(["j1905.DCE.Tick.0", "j1905.DCE.BAR.60"])
