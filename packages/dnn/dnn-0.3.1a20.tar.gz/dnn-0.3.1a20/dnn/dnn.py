...
class DNN:
    ...
    def maybe_save_checkpoint (self, r):
        ...
        if performance > self.max_performance:
            ...
            if self.max_performance < self.performance_threshold:
                return
    ...
    def evaluate (self, x, y, is_training, ops, *args, **kargs):
        ...
        r = result.Result (
            ...
            is_training, True, self.on_ftest
        )
    ...
    def batch (self, x, y, ops = None, **kargs):
        ...
        return result.Result (
            ...
            self.epoch,  global_step, True, False, False
        )
    ...
    def optimizer (self, name = 'adam', cost = None, learning_rate = None, var_names = [], **karg):
        ...
        net_cost, reg_cost, var_list, task_name = cost
        if var_list:
