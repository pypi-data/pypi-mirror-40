...
class Result:
    ...
    labels = None
    name = None
    _perfmetricfunc = None
    _summaryfunc = None        
            
    def __init__ (self, xs, ys, is_validating, logits, cost, acc, epoch, ops = None, args = None):
        self.xs = xs
        self.ys = ys
        self.logits = logits
        self.cost = cost        
        ...
        if acc is not None and self._perfmetricfunc: # no run within batch steps
            self.performance = self._perfmetricfunc (self)
