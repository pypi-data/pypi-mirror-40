...
The end of an interval is given as a :code:`datetime` when required to maintain the resolution specified by a duration, even if the duration start is given as a date::
