...
"""
__all__ = ["SingletonContainerImpl"]

from typing import Any, Dict, ItemsView, Iterator, KeysView, Optional, Type, ValuesView

from ricochet.registries import singleton_container
from ricochet.utils import logger_mixin


class SingletonContainerImpl(singleton_container.SingletonContainer, logger_mixin.LoggerMixin):
    """
    Basic implementation of a Singleton registry. This provides access to any singleton elements as normal references,
