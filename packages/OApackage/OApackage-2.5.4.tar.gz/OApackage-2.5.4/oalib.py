...
class array_link(object):
    ...
    def create_root(self, ad, fill_value=0):
        """
        create_root(array_link self, arraydata_t ad, int fill_value=0)
        ...
        """
        return _oalib.array_link_create_root(self, ad, fill_value)
...
def myassert(condition, error_message=None):
    """
    myassert(int condition, char const * error_message=None)
...
def extend_arraylist(*args):
    """
    extend_arraylist(arraylist_t alist, arraydata_t arrayclass, OAextend oaextend, colindex_t extensioncol, arraylist_t extensions) -> int
    extend_arraylist(arraylist_t alist, arraydata_t arrayclass, OAextend oaextend_options) -> arraylist_t
...
def allocate_rowsort(N):
    """
    allocate_rowsort(int N) -> rowsort_t
    ...
    """
    return _oalib.allocate_rowsort(N)

def deallocate_rowsort(rowsort):
    """
    deallocate_rowsort(rowsort_t *& rowsort)
    ...
    """
    return _oalib.deallocate_rowsort(rowsort)
...
class conference_t(object):
    ...
    def create_root(self):
        ...
        create the unique representative of the 2 column design (for conference
        matrices)  
...
def generateConferenceExtensions(al, conference_type, zero_index, verbose=1, filtersymm=1, filterj2=1):
    """
    generateConferenceExtensions(array_link al, conference_t conference_type, int zero_index, int verbose=1, int filtersymm=1, int filterj2=1) -> conference_columnVector
    generateConferenceExtensions(array_link al, conference_t conference_type, int zero_index, int verbose=1, int filtersymm=1) -> conference_columnVector
    generateConferenceExtensions(array_link al, conference_t conference_type, int zero_index, int verbose=1) -> conference_columnVector
    generateConferenceExtensions(array_link al, conference_t conference_type, int zero_index) -> conference_columnVector
    ...
    * `filterj2` :  
    ...
    """
    return _oalib.generateConferenceExtensions(al, conference_type, zero_index, verbose, filtersymm, filterj2)

def generateConferenceRestrictedExtensions(al, conference_type, zero_index, verbose=1, filtersymm=1, filterip=1):
    """
    generateConferenceRestrictedExtensions(array_link al, conference_t conference_type, int zero_index, int verbose=1, int filtersymm=1, int filterip=1) -> conference_columnVector
    generateConferenceRestrictedExtensions(array_link al, conference_t conference_type, int zero_index, int verbose=1, int filtersymm=1) -> conference_columnVector
    generateConferenceRestrictedExtensions(array_link al, conference_t conference_type, int zero_index, int verbose=1) -> conference_columnVector
    generateConferenceRestrictedExtensions(array_link al, conference_t conference_type, int zero_index) -> conference_columnVector
    ...
    """
    return _oalib.generateConferenceRestrictedExtensions(al, conference_type, zero_index, verbose, filtersymm, filterip)

def generateDoubleConferenceExtensions(al, conference_type, verbose=1, filtersymm=1, filterip=1, filterJ3=0, filtersymminline=1):
    """
    generateDoubleConferenceExtensions(array_link al, conference_t conference_type, int verbose=1, int filtersymm=1, int filterip=1, int filterJ3=0, int filtersymminline=1) -> conference_columnVector
    generateDoubleConferenceExtensions(array_link al, conference_t conference_type, int verbose=1, int filtersymm=1, int filterip=1, int filterJ3=0) -> conference_columnVector
    generateDoubleConferenceExtensions(array_link al, conference_t conference_type, int verbose=1, int filtersymm=1, int filterip=1) -> conference_columnVector
    generateDoubleConferenceExtensions(array_link al, conference_t conference_type, int verbose=1, int filtersymm=1) -> conference_columnVector
    generateDoubleConferenceExtensions(array_link al, conference_t conference_type, int verbose=1) -> conference_columnVector
    generateDoubleConferenceExtensions(array_link al, conference_t conference_type) -> conference_columnVector



    """
    return _oalib.generateDoubleConferenceExtensions(al, conference_type, verbose, filtersymm, filterip, filterJ3, filtersymminline)

def generateSingleConferenceExtensions(al, conference_type, zero_index, verbose, filtersymm, filterj2, filterj3, filtersymminline=0):
    """
    generateSingleConferenceExtensions(array_link al, conference_t conference_type, int zero_index, int verbose, int filtersymm, int filterj2, int filterj3, int filtersymminline=0) -> conference_columnVector
    generateSingleConferenceExtensions(array_link al, conference_t conference_type, int zero_index, int verbose, int filtersymm, int filterj2, int filterj3) -> conference_columnVector



    """
    return _oalib.generateSingleConferenceExtensions(al, conference_type, zero_index, verbose, filtersymm, filterj2, filterj3, filtersymminline)
...
class DconferenceFilter(object):
    ...
    def filterJpartial(self, c, maxrow):
        """
        filterJpartial(DconferenceFilter self, charVector c, int maxrow) -> bool
        ...
        """
        return _oalib.DconferenceFilter_filterJpartial(self, c, maxrow)
...
def inflateCandidateExtension(basecandidate, als, alsg, check_indices, ct, verbose, filter):
    """
    inflateCandidateExtension(charVector basecandidate, array_link als, symmetry_group alsg, intVector check_indices, conference_t ct, int verbose, DconferenceFilter filter) -> conference_columnVector



    Inflate a candidate column  

    The extensions are generated according to the symmertry specified by the
    symmetry group. Filtering is performed using the filter object.  
