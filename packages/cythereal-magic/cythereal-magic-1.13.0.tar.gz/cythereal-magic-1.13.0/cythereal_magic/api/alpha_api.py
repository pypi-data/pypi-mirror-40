...
class AlphaApi(object):
    ...
    def get_public_files(self, **kwargs):  # noqa: E501
        """List all public binaries available  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_public_files(async=True)
        >>> result = thread.get()
        ...
        :return: PublicFilesListResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_public_files_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_public_files_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_public_files_with_http_info(self, **kwargs):  # noqa: E501
        """List all public binaries available  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_public_files_with_http_info(async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_public_files" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='PublicFilesListResponse',  # noqa: E501
            auth_settings=auth_settings,
            async=params.get('async'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
