...
class FileStatus(object):
    ...
    def status(self):
        ...
        One of: - **pending**: Processing has not started yet. - **in progress**: Processing has begun, but not all analysis are complete. - **success**: All analysis successfully completed. - **error**: At least one analysis returned an error. - **none**: File is not a file type that is analyzed. - **Improperly processed file**: The   file was improperly processed. There   is no object class for the file. - **unhandled file type**: The file is   not of a supported type.   # noqa: E501
    ...
    def status(self, status):
        ...
        allowed_values = ["pending", "in progress", "success", "error", "none", "Improperly processed file", "unhandled file type"]  # noqa: E501
